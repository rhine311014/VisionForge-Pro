...
void MeasureAreaToolDialog::connectSignals()
{
    ...
    // 图像操作按钮
    connect(loadImageBtn_, &QPushButton::clicked, this, &MeasureAreaToolDialog::onLoadImageClicked);
    connect(captureImageBtn_, &QPushButton::clicked, this, &MeasureAreaToolDialog::onCaptureImageClicked);
}
...
void MeasureAreaToolDialog::onLoadImageClicked()
{
...
void MeasureAreaToolDialog::onCaptureImageClicked()
{
