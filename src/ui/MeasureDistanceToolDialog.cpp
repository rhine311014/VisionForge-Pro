...
void MeasureDistanceToolDialog::connectSignals()
{
    ...
    // 图像操作按钮
    connect(loadImageBtn_, &QPushButton::clicked, this, &MeasureDistanceToolDialog::onLoadImageClicked);
    connect(captureImageBtn_, &QPushButton::clicked, this, &MeasureDistanceToolDialog::onCaptureImageClicked);
}
...
void MeasureDistanceToolDialog::onLoadImageClicked()
{
...
void MeasureDistanceToolDialog::onCaptureImageClicked()
{
