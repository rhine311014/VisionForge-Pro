...
class CDlgSearch;
class CDlgPatternCircle4LineSearchTool : public CDialogEx
{
	DECLARE_DYNAMIC(CDlgPatternCircle4LineSearchTool)

public:
	CDlgPatternCircle4LineSearchTool(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgPatternCircle4LineSearchTool();
...
// 对话框数据
	enum { IDD = IDD_DLG_PATTERN_CIRCLE_4LINESEARCH_TOOL };
