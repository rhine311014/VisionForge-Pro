...
// 
// IMPLEMENT_DYNAMIC(CDlgPatternLineCircleTool, CDialog)
// 
// CDlgPatternLineCircleTool::CDlgPatternLineCircleTool(CWnd* pParent /*=NULL*/)
// 	: CDialog(CDlgPatternLineCircleTool::IDD, pParent)
// {
// 
// }
// 
// CDlgPatternLineCircleTool::~CDlgPatternLineCircleTool()
// {
// }
// 
// void CDlgPatternLineCircleTool::DoDataExchange(CDataExchange* pDX)
// {
// 	CDialog::DoDataExchange(pDX);
// }
// 
// 
// BEGIN_MESSAGE_MAP(CDlgPatternLineCircleTool, CDialog)
// END_MESSAGE_MAP()


// CDlgPatternLineCircleTool 消息处理程序
...
// 	m_lTotalMag = 500;
	...
	m_nLinePolarityMode1 = (int)eDontCare;
	m_lLineFilterHalfWidth1 = 1;
	m_bLineSortByScore1 = TRUE;
	m_nLineAngleType = 0;
...
void CDlgPatternLineCircleTool::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHECK_SORT_BY_SCORE2, m_bLineSortByScore1);
	DDX_Control(pDX, IDC_CHECK_SORT_BY_SCORE2, m_LineCheckSortByScore1);
	...
	DDX_Check(pDX, IDC_CHECK_SHOW_LINE_POINT2, m_bEnableShowLinePoint2);
	DDX_Control(pDX, IDC_CHECK_SHOW_LINE_POINT2, m_checkShowLinePoint2);
...
// 	ON_EN_SETFOCUS(IDC_EDT_TOTAL_MAG, OnSetfocusEdtTotalMag)
	...
	ON_CBN_SELCHANGE(IDC_COMBO_LINE_ANGLE_TYPE, &CDlgPatternLineCircleTool::OnCbnSelchangeComboLineAngleType)
...
// 	ON_EN_SETFOCUS(IDC_EDT_ANGLE_HIGH, OnSetfocusEdtAngleHigh)
	...
	ON_BN_CLICKED(IDC_CHECK_SHOW_LINE_POINT, &CDlgPatternLineCircleTool::OnBnClickedCheckShowLinePoint)
	ON_BN_CLICKED(IDC_CHECK_SHOW_LINE_POINT2, &CDlgPatternLineCircleTool::OnBnClickedCheckShowLinePoint2)
	ON_BN_CLICKED(IDC_CHK_SHOW_CIRCLE_CALIPER, &CDlgPatternLineCircleTool::OnBnClickedChkShowCircleCaliper)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER, &CDlgPatternLineCircleTool::OnBnClickedChkShowLineCaliper)
	ON_BN_CLICKED(IDC_CHECK_CIRCLE_MASK, &CDlgPatternLineCircleTool::OnBnClickedCheckCircleMask)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK, &CDlgPatternLineCircleTool::OnBnClickedCheckLineMask)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgCircleSearchTool message handlers

void CDlgPatternLineCircleTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgPatternLineCircleTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy = (Accuracy)(1<<m_nPatAccuracyMode);
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale = (CoarseScale)(m_nPatSpeedMode+1);
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow  =  m_dAngleLow;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh = m_dAngleHigh;

		// Circle
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nCircleOutLineNum = m_nCircleOutLineNum;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dCircleContrastThre = m_dCircleContrastThre;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lCircleFilterHalfWidth = m_lCircleFilterHalfWidth;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_eCircledgeProperty = (EdgePolarity)m_nCirclePolarityMode;		
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bCircleSortByScore = m_bCircleSortByScore;
		((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCircleCaliperNum = m_nCircleCaliperNum;
		((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CircleCaliperSearchDirection = (CaliperSearchDirection)m_nCircleInwardMode;
		((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCircleCaliperVisible = m_bShowCircleCaliper;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableCircleDualEdge = m_bEnableCircleDualEdge;
		((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableCircleMask = m_bEnableCircleMask;;

		// Line
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineOutLineNum[0]  = m_nLineOutLineNum1;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dLineContrastThre[0] = m_dLineContrastThre1;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lLineFilterHalfWidth[0] = m_lLineFilterHalfWidth1;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_eLinedgeProperty[0] = (EdgePolarity)m_nLinePolarityMode1;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bLineSortByScore[0] = m_bLineSortByScore1;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineAngleType[0] = m_nLineAngleType;
		((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nLineCaliperNum[0] = m_nLineCaliperNum1;
		((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bLineCaliperVisible[0] = m_bShowLineCaliper;
		((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableLineDualEdge[0] = m_bEnableLineDualEdge;
		((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[0] = m_bEnableLineMask;
	...
	{		
		m_nImageChannel = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_nPatAccuracyMode = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy/2;
		m_nPatSpeedMode = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale-1;
		m_dAngleLow	    = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh;
		m_bEnableMask = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;	

		// Circle
		m_nCircleOutLineNum =  ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nCircleOutLineNum;
		m_dCircleContrastThre = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dCircleContrastThre;
		m_lCircleFilterHalfWidth = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lCircleFilterHalfWidth;
		m_nCirclePolarityMode = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_eCircledgeProperty;
		m_bCircleSortByScore = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bCircleSortByScore;
		m_nCircleCaliperNum = ((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCircleCaliperNum;
		m_nCircleInwardMode = ((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CircleCaliperSearchDirection;
		m_bShowCircleCaliper = ((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCircleCaliperVisible;
		m_bEnableCircleDualEdge = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableCircleDualEdge;
		m_bEnableCircleMask = ((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableCircleMask;
		// Line
		m_nLineOutLineNum1 =  ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineOutLineNum[0];
		m_dLineContrastThre1 = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dLineContrastThre[0];
		m_lLineFilterHalfWidth1 = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lLineFilterHalfWidth[0];
		m_nLinePolarityMode1 = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_eLinedgeProperty[0];
		m_bLineSortByScore1 = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bLineSortByScore[0];
		m_nLineAngleType = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineAngleType[0];
		m_nLineCaliperNum1 = ((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nLineCaliperNum[0];
		m_bShowLineCaliper = ((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bLineCaliperVisible[0];
		m_bEnableLineDualEdge = ((CPatternLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableLineDualEdge[0];
		m_bEnableLineMask = ((CPatternLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[0];
		if (m_bEnableMask)
		{
		...
		m_checkShowLinePoint2.SetCheck(m_bEnableShowLinePoint2);
		UpdateData(FALSE);
	}
}


void CDlgPatternLineCircleTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CPatternLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CPatternLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CPatternLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre = m_dConfusionThre;
		((CPatternLineCircleSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint = m_bEnableShowLinePoint;
		((CPatternLineCircleSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint2 = m_bEnableShowLinePoint2;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CPatternLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CPatternLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;
		m_dConfusionThre = ((CPatternLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre;

		m_bEnableShowLinePoint = ((CPatternLineCircleSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint;
		m_bEnableShowLinePoint2 = ((CPatternLineCircleSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint2;
		UpdateData(FALSE);
	}

}

void CDlgPatternLineCircleTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgPatternLineCircleTool::UpdateDialogLanguage()
{
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_PATTERN_LINE_CIRCLE_TOOL") == strDlgID)
		{
			int nID;
...
BOOL CDlgPatternLineCircleTool::OnInitDialog()
{
...
BOOL CDlgPatternLineCircleTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgPatternLineCircleTool::OnBtnGetTrainImage() 
{
...
void CDlgPatternLineCircleTool::OnBtnTrain() 
{
...
void CDlgPatternLineCircleTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgPatternLineCircleTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
void CDlgPatternLineCircleTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CPatternLineCircleSearchTrainGuiParam trainGuiParam;
...
void CDlgPatternLineCircleTool::OnSelchangeComboAccuracyMode() 
{
	m_nPatAccuracyMode = m_comboAccuracy.GetCurSel();	
}

void CDlgPatternLineCircleTool::OnSelchangeComboSpeedMode() 
{
	m_nPatSpeedMode = m_comboSpeed.GetCurSel();
}

void CDlgPatternLineCircleTool::OnSetfocusEdtAngleLow() 
{
...
void CDlgPatternLineCircleTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnChangeEdtCircleCalipernum() 
{
...
void CDlgPatternLineCircleTool::OnSetfocusEdtCircleCalipernum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnSetfocusEdtCircleOutlineNum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnSetfocusEdtCircleContrastThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnRadCircleInwardMode0() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgPatternLineCircleTool::OnRadCircleInwardMode1() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgPatternLineCircleTool::OnChangeEdtLineCalipernum1() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternLineCircleTool::OnSetfocusEdtLineCalipernum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnSetfocusEdtLineContrastThre1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnSetfocusEdtLineOutlineNum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnCbnSelchangeComboLineAngleType()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nLineAngleType = m_comboLineAngleType.GetCurSel();
}

void CDlgPatternLineCircleTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgPatternLineCircleTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnSetfocusEdtConfusionThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternLineCircleTool::OnBnClickedCheckShowLinePoint()
{
	// TODO: 在此添加控件通知处理程序代码

	m_bEnableShowLinePoint = !m_bEnableShowLinePoint;

	CPatternLineCircleSearchSearchGuiParam searchGuiParam;
...
void CDlgPatternLineCircleTool::OnBnClickedCheckShowLinePoint2()
{
	// TODO: 在此添加控件通知处理程序代码

	m_bEnableShowLinePoint2 = !m_bEnableShowLinePoint2;

	CPatternLineCircleSearchSearchGuiParam searchGuiParam;
	m_pDlgParent->m_pSearchTool->GetSearchGuiParam(&searchGuiParam);

	searchGuiParam.m_bEnableShowLinePoint2= m_bEnableShowLinePoint2;
...
void CDlgPatternLineCircleTool::OnBnClickedChkShowCircleCaliper()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgPatternLineCircleTool::OnBnClickedChkShowLineCaliper()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgPatternLineCircleTool::OnBnClickedCheckCircleMask()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgPatternLineCircleTool::OnBnClickedCheckLineMask()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}

void CDlgPatternLineCircleTool::OnEnSetfocusEditLineFilterHalfWidth() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternLineCircleTool::OnEnSetfocusEditCircleFilterHalfWidth() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
