// DlgSysPlatformYDPXParam.cpp : implementation file
//
...
CDlgSysPlatformYDPX1X2Param::CDlgSysPlatformYDPX1X2Param(CWnd* pParent /*=NULL*/)
	: CDlgSysPlatformParam(CDlgSysPlatformYDPX1X2Param::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgSysPlatformYDPX1X2Param)
...
void CDlgSysPlatformYDPX1X2Param::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_SYS_PLATFORM_YDPX1X2_PARAM") == strDlgID)
		{
			int nID;
...
void CDlgSysPlatformYDPX1X2Param::InitDlgItem()
{
...
void CDlgSysPlatformYDPX1X2Param::UpdateDlgData( BOOL bSaveAndValidate /*= TRUE*/ )
{
	if (GetSafeHwnd() == NULL)
	{
		return;
...
BOOL CDlgSysPlatformYDPX1X2Param::SetPlatformInfo( const CPlatformInfo* platformInfo )
{
	if (platformInfo->GetPlatformType() != ePlatformYDPX1X2)
	{
		return FALSE;
	}
	...
	{
		m_pPlatformInfo = new CPlatformYDPX1X2Info(*((CPlatformYDPX1X2Info*)platformInfo));
	}
	return TRUE;
}

void CDlgSysPlatformYDPX1X2Param::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgSysPlatformYDPX1X2Param)
...
BEGIN_MESSAGE_MAP(CDlgSysPlatformYDPX1X2Param, CDialog)
	//{{AFX_MSG_MAP(CDlgSysPlatformYDPX1X2Param)
	...
	//}}AFX_MSG_MAP
	ON_CBN_SELCHANGE(IDC_COMBO_CH0X_COORD_TYPE, &CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboCh0xCoordType)
	ON_CBN_SELCHANGE(IDC_COMBO_CH1X_COORD_TYPE, &CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboCh1xCoordType)
	ON_CBN_SELCHANGE(IDC_COMBO_Y_COORD_TYPE, &CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboYCoordType)
	ON_CBN_SELCHANGE(IDC_COMBO_R_DIRECTION, &CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboRDirection)
	ON_CBN_SELCHANGE(IDC_COMBO_DRIVE_TYPE, &CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboDriveType)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgSysPlatformYDPX1X2Param message handlers

BOOL CDlgSysPlatformYDPX1X2Param::OnInitDialog() 
{
...
void CDlgSysPlatformYDPX1X2Param::OnSetfocusEditRotationLength() 
{
...
void CDlgSysPlatformYDPX1X2Param::OnKillfocusEditRotationLength() 
{
	if (m_bKillFocusEnabled)
	{
		...
		{
			strVal.Format(_T("%.3f"), ((CPlatformYDPX1X2Info*)m_pPlatformInfo)->m_dPlatformRotationLength);
...
BOOL CDlgSysPlatformYDPX1X2Param::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboCh0xCoordType()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strComboX1DriveDirection;
	m_comboCH0AxisXDirection.GetWindowText(strComboX1DriveDirection);
...
void CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboCh1xCoordType()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strComboX2DriveDirection;
	m_comboCH1AxisXDirection.GetWindowText(strComboX2DriveDirection);
...
void CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboYCoordType()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strComboYDriveDirection;
	m_comboYDriveDirection.GetWindowText(strComboYDriveDirection);
...
void CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboRDirection()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strComboRDirection;
	m_comboRDriveDirection.GetWindowText(strComboRDirection);
...
void CDlgSysPlatformYDPX1X2Param::OnCbnSelchangeComboDriveType()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strComboDriveType;
	m_comboRDriveType.GetWindowText(strComboDriveType);
...
void CDlgSysPlatformYDPX1X2Param::SetGroupBoxStatus(int nID,BOOL bEnable,BOOL bShow)
{
	CRect CRectGroupBox;
	// 检查是否为Group控件
...
void CDlgSysPlatformYDPX1X2Param::UpdateDlgByAuthorize()
{
