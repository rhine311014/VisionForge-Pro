// PatternSearchObroundTool.cpp: implementation of the CPatternSearchObroundTool class.
//
//////////////////////////////////////////////////////////////////////
...
CPatternSearchObroundTool::CPatternSearchObroundTool()
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
	...
	m_FindObroundTool.GetCaliperProperty(m_tmpTrainDataParam.m_dContrastThre, m_tmpTrainDataParam.m_edgeProperty, 
		m_tmpTrainDataParam.m_lFilterHalfWidth);
	m_tmpTrainDataParam.m_nOutLineNum			= 10;
	
	m_tmpTrainGuiParam.m_nCaliperNum			= m_GuiFindObround.GetCaliperNum();
	...
	m_tmpTrainGuiParam.m_dCaliperProjectLen		= m_GuiFindObround.GetCaliperProjectionLength();
	m_tmpTrainGuiParam.m_dCaliperSearchLen		= m_GuiFindObround.GetCaliperSearchLength();
	m_tmpTrainGuiParam.m_CaliperSearchDirection = (CaliperSearchDirection)m_GuiFindObround.GetCaliperSearchDirection();
...
CPatternSearchObroundTool::CPatternSearchObroundTool(CPatternSearchObroundTool &cPatternSearchObroundTool)
{
	if (cPatternSearchObroundTool.GetSearchToolType() != ePatternSearchObroundTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cPatternSearchObroundTool.m_CamHeight;
	m_CamWidth								= cPatternSearchObroundTool.m_CamWidth;

	m_TrainDataParam						= cPatternSearchObroundTool.m_TrainDataParam;
	m_TrainGuiParam							= cPatternSearchObroundTool.m_TrainGuiParam;
	m_SearchDataParam						= cPatternSearchObroundTool.m_SearchDataParam;
	m_SearchGuiParam						= cPatternSearchObroundTool.m_SearchGuiParam;
	m_TrainResult							= cPatternSearchObroundTool.m_TrainResult;
	m_ImageTrain							= cPatternSearchObroundTool.m_ImageTrain;
	m_ImageMask								= cPatternSearchObroundTool.m_ImageMask;
	m_bTrainGuiShow							= cPatternSearchObroundTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow                   = cPatternSearchObroundTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cPatternSearchObroundTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cPatternSearchObroundTool.m_bTrainOK;
	m_pGuiDisplay							= cPatternSearchObroundTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cPatternSearchObroundTool.UpdateSearchGuiData(true);
	cPatternSearchObroundTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cPatternSearchObroundTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cPatternSearchObroundTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cPatternSearchObroundTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cPatternSearchObroundTool.m_tmpSearchGuiParam);
	SetTrainImage(cPatternSearchObroundTool.m_tmpImageTrain);
	SetMaskImage(cPatternSearchObroundTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_PatternSearchTool = cPatternSearchObroundTool.m_PatternSearchTool;
	}
}

CPatternSearchObroundTool& CPatternSearchObroundTool::operator=(CPatternSearchObroundTool &cPatternSearchObroundTool)
{
	if (this == &cPatternSearchObroundTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CPatternSearchObroundTool::GetSearchToolType()
{
	return ePatternSearchObroundTool;
}										   

// 设置显示控件指针		
bool CPatternSearchObroundTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{	
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CPatternSearchObroundTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 设置Gui图形的关键字														
bool CPatternSearchObroundTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CPatternSearchObroundTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CPatternSearchObroundTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CPatternSearchObroundTool::ShowTrainResultGui(bool bShow)
{
...
// 更新搜索界面显示									
bool CPatternSearchObroundTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练Gui控件显示
bool CPatternSearchObroundTool::UpdateTrainGuiDisplay()
{
...
// 更新训练结果Gui控件显示
bool CPatternSearchObroundTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索Gui控件显示														
bool CPatternSearchObroundTool::UpdateSearchResultGuiDisplay()
{
	int i=0;
...
// 更新界面显示
bool CPatternSearchObroundTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CPatternSearchObroundTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != ePatternSearchObroundTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CPatternSearchObroundTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CPatternSearchObroundTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CPatternSearchObroundTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CPatternSearchObroundTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != ePatternSearchObroundTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CPatternSearchObroundTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CPatternSearchObroundTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CPatternSearchObroundTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CPatternSearchObroundTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CPatternSearchObroundTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CPatternSearchObroundTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CPatternSearchObroundTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CPatternSearchObroundTool::Train()
{
	m_bTrainOK = false;
	...
	if (m_tmpTrainDataParam.m_bMaskEnable)
	{
		...
		// 找圆
		m_FindObroundTool.SetCaliperNum(m_tmpTrainGuiParam.m_nCaliperNum);
		m_FindObroundTool.SetCaliperParams(m_tmpTrainGuiParam.m_nCaliperNum, m_tmpTrainGuiParam.m_CaliperSearchDirection, m_tmpTrainGuiParam.m_dCaliperSearchLen
			,m_tmpTrainGuiParam.m_dCaliperProjectLen);
		m_FindObroundTool.SetCaliperProperty(m_tmpTrainDataParam.m_dContrastThre, m_tmpTrainDataParam.m_edgeProperty, m_tmpTrainDataParam.m_lFilterHalfWidth);
		m_FindObroundTool.SetOutLineNum(m_tmpTrainDataParam.m_nOutLineNum);
		m_FindObroundTool.EnableCaliperSortByScore(m_tmpTrainDataParam.m_bSortByScore);
		...
		m_tmpTrainResult.m_dCenterX = cObround.GetCenter().GetX();
		m_tmpTrainResult.m_dCenterY = cObround.GetCenter().GetY();
...
// 获取训练结果图像														
bool CPatternSearchObroundTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CPatternSearchObroundTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != ePatternSearchObroundTool)
	{
		return false;
	}
	
	*((CPatternSearchObroundTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}	

// 是否训练成功
bool CPatternSearchObroundTool::IsTrained()
{
	return m_bTrainOK;
}
				
// 设置搜索Data参数	
bool CPatternSearchObroundTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != ePatternSearchObroundTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CPatternSearchObroundSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CPatternSearchObroundTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CPatternSearchObroundSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CPatternSearchObroundTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != ePatternSearchObroundTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CPatternSearchObroundSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CPatternSearchObroundTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CPatternSearchObroundSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CPatternSearchObroundTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
	...
	m_FindObroundTool.SetCaliperNum(m_TrainGuiParam.m_nCaliperNum);
	m_FindObroundTool.SetCaliperParams(m_TrainGuiParam.m_nCaliperNum, m_TrainGuiParam.m_CaliperSearchDirection, m_TrainGuiParam.m_dCaliperSearchLen
		,m_TrainGuiParam.m_dCaliperProjectLen);
	m_FindObroundTool.SetCaliperProperty(m_TrainDataParam.m_dContrastThre, m_TrainDataParam.m_edgeProperty, m_TrainDataParam.m_lFilterHalfWidth);
	m_FindObroundTool.SetOutLineNum(m_TrainDataParam.m_nOutLineNum);
	m_FindObroundTool.EnableCaliperSortByScore(m_TrainDataParam.m_bSortByScore);
	...
	if (bRet)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			if(bIsProcessImage)
			{
				bRet = m_FindObroundTool.Execute(tmpImage, ResObround, dRMS);
			}
			else
			{
				bRet = m_FindObroundTool.Execute(ImageSearch, ResObround, dRMS);
			}
			if (bRet) // 成功
			{
				...
				CString st;
				st.Format(_T("%d X:%.1f;Y:%.1f"), i, ResObround.GetCenter().GetX(), ResObround.GetCenter().GetY());
				...
				scGuiCross *pTempObroundCenter = m_GuiSearchObroundCenter+i;
...
// 获取搜索结果个数										
int CPatternSearchObroundTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CPatternSearchObroundTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像
bool CPatternSearchObroundTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != ePatternSearchObroundTool)
	{
		return false;
	}
...
// 加载模板文件
bool CPatternSearchObroundTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CPatternSearchObroundTrainDataParam tmpTrainDataParam;
	CPatternSearchObroundTrainGuiParam tmpTrainGuiParam;
	CPatternSearchObroundSearchDataParam tmpSearchDataParam;
	CPatternSearchObroundSearchGuiParam tmpSearchGuiParam;
	CPatternSearchObroundTrainResult  tmpTrainResult;
	if (!cXMLConfigurator.Load(strXmlPath))
	{
		return false;
	}
...
// 保存模板文件							
bool CPatternSearchObroundTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CPatternSearchObroundTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
	...
	else // 将数据传递到Gui控件上
	{
		...
		m_GuiFindObround.SetCaliperNum(m_tmpTrainGuiParam.m_nCaliperNum);
		m_GuiFindObround.SetObround(m_tmpTrainGuiParam.m_Obround);
		m_GuiFindObround.SetCaliperProjectionLength(m_tmpTrainGuiParam.m_dCaliperProjectLen);
		m_GuiFindObround.SetCaliperSearchLength(m_tmpTrainGuiParam.m_dCaliperSearchLen);
		m_GuiFindObround.SetCaliperSearchDirection(m_tmpTrainGuiParam.m_CaliperSearchDirection);
	}

	return true;
}

bool CPatternSearchObroundTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CPatternSearchObroundTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
bool CPatternSearchObroundTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CPatternSearchObroundTool::ClearResult()
{
	ClearResultGui();
...
bool CPatternSearchObroundTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CPatternSearchObroundTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
		...
		m_pGuiStaticContainer = m_pGuiDisplay->GetStaticContainer();
		m_pGuiStaticContainer->RemoveItem(m_strKeyText +_T("_TrainResultObround"));
	}
	
	return true;	
}

bool CPatternSearchObroundTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CPatternSearchObroundTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CPatternSearchObroundTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CPatternSearchObroundTool::RestoreSearchParam()
{
...
void CPatternSearchObroundTool::SetLanguage(int nLanguage)
{
...
CString CPatternSearchObroundTool::GetResultErrInfo()
{
	CString strErrInfo;
	...
	case 0:
		{
			...
			case -1:			//	区域定位失败			
				...
				break;
			case -2:			// 	找长圆失败			
				strErrInfo += _T("Find Obround failed");
				break;
			case -99:			// 	训练未成功			
