...
// CMQuickPickCornerSearchTool.cpp: implementation of the CMQuickPickCornerSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
CMQuickPickCornerSearchTool::CMQuickPickCornerSearchTool()
{
	m_pGuiDisplay										= NULL;
	m_hDispWnd											= NULL;
...
CMQuickPickCornerSearchTool::CMQuickPickCornerSearchTool(CMQuickPickCornerSearchTool &cMQuickPickCornerSearchTool)
{
	if (cMQuickPickCornerSearchTool.GetSearchToolType() != eMQuickPickCornerSearchTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cMQuickPickCornerSearchTool.m_CamHeight;
	m_CamWidth								= cMQuickPickCornerSearchTool.m_CamWidth;
	m_TrainDataParam						= cMQuickPickCornerSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cMQuickPickCornerSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cMQuickPickCornerSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cMQuickPickCornerSearchTool.m_SearchGuiParam;
	m_TrainResult							= cMQuickPickCornerSearchTool.m_TrainResult;
	m_ImageTrain							= cMQuickPickCornerSearchTool.m_ImageTrain;
	m_ImageMask								= cMQuickPickCornerSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cMQuickPickCornerSearchTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow					= cMQuickPickCornerSearchTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cMQuickPickCornerSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cMQuickPickCornerSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cMQuickPickCornerSearchTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cMQuickPickCornerSearchTool.UpdateSearchGuiData(true);
	cMQuickPickCornerSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cMQuickPickCornerSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cMQuickPickCornerSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cMQuickPickCornerSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cMQuickPickCornerSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cMQuickPickCornerSearchTool.m_tmpImageTrain);
	SetMaskImage(cMQuickPickCornerSearchTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CMQuickPickCornerSearchTool& CMQuickPickCornerSearchTool::operator=(CMQuickPickCornerSearchTool &cMQuickPickCornerSearchTool)
{
	if (this == &cMQuickPickCornerSearchTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CMQuickPickCornerSearchTool::GetSearchToolType()
{
	return eMQuickPickCornerSearchTool;
}										   

// 设置显示控件指针		
bool CMQuickPickCornerSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CMQuickPickCornerSearchTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CMQuickPickCornerSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CMQuickPickCornerSearchTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CMQuickPickCornerSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CMQuickPickCornerSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CMQuickPickCornerSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CMQuickPickCornerSearchTool::ShowTrainResultGui(bool bShow)
{
...
// 更新搜索界面显示									
bool CMQuickPickCornerSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练Gui控件显示
bool CMQuickPickCornerSearchTool::UpdateTrainGuiDisplay()
{
	// 更新
	m_GuiTrainRect.SetVisible(m_bTrainGuiShow && m_tmpTrainGuiParam.m_bTrainAffineRectVisible);
	m_GuiHand1SearchRect.SetVisible(m_bTrainGuiShow && m_tmpTrainGuiParam.m_bTrainAffineRectVisible);
	m_GuiHand2SearchRect.SetVisible(m_bTrainGuiShow && m_tmpTrainGuiParam.m_bTrainAffineRectVisible);
...
// 更新训练结果Gui控件显示
bool CMQuickPickCornerSearchTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索Gui控件显示														
bool CMQuickPickCornerSearchTool::UpdateSearchResultGuiDisplay()
{
...
// 更新界面显示
bool CMQuickPickCornerSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CMQuickPickCornerSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eMQuickPickCornerSearchTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CMQuickPickCornerSearchTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CMQuickPickCornerSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CMQuickPickCornerSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CMQuickPickCornerSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eMQuickPickCornerSearchTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CMQuickPickCornerSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CMQuickPickCornerSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CMQuickPickCornerSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CMQuickPickCornerSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CMQuickPickCornerSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 执行训练											
bool CMQuickPickCornerSearchTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CMQuickPickCornerSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CMQuickPickCornerSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eMQuickPickCornerSearchTool)
	{
		return false;
	}
	
	*((CMQuickPickCornerSearchTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}	

// 是否训练成功
bool CMQuickPickCornerSearchTool::IsTrained()
{
	return m_bTrainOK;
}
				
// 设置搜索Data参数	
bool CMQuickPickCornerSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eMQuickPickCornerSearchTool)
	{
		return false;
	}

	//*((CMQuickPickCornerSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;
	m_tmpSearchDataParam = *((CMQuickPickCornerSearchDataParam*)pSearchDataParam);
	return true;
}

// 获取搜索Data参数				
bool CMQuickPickCornerSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
...
// 设置搜索Gui参数					
bool CMQuickPickCornerSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eMQuickPickCornerSearchTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CMQuickPickCornerSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CMQuickPickCornerSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CMQuickPickCornerSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CMQuickPickCornerSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
...
//		m_FindLineTool[i].SetCaliperProperty(m_TrainDataParam.m_dContrastThre[i], m_TrainDataParam.m_edgeProperty[i], m_TrainDataParam.m_lFilterHalfWidth[i]);
	...
	if (bRet)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			sc2Vector center= tmpQuickResult.MatchRegion().GetCenter();
			...
			if (bFindLine[0] && bFindLine[1]&& bFindLine[2] &&bFindLine[3])
			{
...

				{
					...
					if (PointInRect(center,m_tmpTrainGuiParam.m_Hand1SearchRect)&&!hand1flag)
					{
						...
						{
							scAffineRect matchRect =  tmpQuickResult.MatchRegion();
...
// 获取搜索结果个数										
int CMQuickPickCornerSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CMQuickPickCornerSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像文件
bool CMQuickPickCornerSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eMQuickPickCornerSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CMQuickPickCornerSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Pattern.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CMQuickPickCornerSearchTrainDataParam tmpTrainDataParam;
	CMQuickPickCornerSearchTrainGuiParam tmpTrainGuiParam;
	CMQuickPickCornerSearchDataParam tmpSearchDataParam;
	CMQuickPickCornerSearchGuiParam tmpSearchGuiParam;
	CMQuickPickCornerSearchTrainResult    tmpTrainResult;
	if (!cXMLConfigurator.Load(strXmlPath))
	{
		return false;
	}
...
// 保存模板文件							
bool CMQuickPickCornerSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CMQuickPickCornerSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CMQuickPickCornerSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CMQuickPickCornerSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{	
...
// 清除定位工具在Display上的控件				
bool CMQuickPickCornerSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CMQuickPickCornerSearchTool::ClearResult()
{
...
bool CMQuickPickCornerSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CMQuickPickCornerSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
bool CMQuickPickCornerSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CMQuickPickCornerSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CMQuickPickCornerSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CMQuickPickCornerSearchTool::RestoreSearchParam()
{
...
bool CMQuickPickCornerSearchTool::SetMaskImage( const cpImage &ImageMask )
{
...
bool CMQuickPickCornerSearchTool::GetMaskImage( cpImage &ImageMask )
{
...
// bool CMQuickPickCornerSearchTool::GetResultRelative( int nIndex, CSearchResult &searchResult )
// {
...
// CString CMQuickPickCornerSearchTool::GetCurPatDir() const
// {
// 	return m_strPatDirTmp;
// }

void CMQuickPickCornerSearchTool::SetLanguage(int nLanguage)
{
...
CString	CMQuickPickCornerSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
...
BOOL CMQuickPickCornerSearchTool::PointInRect(sc2Vector point,scRect rect)
{
