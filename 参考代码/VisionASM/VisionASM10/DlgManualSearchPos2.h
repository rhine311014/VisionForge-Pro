...
class CDlgManualSearchPos2 : public CDialog
{
	DECLARE_DYNAMIC(CDlgManualSearchPos2)

public:
	CDlgManualSearchPos2(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgManualSearchPos2();

// 对话框数据
	enum { IDD = IDD_DLG_MANUAL_SEARCH_POS2 };
