// QuickSearchObroundTool.cpp: implementation of the CQuickCornerMulObroundTool class.
//
//////////////////////////////////////////////////////////////////////
...
CQuickCornerMulObroundTool::CQuickCornerMulObroundTool()
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
...
CQuickCornerMulObroundTool::CQuickCornerMulObroundTool(CQuickCornerMulObroundTool &CQuickCornerMulObroundTool)
{
	if (CQuickCornerMulObroundTool.GetSearchToolType() != eQuickCornerMulObroundTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= CQuickCornerMulObroundTool.m_CamHeight;
	m_CamWidth								= CQuickCornerMulObroundTool.m_CamWidth;

	m_TrainDataParam						= CQuickCornerMulObroundTool.m_TrainDataParam;
	m_TrainGuiParam							= CQuickCornerMulObroundTool.m_TrainGuiParam;
	m_SearchDataParam						= CQuickCornerMulObroundTool.m_SearchDataParam;
	m_SearchGuiParam						= CQuickCornerMulObroundTool.m_SearchGuiParam;
	m_TrainResult							= CQuickCornerMulObroundTool.m_TrainResult;
	m_ImageTrain							= CQuickCornerMulObroundTool.m_ImageTrain;
	m_ImageMask								= CQuickCornerMulObroundTool.m_ImageMask;
	m_bTrainGuiShow							= CQuickCornerMulObroundTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow                   = CQuickCornerMulObroundTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= CQuickCornerMulObroundTool.m_bSearchResultGuiShow;
	m_bTrainOK								= CQuickCornerMulObroundTool.m_bTrainOK;
	m_pGuiDisplay							= CQuickCornerMulObroundTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	CQuickCornerMulObroundTool.UpdateSearchGuiData(true);
	CQuickCornerMulObroundTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&CQuickCornerMulObroundTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&CQuickCornerMulObroundTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&CQuickCornerMulObroundTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&CQuickCornerMulObroundTool.m_tmpSearchGuiParam);
	SetTrainImage(CQuickCornerMulObroundTool.m_tmpImageTrain);
	SetMaskImage(CQuickCornerMulObroundTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CQuickCornerMulObroundTool& CQuickCornerMulObroundTool::operator=(CQuickCornerMulObroundTool &CQuickCornerMulObroundTool)
{
	if (this == &CQuickCornerMulObroundTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CQuickCornerMulObroundTool::GetSearchToolType()
{
	return eQuickCornerMulObroundTool;
}										   

// 设置显示控件指针		
bool CQuickCornerMulObroundTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{	
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CQuickCornerMulObroundTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CQuickCornerMulObroundTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CQuickCornerMulObroundTool::GetTrainResultDisplay()
{
...
// 设置Gui图形的关键字														
bool CQuickCornerMulObroundTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CQuickCornerMulObroundTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CQuickCornerMulObroundTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CQuickCornerMulObroundTool::ShowTrainResultGui(bool bShow)
{
...
// 更新搜索界面显示									
bool CQuickCornerMulObroundTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练Gui控件显示
bool CQuickCornerMulObroundTool::UpdateTrainGuiDisplay()
{
...
// 更新训练结果Gui控件显示
bool CQuickCornerMulObroundTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索Gui控件显示														
bool CQuickCornerMulObroundTool::UpdateSearchResultGuiDisplay()
{
	int i=0;
...
// 更新界面显示
bool CQuickCornerMulObroundTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
	UpdateSearchResultGuiDisplay();
...
// 设置训练Data参数	
bool CQuickCornerMulObroundTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eQuickCornerMulObroundTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CQuickCornerMulObroundTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CQuickCornerMulObroundTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CQuickCornerMulObroundTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CQuickCornerMulObroundTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eQuickCornerMulObroundTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CQuickCornerMulObroundTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CQuickCornerMulObroundTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CQuickCornerMulObroundTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CQuickCornerMulObroundTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CQuickCornerMulObroundTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CQuickCornerMulObroundTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CQuickCornerMulObroundTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CQuickCornerMulObroundTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CQuickCornerMulObroundTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CQuickCornerMulObroundTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eQuickCornerMulObroundTool)
	{
		return false;
	}
	
	*((CQuickCornerMulObroundTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}	

// 是否训练成功
bool CQuickCornerMulObroundTool::IsTrained()
{
	return m_bTrainOK;
}
				
// 设置搜索Data参数	
bool CQuickCornerMulObroundTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eQuickCornerMulObroundTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CQuickCornerMulObroundSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CQuickCornerMulObroundTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CQuickCornerMulObroundSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CQuickCornerMulObroundTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eQuickCornerMulObroundTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CQuickCornerMulObroundSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CQuickCornerMulObroundTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CQuickCornerMulObroundSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CQuickCornerMulObroundTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			for (int j=0;j<OBROUND_NUM;j++)
			{
				...
				else
				{
					if (j==0)
					{
						if (!m_FindObroundTool[0].Execute(ImageSearch, ResObround[j], dRMS[j]))
						{
...
// 					bFindObround[1]=true;
			...
			// 成功
			{
				...
				{
					CResultLine	line;
					line.m_vLineX[0] = cLineSeg[0].GetP1().GetX();
					line.m_vLineY[0] = cLineSeg[0].GetP1().GetY();
					line.m_vLineX[1] = cLineSeg[0].GetP2().GetX();
					line.m_vLineY[1] = cLineSeg[0].GetP2().GetY();
					searchResult.m_vLineSearchResult.push_back(line);
				}

				CResultObround obround;
				obround.m_scObround = ResObround[0];
				searchResult.m_vObroundSearchResult.push_back(obround);
				if (m_tmpTrainDataParam.m_bEnableMulObround)
				{
					obround.m_scObround = ResObround[1];
					searchResult.m_vObroundSearchResult.push_back(obround);
				}
...
// 获取搜索结果个数										
int CQuickCornerMulObroundTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CQuickCornerMulObroundTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像文件
bool CQuickCornerMulObroundTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eQuickCornerMulObroundTool)
	{
		return false;
	}
...
// 加载模板文件
bool CQuickCornerMulObroundTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	//    (2) 模板图像ModelImage.bmp
	//    (3) QuickSearch模板文件Quick.ptq或QuickSearch模板文件Quick.pts或者没有(视定位工具而定)
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CQuickCornerMulObroundTrainDataParam tmpTrainDataParam;
	CQuickCornerMulObroundTrainGuiParam tmpTrainGuiParam;
	CQuickCornerMulObroundSearchDataParam tmpSearchDataParam;
	CQuickCornerMulObroundSearchGuiParam tmpSearchGuiParam;
	CQuickCornerMulObroundTrainResult  tmpTrainResult;
	if (!cXMLConfigurator.Load(strXmlPath))
	{
		return false;
	}
...
// 	tmpSearchGuiParam.m_bCircleCenterVisible = _ttoi(cXMLConfigurator.GetElemData());
	...
	bRet = m_QuickSearchTool.LoadTrainModelFromBinaryFile(strDir + _T("Model.pts"));
	if (!bRet)
	{
		return false;
	}
...
// 保存模板文件							
bool CQuickCornerMulObroundTool::SaveModelToFile(CString strDir)
{
...
// 	cXMLConfigurator.AddElem(_T("CircleCenterVisible"), strInfo);
	...
	//////////////////////////存储模板ptq文件//////////////////////////
	bRet = m_QuickSearchTool.SaveTrainModelToBinaryFile(strDir + _T("Model.pts"));
	if (!bRet)
	{
		return false;
	}
...
// 更新训练控件数据信息	
bool CQuickCornerMulObroundTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CQuickCornerMulObroundTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CQuickCornerMulObroundTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
bool CQuickCornerMulObroundTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CQuickCornerMulObroundTool::ClearResult()
{
	ClearResultGui();
...
bool CQuickCornerMulObroundTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CQuickCornerMulObroundTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CQuickCornerMulObroundTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CQuickCornerMulObroundTool::GetPatternImage(cpImage &ImageQuick)
{
	/*bool bRet = m_QuickSearchTool.GetTrainModelImage(ImageQuick);
	if (!bRet)
	{
		return false;
	}
	...
	if(0 == m_tmpImageTrain.GetSubImage(ImageQuick,m_QuickSearchTool.GetTrainRectRegion()))
	{
		return true;
	}
	else
...
// 恢复训练参数
bool CQuickCornerMulObroundTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CQuickCornerMulObroundTool::RestoreSearchParam()
{
...
void CQuickCornerMulObroundTool::SetLanguage(int nLanguage)
{
...
bool CQuickCornerMulObroundTool::CalcLineCross(scLineSeg cLineSeg1, scLineSeg cLineSeg2, sc2Vector& centerLine1, sc2Vector& centerLine2, std::vector<sc2Vector>& vtCrossArray)
{
	bool bIntersect;
...
CString	CQuickCornerMulObroundTool::GetResultErrInfo()
{
	CString strErrInfo;
