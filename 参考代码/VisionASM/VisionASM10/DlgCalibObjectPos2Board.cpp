// DlgCalibObjectPos2Board.cpp : 实现文件
//
...
IMPLEMENT_DYNAMIC(CDlgCalibObjectPos2Board, CDialog)


CDlgCalibObjectPos2Board::CDlgCalibObjectPos2Board(CWnd* pParent /*=NULL*/)
: CDialog(CDlgCalibObjectPos2Board::IDD, pParent)
	, m_nRadioCalibTargetPos(0)
	, m_strCalibBoardObject1PosX0(_T(""))
	, m_strCalibBoardObject1PosY0(_T(""))
	, m_strCalibBoardObject1PosX1(_T(""))
	, m_strCalibBoardObject1PosY1(_T(""))
	, m_strCalibBoardObject2PosX0(_T(""))
	, m_strCalibBoardObject2PosY0(_T(""))
	, m_strCalibBoardObject2PosX1(_T(""))
...
CDlgCalibObjectPos2Board::~CDlgCalibObjectPos2Board()
{
	int i=0;
...
void CDlgCalibObjectPos2Board::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_BTN_CALIB_OBJECT_POS_, m_btnCalcuVirtualObject);
	...
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0, m_strCalibBoardObject1PosX0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0, m_strCalibBoardObject1PosY0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1, m_strCalibBoardObject1PosX1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1, m_strCalibBoardObject1PosY1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0, m_strCalibBoardObject2PosX0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0, m_strCalibBoardObject2PosY0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1, m_strCalibBoardObject2PosX1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1, m_strCalibBoardObject2PosY1);
...
BEGIN_MESSAGE_MAP(CDlgCalibObjectPos2Board, CDialog)
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_BTN_SERIAL_GRAB, &CDlgCalibObjectPos2Board::OnBnClickedBtnSerialGrab)
	ON_BN_CLICKED(IDCANCEL, &CDlgCalibObjectPos2Board::OnBnClickedCancel)
	ON_BN_CLICKED(IDOK, &CDlgCalibObjectPos2Board::OnBnClickedOk)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT0_MOVE_POS0, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObject0Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT1_MOVE_POS0, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObject1Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT0_MOVE_POS1, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObject0Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT1_MOVE_POS1, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObject1Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET0_MOVE_POS0, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchVirtualObject0Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET1_MOVE_POS0, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchVirtualObject1Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET0_MOVE_POS1, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchVirtualObject0Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET1_MOVE_POS1, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchVirtualObject1Pos1)
	ON_BN_CLICKED(IDC_BTN_CALIB_OBJECT_POS_, &CDlgCalibObjectPos2Board::OnBnClickedBtnCalcuVirtualObject)
	ON_BN_CLICKED(IDC_BTN_COMM_GET_PLATFORM_AXIS_POS, &CDlgCalibObjectPos2Board::OnBnClickedBtnCommGetPlatformAxisPos)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject1PosX0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject1PosX0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject1PosY0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject1PosY0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject1PosX1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject1PosX1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject1PosY1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject1PosY1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject2PosX0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject2PosX0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject2PosY0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject2PosY0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject2PosX1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject2PosX1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject2PosY1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject2PosY1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT_ALL, &CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObjectAll)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIB_BOARD_SIZE_X, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibBoardSizeX)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIB_BOARD_SIZE_X, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibBoardSizeX)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIB_BOARD_SIZE_Y, &CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibBoardSizeY)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIB_BOARD_SIZE_Y, &CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibBoardSizeY)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS0, &CDlgCalibObjectPos2Board::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS2, &CDlgCalibObjectPos2Board::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS1, &CDlgCalibObjectPos2Board::OnBnClickedRadioCalibTargetPos0)

	ON_BN_CLICKED(IDC_BUTTON_POS1_CAMERA_SHUTTER, &CDlgCalibObjectPos2Board::OnBnClickedSetCalibTargetShutter1)
	ON_BN_CLICKED(IDC_BUTTON_POS2_CAMERA_SHUTTER, &CDlgCalibObjectPos2Board::OnBnClickedSetCalibTargetShutter2)
	ON_MESSAGE(WM_SV_DISPLAY_DBLCLICK, OnGuiDisplayDblClk)

END_MESSAGE_MAP()


// CDlgCalibObjectPos2Board 消息处理程序

void CDlgCalibObjectPos2Board::SetVisionAlignerRef( vcBaseVisionAlign *pVisionAligner)
{
...
BOOL CDlgCalibObjectPos2Board::OnInitDialog()
{
...
void CDlgCalibObjectPos2Board::InitDlgItem()
{
// 	// 	CRect cr;
...
//	m_btnAssistSearch.SetAlign(CButtonST::ST_ALIGN_VERT);
	...
	for (i=0; i<m_pVisionASM->GetTargetPosNum(); i++)
	{
		...
		m_vpGuiTargetDisplay.at(i)->ShowWindow(SW_HIDE);
		pGUIDisplay = NULL;
	}
	...
	m_vbCalibObjectPosSuccess.resize(m_pVisionASM->GetTargetPosNum(), FALSE);
	...
	if (/*sysPlatformInfo.m_bTargetObjectCamSeparate && sysPlatformInfo.m_nPositionNum == 4*/
		sysPlatformInfo.m_bTargetObjectCamSeparate == FALSE && sysPlatformInfo.m_bTargetCalibUseBoard == TRUE && sysPlatformInfo.m_nPositionNum == 2)
	{
		UpdateDlgItem(TRUE);
	}
	else
...
void CDlgCalibObjectPos2Board::UpdateDlgItem(BOOL bEnable)
{
	...
	GetDlgItem(IDC_BTN_SEARCH_OBJECT_ALL)->EnableWindow(bEnable);
	GetDlgItem(IDC_BTN_CALIB_OBJECT_POS_)->EnableWindow(bEnable);
	GetDlgItem(IDOK)->EnableWindow(bEnable);
}



void CDlgCalibObjectPos2Board::UpdateDlgData(BOOL bSaveAndValidate/* = TRUE*/)
{
	...
	if (bSaveAndValidate)
	{
		...
		nCalibIndex = 0;
		i = 0;
		pos.m_dPosX = atof(m_strCalibBoardObject1PosX0);
		pos.m_dPosY = atof(m_strCalibBoardObject1PosY0);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);
		i = 1;
		pos.m_dPosX = atof(m_strCalibBoardObject1PosX1);
		pos.m_dPosY = atof(m_strCalibBoardObject1PosY1);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);

		nCalibIndex = 1;
		i = 0;
		pos.m_dPosX = atof(m_strCalibBoardObject2PosX0);
		pos.m_dPosY = atof(m_strCalibBoardObject2PosY0);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);
		i = 1;
		pos.m_dPosX = atof(m_strCalibBoardObject2PosX1);
		pos.m_dPosY = atof(m_strCalibBoardObject2PosY1);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);
	...
	else
	{
		...
		nCalibIndex = 0;	// 对象靶标标定，索引从目标2改为对象0
			...
			&& pCalibData->m_vpCalibratedInfo.at(nCalibIndex) != NULL)
		{
			...
			i = 0;
			m_strCalibBoardObject1PosX0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardObject1PosY0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
			i = 1;
			m_strCalibBoardObject1PosX1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardObject1PosY1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
		...
		{
			i = 0;
			m_strCalibBoardObject1PosX0.Format(_T("0.0000"));
			m_strCalibBoardObject1PosY0.Format(_T("0.0000"));
			i = 1;
			m_strCalibBoardObject1PosX1.Format(_T("0.0000"));
			m_strCalibBoardObject1PosY1.Format(_T("0.0000"));
		...
		nCalibIndex = 1;	// 对象靶标标定，索引从目标3改为对象1
		if (nCalibIndex < pCalibData->m_vpCalibratedInfo.size() 
			&& pCalibData->m_vpCalibratedInfo.at(nCalibIndex) != NULL)
		{
			pCalibData->m_vpCalibratedInfo.at(nCalibIndex)->GetCalibBoardMarkBoardCoordPos(cpCalibBoardMarkBoardCoordPos);
			...
			i = 0;
			m_strCalibBoardObject2PosX0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardObject2PosY0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
			i = 1;
			m_strCalibBoardObject2PosX1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardObject2PosY1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
		}
		else
		{
			i = 0;
			m_strCalibBoardObject2PosX0.Format(_T("0.0000"));
			m_strCalibBoardObject2PosY0.Format(_T("0.0000"));
			i = 1;
			m_strCalibBoardObject2PosX1.Format(_T("0.0000"));
			m_strCalibBoardObject2PosY1.Format(_T("0.0000"));
		}
...
BOOL CDlgCalibObjectPos2Board::IsStringNumerical( LPCTSTR lpszVal )
{
...
void CDlgCalibObjectPos2Board::UpdateStatusBar()
{
...
void CDlgCalibObjectPos2Board::OnDestroy()
{
	CDialog::OnDestroy();
...
LRESULT CDlgCalibObjectPos2Board::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void CDlgCalibObjectPos2Board::UpdateBtnLiveGrab()
{
	// 更新“连续采集/停止采集”按钮 
...
void CDlgCalibObjectPos2Board::UpdateShutterDisplay()
{
// 	// 更新曝光时间显示
...
BOOL CDlgCalibObjectPos2Board::SetGUI()
{
	int nCamNum = m_pVisionASM->GetCameraNum();
	nCamNum = (nCamNum == 4) ? 2 : nCamNum;
...
// 更新训练Gui控件显示
bool CDlgCalibObjectPos2Board::UpdateGuiDisplay()
{
	// 更新
	int nCamNum = m_pVisionASM->GetCameraNum();
	nCamNum = (nCamNum == 4) ? 2 : nCamNum;
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSerialGrab()
{
	// TODO: 在此添加控件通知处理程序代码
	int i=0;
	BOOL bSucceed = TRUE;
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObjectAll()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nEvent = 6; // 全部移动位置1
	CString strLog;
	strLog.Format(_T("点击[搜索对象位置]\n"));
	g_opLogFile.SaveLogText(strLog,2);
}

void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObject0Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObject1Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchVirtualObject0Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 2; // 目标移动位置1
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchVirtualObject1Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 2; // 目标移动位置1
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObject0Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 3; // 对象移动位置2
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchObject1Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 3; // 对象移动位置2
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchVirtualObject0Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 4; // 目标移动位置2
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnSearchVirtualObject1Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 4; // 目标移动位置2
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnCommGetPlatformAxisPos()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibObjectPos2Board::OnBnClickedBtnCalcuVirtualObject()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
// 	}
	...
	if (m_nRadioCalibTargetPos == 0)			// 同时标定目标位置
	{
		{			
			...
			{
				for (nPosIndex = 0/*m_pVisionASM->GetObjectPosNum()*/; nPosIndex < m_pVisionASM->GetPosNum(); nPosIndex++)
				{
					if (FALSE == m_vpmpCalibMarkImagePos.at(nMovePosIndex)->GetIsMarkImagePosOK(nPosIndex))
					{
						m_bStatusBarFlag = FALSE;
						m_strStatusBarInfo1.Format(_T("标定失败"));
						m_strStatusBarInfo2.Format(_T("请获取对象位置的标记位置！"));
		...
		{
			int nMarkType = 1;
			if (TRUE == m_pVisionASM->ExecuteCalibrateBoard(m_vpmpCalibMarkImagePos, m_vpmpCalibMarkBoardPos, vBoardSize, nPosIndex+m_pVisionASM->GetPosNum()*nExProductIndex/* + m_pVisionASM->GetObjectPosNum()*/, nMarkType))
			{
	...
	else if (m_nRadioCalibTargetPos > 0)
	{
		...
		int nMarkType = 1;
		if (TRUE == m_pVisionASM->ExecuteCalibrateBoard(m_vpmpCalibMarkImagePos, m_vpmpCalibMarkBoardPos, vBoardSize, nPosIndex + m_pVisionASM->GetObjectPosNum(), nMarkType))
		{
			m_vbCalibObjectPosSuccess.at(nPosIndex) = TRUE;
		}
		else
		...
		m_bStatusBarFlag = m_vbCalibObjectPosSuccess.at(nPosIndex);
		if (TRUE == m_vbCalibObjectPosSuccess.at(nPosIndex))
		{
			strTempInfo2.Format(_T("对象位置%d标定成功！"), nPosIndex + 1);
		}
...
void CDlgCalibObjectPos2Board::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
	...
	m_bCalibObjectPosSuccess = FALSE;
	int nPosIndex = 0;
	m_bCalibObjectPosSuccess = m_vbCalibObjectPosSuccess.at(nPosIndex);
	for(nPosIndex = 0; nPosIndex < m_pVisionASM->GetTargetPosNum(); nPosIndex++)
	{
		m_bCalibObjectPosSuccess = m_bCalibObjectPosSuccess && m_vbCalibObjectPosSuccess.at(nPosIndex);	
	}

	if (m_bCalibObjectPosSuccess)
	{
		CPlatformOptionInfo optionInfo;
		m_pVisionASM->GetPlatformOptionInfo(optionInfo);
		//执行复制标定
...
void CDlgCalibObjectPos2Board::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
UINT CDlgCalibObjectPos2Board::ThreadReceiveData( LPVOID pParam )
{
	CDlgCalibObjectPos2Board *pOwner = (CDlgCalibObjectPos2Board*)pParam;
	CString strReceived;
...
// 				pOwner->SearchTargetPos1(nPosIndex);
// 			}
			for(nPosIndex = 0; nPosIndex < pOwner->m_pVisionASM->GetPosNum(); nPosIndex++)
			{
				// 对象移动位置1
...
void CDlgCalibObjectPos2Board::SearchObjectPos(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibObjectPos2Board::SearchObjectPos1(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibObjectPos2Board::SearchTargetPos(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibObjectPos2Board::SearchTargetPos1(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibObjectPos2Board::CommGetPlatformAxisPos()
{
	m_bCommGetPlatformAxisPosSuccess = FALSE;
	if (m_pVisionASM == NULL)
	{
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject1PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[对象1位置1][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationObject1PosX0();
	}	
}


void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject1PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0, m_strCalibBoardObject1PosX0);
		}
		else
		{
			m_strCalibBoardObject1PosX0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X0, m_strCalibBoardObject1PosX0);
		}
	}	
}
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject1PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[对象1位置1][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationObject1PosY0();
	}	
}


void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject1PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0, m_strCalibBoardObject1PosY0);
		}
		else
		{
			m_strCalibBoardObject1PosY0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y0, m_strCalibBoardObject1PosY0);
		}
	}	
}
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject1PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[对象1位置2][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationObject1PosX1();
	}	
}


void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject1PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1, m_strCalibBoardObject1PosX1);
		}
		else
		{
			m_strCalibBoardObject1PosX1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_X1, m_strCalibBoardObject1PosX1);
		}
	}	
}
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject1PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[对象1位置2][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationObject1PosY1();
	}	
}


void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject1PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1, m_strCalibBoardObject1PosY1);
		}
		else
		{
			m_strCalibBoardObject1PosY1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT1_POS_Y1, m_strCalibBoardObject1PosY1);
		}
	}	
}
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject2PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[对象2位置1][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationObject2PosX0();
	}	
}


void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject2PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0, m_strCalibBoardObject2PosX0);
		}
		else
		{
			m_strCalibBoardObject2PosX0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X0, m_strCalibBoardObject2PosX0);
		}
	}	
}
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject2PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[对象2位置1][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationObject2PosY0();
	}	
}


void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject2PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0, m_strCalibBoardObject2PosY0);
		}
		else
		{
			m_strCalibBoardObject2PosY0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y0, m_strCalibBoardObject2PosY0);
		}
	}	
}
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject2PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[对象2位置2][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationObject2PosX1();
	}	
}


void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject2PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1, m_strCalibBoardObject2PosX1);
		}
		else
		{
			m_strCalibBoardObject2PosX1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_X1, m_strCalibBoardObject2PosX1);
		}
	}	
}
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibrationObject2PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[对象2位置2][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationObject2PosY1();
	}	
}


void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibrationObject2PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1, m_strCalibBoardObject2PosY1);
		}
		else
		{
			m_strCalibBoardObject2PosY1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_OBJECT2_POS_Y1, m_strCalibBoardObject2PosY1);
		}
	}	
}
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibBoardSizeX()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bSysKeyboardEnabled)
	{
...
void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibBoardSizeX()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
...
void CDlgCalibObjectPos2Board::OnEnSetfocusEditValCalibBoardSizeY()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bSysKeyboardEnabled)
	{
...
void CDlgCalibObjectPos2Board::OnEnKillfocusEditValCalibBoardSizeY()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
...
void CDlgCalibObjectPos2Board::UpdateDialogLanguage()
{
	//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_CALIB_OBJECT_POS2_BOARD") == strDlgID)
		{
			int nID;
...
void CDlgCalibObjectPos2Board::OnBnClickedRadioCalibTargetPos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
*/
/************************************************************************/
bool CDlgCalibObjectPos2Board::CreateMultipleDirectory(CString& szPath, char split)
{
...
//获得关联结果
bool CDlgCalibObjectPos2Board::GetCalibResultCString(CString & strCalibResult)
{
...
// 保存CVS 文件
bool CDlgCalibObjectPos2Board::SaveCSVFile(CString strImageFileDirt,CString strName,CString& strSaveData )
{
	SYSTEMTIME sys;
	GetLocalTime(&sys);
	CString strFileName;
...
// 保存畸变校正前的图片
void CDlgCalibObjectPos2Board::SaveCalibSearchImage(CString strImageFileDirt,CString strImageName,cpImage & imageSave)
{
...
void CDlgCalibObjectPos2Board::OnBnClickedSetCalibTargetShutter1()
{
	// TODO: 在此添加控件通知处理程序代码
	SetCalibTargetShutter(0);
}

void CDlgCalibObjectPos2Board::OnBnClickedSetCalibTargetShutter2()
{
	// TODO: 在此添加控件通知处理程序代码
	SetCalibTargetShutter(1);
}

void CDlgCalibObjectPos2Board::ResetCameraShutter()
{
	if(m_pVisionASM)
	{
		for(int nPos=0;nPos<2 && nPos<m_pVisionASM->GetPosNum();nPos++)
...
void CDlgCalibObjectPos2Board::SetCalibTargetShutter(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
void CDlgCalibObjectPos2Board::CallDlgSearch(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
void CDlgCalibObjectPos2Board::SetCalibTargetSearchTool(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
LRESULT CDlgCalibObjectPos2Board::OnGuiDisplayDblClk(WPARAM wParam, LPARAM lParam)
{
