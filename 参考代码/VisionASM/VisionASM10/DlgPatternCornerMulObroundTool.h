...
#define DLG_PATTERN_OBROUND_NUM 2


class CDlgSearch;
class CDlgPatternCornerMulObroundTool : public CDialog
{
// Construction
public:
	CDlgPatternCornerMulObroundTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	...
	enum { IDD = IDD_DLG_PATTERN_CORNER_MUIOBROUND_TOOL };
	...
	int		m_nTempCircleInwardMode[DLG_PATTERN_OBROUND_NUM];
	int		m_nTempCirclePolarityMode[DLG_PATTERN_OBROUND_NUM];
	int		m_nTempCircleCaliperNum[DLG_PATTERN_OBROUND_NUM];
	double	m_dTempCircleContrastThre[DLG_PATTERN_OBROUND_NUM];
	long	m_lTempCircleFilterHalfWidth[DLG_PATTERN_OBROUND_NUM];
	int		m_nTempCircleOutLineNum[DLG_PATTERN_OBROUND_NUM];
	BOOL	m_bTempSortByScore1[DLG_PATTERN_OBROUND_NUM];
	BOOL	m_bTempShowCaliper[DLG_PATTERN_OBROUND_NUM];
	BOOL	m_bTempLineEnableDualEdge[DLG_PATTERN_OBROUND_NUM];
...
public:
	...
	BOOL	 m_bTempLineEnableMask[DLG_PATTERN_LINE_NUM];
