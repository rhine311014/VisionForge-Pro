// CombinedQuickSearch.h: interface for the CCombinedQuickSearch class.
//
//////////////////////////////////////////////////////////////////////
...
typedef struct tagCombinedQuickSearchTrainDataParam : public CBaseTrainDataParam
{
	double	m_dGrau;									// 颗粒度
	double	m_dGrau1;									// 颗粒度
	...
	tagCombinedQuickSearchTrainDataParam()
	{
		m_dGrau			= 2.0;
		m_dGrau1		= 2.0;
		m_lNoiseThre	= 10;
...
}CCombinedQuickSearchTrainDataParam;

// QuickSearch定位工具训练Gui参数类
typedef struct tagCombinedQuickSearchTrainGuiParam : public CBaseTrainGuiParam
{
	...
	tagCombinedQuickSearchTrainGuiParam()
	{
...
}CCombinedQuickSearchTrainGuiParam;

// QuickSearch定位工具搜索Data参数类
typedef struct tagCombinedQuickSearchDataParam : public CBaseSearchDataParam
{
	...
	tagCombinedQuickSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.8;
		m_dAcceptThre2	= 0.8;
...
}CCombinedQuickSearchDataParam;

// QuickSearch定位工具搜索Gui参数类
typedef struct tagCombinedQuickSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	...
	tagCombinedQuickSearchGuiParam()
	{
...
}CCombinedQuickSearchGuiParam;

// QuickSearch训练结果
typedef struct tagCombinedQuickSearchTrainResult
{
	...
	tagCombinedQuickSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CCombinedQuickSearchTrainResult;

class CCombinedQuickSearch : public CBaseSearchTool
{
public:
	CCombinedQuickSearch();
	CCombinedQuickSearch(CCombinedQuickSearch &cQuickSearchTool);
	CCombinedQuickSearch& operator=(CCombinedQuickSearch &cQuickSearchTool);
	virtual ~CCombinedQuickSearch(void);
...
private:
	...
	CCombinedQuickSearchTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CCombinedQuickSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CCombinedQuickSearchDataParam			m_tmpSearchDataParam;			// 当前搜索Data参数	
	CCombinedQuickSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CCombinedQuickSearchTrainResult				m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	cpImage							m_tmpImageMask1;					// 当前掩模图像
	CCombinedQuickSearchTrainDataParam			m_TrainDataParam;				// 训练Data参数
	CCombinedQuickSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CCombinedQuickSearchDataParam			m_SearchDataParam;				// 搜索Data参数	
	CCombinedQuickSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CCombinedQuickSearchTrainResult				m_TrainResult;					// 训练结果
