// DlgPatternRectSearchTool.cpp : 实现文件
//
...
IMPLEMENT_DYNAMIC(CDlgPatternRectSearchTool, CDialogEx)

CDlgPatternRectSearchTool::CDlgPatternRectSearchTool(CWnd* pParent /*=NULL*/)
	: CDialogEx(CDlgPatternRectSearchTool::IDD, pParent)
...
CDlgPatternRectSearchTool::~CDlgPatternRectSearchTool()
{
}

void CDlgPatternRectSearchTool::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_CBIndex(pDX, IDC_COMBO_OUTPUTPOINT1, m_nResultOutMode);
	DDX_Control(pDX, IDC_COMBO_OUTPUTPOINT1, m_comboOuput);
...
BEGIN_MESSAGE_MAP(CDlgPatternRectSearchTool, CDialogEx)
...
//	ON_BN_CLICKED(IDC_BTN_SET_CENTER, OnBtnSetCenter)
	...
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_1, &CDlgPatternRectSearchTool::OnBnClickedCheckLineMask1)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_1, &CDlgPatternRectSearchTool::OnBnClickedCheckShowFitpoint1)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_2, &CDlgPatternRectSearchTool::OnBnClickedCheckLineMask2)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_2, &CDlgPatternRectSearchTool::OnBnClickedCheckShowFitpoint2)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_3, &CDlgPatternRectSearchTool::OnBnClickedCheckLineMask3)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_3, &CDlgPatternRectSearchTool::OnBnClickedCheckShowFitpoint3)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_4, &CDlgPatternRectSearchTool::OnBnClickedCheckLineMask4)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_4, &CDlgPatternRectSearchTool::OnBnClickedCheckShowFitpoint4)

	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER_1, &CDlgPatternRectSearchTool::OnBnClickedChkShowLineCaliper1)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER_2, &CDlgPatternRectSearchTool::OnBnClickedChkShowLineCaliper2)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER_3, &CDlgPatternRectSearchTool::OnBnClickedChkShowLineCaliper3)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER_4, &CDlgPatternRectSearchTool::OnBnClickedChkShowLineCaliper4)

END_MESSAGE_MAP()


// CDlgPatternRectSearchTool 消息处理程序

void CDlgPatternRectSearchTool::UpdateControlDisplay()
{
 	UpdateData(TRUE);
...
void CDlgPatternRectSearchTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy = (Accuracy)(1<<m_nPatAccuracyMode);
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale = (CoarseScale)(m_nPatSpeedMode+1);
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow  =  m_dAngleLow;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh = m_dAngleHigh;

		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[0]  = m_nLineOutLineNum1;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[0] = m_dLineContrastThre1;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[0] = m_lLineFilterHalfWidth1;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[0] = (EdgePolarity)m_nLinePolarityMode1;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[0] = m_bSortByScore1;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[0] = m_nLineCaliperNum1;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[0] = m_bEnableLineMask_1;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[0] = m_bShowCaliper_1;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[0] = m_bEnableDualEdge_1;

		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[1] = m_nLineOutLineNum2;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[1] = m_dLineContrastThre2;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[1] = m_lLineFilterHalfWidth2;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[1] = (EdgePolarity)m_nLinePolarityMode2;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[1] = m_bSortByScore2;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[1] = m_nLineCaliperNum2;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[1] = m_bEnableLineMask_2;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[1] = m_bShowCaliper_2;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[1] = m_bEnableDualEdge_2;

		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[2]  = m_nLineOutLineNum3;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[2] = m_dLineContrastThre3;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[2] = m_lLineFilterHalfWidth3;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[2] = (EdgePolarity)m_nLinePolarityMode3;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[2] = m_bSortByScore3;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[2] = m_nLineCaliperNum3;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[2] = m_bEnableLineMask_3;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[2] = m_bShowCaliper_3;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[2] = m_bEnableDualEdge_3;

		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[3] = m_nLineOutLineNum4;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[3] = m_dLineContrastThre4;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[3] = m_lLineFilterHalfWidth4;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[3] = (EdgePolarity)m_nLinePolarityMode4;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[3] = m_bSortByScore4;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[3] = m_nLineCaliperNum4;	
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[3] = m_bEnableLineMask_4;
		((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[3] = m_bShowCaliper_4;
		((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[3] = m_bEnableDualEdge_4;
	...
	{
		m_nImageChannel = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_nPatAccuracyMode = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy/2;
		m_nPatSpeedMode = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale-1;
		m_dAngleLow	    = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh;
		m_bEnableMask = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;	

		m_nLineOutLineNum1 =  ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[0];
		m_dLineContrastThre1 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[0];
		m_lLineFilterHalfWidth1 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[0];
		m_nLinePolarityMode1 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[0];
		m_bSortByScore1 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[0];
		m_nLineCaliperNum1 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[0];
		m_bEnableLineMask_1 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[0];
		m_bShowCaliper_1 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[0];
		m_bEnableDualEdge_1 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[0];

		m_nLineOutLineNum2 =  ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[1];
		m_dLineContrastThre2 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[1];
		m_lLineFilterHalfWidth2 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[1];
		m_nLinePolarityMode2 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[1];
		m_bSortByScore2 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[1];
		m_nLineCaliperNum2 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[1];
		m_bEnableLineMask_2 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[1];
		m_bShowCaliper_2 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[1];
		m_bEnableDualEdge_2 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[1];

		m_nLineOutLineNum3 =  ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[2];
		m_dLineContrastThre3 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[2];
		m_lLineFilterHalfWidth3 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[2];
		m_nLinePolarityMode3 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[2];
		m_bSortByScore3 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[2];
		m_nLineCaliperNum3 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[2];
		m_bEnableLineMask_3 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[2];
		m_bShowCaliper_3 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[2];
		m_bEnableDualEdge_3 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[2];

		m_nLineOutLineNum4 =  ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[3];
		m_dLineContrastThre4 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[3];
		m_lLineFilterHalfWidth4 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[3];
		m_nLinePolarityMode4 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[3];
		m_bSortByScore4 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[3];
		m_nLineCaliperNum4 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[3];
		m_bEnableLineMask_4 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[3];
		m_bShowCaliper_4 = ((CPatternRectSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[3];
		m_bEnableDualEdge_4 = ((CPatternRectSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[3];
		if (m_bEnableMask)
		{
...
void CDlgPatternRectSearchTool::UpdateSearchData(bool bValidate)
{
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CPatternRectSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CPatternRectSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CPatternRectSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre = m_dConfusionThre;

		((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint = m_bShowFitPoint_1;
		((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint1 = m_bShowFitPoint_2;
		((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint2 = m_bShowFitPoint_3;
		((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint3 = m_bShowFitPoint_4;
		((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_nResultOutMode=m_nResultOutMode;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CPatternRectSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CPatternRectSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;	
		m_dConfusionThre = ((CPatternRectSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre;

		m_bShowFitPoint_1	= ((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint;
		m_bShowFitPoint_2	= ((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint1;
		m_bShowFitPoint_3	= ((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint2;
		m_bShowFitPoint_4	= ((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint3;
		m_nResultOutMode	= ((CPatternRectSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_nResultOutMode;
		UpdateData(FALSE);
	}

}

void CDlgPatternRectSearchTool::UpdateDialogLanguage()
{
...
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_PATTERNRECTSEARCH_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgPatternRectSearchTool::CheckDlgDataValidation()
{
...
void CDlgPatternRectSearchTool::OnBtnGetTrainImage() 
{
...
void CDlgPatternRectSearchTool::OnBtnTrain() 
{
...
void CDlgPatternRectSearchTool::OnBtnSetMaskImage()
{
...
void CDlgPatternRectSearchTool::OnChkEnableMask() 
{
...
BOOL CDlgPatternRectSearchTool::OnInitDialog() 
{
...
void CDlgPatternRectSearchTool::OnSelchangeComboAccuracyMode() 
{
	m_nPatAccuracyMode = m_comboAccuracy.GetCurSel();	
}

void CDlgPatternRectSearchTool::OnSelchangeComboSpeedMode() 
{
	m_nPatSpeedMode = m_comboSpeed.GetCurSel();
}

void CDlgPatternRectSearchTool::OnSetfocusEdtAngleLow() 
{
...
void CDlgPatternRectSearchTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtSearchNum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtConfusionThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineCalipernum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineContrastThre1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineOutlineNum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineCalipernum2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineContrastThre2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineOutlineNum2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineCalipernum3() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineContrastThre3() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineOutlineNum3() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineCalipernum4() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineContrastThre4() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnSetfocusEdtLineOutlineNum4() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternRectSearchTool::OnChangeEdtLineCalipernum1() 
{
...
void CDlgPatternRectSearchTool::OnChangeEdtLineCalipernum2() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternRectSearchTool::OnChangeEdtLineCalipernum3() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternRectSearchTool::OnChangeEdtLineCalipernum4() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternRectSearchTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CPatternRectSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgPatternRectSearchTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgPatternRectSearchTool::OnBnClickedCheckLineMask1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternRectSearchTool::OnBnClickedCheckShowFitpoint1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternRectSearchTool::OnBnClickedCheckLineMask2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternRectSearchTool::OnBnClickedCheckShowFitpoint2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternRectSearchTool::OnBnClickedCheckLineMask3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternRectSearchTool::OnBnClickedCheckShowFitpoint3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternRectSearchTool::OnBnClickedCheckLineMask4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternRectSearchTool::OnBnClickedCheckShowFitpoint4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternRectSearchTool::OnBnClickedChkShowLineCaliper1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgPatternRectSearchTool::OnBnClickedChkShowLineCaliper2()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgPatternRectSearchTool::OnBnClickedChkShowLineCaliper3()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgPatternRectSearchTool::OnBnClickedChkShowLineCaliper4()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}

void CDlgPatternRectSearchTool::OnEnSetfocusEditLineFilterHalfWidth1() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternRectSearchTool::OnEnSetfocusEditLineFilterHalfWidth2() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternRectSearchTool::OnEnSetfocusEditLineFilterHalfWidth3() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternRectSearchTool::OnEnSetfocusEditLineFilterHalfWidth4() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
