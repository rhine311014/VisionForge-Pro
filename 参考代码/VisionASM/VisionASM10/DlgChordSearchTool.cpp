// DlgChordSearchToolSetting.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDlgChordSearchTool dialog


CDlgChordSearchTool::CDlgChordSearchTool(CWnd* pParent /*=NULL*/)
: CDialog(CDlgChordSearchTool::IDD, pParent)
...
, m_dOffsetRatio(1.0)
{
	//{{AFX_DATA_INIT(CDlgChordSearchTool)
...
void CDlgChordSearchTool::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgChordSearchTool)
...
BEGIN_MESSAGE_MAP(CDlgChordSearchTool, CDialog)
//{{AFX_MSG_MAP(CDlgChordSearchTool)
	...
	//}}AFX_MSG_MAP
	ON_EN_SETFOCUS(IDC_EDT_LINE_CALIPERNUM, &CDlgChordSearchTool::OnEnSetfocusEdtLineCalipernum)
	ON_EN_SETFOCUS(IDC_EDT_LINE_OUTLINE_NUM, &CDlgChordSearchTool::OnEnSetfocusEdtLineOutlineNum)
	ON_EN_SETFOCUS(IDC_EDT_LINE_CONTRAST_THRE, &CDlgChordSearchTool::OnEnSetfocusEdtLineContrastThre)
	ON_EN_CHANGE(IDC_EDT_LINE_CALIPERNUM, &CDlgChordSearchTool::OnEnChangeEdtLineCalipernum)
	ON_BN_CLICKED(IDC_CHECK_ENABLE_LINE_MASK, &CDlgChordSearchTool::OnBnClickedCheckEnableLineMask)
	ON_BN_CLICKED(IDC_CHECK_SHOW_LINE_POINT, &CDlgChordSearchTool::OnBnClickedCheckShowLinePoint)
	ON_BN_CLICKED(IDC_CHECK_SHOW_CIRCLE_POINT, &CDlgChordSearchTool::OnBnClickedCheckShowCirclePoint)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER, &CDlgChordSearchTool::OnBnClickedChkShowLineCaliper)
	ON_BN_CLICKED(IDC_CHK_SHOW_CIRCLE_CALIPER, &CDlgChordSearchTool::OnBnClickedChkShowCircleCaliper)
	ON_BN_CLICKED(IDC_CHECK_CIRCLE_MASK, &CDlgChordSearchTool::OnBnClickedCheckCircleMask)
	ON_BN_CLICKED(IDC_CHECK_ENABLE_LINE_CIRCLE_CROSS, &CDlgChordSearchTool::OnBnClickedCheckEnableLineCircleCross)
	ON_EN_SETFOCUS(IDC_EDIT_FIT_LINE_DMS, &CDlgChordSearchTool::OnEnSetfocusEditFitLineDms)
	ON_EN_SETFOCUS(IDC_EDIT_OFFSET_RATIO, &CDlgChordSearchTool::OnEnSetfocusEditOffsetRatio)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgChordSearchTool message handlers

void CDlgChordSearchTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgChordSearchTool::UpdateTrainData(bool bValidate)
{
	...
	CChordSearchTrainDataParam* pTrainDataParam = (CChordSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam;
	CChordSearchTrainGuiParam* pTrainGuiParam = (CChordSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam;
...
void CDlgChordSearchTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	CChordSearchSearchDataParam* pSearchDataParam = (CChordSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam;
	CChordSearchSearchGuiParam* pSearchGuiParam = (CChordSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam;
	if (bValidate) // 从界面获取搜索参数
	{
		...
		pSearchDataParam->m_dAngleLow = m_dAngleLow;
		pSearchDataParam->m_dAngleHigh = m_dAngleHigh;
	...
	else // 设置界面值
	{
		...
		m_dAngleLow		= pSearchDataParam->m_dAngleLow;
		m_dAngleHigh	= pSearchDataParam->m_dAngleHigh;
...
void CDlgChordSearchTool::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_CHORDSEARCH_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgChordSearchTool::OnBtnGetTrainImage() 
{
...
void CDlgChordSearchTool::OnBtnTrain() 
{
...
void CDlgChordSearchTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgChordSearchTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgChordSearchTool::OnInitDialog()
{
...
void CDlgChordSearchTool::OnChangeEdtChordCalipernum() 
{
...
void CDlgChordSearchTool::OnRadChordInwardMode0() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgChordSearchTool::OnRadChordInwardMode1() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgChordSearchTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgChordSearchTool::OnSetfocusEdtGrau() 
{
...
void CDlgChordSearchTool::OnSetfocusEdtNoisethre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnSetfocusEdtTotalMag() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnSetfocusEdtChordCalipernum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnSetfocusEdtChordContrastThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnSetfocusEdtChordOutlineNum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgChordSearchTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnSetfocusEdtAngleLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CChordSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgChordSearchTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgChordSearchTool::OnEnSetfocusEdtLineCalipernum()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgChordSearchTool::OnEnSetfocusEdtLineOutlineNum()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgChordSearchTool::OnEnSetfocusEdtLineContrastThre()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgChordSearchTool::OnEnChangeEdtLineCalipernum()
{
...
void CDlgChordSearchTool::OnBnClickedCheckEnableLineMask()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData();
	UpdateTrainData(TRUE);
...
void CDlgChordSearchTool::OnBnClickedCheckShowLinePoint()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData();
	UpdateSearchData(TRUE);
...
void CDlgChordSearchTool::OnBnClickedCheckShowCirclePoint()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgChordSearchTool::OnBnClickedChkShowLineCaliper()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}
...
void CDlgChordSearchTool::OnBnClickedChkShowCircleCaliper()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}
...
void CDlgChordSearchTool::OnBnClickedCheckCircleMask()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}

void CDlgChordSearchTool::OnEnSetfocusEditLineFilterHalfWidth() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgChordSearchTool::OnBnClickedCheckEnableLineCircleCross()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	if (m_bEnableLineCircleCross)
...
void CDlgChordSearchTool::OnEnSetfocusEditCircleFilterHalfWidth() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgChordSearchTool::OnEnSetfocusEditFitLineDms()
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgChordSearchTool::OnEnSetfocusEditOffsetRatio()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
