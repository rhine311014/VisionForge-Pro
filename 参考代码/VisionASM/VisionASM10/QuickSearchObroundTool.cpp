// QuickSearchObroundTool.cpp: implementation of the CQuickSearchObroundTool class.
//
//////////////////////////////////////////////////////////////////////
...
CQuickSearchObroundTool::CQuickSearchObroundTool()
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
...
CQuickSearchObroundTool::CQuickSearchObroundTool(CQuickSearchObroundTool &cQuickSearchObroundTool)
{
	if (cQuickSearchObroundTool.GetSearchToolType() != eQuickSearchObroundTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cQuickSearchObroundTool.m_CamHeight;
	m_CamWidth								= cQuickSearchObroundTool.m_CamWidth;

	m_TrainDataParam						= cQuickSearchObroundTool.m_TrainDataParam;
	m_TrainGuiParam							= cQuickSearchObroundTool.m_TrainGuiParam;
	m_SearchDataParam						= cQuickSearchObroundTool.m_SearchDataParam;
	m_SearchGuiParam						= cQuickSearchObroundTool.m_SearchGuiParam;
	m_TrainResult							= cQuickSearchObroundTool.m_TrainResult;
	m_ImageTrain							= cQuickSearchObroundTool.m_ImageTrain;
	m_ImageMask								= cQuickSearchObroundTool.m_ImageMask;
	m_bTrainGuiShow							= cQuickSearchObroundTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow                   = cQuickSearchObroundTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cQuickSearchObroundTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cQuickSearchObroundTool.m_bTrainOK;
	m_pGuiDisplay							= cQuickSearchObroundTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cQuickSearchObroundTool.UpdateSearchGuiData(true);
	cQuickSearchObroundTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cQuickSearchObroundTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cQuickSearchObroundTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cQuickSearchObroundTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cQuickSearchObroundTool.m_tmpSearchGuiParam);
	SetTrainImage(cQuickSearchObroundTool.m_tmpImageTrain);
	SetMaskImage(cQuickSearchObroundTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CQuickSearchObroundTool& CQuickSearchObroundTool::operator=(CQuickSearchObroundTool &cQuickSearchObroundTool)
{
	if (this == &cQuickSearchObroundTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CQuickSearchObroundTool::GetSearchToolType()
{
	return eQuickSearchObroundTool;
}										   

// 设置显示控件指针		
bool CQuickSearchObroundTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{	
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CQuickSearchObroundTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CQuickSearchObroundTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CQuickSearchObroundTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CQuickSearchObroundTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CQuickSearchObroundTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CQuickSearchObroundTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CQuickSearchObroundTool::ShowTrainResultGui(bool bShow)
{
...
// 更新搜索界面显示									
bool CQuickSearchObroundTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练Gui控件显示
bool CQuickSearchObroundTool::UpdateTrainGuiDisplay()
{
...
// 更新训练结果Gui控件显示
bool CQuickSearchObroundTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索Gui控件显示														
bool CQuickSearchObroundTool::UpdateSearchResultGuiDisplay()
{
	int i=0;
...
// 更新界面显示
bool CQuickSearchObroundTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CQuickSearchObroundTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eQuickSearchObroundTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CQuickSearchObroundTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CQuickSearchObroundTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CQuickSearchObroundTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CQuickSearchObroundTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eQuickSearchObroundTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CQuickSearchObroundTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CQuickSearchObroundTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CQuickSearchObroundTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CQuickSearchObroundTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CQuickSearchObroundTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CQuickSearchObroundTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CQuickSearchObroundTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CQuickSearchObroundTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CQuickSearchObroundTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CQuickSearchObroundTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eQuickSearchObroundTool)
	{
		return false;
	}
	
	*((CQuickSearchObroundTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}	

// 是否训练成功
bool CQuickSearchObroundTool::IsTrained()
{
	return m_bTrainOK;
}
				
// 设置搜索Data参数	
bool CQuickSearchObroundTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eQuickSearchObroundTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CQuickSearchObroundSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CQuickSearchObroundTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CQuickSearchObroundSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CQuickSearchObroundTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eQuickSearchObroundTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CQuickSearchObroundSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CQuickSearchObroundTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CQuickSearchObroundSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CQuickSearchObroundTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
...
// 获取搜索结果个数										
int CQuickSearchObroundTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CQuickSearchObroundTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像文件
bool CQuickSearchObroundTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eQuickSearchObroundTool)
	{
		return false;
	}
...
// 加载模板文件
bool CQuickSearchObroundTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CQuickSearchObroundTrainDataParam tmpTrainDataParam;
	CQuickSearchObroundTrainGuiParam tmpTrainGuiParam;
	CQuickSearchObroundSearchDataParam tmpSearchDataParam;
	CQuickSearchObroundSearchGuiParam tmpSearchGuiParam;
	CQuickSearchObroundTrainResult  tmpTrainResult;
	if (!cXMLConfigurator.Load(strXmlPath))
	{
		return false;
	}
...
// 保存模板文件							
bool CQuickSearchObroundTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CQuickSearchObroundTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CQuickSearchObroundTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CQuickSearchObroundTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
bool CQuickSearchObroundTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CQuickSearchObroundTool::ClearResult()
{
	ClearResultGui();
...
bool CQuickSearchObroundTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CQuickSearchObroundTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CQuickSearchObroundTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CQuickSearchObroundTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CQuickSearchObroundTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CQuickSearchObroundTool::RestoreSearchParam()
{
...
void CQuickSearchObroundTool::SetLanguage(int nLanguage)
{
...
CString CQuickSearchObroundTool::GetResultErrInfo()
{
	CString strErrInfo;
