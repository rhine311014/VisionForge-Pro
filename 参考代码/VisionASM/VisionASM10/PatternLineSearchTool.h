// PatternLineSearchTool.h: interface for the CPatternLineSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
// PatternLineSearch定位工具训练Data参数类
typedef struct tagPatternLineSearchTrainDataParam : public CBaseTrainDataParam
{
	...
	tagPatternLineSearchTrainDataParam()
	{
...
}CPatternLineSearchTrainDataParam;

// PatternLineSearch定位工具训练Gui参数类
typedef struct tagPatternLineSearchTrainGuiParam : public CBaseTrainGuiParam
{
...
//	bool			m_bSearchRectVisible;				// 搜索区域是否可见
	...
	tagPatternLineSearchTrainGuiParam()
	{
		m_nCaliperNum[0]				= 2;
		m_dStartX[0]					= 100.0;
		m_dStartY[0]					= 100.0;
...
}CPatternLineSearchTrainGuiParam;

// PatternLineSearch定位工具搜索Data参数类
typedef struct tagPatternLineSearchSearchDataParam : public CBaseSearchDataParam
{
	int		m_nSearchNum;								// 搜索个数
	double	m_dAcceptThre;								// 接收阈值
	double  m_dConfusionThre;							// 混淆阈值。混淆阈值不小于接收阈值
	tagPatternLineSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.6;
...
}CPatternLineSearchSearchDataParam;

// PatternLineSearch定位工具搜索Gui参数类
typedef struct tagPatternLineSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
...
}CPatternLineSearchSearchGuiParam;

// PatternSearch训练结果
typedef struct tagPatternLineSearchTrainResult
{
	...
	tagPatternLineSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CPatternLineSearchTrainResult;

class CPatternLineSearchTool :public CBaseSearchTool
{
public:
	CPatternLineSearchTool(void);
	CPatternLineSearchTool(CPatternLineSearchTool &cPatternLineSearchTool);
	CPatternLineSearchTool& operator=(CPatternLineSearchTool &cPatternLineSearchTool);
	~CPatternLineSearchTool(void);
...
private:
	...
	CPatternLineSearchTrainDataParam		m_tmpTrainDataParam;			// 当前训练Data参数
	CPatternLineSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CPatternLineSearchSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CPatternLineSearchSearchGuiParam		m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CPatternLineSearchTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像

	CPatternLineSearchTrainDataParam		m_TrainDataParam;				// 训练Data参数
	CPatternLineSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CPatternLineSearchSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CPatternLineSearchSearchGuiParam		m_SearchGuiParam;				// 搜索Gui参数	
	CPatternLineSearchTrainResult			m_TrainResult;					// 训练结果
