// LineSearchTool.h: interface for the CLineSearchTool class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_LINESEARCHTOOL_H__BE74778E_0350_48F2_83EE_80A1F19989EE__INCLUDED_)
#define AFX_LINESEARCHTOOL_H__BE74778E_0350_48F2_83EE_80A1F19989EE__INCLUDED_
...
// LineSearch定位工具训练Data参数类
typedef struct tagLineSearchTrainDataParam : public CBaseTrainDataParam
{
	double			m_dGrau;							// 颗粒度
...
}CLineSearchTrainDataParam;

// LineSearch定位工具训练Gui参数类
typedef struct tagLineSearchTrainGuiParam : public CBaseTrainGuiParam
{
...
}CLineSearchTrainGuiParam;

// LineSearch定位工具搜索Data参数类
typedef struct tagLineSearchSearchDataParam : public CBaseSearchDataParam
{
...
}CLineSearchSearchDataParam;

// LineSearch定位工具搜索Gui参数类
typedef struct tagLineSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;			// 图形颜色
	int				m_nLineWidth;			// 图形线宽
...
}CLineSearchSearchGuiParam;

// QuickSearch训练结果
typedef struct tagLineSearchTrainResult
{
...
}CLineSearchTrainResult;


//
//	线定位工具
//
class /*SV_SEARCHTOOL_API*/ CLineSearchTool : public CBaseSearchTool    
{
public:
	CLineSearchTool();
	CLineSearchTool(CLineSearchTool &cLineSearchTool);
	CLineSearchTool& operator=(CLineSearchTool &cLineSearchTool);
	virtual ~CLineSearchTool();
...
private:	
	...
	CLineSearchTrainDataParam			m_tmpTrainDataParam;		// 当前训练Data参数
	CLineSearchTrainGuiParam			m_tmpTrainGuiParam;			// 当前训练Gui参数	
	CLineSearchSearchDataParam			m_tmpSearchDataParam;		// 当前搜索Data参数	
	CLineSearchSearchGuiParam			m_tmpSearchGuiParam;		// 当前搜索Gui参数
	CLineSearchTrainResult				m_tmpTrainResult;			// 当前训练结果
	cpImage							m_tmpImageTrain;			// 当前训练图像
	cpImage							m_tmpImageMask;				// 当前掩模图像
	CLineSearchTrainDataParam			m_TrainDataParam;			// 训练Data参数
	CLineSearchTrainGuiParam			m_TrainGuiParam;			// 训练Gui参数	
	CLineSearchSearchDataParam			m_SearchDataParam;			// 搜索Data参数	
	CLineSearchSearchGuiParam			m_SearchGuiParam;			// 搜索Gui参数
	CLineSearchTrainResult				m_TrainResult;				// 训练结果
...
#endif // !defined(AFX_LINESEARCHTOOL_H__BE74778E_0350_48F2_83EE_80A1F19989EE__INCLUDED_)
