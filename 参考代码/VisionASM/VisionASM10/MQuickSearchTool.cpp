...
CMQuickSearchTool::CMQuickSearchTool()
{
	m_pGuiDisplay							= NULL;
	m_hDispWnd                              = NULL;
...
CMQuickSearchTool::CMQuickSearchTool(CMQuickSearchTool &cMQuickSearchTool)
{
	if (cMQuickSearchTool.GetSearchToolType() != eMQuickSearchTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cMQuickSearchTool.m_CamHeight;
	m_CamWidth								= cMQuickSearchTool.m_CamWidth;


	m_TrainDataParam						= cMQuickSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cMQuickSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cMQuickSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cMQuickSearchTool.m_SearchGuiParam;
	m_TrainResult                           = cMQuickSearchTool.m_TrainResult;
	m_ImageTrain							= cMQuickSearchTool.m_ImageTrain;
	m_ImageMask								= cMQuickSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cMQuickSearchTool.m_bTrainGuiShow;
	m_bSearchResultGuiShow					= cMQuickSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cMQuickSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cMQuickSearchTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cMQuickSearchTool.UpdateSearchGuiData(true);
	cMQuickSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cMQuickSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cMQuickSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cMQuickSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cMQuickSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cMQuickSearchTool.m_tmpImageTrain);
	SetMaskImage(cMQuickSearchTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CMQuickSearchTool& CMQuickSearchTool::operator=(CMQuickSearchTool& cMQuickSearchTool)
{
	if (this == &cMQuickSearchTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CMQuickSearchTool::GetSearchToolType()
{
	return eMQuickSearchTool;
}										   

// 设置显示控件指针		
bool CMQuickSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CMQuickSearchTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CMQuickSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CMQuickSearchTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CMQuickSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CMQuickSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CMQuickSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CMQuickSearchTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CMQuickSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CMQuickSearchTool::UpdateTrainGuiDisplay()
{
...
// 更新搜索界面显示									
bool CMQuickSearchTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
bool CMQuickSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CMQuickSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eMQuickSearchTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CMQuickSearchTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CMQuickSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CMQuickSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CMQuickSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eMQuickSearchTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CMQuickSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CMQuickSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CMQuickSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CMQuickSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CMQuickSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CMQuickSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CMQuickSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 获取训练结果图像														
bool CMQuickSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CMQuickSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eMQuickSearchTool)
	{
		return false;
	}
	
	*((CMQuickSearchTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}						

// 是否训练成功
bool CMQuickSearchTool::IsTrained()
{
	return m_bTrainOK;
}															
			
// 设置搜索Data参数	
bool CMQuickSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eMQuickSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CMQuickSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CMQuickSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CMQuickSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CMQuickSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eMQuickSearchTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CMQuickSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CMQuickSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CMQuickSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CMQuickSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
	...
	if (bRet)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			st.Format(_T("%d X:%.1f;Y:%.1f;D:%.3f;S:%.2f"), i, searchResult.m_vdAuxiliaryPosX.at(0), searchResult.m_vdAuxiliaryPosY.at(0), tmpQuickResult.GetRotate().ToDouble(),tmpQuickResult.GetScore());
...
// 获取搜索结果个数										
int CMQuickSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CMQuickSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像文件
bool CMQuickSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eMQuickSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CMQuickSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CMQuickSearchTrainDataParam tmpTrainDataParam;
	CMQuickSearchTrainGuiParam tmpTrainGuiParam;
	CMQuickSearchSearchDataParam tmpSearchDataParam;
	CMQuickSearchSearchGuiParam tmpSearchGuiParam;
	CMQuickSearchTrainResult    tmpTrainResult;
...
// 保存模板文件							
bool CMQuickSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CMQuickSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CMQuickSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CMQuickSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CMQuickSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CMQuickSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CMQuickSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CMQuickSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CMQuickSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CMQuickSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CMQuickSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CMQuickSearchTool::RestoreSearchParam()
{
...
void CMQuickSearchTool::SetLanguage(int nLanguage)
{
...
CString	CMQuickSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
