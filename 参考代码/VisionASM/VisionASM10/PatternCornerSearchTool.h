...
typedef struct tagPatternCornerSearchTrainDataParam : public CBaseTrainDataParam
{
	...
	tagPatternCornerSearchTrainDataParam()
	{
...
}CPatternCornerSearchTrainDataParam;

// PatternCornerSearch定位工具训练Gui参数类
typedef struct tagPatternCornerSearchTrainGuiParam : public CBaseTrainGuiParam
{
...
//	bool			m_bSearchRectVisible;				// 搜索区域是否可见
	...
	tagPatternCornerSearchTrainGuiParam()
	{
		m_nCaliperNum[0]				= 2;
		m_dStartX[0]					= 100.0;
		m_dStartY[0]					= 100.0;
...
}CPatternCornerSearchTrainGuiParam;

// PatternnCornerSearch定位工具搜索Data参数类
typedef struct tagPatternnCornerSearchSearchDataParam : public CBaseSearchDataParam
{
	...
	tagPatternnCornerSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.6;
...
}CPatternCornerSearchSearchDataParam;

// PatternCornerSearch定位工具搜索Gui参数类
typedef struct tagPatternCornerSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
...
//	bool			m_bModelPointVisible;				// 参考点是否可见
	...
	tagPatternCornerSearchGuiParam()
	{
...
}CPatternCornerSearchSearchGuiParam;

// PatternSearch训练结果
typedef struct tagPatternCornerSearchTrainResult
{
	...
	tagPatternCornerSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CPatternCornerSearchTrainResult;

class CPatternCornerSearchTool :public CBaseSearchTool
{
public:
	CPatternCornerSearchTool(void);
	CPatternCornerSearchTool(CPatternCornerSearchTool &cPatternCornerSearchTool);
	CPatternCornerSearchTool& operator=(CPatternCornerSearchTool &cPatternCornerSearchTool);
	~CPatternCornerSearchTool(void);
...
private:
	...
	CPatternCornerSearchTrainDataParam		m_tmpTrainDataParam;			// 当前训练Data参数
	CPatternCornerSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CPatternCornerSearchSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CPatternCornerSearchSearchGuiParam		m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CPatternCornerSearchTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	CPatternCornerSearchTrainDataParam		m_TrainDataParam;				// 训练Data参数
	CPatternCornerSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CPatternCornerSearchSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CPatternCornerSearchSearchGuiParam		m_SearchGuiParam;				// 搜索Gui参数	
	CPatternCornerSearchTrainResult			m_TrainResult;					// 训练结果
