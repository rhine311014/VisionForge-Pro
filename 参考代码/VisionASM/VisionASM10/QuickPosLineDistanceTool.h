...
// QuickPosLineDistance定位工具训练Data参数类
typedef struct tagQuickPosLineDistanceTrainDataParam : public CBaseTrainDataParam
{
	...
	tagQuickPosLineDistanceTrainDataParam()
	{
...
}CQuickPosLineDistanceTrainDataParam;

// QuickPosLineDistance定位工具训练Gui参数类
typedef struct tagQuickPosLineDistanceTrainGuiParam : public CBaseTrainGuiParam
{
	scAffineRect	m_TrainAffineRect;					// 训练区域
	sc2Vector		m_ModelPoint;						// 参考点
	scRect			m_SearchRect;						// 搜索区域m_TrainRect
	...
	tagQuickPosLineDistanceTrainGuiParam()
	{
		m_nCaliperNum[0]				= 2;
		m_dStartX[0]					= 100.0;
		m_dStartY[0]					= 100.0;
...
}CQuickPosLineDistanceTrainGuiParam;

// QuickPosLineDistance定位工具搜索Data参数类
typedef struct tagQuickPosLineDistanceSearchDataParam : public CBaseSearchDataParam
{
	...
	tagQuickPosLineDistanceSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.6;
...
}CQuickPosLineDistanceSearchDataParam;

// QuickPosLineDistance定位工具搜索Gui参数类
typedef struct tagQuickPosLineDistanceGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	...
	tagQuickPosLineDistanceGuiParam()
	{
...
}CQuickPosLineDistanceSearchGuiParam;

// PatternSearch训练结果
typedef struct tagQuickPosLineDistanceTrainResult
{
	...
	tagQuickPosLineDistanceTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CQuickPosLineDistanceTrainResult;

class CQuickPosLineDistanceTool : public CBaseSearchTool
{
public:
	CQuickPosLineDistanceTool(void);
	CQuickPosLineDistanceTool(CQuickPosLineDistanceTool &cQuickPosLineDistanceTool);
	CQuickPosLineDistanceTool& operator=(CQuickPosLineDistanceTool &cQuickPosLineDistanceTool);
	~CQuickPosLineDistanceTool(void);
...
private:
	...
	CQuickPosLineDistanceTrainDataParam		m_tmpTrainDataParam;			// 当前训练Data参数
	CQuickPosLineDistanceTrainGuiParam		m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CQuickPosLineDistanceSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CQuickPosLineDistanceSearchGuiParam		m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CQuickPosLineDistanceTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	CQuickPosLineDistanceTrainDataParam		m_TrainDataParam;				// 训练Data参数
	CQuickPosLineDistanceTrainGuiParam		m_TrainGuiParam;				// 训练Gui参数	
	CQuickPosLineDistanceSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CQuickPosLineDistanceSearchGuiParam		m_SearchGuiParam;				// 搜索Gui参数	
	CQuickPosLineDistanceTrainResult			m_TrainResult;					// 训练结果
