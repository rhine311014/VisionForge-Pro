// QuickSearchCheckTool.h: interface for the CQuickSearchCheckTool class.
//
//////////////////////////////////////////////////////////////////////
...
typedef struct tagQuickSearchCheckTrainDataParam : public CBaseTrainDataParam
{
	double	m_dGrau;									// 颗粒度
	double	m_dGrau1;									// 颗粒度
	...
	tagQuickSearchCheckTrainDataParam()
	{
		m_dGrau			= 2.0;
		m_dGrau1		= 2.0;
		m_lNoiseThre	= 10;
...
}CQuickSearchCheckTrainDataParam;

// QuickSearch定位工具训练Gui参数类
typedef struct tagQuickSearchCheckTrainGuiParam : public CBaseTrainGuiParam
{
	...
	tagQuickSearchCheckTrainGuiParam()
	{
...
}CQuickSearchCheckTrainGuiParam;

// QuickSearch定位工具搜索Data参数类
typedef struct tagQuickSearchCheckSearchDataParam : public CBaseSearchDataParam
{
	...
	tagQuickSearchCheckSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.8;
		m_dAcceptThre2	= 0.8;
...
}CQuickSearchCheckSearchDataParam;

// QuickSearch定位工具搜索Gui参数类
typedef struct tagQuickSearchCheckSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	...
	tagQuickSearchCheckSearchGuiParam()
	{
...
}CQuickSearchCheckSearchGuiParam;

// QuickSearch训练结果
typedef struct tagQuickSearchCheckTrainResult
{
	double m_dModelX; // 参考点X					
	double m_dModelY; // 参考点Y

	tagQuickSearchCheckTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
	}
...
}CQuickSearchCheckTrainResult;

class CQuickSearchCheckTool : public CBaseSearchTool
{
public:
	CQuickSearchCheckTool();
	CQuickSearchCheckTool(CQuickSearchCheckTool &cQuickSearchTool);
	CQuickSearchCheckTool& operator=(CQuickSearchCheckTool &cQuickSearchTool);
	virtual ~CQuickSearchCheckTool(void);
...
private:
	...
	scGuiDisplay					   *m_pGuiTrainResultDisplay3;		// 显示训练结果对象指针
	HWND								m_hTrainResultDispWnd3;			// 显示训练结果对象句柄
	...
	CQuickSearchCheckTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CQuickSearchCheckTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CQuickSearchCheckSearchDataParam			m_tmpSearchDataParam;			// 当前搜索Data参数	
	CQuickSearchCheckSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CQuickSearchCheckTrainResult				m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像

	CQuickSearchCheckTrainDataParam			m_TrainDataParam;				// 训练Data参数
	CQuickSearchCheckTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CQuickSearchCheckSearchDataParam			m_SearchDataParam;				// 搜索Data参数	
	CQuickSearchCheckSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CQuickSearchCheckTrainResult				m_TrainResult;					// 训练结果
	...
	scGuiFeaturelet						m_GuiTrainFeaturelet3;			// 训练特征链集
	// 搜索结果GUI
