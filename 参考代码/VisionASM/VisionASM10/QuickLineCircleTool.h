...
// QuickLineCircleSearch定位工具训练Data参数类
typedef struct tagQuickLineCircleSearchTrainDataParam : public CBaseTrainDataParam
{
	...
	bool			m_bEnableLine[QUICK_LINE_CIRCLE_NUM];
	bool			m_bLineCaliperVisible[QUICK_LINE_CIRCLE_NUM];		//找线卡尺是否可见			
	
	tagQuickLineCircleSearchTrainDataParam()
	{
		m_dGrau				= 2.0;
		m_lNoiseThre		= 10;
		m_lTotalMag			= 500;
...
}CQuickLineCircleSearchTrainDataParam;

// QuickLineCircleSearch定位工具训练Gui参数类
typedef struct tagQuickLineCircleSearchTrainGuiParam : public CBaseTrainGuiParam
{

	scAffineRect	m_TrainAffineRect;					// 训练区域
	scRect			m_SearchRect;						// 搜索区域
	sc2Vector		m_ModelPoint;						// 参考点
	sc2Vector		m_ModelPoint2;						// 第二参考点
	...
	tagQuickLineCircleSearchTrainGuiParam()
	{
		// Circle
...
}CQuickLineCircleSearchTrainGuiParam;

// QuickLineCircleSearch定位工具搜索Data参数类
typedef struct tagQuickLineCircleSearchSearchDataParam : public CBaseSearchDataParam
{
	...
	tagQuickLineCircleSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.8;
		m_dAngleLow		= -5.0;
...
}CQuickLineCircleSearchSearchDataParam;

// QuickLineCircleSearch定位工具搜索Gui参数类
typedef struct tagQuickLineCircleSearchGuiParam : public CBaseSearchGuiParam
{
	...
	tagQuickLineCircleSearchGuiParam()
	{
...
}CQuickLineCircleSearchSearchGuiParam;

// QuickSearch训练结果
typedef struct tagQuickLineCircleSearchTrainResult
{
	double m_dModelX;
	double m_dModelY;
	...
	tagQuickLineCircleSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
		m_dModelX2 = 0;
...
}CQuickLineCircleSearchTrainResult;


class CQuickLineCircleTool : public CBaseSearchTool
{

public:
	CQuickLineCircleTool();
	CQuickLineCircleTool(CQuickLineCircleTool &cQuickLineCircleTool);
	CQuickLineCircleTool& operator=(CQuickLineCircleTool &cQuickLineCircleTool);
	virtual ~CQuickLineCircleTool();
...
private:	
	...
	CQuickLineCircleSearchTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CQuickLineCircleSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CQuickLineCircleSearchSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CQuickLineCircleSearchSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CQuickLineCircleSearchTrainResult			m_tmpTrainResult;				// 当前训练结果

	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像

	CQuickLineCircleSearchTrainDataParam			m_TrainDataParam;				// 训练Data参数
	CQuickLineCircleSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CQuickLineCircleSearchSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CQuickLineCircleSearchSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CQuickLineCircleSearchTrainResult			m_TrainResult;					// 训练结果
	...
	scGuiCross                          m_GuiModelPoint2;				// 第二参考点
	...
	std::vector<scGuiGraphic*>          m_pGuiSearchCrossArray1;		// 搜索结果参考点
	...
	std::vector<scGuiGraphic*>          m_pGuiSearchLineArrayModelPoint;		// 搜索结果直线
	std::vector<scGuiGraphic*>          m_pGuiSearchLineArrayVirtural;			// 搜索结果直线
	...
	scGuiLine							m_GuiSearchLineModelPoint[MAXRESNUM*PATTERN_LINE_NUM];
	scGuiLine							m_GuiSearchLineVirtucal[MAXRESNUM*PATTERN_LINE_NUM];
	...
	std::vector<scGuiGraphic*>          m_pGuiSearchResultFitPoint1Array;		// Line
	scGuiCoordCross						m_GuiSearchResultFitPoint1[4096];

	std::vector<scGuiGraphic*>          m_pGuiSearchResultFitPoint2Array;		// Circle
