// PatternVirtualRectSearchTool.cpp: implementation of the CPatternVirtualRectSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
CPatternVirtualRectSearchTool::CPatternVirtualRectSearchTool(void)
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
	...
	m_tmpSearchGuiParam.m_nResultOutMode		= 0;
...
CPatternVirtualRectSearchTool::CPatternVirtualRectSearchTool(CPatternVirtualRectSearchTool &cPatternVirtualRectSearchTool)
{
	if (cPatternVirtualRectSearchTool.GetSearchToolType() != ePatternVirtualRectSearchTool)
	{
		return;
	}
	...
	// 赋值
	m_CamHeight								=  cPatternVirtualRectSearchTool.m_CamHeight;
	m_CamWidth								=  cPatternVirtualRectSearchTool.m_CamWidth;

	m_TrainDataParam						= cPatternVirtualRectSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cPatternVirtualRectSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cPatternVirtualRectSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cPatternVirtualRectSearchTool.m_SearchGuiParam;
	m_TrainResult							= cPatternVirtualRectSearchTool.m_TrainResult;
	m_ImageTrain							= cPatternVirtualRectSearchTool.m_ImageTrain;
	m_ImageMask								= cPatternVirtualRectSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cPatternVirtualRectSearchTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow					= cPatternVirtualRectSearchTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cPatternVirtualRectSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cPatternVirtualRectSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cPatternVirtualRectSearchTool.m_pGuiDisplay;
	...
	cPatternVirtualRectSearchTool.UpdateSearchGuiData(true);
	cPatternVirtualRectSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cPatternVirtualRectSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cPatternVirtualRectSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cPatternVirtualRectSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cPatternVirtualRectSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cPatternVirtualRectSearchTool.m_tmpImageTrain);
	SetMaskImage(cPatternVirtualRectSearchTool.m_tmpImageMask);
	m_PatternSearchTool = cPatternVirtualRectSearchTool.m_PatternSearchTool;  //  jjh 1217
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CPatternVirtualRectSearchTool& CPatternVirtualRectSearchTool::operator=(CPatternVirtualRectSearchTool &cPatternVirtualRectSearchTool)
{
	if (this == &cPatternVirtualRectSearchTool)
	{
		return *this;	
	}
...
bool CPatternVirtualRectSearchTool::GetFindLineCenterPoint(scFindLine* m_FindLineTool,sc2Vector &pointCenter2)
{
	bool bRet = false;
...
CSearchToolType CPatternVirtualRectSearchTool::GetSearchToolType()
{
	return ePatternVirtualRectSearchTool;
}

// 设置显示控件指针		
bool CPatternVirtualRectSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CPatternVirtualRectSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 设置Gui图形的关键字														
bool CPatternVirtualRectSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CPatternVirtualRectSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CPatternVirtualRectSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CPatternVirtualRectSearchTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CPatternVirtualRectSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CPatternVirtualRectSearchTool::UpdateTrainGuiDisplay()
{	
...
bool CPatternVirtualRectSearchTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索界面显示									
bool CPatternVirtualRectSearchTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
// 更新界面显示
bool CPatternVirtualRectSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CPatternVirtualRectSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != ePatternVirtualRectSearchTool)
	{
		return false;
	}

	m_tmpTrainDataParam = *((CPatternVirtualRectSearchTrainDataParam*)pTrainDataParam);

	return true;
}

// 获取训练Data参数									
bool CPatternVirtualRectSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CPatternVirtualRectSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;

	return true;
}

// 获取搜索Gui参数						
bool CPatternVirtualRectSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != ePatternVirtualRectSearchTool)
	{
		return false;
	}

	m_tmpTrainGuiParam = *((CPatternVirtualRectSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CPatternVirtualRectSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CPatternVirtualRectSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;

	return true;
}

// 设置训练原始图像				
bool CPatternVirtualRectSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CPatternVirtualRectSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CPatternVirtualRectSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CPatternVirtualRectSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CPatternVirtualRectSearchTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CPatternVirtualRectSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CPatternVirtualRectSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != ePatternVirtualRectSearchTool)
	{
		return false;
	}

	*((CPatternVirtualRectSearchTrainResult*)pTrainResult) = m_tmpTrainResult;

	return true;
}	

// 是否训练成功
bool CPatternVirtualRectSearchTool::IsTrained()
{
	return m_bTrainOK;
}

// 设置搜索Data参数	
bool CPatternVirtualRectSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != ePatternVirtualRectSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CPatternVirtualRectSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CPatternVirtualRectSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CPatternVirtualRectSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CPatternVirtualRectSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != ePatternVirtualRectSearchTool)
	{
		return false;
	}

	m_tmpSearchGuiParam = *((CPatternVirtualRectSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CPatternVirtualRectSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CPatternVirtualRectSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;

	return true;
}

// 执行搜索 					
bool CPatternVirtualRectSearchTool::Search(cpImage &ImageSearch)
{
...
// 			}
			if (m_tmpSearchDataParam.m_nRiviseMode==0)
			{
				...
				if (bIntersect[0] && bIntersect[1] && bIntersect[2] && bIntersect[3])
				{
					...
					strTmpKey.Format(_T("%s_ResultCross%d"), m_strKeyText, i);
					//scGuiCross *pTempCross = new scGuiCross;
					scGuiCross *pTempCross = m_GuiSearchCross+2*i+1;
...
// 获取搜索结果个数										
int CPatternVirtualRectSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CPatternVirtualRectSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板文件
bool CPatternVirtualRectSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
	//	BYTE byR, byG, byB;
	CPatternVirtualRectSearchTrainDataParam tmpTrainDataParam;
	CPatternVirtualRectSearchTrainGuiParam tmpTrainGuiParam;
	CPatternVirtualRectSearchSearchDataParam tmpSearchDataParam;
	CPatternVirtualRectSearchSearchGuiParam tmpSearchGuiParam;	
	CPatternVirtualRectSearchTrainResult    tmpTrainResult;
	...
	if (cSearchToolType != ePatternVirtualRectSearchTool)
	{
		return false;
	}
...
// 保存模板文件							
bool CPatternVirtualRectSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CPatternVirtualRectSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CPatternVirtualRectSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CPatternVirtualRectSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CPatternVirtualRectSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CPatternVirtualRectSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CPatternVirtualRectSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CPatternVirtualRectSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
bool CPatternVirtualRectSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CPatternVirtualRectSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CPatternVirtualRectSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CPatternVirtualRectSearchTool::RestoreSearchParam()
{
...
void CPatternVirtualRectSearchTool::SetLanguage(int nLanguage)
{
...
CString CPatternVirtualRectSearchTool::GetResultErrInfo()
{
	CString strInfo = _T("");
...
// 加载模板训练图像
bool CPatternVirtualRectSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
