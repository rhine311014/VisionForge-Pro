...
#if !defined(AFX_MQUICKSEARCHTOOL_H__8CF0FDDA_2D35_45FE_A3EF_327D8D73244F__INCLUDED_)
#define AFX_MQUICKSEARCHTOOL_H__8CF0FDDA_2D35_45FE_A3EF_327D8D73244F__INCLUDED_
...
// MQuickSearch定位工具训练Data参数类
typedef struct tagMQuickSearchTrainDataParam : public CBaseTrainDataParam
{
	double	m_dGrau;									// 颗粒度
	long	m_lNoiseThre;								// 噪声阈值
	long	m_lTotalMag;								// 幅值和
	bool	m_bMaskEnable;								// 是否设置掩模图像
	tagMQuickSearchTrainDataParam()
	{
		m_dGrau			= 2.0;
		m_lNoiseThre	= 10;
		m_lTotalMag		= 200;
...
}CMQuickSearchTrainDataParam;

// QuickSearch定位工具训练Gui参数类
typedef struct tagMQuickSearchTrainGuiParam : public CBaseTrainGuiParam
{
...
}CMQuickSearchTrainGuiParam;

// QuickSearch定位工具搜索Data参数类
typedef struct tagMQuickSearchSearchDataParam : public CBaseSearchDataParam
{
	...
	tagMQuickSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.8;
		m_dAngleLow		= -5.0;
...
}CMQuickSearchSearchDataParam;

// QuickSearch定位工具搜索Gui参数类
typedef struct tagMQuickSearchSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	bool			m_bAffineRectVisible;				// 搜索结果矩形可见
	bool			m_bModelPointVisible;				// 参考点是够可见
	tagMQuickSearchSearchGuiParam()
	{
...
}CMQuickSearchSearchGuiParam;

// QuickSearch训练结果
typedef struct tagMQuickSearchTrainResult
{
...
}CMQuickSearchTrainResult;

//
//	QuickSearch定位工具
//
class /*SV_SEARCHTOOL_API*/ CMQuickSearchTool : public CBaseSearchTool  
{
public:
	CMQuickSearchTool();
	CMQuickSearchTool(CMQuickSearchTool &cMQuickSearchTool);
	CMQuickSearchTool& operator=(CMQuickSearchTool &cMQuickSearchTool);
	virtual ~CMQuickSearchTool();
...
private:
	...
	CMQuickSearchTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CMQuickSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CMQuickSearchSearchDataParam			m_tmpSearchDataParam;			// 当前搜索Data参数	
	CMQuickSearchSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CMQuickSearchTrainResult				m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	CMQuickSearchTrainDataParam			m_TrainDataParam;				// 训练Data参数
	CMQuickSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CMQuickSearchSearchDataParam			m_SearchDataParam;				// 搜索Data参数	
	CMQuickSearchSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CMQuickSearchTrainResult				m_TrainResult;					// 训练结果
