// RectSearchTool.cpp: implementation of the CRectSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
CRectSearchTool::CRectSearchTool()
{
	m_pGuiDisplay										= NULL;
	m_hDispWnd											= NULL;
...
CRectSearchTool::CRectSearchTool(CRectSearchTool &cRectSearchTool)
{
	if (cRectSearchTool.GetSearchToolType() != eRectSearchTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cRectSearchTool.m_CamHeight;
	m_CamWidth								= cRectSearchTool.m_CamWidth;
	m_TrainDataParam						= cRectSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cRectSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cRectSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cRectSearchTool.m_SearchGuiParam;
	m_TrainResult							= cRectSearchTool.m_TrainResult;
	m_ImageTrain							= cRectSearchTool.m_ImageTrain;
	m_ImageMask								= cRectSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cRectSearchTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow					= cRectSearchTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cRectSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cRectSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cRectSearchTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cRectSearchTool.UpdateSearchGuiData(true);
	cRectSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cRectSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cRectSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cRectSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cRectSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cRectSearchTool.m_tmpImageTrain);
	SetMaskImage(cRectSearchTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CRectSearchTool& CRectSearchTool::operator=(CRectSearchTool &cRectSearchTool)
{
	if (this == &cRectSearchTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CRectSearchTool::GetSearchToolType()
{
	return eRectSearchTool;
}										   

// 设置显示控件指针		
bool CRectSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CRectSearchTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CRectSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CRectSearchTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CRectSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CRectSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CRectSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CRectSearchTool::ShowTrainResultGui(bool bShow)
{
...
// 更新搜索界面显示									
bool CRectSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练Gui控件显示
bool CRectSearchTool::UpdateTrainGuiDisplay()
{
	// 更新
...
// 更新训练结果Gui控件显示
bool CRectSearchTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索Gui控件显示														
bool CRectSearchTool::UpdateSearchResultGuiDisplay()
{
	int i=0;
...
// 更新界面显示
bool CRectSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CRectSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eRectSearchTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CRectSearchTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CRectSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CRectSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CRectSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eRectSearchTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CRectSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CRectSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CRectSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CRectSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CRectSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CRectSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CRectSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 获取训练结果图像														
bool CRectSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CRectSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eRectSearchTool)
	{
		return false;
	}
	
	*((CRectSearchTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}	

// 是否训练成功
bool CRectSearchTool::IsTrained()
{
	return m_bTrainOK;
}
				
// 设置搜索Data参数	
bool CRectSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eRectSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CRectSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CRectSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CRectSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CRectSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eRectSearchTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CRectSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CRectSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CRectSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CRectSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
...
// 获取搜索结果个数										
int CRectSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CRectSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像文件
bool CRectSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eRectSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CRectSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CRectSearchTrainDataParam tmpTrainDataParam;
	CRectSearchTrainGuiParam tmpTrainGuiParam;
	CRectSearchSearchDataParam tmpSearchDataParam;
	CRectSearchSearchGuiParam tmpSearchGuiParam;
	CRectSearchTrainResult    tmpTrainResult;
	if (!cXMLConfigurator.Load(strXmlPath))
	{
		return false;
	}
...
// 保存模板文件							
bool CRectSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CRectSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CRectSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CRectSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{	
...
// 清除定位工具在Display上的控件				
bool CRectSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CRectSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CRectSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CRectSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
bool CRectSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CRectSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CRectSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CRectSearchTool::RestoreSearchParam()
{
...
void CRectSearchTool::SetLanguage(int nLanguage)
{
...
CString CRectSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
