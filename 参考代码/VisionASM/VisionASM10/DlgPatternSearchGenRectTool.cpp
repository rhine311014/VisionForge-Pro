...
CDlgPatternSearchGenRectTool::CDlgPatternSearchGenRectTool(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgPatternSearchGenRectTool::IDD, pParent)
	, m_nComboboxMethod(0)
	, m_bSortByScore1(TRUE)
	, m_nImageChannel(0)
{
	//{{AFX_DATA_INIT(CDlgPatternSearchGenRectTool)
	m_nSearchNum = 1;
	m_dAcceptThre = 0.6;
...
void CDlgPatternSearchGenRectTool::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgPatternSearchGenRectTool)
	...
	DDX_CBIndex(pDX, IDC_COMBO_METHOD, m_nComboboxMethod);
	//}}AFX_DATA_MAP
	DDX_Radio(pDX, IDC_RADIO_CHANNEL_GRAY, m_nImageChannel);
}


BEGIN_MESSAGE_MAP(CDlgPatternSearchGenRectTool, CDialog)
	//{{AFX_MSG_MAP(CDlgPatternSearchGenRectTool)
	...
	//}}AFX_MSG_MAP
	ON_CBN_SELCHANGE(IDC_COMBO_METHOD, &CDlgPatternSearchGenRectTool::OnCbnSelchangeComboMethod)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgPatternSearchGenRectTool message handlers
void CDlgPatternSearchGenRectTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgPatternSearchGenRectTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy = (Accuracy)(1<<m_nPatAccuracyMode);
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale = (CoarseScale)(m_nPatSpeedMode+1);
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow  =  m_dAngleLow;
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh = m_dAngleHigh;
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum = m_nCircleOutLineNum;
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre = m_dCircleContrastThre;
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth = m_lCircleFilterHalfWidth;
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty = (EdgePolarity)m_nCirclePolarityMode;
		((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore = m_bSortByScore1;
		((CPatternSearchGenRectTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum = m_nCircleCaliperNum;
		((CPatternSearchGenRectTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CaliperSearchDirection = (CaliperSearchDirection)m_nCircleInwardMode;
	...
	{
		m_nImageChannel = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_nPatAccuracyMode = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy/2;
		m_nPatSpeedMode = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale-1;
		m_dAngleLow	    = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh;
		m_bEnableMask = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;		
		m_nCircleOutLineNum =  ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum;
		m_dCircleContrastThre = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre;
		m_lCircleFilterHalfWidth = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth;
		m_nCirclePolarityMode = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty;
		m_bSortByScore1 = ((CPatternSearchGenRectTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore;
		m_nCircleCaliperNum = ((CPatternSearchGenRectTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum;
		m_nCircleInwardMode = ((CPatternSearchGenRectTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CaliperSearchDirection;
...
void CDlgPatternSearchGenRectTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CPatternSearchGenRectSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CPatternSearchGenRectSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CPatternSearchGenRectSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre = m_dConfusionThre;
		((CPatternSearchGenRectSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nMethod = m_nComboboxMethod;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CPatternSearchGenRectSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CPatternSearchGenRectSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;	
		m_dConfusionThre = ((CPatternSearchGenRectSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre;
		m_nComboboxMethod = ((CPatternSearchGenRectSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nMethod;

		m_comboboxMethod.SetCurSel(m_nComboboxMethod);
		UpdateData(FALSE);
	}
	
}

void CDlgPatternSearchGenRectTool::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_PATTERNSEARCH_GENRECT_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgPatternSearchGenRectTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
// 	}
	if ((m_nCircleOutLineNum < 0) || (m_nCircleOutLineNum * (1-0.01 * m_nCircleOutLineNum)) < 3)
	{
		m_nCircleOutLineNum = 10;
	}
...
void CDlgPatternSearchGenRectTool::OnBtnGetTrainImage() 
{
...
void CDlgPatternSearchGenRectTool::OnBtnTrain() 
{
...
void CDlgPatternSearchGenRectTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgPatternSearchGenRectTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgPatternSearchGenRectTool::OnInitDialog() 
{
...
//	m_GuiPatternDisplay.SetBackgroundColor(RGB(0,0,0));
	...
	m_comboboxMethod.AddString(GetSysInfoString(m_psaSysInfoStrings,IDS_CMB_SEARCH_METHOD_4LINE));
	m_comboboxMethod.AddString(GetSysInfoString(m_psaSysInfoStrings,IDS_CMB_SEARCH_METHOD_4CIRCLE));
...
void CDlgPatternSearchGenRectTool::OnSelchangeComboAccuracyMode() 
{
	m_nPatAccuracyMode = m_comboAccuracy.GetCurSel();	
}

void CDlgPatternSearchGenRectTool::OnSelchangeComboSpeedMode() 
{
	m_nPatSpeedMode = m_comboSpeed.GetCurSel();
}

void CDlgPatternSearchGenRectTool::OnBtnSetCenter() 
{
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		cpImage imageTrain, imagePattern;
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CPatternSearchGenRectTrainGuiParam *pTrainGuiParam = new CPatternSearchGenRectTrainGuiParam;
...
void CDlgPatternSearchGenRectTool::OnSetfocusEdtAngleLow() 
{
...
void CDlgPatternSearchGenRectTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternSearchGenRectTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgPatternSearchGenRectTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternSearchGenRectTool::OnSetfocusEdtConfusionThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternSearchGenRectTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CPatternSearchGenRectTrainGuiParam trainGuiParam;
...
BOOL CDlgPatternSearchGenRectTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgPatternSearchGenRectTool::OnChangeEdtCircleCalipernum() 
{
...
void CDlgPatternSearchGenRectTool::OnRadCircleInwardMode0() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgPatternSearchGenRectTool::OnRadCircleInwardMode1() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgPatternSearchGenRectTool::OnSetfocusEdtCircleCalipernum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternSearchGenRectTool::OnSetfocusEdtCircleContrastThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternSearchGenRectTool::OnSetfocusEdtCircleOutlineNum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternSearchGenRectTool::OnCbnSelchangeComboMethod()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nComboboxMethod = m_comboboxMethod.GetCurSel();
	UpdateSearchData(TRUE);
}
