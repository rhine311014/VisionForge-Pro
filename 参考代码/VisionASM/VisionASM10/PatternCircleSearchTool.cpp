...
// PatternCircleSearchTool.cpp: implementation of the CPatternCircleSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
CPatternCircleSearchTool::CPatternCircleSearchTool()
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
...
CPatternCircleSearchTool::CPatternCircleSearchTool(CPatternCircleSearchTool &cPatternCircleSearchTool)
{
	if (cPatternCircleSearchTool.GetSearchToolType() != ePatternCircleSearchTool)
	{
		return;
	}
...
// 	m_GuiModelPoint.SetCenterXYWidthHeight(250, 200, 40, 40);
	...
	m_GuiFindCircle.SetAnnulusFindCircleVisible(TRUE);
	// 赋值
	m_CamHeight								= cPatternCircleSearchTool.m_CamHeight;
	m_CamWidth								= cPatternCircleSearchTool.m_CamWidth;

	m_TrainDataParam						= cPatternCircleSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cPatternCircleSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cPatternCircleSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cPatternCircleSearchTool.m_SearchGuiParam;
	m_TrainResult							= cPatternCircleSearchTool.m_TrainResult;
	m_ImageTrain							= cPatternCircleSearchTool.m_ImageTrain;
	m_ImageMask								= cPatternCircleSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cPatternCircleSearchTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow                   = cPatternCircleSearchTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cPatternCircleSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cPatternCircleSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cPatternCircleSearchTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cPatternCircleSearchTool.UpdateSearchGuiData(true);
	cPatternCircleSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cPatternCircleSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cPatternCircleSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cPatternCircleSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cPatternCircleSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cPatternCircleSearchTool.m_tmpImageTrain);
	SetMaskImage(cPatternCircleSearchTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_PatternSearchTool = cPatternCircleSearchTool.m_PatternSearchTool;
	}
}

CPatternCircleSearchTool& CPatternCircleSearchTool::operator=(CPatternCircleSearchTool &cPatternCircleSearchTool)
{
	if (this == &cPatternCircleSearchTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CPatternCircleSearchTool::GetSearchToolType()
{
	return ePatternCircleSearchTool;
}										   

// 设置显示控件指针		
bool CPatternCircleSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{	
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CPatternCircleSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 设置Gui图形的关键字														
bool CPatternCircleSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CPatternCircleSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CPatternCircleSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CPatternCircleSearchTool::ShowTrainResultGui(bool bShow)
{
...
// 更新搜索界面显示									
bool CPatternCircleSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练Gui控件显示
bool CPatternCircleSearchTool::UpdateTrainGuiDisplay()
{
...
// 更新训练结果Gui控件显示
bool CPatternCircleSearchTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索Gui控件显示														
bool CPatternCircleSearchTool::UpdateSearchResultGuiDisplay()
{
	int i=0;

	for (i=0; i<m_pGuiSearchAffineRectArray.size(); i++)
	{
		m_pGuiSearchAffineRectArray[i]->SetVisible(m_bSearchResultGuiShow && m_tmpSearchGuiParam.m_bRectVisible);
	}
...
// 更新界面显示
bool CPatternCircleSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CPatternCircleSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != ePatternCircleSearchTool)
	{
		return false;
	}

	m_tmpTrainDataParam = *((CPatternCircleSearchTrainDataParam*)pTrainDataParam);

	return true;
}

// 获取训练Data参数									
bool CPatternCircleSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CPatternCircleSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;

	return true;
}

// 获取搜索Gui参数						
bool CPatternCircleSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != ePatternCircleSearchTool)
	{
		return false;
	}

	m_tmpTrainGuiParam = *((CPatternCircleSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CPatternCircleSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CPatternCircleSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;

	return true;
}

// 设置训练原始图像				
bool CPatternCircleSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CPatternCircleSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CPatternCircleSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CPatternCircleSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CPatternCircleSearchTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CPatternCircleSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CPatternCircleSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != ePatternCircleSearchTool)
	{
		return false;
	}

	*((CPatternCircleSearchTrainResult*)pTrainResult) = m_tmpTrainResult;

	return true;
}	

// 是否训练成功
bool CPatternCircleSearchTool::IsTrained()
{
	return m_bTrainOK;
}

// 设置搜索Data参数	
bool CPatternCircleSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != ePatternCircleSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CPatternCircleSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CPatternCircleSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CPatternCircleSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CPatternCircleSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != ePatternCircleSearchTool)
	{
		return false;
	}

	m_tmpSearchGuiParam = *((CPatternCircleSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CPatternCircleSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CPatternCircleSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;

	return true;
}

// 执行搜索 					
// bool CPatternCircleSearchTool::Search(const scImage8 &ImageSearch)
// {
// 	if (!m_bTrainOK)
// 	{
// 		return false;
...
bool CPatternCircleSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
			...
			if (bRet) // 成功
			{
				...
				if (m_TrainDataParam.m_nAuxiliaryPosType == 1)
				{
					...
					if (crossPointArray.size() == 2)
					{
						...
						if (dLeftX < dRightX)
						{
							...
							searchResult.m_vdAuxiliaryAngle.at(0) = tmpPatternResult.GetRotate().ToDouble();
				...
				else
				{
					if(m_tmpSearchDataParam.m_bEnableCircleCenterMove)
					{
						...
						CResultCircleSearchTool circle;
						circle.m_scCircleCircle =  sc2Vector(searchResult.m_dPosX,searchResult.m_dPosY);
						circle.m_dRadius = ResCircle.GetRadius();
						searchResult.m_vCircleSearchResult.push_back(circle);
					}
					else
...
// 获取搜索结果个数										
int CPatternCircleSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CPatternCircleSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像
bool CPatternCircleSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != ePatternCircleSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CPatternCircleSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
	//	BYTE byR, byG, byB;
	CPatternCircleSearchTrainDataParam tmpTrainDataParam;
	CPatternCircleSearchTrainGuiParam tmpTrainGuiParam;
	CPatternCircleSearchSearchDataParam tmpSearchDataParam;
	CPatternCircleSearchSearchGuiParam tmpSearchGuiParam;
	CPatternCircleSearchTrainResult  tmpTrainResult;
	if (!cXMLConfigurator.Load(strXmlPath))
	{
		return false;
	}
...
// 保存模板文件							
bool CPatternCircleSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CPatternCircleSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CPatternCircleSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CPatternCircleSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
bool CPatternCircleSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CPatternCircleSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CPatternCircleSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CPatternCircleSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CPatternCircleSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CPatternCircleSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CPatternCircleSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CPatternCircleSearchTool::RestoreSearchParam()
{
...
void CPatternCircleSearchTool::SetLanguage(int nLanguage)
{
...
CString	CPatternCircleSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
