...
/////////////////////////////////////////////////////////////////////////////
// CDlgTwoPatModelSearchTool dialog


CDlgTwoPatModelSearchTool::CDlgTwoPatModelSearchTool(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgTwoPatModelSearchTool::IDD, pParent)
	...
	, m_dPixelRatio(0)
{
	//{{AFX_DATA_INIT(CDlgTwoPatModelSearchTool)
	m_nSearchNum = 1;
	m_dAcceptThre = 0.6;
	m_bEnableMask = FALSE;
	m_dAngleHigh = 5.0;
...
void CDlgTwoPatModelSearchTool::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgTwoPatModelSearchTool)
	...
	//}}AFX_DATA_MAP
	DDX_Text(pDX, IDC_EDT_ACCEPT_CONFUSION_THRE4, m_dConfusionThre);
...
BEGIN_MESSAGE_MAP(CDlgTwoPatModelSearchTool, CDialog)
	//{{AFX_MSG_MAP(CDlgTwoPatModelSearchTool)
	...
	//}}AFX_MSG_MAP
	ON_EN_SETFOCUS(IDC_EDT_ACCEPT_CONFUSION_THRE4, &CDlgTwoPatModelSearchTool::OnEnSetfocusEdtAcceptConfusionThre4)
	ON_BN_CLICKED(IDC_BTN_SET_CENTER2, &CDlgTwoPatModelSearchTool::OnBnClickedBtnSetCenter2)
	ON_EN_SETFOCUS(IDC_EDT_PIXEL_RATIO, &CDlgTwoPatModelSearchTool::OnSetfocusEdtPixelRatio)
	ON_EN_SETFOCUS(IDC_EDT_DISTANCE_MAX_1, &CDlgTwoPatModelSearchTool::OnSetfocusEdtDistanceMax1)
	ON_EN_SETFOCUS(IDC_EDT_DISTANCE_MIN_1, &CDlgTwoPatModelSearchTool::OnSetfocusEdtDistanceMin1)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgTwoPatModelSearchTool message handlers
void CDlgTwoPatModelSearchTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgTwoPatModelSearchTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy = (Accuracy)(1<<m_nPatAccuracyMode);
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale = (CoarseScale)(m_nPatSpeedMode+1);
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow  =  m_dAngleLow;
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh = m_dAngleHigh;

		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy2 = (Accuracy)(1<<m_nPatAccuracyMode2);
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale2 = (CoarseScale)(m_nPatSpeedMode2+1);
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable2 = m_bEnableMask2/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow2  =  m_dAngleLow2;
		((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh2 = m_dAngleHigh2;
	...
	{
		m_nImageChannel = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_nPatAccuracyMode = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy/2;
		m_nPatSpeedMode = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale-1;
		m_dAngleLow	    = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh;
		m_bEnableMask = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;
		
		m_nPatAccuracyMode2 = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy2/2;
		m_nPatSpeedMode2 = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale2-1;
		m_dAngleLow2	    = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow2;
		m_dAngleHigh2	= ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh2;
		m_bEnableMask2 = ((CTwoPatModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable2;
...
void CDlgTwoPatModelSearchTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre = m_dConfusionThre;

		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableSizeCheck = m_bEnableSizeCheck;
		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dPixelRatio = m_dPixelRatio;
		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableMax = m_bEnableMax;
		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableMin= m_bEnableMin;
		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dDistanceMax = m_dDistanceMax;
		((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dDistanceMin = m_dDistanceMin;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;
		m_dConfusionThre = ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre;

		m_bEnableSizeCheck = ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableSizeCheck;
		m_dPixelRatio = ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dPixelRatio;
		m_bEnableMax = ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableMax;
		m_bEnableMin = ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableMin;
		m_dDistanceMax = ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dDistanceMax;
		m_dDistanceMin = ((CTwoPatModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dDistanceMin;
...
void CDlgTwoPatModelSearchTool::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_TWO_PATCORNERSEARCH_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgTwoPatModelSearchTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgTwoPatModelSearchTool::OnBtnGetTrainImage() 
{
...
void CDlgTwoPatModelSearchTool::OnBtnTrain() 
{
...
void CDlgTwoPatModelSearchTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgTwoPatModelSearchTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
void CDlgTwoPatModelSearchTool::OnBtnSetMaskImage2() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgTwoPatModelSearchTool::OnChkEnableMask2() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgTwoPatModelSearchTool::OnInitDialog() 
{
...
void CDlgTwoPatModelSearchTool::OnSelchangeComboAccuracyMode() 
{
	m_nPatAccuracyMode = m_comboAccuracy.GetCurSel();	
}

void CDlgTwoPatModelSearchTool::OnSelchangeComboSpeedMode() 
{
	m_nPatSpeedMode = m_comboSpeed.GetCurSel();
}


void CDlgTwoPatModelSearchTool::OnSelchangeComboAccuracyMode2() 
{
	m_nPatAccuracyMode2 = m_comboAccuracy2.GetCurSel();	
}

void CDlgTwoPatModelSearchTool::OnSelchangeComboSpeedMode2() 
{
	m_nPatSpeedMode2 = m_comboSpeed2.GetCurSel();
}

void CDlgTwoPatModelSearchTool::OnBtnSetCenter() 
{
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		cpImage imageTrain, imagePattern;
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CTwoPatModelSearchTrainGuiParam *pTrainGuiParam = new CTwoPatModelSearchTrainGuiParam;
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtAngleLow() 
{
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtAngleLow2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtAngleHigh2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgTwoPatModelSearchTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CTwoPatModelSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgTwoPatModelSearchTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgTwoPatModelSearchTool::OnEnSetfocusEdtAcceptConfusionThre4()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDT_ACCEPT_CONFUSION_THRE4)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDT_ACCEPT_CONFUSION_THRE4, strInput);

		if (TRUE == m_pDlgParent->m_ctrlKeyboard.ShowNumeralDotKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDT_ACCEPT_CONFUSION_THRE4, strOutput);
		}
	}
}


void CDlgTwoPatModelSearchTool::OnBnClickedBtnSetCenter2()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtPixelRatio()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtDistanceMax1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoPatModelSearchTool::OnSetfocusEdtDistanceMin1()
{
	// TODO: 在此添加控件通知处理程序代码
