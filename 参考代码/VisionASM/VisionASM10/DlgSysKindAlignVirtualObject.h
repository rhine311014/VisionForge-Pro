...
class CDlgSysKindAlignVirtualObject : public CDialog
{
	DECLARE_DYNAMIC(CDlgSysKindAlignVirtualObject)

public:
	CDlgSysKindAlignVirtualObject(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgSysKindAlignVirtualObject();

// 对话框数据
	enum { IDD = IDD_SYS_KIND_ALIGN_VIRTUAL_OBJECT };
...
public:
	...
	afx_msg void OnBnClickedRadioVirtualObjectcSearchMode0();
	afx_msg void OnBnClickedRadioObjectcSearchMode0();
	afx_msg void OnBnClickedRadioObjectcSearchSync0();
