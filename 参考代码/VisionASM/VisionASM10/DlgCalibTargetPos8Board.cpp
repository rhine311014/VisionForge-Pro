...
IMPLEMENT_DYNAMIC(CDlgCalibTargetPos8Board, CDialog)


CDlgCalibTargetPos8Board::CDlgCalibTargetPos8Board(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgCalibTargetPos8Board::IDD, pParent)
	, m_nRadioCalibTargetPos(0)
	, m_strCalibBoardTaget5PosX0(_T(""))
	, m_strCalibBoardTaget5PosY0(_T(""))
	, m_strCalibBoardTaget5PosX1(_T(""))
	, m_strCalibBoardTaget5PosY1(_T(""))
	, m_strCalibBoardTaget6PosX0(_T(""))
	, m_strCalibBoardTaget6PosY0(_T(""))
	, m_strCalibBoardTaget6PosX1(_T(""))
	, m_strCalibBoardTaget6PosY1(_T(""))
	, m_strCalibBoardTaget7PosX0(_T(""))
	, m_strCalibBoardTaget7PosY0(_T(""))
	, m_strCalibBoardTaget7PosX1(_T(""))
	, m_strCalibBoardTaget7PosY1(_T(""))
	, m_strCalibBoardTaget8PosX0(_T(""))
	, m_strCalibBoardTaget8PosY0(_T(""))
	, m_strCalibBoardTaget8PosX1(_T(""))
	, m_strCalibBoardTaget8PosY1(_T(""))
...
CDlgCalibTargetPos8Board::~CDlgCalibTargetPos8Board()
{
	int i=0;
...
void CDlgCalibTargetPos8Board::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0, m_strCalibBoardTaget5PosX0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0, m_strCalibBoardTaget5PosY0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1, m_strCalibBoardTaget5PosX1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1, m_strCalibBoardTaget5PosY1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0, m_strCalibBoardTaget6PosX0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0, m_strCalibBoardTaget6PosY0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1, m_strCalibBoardTaget6PosX1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1, m_strCalibBoardTaget6PosY1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0, m_strCalibBoardTaget7PosX0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0, m_strCalibBoardTaget7PosY0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1, m_strCalibBoardTaget7PosX1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1, m_strCalibBoardTaget7PosY1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0, m_strCalibBoardTaget8PosX0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0, m_strCalibBoardTaget8PosY0);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1, m_strCalibBoardTaget8PosX1);
	DDX_Text(pDX, IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1, m_strCalibBoardTaget8PosY1);
...
BEGIN_MESSAGE_MAP(CDlgCalibTargetPos8Board, CDialog)
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_BTN_SERIAL_GRAB, &CDlgCalibTargetPos8Board::OnBnClickedBtnSerialGrab)
	ON_BN_CLICKED(IDCANCEL, &CDlgCalibTargetPos8Board::OnBnClickedCancel)
	ON_BN_CLICKED(IDOK, &CDlgCalibTargetPos8Board::OnBnClickedOk)
	//ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT0_MOVE_POS0, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchObject0Pos0)
	//ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT1_MOVE_POS0, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchObject1Pos0)
	//ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT0_MOVE_POS1, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchObject0Pos1)
	//ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT1_MOVE_POS1, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchObject1Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET0_MOVE_POS0, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject0Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET1_MOVE_POS0, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject1Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET0_MOVE_POS1, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject0Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET1_MOVE_POS1, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject1Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET2_MOVE_POS0, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject2MovePos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET3_MOVE_POS0, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject3MovePos0)
	ON_BN_CLICKED(IDC_BTN_CALIB_TARGET_POS, &CDlgCalibTargetPos8Board::OnBnClickedBtnCalcuVirtualObject)
	ON_BN_CLICKED(IDC_BTN_COMM_GET_PLATFORM_AXIS_POS, &CDlgCalibTargetPos8Board::OnBnClickedBtnCommGetPlatformAxisPos)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget5PosX0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget5PosX0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget5PosY0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget5PosY0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget5PosX1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget5PosX1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget5PosY1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget5PosY1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget6PosX0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget6PosX0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget6PosY0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget6PosY0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget6PosX1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget6PosX1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget6PosY1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget6PosY1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget7PosX0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget7PosX0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget7PosY0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget7PosY0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget7PosX1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget7PosX1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget7PosY1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget7PosY1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget8PosX0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget8PosX0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget8PosY0)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget8PosY0)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget8PosX1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget8PosX1)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget8PosY1)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget8PosY1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET_ALL, &CDlgCalibTargetPos8Board::OnBnClickedBtnSearchTargetAll)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIB_BOARD_SIZE_X, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibBoardSizeX)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIB_BOARD_SIZE_X, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibBoardSizeX)
	ON_EN_SETFOCUS(IDC_EDIT_VAL_CALIB_BOARD_SIZE_Y, &CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibBoardSizeY)
	ON_EN_KILLFOCUS(IDC_EDIT_VAL_CALIB_BOARD_SIZE_Y, &CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibBoardSizeY)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS0, &CDlgCalibTargetPos8Board::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS2, &CDlgCalibTargetPos8Board::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS1, &CDlgCalibTargetPos8Board::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_BTN_SET_DMCODE_PARAM, &CDlgCalibTargetPos8Board::OnBnClickedBtnSetDmcodeParam)

	ON_BN_CLICKED(IDC_BUTTON_POS1_CAMERA_SHUTTER, &CDlgCalibTargetPos8Board::OnBnClickedSetCalibTargetShutter1)
	ON_BN_CLICKED(IDC_BUTTON_POS2_CAMERA_SHUTTER, &CDlgCalibTargetPos8Board::OnBnClickedSetCalibTargetShutter2)
	ON_BN_CLICKED(IDC_BUTTON_POS3_CAMERA_SHUTTER, &CDlgCalibTargetPos8Board::OnBnClickedSetCalibTargetShutter3)
	ON_BN_CLICKED(IDC_BUTTON_POS4_CAMERA_SHUTTER, &CDlgCalibTargetPos8Board::OnBnClickedSetCalibTargetShutter4)
	ON_MESSAGE(WM_SV_DISPLAY_DBLCLICK, OnGuiDisplayDblClk)

END_MESSAGE_MAP()


// CDlgCalibTargetPos8Board 消息处理程序

void CDlgCalibTargetPos8Board::SetVisionAlignerRef( vcBaseVisionAlign *pVisionAligner)
{
...
BOOL CDlgCalibTargetPos8Board::OnInitDialog()
{
...
void CDlgCalibTargetPos8Board::InitDlgItem()
{
	// 	// 	CRect cr;
	...
	{
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET8_POS1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1)->ShowWindow(SW_HIDE);
	...
	if (sysPlatformInfo.m_bTargetObjectCamSeparate && sysPlatformInfo.m_nPositionNum == 8)
	{
		UpdateDlgItem(TRUE);
	}
	else
...
void CDlgCalibTargetPos8Board::UpdateDlgItem(BOOL bEnable)
{
	...
	if (m_bIsDmCodeSearch)
	{
		...
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET5_POS0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET5_POS1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET6_POS0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET6_POS1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET7_POS0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET7_POS1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET8_POS0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_STATIC_CALIBRATION_TARGET8_POS1)->ShowWindow(SW_HIDE);
		...
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1)->ShowWindow(SW_HIDE);
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1)->ShowWindow(SW_HIDE);
		...
		GetDlgItem(IDC_BTN_SEARCH_TARGET2_MOVE_POS0)->ShowWindow(SW_SHOW);
		GetDlgItem(IDC_BTN_SEARCH_TARGET3_MOVE_POS0)->ShowWindow(SW_SHOW);
	}
}



void CDlgCalibTargetPos8Board::UpdateDlgData(BOOL bSaveAndValidate/* = TRUE*/)
{
	...
	if (bSaveAndValidate)
	{
		...
		nCalibIndex = 4;
		i = 0;
		pos.m_dPosX = atof(m_strCalibBoardTaget5PosX0);
		pos.m_dPosY = atof(m_strCalibBoardTaget5PosY0);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);
		i = 1;
		pos.m_dPosX = atof(m_strCalibBoardTaget5PosX1);
		pos.m_dPosY = atof(m_strCalibBoardTaget5PosY1);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);

		nCalibIndex = 5;
		i = 0;
		pos.m_dPosX = atof(m_strCalibBoardTaget6PosX0);
		pos.m_dPosY = atof(m_strCalibBoardTaget6PosY0);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);
		i = 1;
		pos.m_dPosX = atof(m_strCalibBoardTaget6PosX1);
		pos.m_dPosY = atof(m_strCalibBoardTaget6PosY1);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);

		nCalibIndex = 6;
		i = 0;
		pos.m_dPosX = atof(m_strCalibBoardTaget7PosX0);
		pos.m_dPosY = atof(m_strCalibBoardTaget7PosY0);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);
		i = 1;
		pos.m_dPosX = atof(m_strCalibBoardTaget7PosX1);
		pos.m_dPosY = atof(m_strCalibBoardTaget7PosY1);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);

		nCalibIndex = 7;
		i = 0;
		pos.m_dPosX = atof(m_strCalibBoardTaget8PosX0);
		pos.m_dPosY = atof(m_strCalibBoardTaget8PosY0);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);
		i = 1;
		pos.m_dPosX = atof(m_strCalibBoardTaget8PosX1);
		pos.m_dPosY = atof(m_strCalibBoardTaget8PosY1);		
		m_vpmpCalibMarkBoardPos.at(i)->SetMarkImagePos(nCalibIndex,TRUE,pos);
	...
	else
	{
			...
			&& pCalibData->m_vpCalibratedInfo.at(nCalibIndex) != NULL)
		{
			...
			i = 0;
			m_strCalibBoardTaget5PosX0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardTaget5PosY0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
			i = 1;
			m_strCalibBoardTaget5PosX1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardTaget5PosY1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
		...
		{
			i = 0;
			m_strCalibBoardTaget5PosX0.Format(_T("0.0000"));
			m_strCalibBoardTaget5PosY0.Format(_T("0.0000"));
			i = 1;
			m_strCalibBoardTaget5PosX1.Format(_T("0.0000"));
			m_strCalibBoardTaget5PosY1.Format(_T("0.0000"));
		}
			...
			&& pCalibData->m_vpCalibratedInfo.at(nCalibIndex) != NULL)
		{
			...
			i = 0;
			m_strCalibBoardTaget6PosX0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardTaget6PosY0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
			i = 1;
			m_strCalibBoardTaget6PosX1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardTaget6PosY1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
		}
		else
		{
			i = 0;
			m_strCalibBoardTaget6PosX0.Format(_T("0.0000"));
			m_strCalibBoardTaget6PosY0.Format(_T("0.0000"));
			i = 1;
			m_strCalibBoardTaget6PosX1.Format(_T("0.0000"));
			m_strCalibBoardTaget6PosY1.Format(_T("0.0000"));
		}
			...
			&& pCalibData->m_vpCalibratedInfo.at(nCalibIndex) != NULL)
		{
			...
			i = 0;
			m_strCalibBoardTaget7PosX0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardTaget7PosY0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
			i = 1;
			m_strCalibBoardTaget7PosX1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardTaget7PosY1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
		}
		else
		{
			i = 0;
			m_strCalibBoardTaget7PosX0.Format(_T("0.0000"));
			m_strCalibBoardTaget7PosY0.Format(_T("0.0000"));
			i = 1;
			m_strCalibBoardTaget7PosX1.Format(_T("0.0000"));
			m_strCalibBoardTaget7PosY1.Format(_T("0.0000"));
			...
			&& pCalibData->m_vpCalibratedInfo.at(nCalibIndex) != NULL)
		{
			...
			i = 0;
			m_strCalibBoardTaget8PosX0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardTaget8PosY0.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
			i = 1;
			m_strCalibBoardTaget8PosX1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosX());
			m_strCalibBoardTaget8PosY1.Format(_T("%.4f"), cpCalibBoardMarkBoardCoordPos[i].GetPosY());
		}
		else
		{
			i = 0;
			m_strCalibBoardTaget8PosX0.Format(_T("0.0000"));
			m_strCalibBoardTaget8PosY0.Format(_T("0.0000"));
			i = 1;
			m_strCalibBoardTaget8PosX1.Format(_T("0.0000"));
			m_strCalibBoardTaget8PosY1.Format(_T("0.0000"));
		}
...
BOOL CDlgCalibTargetPos8Board::IsStringNumerical( LPCTSTR lpszVal )
{
...
void CDlgCalibTargetPos8Board::UpdateStatusBar()
{
...
void CDlgCalibTargetPos8Board::OnDestroy()
{
	CDialog::OnDestroy();
...
LRESULT CDlgCalibTargetPos8Board::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void CDlgCalibTargetPos8Board::UpdateBtnLiveGrab()
{
	// 更新“连续采集/停止采集”按钮 
...
void CDlgCalibTargetPos8Board::UpdateShutterDisplay()
{
	// 	// 更新曝光时间显示
...
BOOL CDlgCalibTargetPos8Board::SetGUI()
{
	int nCamNum = m_pVisionASM->GetCameraNum();
	nCamNum = (nCamNum == 4) ? 2 : nCamNum;
...
// 更新训练Gui控件显示
bool CDlgCalibTargetPos8Board::UpdateGuiDisplay()
{
	// 更新
	int nCamNum = m_pVisionASM->GetCameraNum();
	nCamNum = (nCamNum == 4) ? 2 : nCamNum;
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSerialGrab()
{
	// TODO: 在此添加控件通知处理程序代码
	int i=0;
	BOOL bSucceed = TRUE;
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchTargetAll()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nEvent = 6; // 全部移动位置1
	CString strLog;
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchObject0Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchObject1Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject0Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 2; // 目标移动位置1
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject1Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 2; // 目标移动位置1
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchObject0Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 3; // 对象移动位置2
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchObject1Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 3; // 对象移动位置2
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject0Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 4; // 目标移动位置2
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject1Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 4; // 目标移动位置2
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnCommGetPlatformAxisPos()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnCalcuVirtualObject()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
void CDlgCalibTargetPos8Board::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
void CDlgCalibTargetPos8Board::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
UINT CDlgCalibTargetPos8Board::ThreadReceiveData( LPVOID pParam )
{
	CDlgCalibTargetPos8Board *pOwner = (CDlgCalibTargetPos8Board*)pParam;
	CString strReceived;
...
void CDlgCalibTargetPos8Board::SearchObjectPos(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibTargetPos8Board::SearchObjectPos1(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibTargetPos8Board::SearchTargetPos(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibTargetPos8Board::SearchTargetPos1(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibTargetPos8Board::CommGetPlatformAxisPos()
{
	m_bCommGetPlatformAxisPosSuccess = FALSE;
	if (m_pVisionASM == NULL)
	{
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget7PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标7位置1][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget7PosX0();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget7PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0, m_strCalibBoardTaget7PosX0);
		}
		else
		{
			m_strCalibBoardTaget7PosX0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X0, m_strCalibBoardTaget7PosX0);
		}
	}	
}

void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget7PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标7位置1][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget7PosY0();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget7PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0, m_strCalibBoardTaget7PosY0);
		}
		else
		{
			m_strCalibBoardTaget7PosY0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y0, m_strCalibBoardTaget7PosY0);
		}
	}	
}
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget7PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标7位置2][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget7PosX1();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget7PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1, m_strCalibBoardTaget7PosX1);
		}
		else
		{
			m_strCalibBoardTaget7PosX1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_X1, m_strCalibBoardTaget7PosX1);
		}
	}	
}

void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget7PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标7位置2][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget7PosY1();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget7PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1, m_strCalibBoardTaget7PosY1);
		}
		else
		{
			m_strCalibBoardTaget7PosY1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET7_POS_Y1, m_strCalibBoardTaget7PosY1);
		}
	}	
}
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget8PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标8位置1][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget8PosX0();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget8PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0, m_strCalibBoardTaget8PosX0);
		}
		else
		{
			m_strCalibBoardTaget8PosX0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X0, m_strCalibBoardTaget8PosX0);
		}
	}	
}

void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget8PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标8位置1][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget8PosY0();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget8PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0, m_strCalibBoardTaget8PosY0);
		}
		else
		{
			m_strCalibBoardTaget8PosY0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y0, m_strCalibBoardTaget8PosY0);
		}
	}	
}
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget8PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标8位置2][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget8PosX1();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget8PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1, m_strCalibBoardTaget8PosX1);
		}
		else
		{
			m_strCalibBoardTaget8PosX1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_X1, m_strCalibBoardTaget8PosX1);
		}
	}	
}

void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget8PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标8位置2][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget8PosY1();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget8PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1, m_strCalibBoardTaget8PosY1);
		}
		else
		{
			m_strCalibBoardTaget8PosY1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET8_POS_Y1, m_strCalibBoardTaget8PosY1);
		}
	}	
}
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget5PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标5位置1][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget5PosX0();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget5PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0, m_strCalibBoardTaget5PosX0);
		}
		else
		{
			m_strCalibBoardTaget5PosX0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X0, m_strCalibBoardTaget5PosX0);
		}
	}	
}

void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget5PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标5位置1][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget5PosY0();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget5PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0, m_strCalibBoardTaget5PosY0);
		}
		else
		{
			m_strCalibBoardTaget5PosY0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y0, m_strCalibBoardTaget5PosY0);
		}
	}	
}
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget5PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标5位置2][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget5PosX1();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget5PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1, m_strCalibBoardTaget5PosX1);
		}
		else
		{
			m_strCalibBoardTaget5PosX1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_X1, m_strCalibBoardTaget5PosX1);
		}
	}	
}

void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget5PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标5位置2][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget5PosY1();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget5PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1, m_strCalibBoardTaget5PosY1);
		}
		else
		{
			m_strCalibBoardTaget5PosY1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET5_POS_Y1, m_strCalibBoardTaget5PosY1);
		}
	}	
}
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget6PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标6位置1][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget6PosX0();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget6PosX0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0, m_strCalibBoardTaget6PosX0);
		}
		else
		{
			m_strCalibBoardTaget6PosX0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X0, m_strCalibBoardTaget6PosX0);
		}
	}	
}

void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget6PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标6位置1][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget6PosY0();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget6PosY0()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0, m_strCalibBoardTaget6PosY0);
		}
		else
		{
			m_strCalibBoardTaget6PosY0.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y0, m_strCalibBoardTaget6PosY0);
		}
	}	
}
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget6PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标6位置2][列号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget6PosX1();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget6PosX1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1, m_strCalibBoardTaget6PosX1);
		}
		else
		{
			m_strCalibBoardTaget6PosX1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_X1, m_strCalibBoardTaget6PosX1);
		}
	}	
}

void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibrationTarget6PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1, strInput);

		if (TRUE == m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1, strOutput);
			if (strInput != strOutput)
			{
				CString strLog;
				strLog.Format(_T("修改[目标6位置2][行号]由%s到%s\n"),strInput,strOutput);
				g_opLogFile.SaveLogText(strLog, 2);
			}
		}
		m_bKillFocusEnabled = TRUE;
		OnEnKillfocusEditValCalibrationTarget6PosY1();
	}	
}


void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibrationTarget6PosY1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
		CString strVal;
		GetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1, strVal);
		if (!IsStringNumerical(strVal))
		{
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1, m_strCalibBoardTaget6PosY1);
		}
		else
		{
			m_strCalibBoardTaget6PosY1.Format(_T("%.4f"), atof(strVal));
			SetDlgItemText(IDC_EDIT_VAL_CALIBRATION_TARGET6_POS_Y1, m_strCalibBoardTaget6PosY1);
		}
	}	
}
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibBoardSizeX()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bSysKeyboardEnabled)
	{
...
void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibBoardSizeX()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
...
void CDlgCalibTargetPos8Board::OnEnSetfocusEditValCalibBoardSizeY()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bSysKeyboardEnabled)
	{
...
void CDlgCalibTargetPos8Board::OnEnKillfocusEditValCalibBoardSizeY()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_bKillFocusEnabled)
	{
...
void CDlgCalibTargetPos8Board::UpdateDialogLanguage()
{
	//	return;
...
void CDlgCalibTargetPos8Board::OnBnClickedRadioCalibTargetPos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
BOOL CDlgCalibTargetPos8Board::DmCodeSearch(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return FALSE;
	...
	//		m_vpGuiAlnTargetImageMarkPos1.at(nPosIndex - m_pVisionASM->GetObjectPosNum())->SetLineWidth(3);
	//		m_vpGuiAlnTargetImageMarkPos1.at(nPosIndex - m_pVisionASM->GetObjectPosNum())->SetVisible(TRUE);
	//	}
	//}
	return TRUE;
...
void CDlgCalibTargetPos8Board::UpdateDmCodeSearchResult(int nPosIndex)
{
	CTotalProductData *pTotalProductData;
	pTotalProductData = m_pVisionASM->GetTotalProuductData();
	int nCurProductIdx = pTotalProductData->GetCurProductIndex();
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSetDmcodeParam()
{
	// TODO: 在此添加控件通知处理程序代码
	CTotalProductData *pTotalProductData;
	pTotalProductData = m_pVisionASM->GetTotalProuductData();
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject2MovePos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8Board::OnBnClickedBtnSearchVirtualObject3MovePos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
*/
/************************************************************************/
bool CDlgCalibTargetPos8Board::CreateMultipleDirectory(CString& szPath, char split)
{
...
//获得关联结果
bool CDlgCalibTargetPos8Board::GetCalibResultCString(CString & strCalibResult)
{
...
// 保存CVS 文件
bool CDlgCalibTargetPos8Board::SaveCSVFile(CString strImageFileDirt,CString strName,CString& strSaveData )
{
	SYSTEMTIME sys;
	GetLocalTime(&sys);
	CString strFileName;
...
// 保存畸变校正前的图片
void CDlgCalibTargetPos8Board::SaveCalibSearchImage(CString strImageFileDirt,CString strImageName,cpImage & imageSave)
{
...
void CDlgCalibTargetPos8Board::OnBnClickedSetCalibTargetShutter1()
{
	// TODO: 在此添加控件通知处理程序代码
	SetCalibTargetShutter(4);
}

void CDlgCalibTargetPos8Board::OnBnClickedSetCalibTargetShutter2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8Board::OnBnClickedSetCalibTargetShutter3()
{
	// TODO: 在此添加控件通知处理程序代码
	SetCalibTargetShutter(6);
}

void CDlgCalibTargetPos8Board::OnBnClickedSetCalibTargetShutter4()
{
	// TODO: 在此添加控件通知处理程序代码
	SetCalibTargetShutter(7);
}

void CDlgCalibTargetPos8Board::ResetCameraShutter()
{
	if(m_pVisionASM)
	{
		for(int nPos=0;nPos<4 && nPos<m_pVisionASM->GetPosNum();nPos++)
...
void CDlgCalibTargetPos8Board::SetCalibTargetShutter(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
void CDlgCalibTargetPos8Board::CallDlgSearch(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
void CDlgCalibTargetPos8Board::SetCalibTargetSearchTool(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
LRESULT CDlgCalibTargetPos8Board::OnGuiDisplayDblClk(WPARAM wParam, LPARAM lParam)
{
