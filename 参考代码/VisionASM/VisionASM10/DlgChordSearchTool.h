#pragma once
// DlgChordSearchToolSetting.h : header file
//
...
class CDlgSearch;
class CDlgChordSearchTool : public CDialog
{
// Construction
public:
	CDlgChordSearchTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CDlgChordSearchTool)
	enum { IDD = IDD_DLG_CHORDSEARCH_TOOL };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlgChordSearchTool)
	public:
