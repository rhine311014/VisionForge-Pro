// DlgSysKindAlignObject.cpp : 实现文件
//
...
// CDlgSysKindAlignObject 对话框

IMPLEMENT_DYNAMIC(CDlgSysKindAlignObject, CDialog)

CDlgSysKindAlignObject::CDlgSysKindAlignObject(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgSysKindAlignObject::IDD, pParent)
...
{
	//{{AFX_DATA_INIT(CDlgSysKindAlignObject)
...
CDlgSysKindAlignObject::~CDlgSysKindAlignObject()
{
	DestroyWindow();
}

void CDlgSysKindAlignObject::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgSysKindAlignObject)
...
BEGIN_MESSAGE_MAP(CDlgSysKindAlignObject, CDialog)
	//{{AFX_MSG_MAP(CDlgSysKindAlignObject)
...
// 	ON_BN_CLICKED(IDC_BTN_CLONE_PRODUCT, OnBtnCloneProduct)
	...
	//}}AFX_MSG_MAP
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB0, &CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib0)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB1, &CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib1)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB2, &CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib2)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB3, &CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib3)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB4, &CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib4)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB5, &CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib5)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB6, &CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib6)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB7, &CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib7)

	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE1, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE2, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE3, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE4, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcShutterEnable)

	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAIN_ENABLE, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGainEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAIN_ENABLE1, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGainEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAIN_ENABLE2, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGainEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAIN_ENABLE3, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGainEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAIN_ENABLE4, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGainEnable)

	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAMMA_ENABLE, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGammaEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAMMA_ENABLE1, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGammaEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAMMA_ENABLE2, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGammaEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAMMA_ENABLE3, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGammaEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAMMA_ENABLE4, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGammaEnable)


	ON_BN_CLICKED(IDC_RADIO_OBJECTC_SEARCH_MODE0, &CDlgSysKindAlignObject::OnBnClickedRadioObjectcSearchMode0)
	ON_BN_CLICKED(IDC_RADIO_OBJECTC_SEARCH_MODE1, &CDlgSysKindAlignObject::OnBnClickedRadioObjectcSearchMode0)
	ON_BN_CLICKED(IDC_RADIO_OBJECTC_SEARCH_SYNC0, &CDlgSysKindAlignObject::OnBnClickedRadioObjectcSearchSync0)
	ON_BN_CLICKED(IDC_RADIO_OBJECTC_SEARCH_SYNC1, &CDlgSysKindAlignObject::OnBnClickedRadioObjectcSearchSync0)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE1, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcOffsetEnable1)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE2, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcOffsetEnable2)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE3, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcOffsetEnable3)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE4, &CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcOffsetEnable4)
END_MESSAGE_MAP()


// CDlgSysKindAlignObject 消息处理程序


BOOL CDlgSysKindAlignObject::OnInitDialog()
{
...
void CDlgSysKindAlignObject::InitDlgItem()
{
	int i = 0, j = 0;
...
// 				GetDlgItem(IDC_STATIC_OBJECT_DISPLAY0+i*2)->ShowWindow(SW_SHOW);
 				GetDlgItem(IDC_STATIC_OBJECT_PATTERN0+i*2)->ShowWindow(m_pParentKind->m_bShowObjectTemplateSet);
//				m_vpObjectGuiDisplay.at(i)->ShowWindow(SW_SHOW);

				if (i < MAXPOSNUM -1)
				{
					GetDlgItem(IDC_STATIC_SEPARATOR3+ i)->ShowWindow(m_pParentKind->m_bShowObjectTemplateSet);
				}
				m_vpLabelPos.at(i)->SetBkColor(RGB(0,255,0));
				m_vpLabelPos.at(i)->ShowWindow(m_pParentKind->m_bShowObjectTemplateSet);
				m_vpBtnCopyObjectToCalib.at(i)->ShowWindow(m_pParentKind->m_bShowObjectTemplateSet);


				for(j = 0; j < OBJECTCANDIDATENUM; j++)
				{
					GetDlgItem(IDC_STATIC_OBJECTC_PATTERN0+i*OBJECTCANDIDATENUM+j)->ShowWindow(m_pParentKind->m_bShowObjectTemplateSet);
					m_vvpObjectGuiDisplay[i][j]->ShowWindow(m_pParentKind->m_bShowObjectTemplateSet);
				}
			}
			else
			{
...
// 				m_vpObjectGuiDisplay.at(i)->ShowWindow(SW_HIDE);
		...
		/*GetDlgItem(IDC_STATIC_OBJECTC_SEARCH_MODE)->EnableWindow(TRUE);
		GetDlgItem(IDC_STATIC_OBJECTC_SEARCH_MODE)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_MODE1)->EnableWindow(TRUE);
		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_MODE1)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_MODE0)->EnableWindow(TRUE);
		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_MODE0)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_STATIC_OBJECTC_SEARCH_SYNC)->EnableWindow(TRUE);
		GetDlgItem(IDC_STATIC_OBJECTC_SEARCH_SYNC)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_SYNC1)->EnableWindow(TRUE);
		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_SYNC1)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_SYNC0)->EnableWindow(TRUE);
		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_SYNC0)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET1)->EnableWindow(TRUE);
		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET1)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE1)->EnableWindow(TRUE);
		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE1)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET2)->EnableWindow(TRUE);
		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET2)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE2)->EnableWindow(TRUE);
		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE2)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET3)->EnableWindow(TRUE);
		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET3)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE3)->EnableWindow(TRUE);
		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE3)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_STATIC_GRP_ALIGN_TARGETC_OFFSET4)->EnableWindow(TRUE);
		GetDlgItem(IDC_STATIC_GRP_ALIGN_TARGETC_OFFSET4)->ShowWindow(SW_SHOW);

		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE4)->EnableWindow(TRUE);
		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE4)->ShowWindow(SW_SHOW);*/
	}
	else
	{
...
// 			m_vpObjectGuiDisplay.at(i)->ShowWindow(SW_HIDE);
		...
		GetDlgItem(IDC_STATIC_OBJECTC_SEARCH_MODE)->EnableWindow(FALSE);
		GetDlgItem(IDC_STATIC_OBJECTC_SEARCH_MODE)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_MODE1)->EnableWindow(FALSE);
		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_MODE1)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_MODE0)->EnableWindow(FALSE);
		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_MODE0)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_STATIC_OBJECTC_SEARCH_SYNC)->EnableWindow(FALSE);
		GetDlgItem(IDC_STATIC_OBJECTC_SEARCH_SYNC)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_SYNC1)->EnableWindow(FALSE);
		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_SYNC1)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_SYNC0)->EnableWindow(FALSE);
		GetDlgItem(IDC_RADIO_OBJECTC_SEARCH_SYNC0)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET1)->EnableWindow(FALSE);
		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET1)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE1)->EnableWindow(FALSE);
		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE1)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET2)->EnableWindow(FALSE);
		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET2)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE2)->EnableWindow(FALSE);
		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE2)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET3)->EnableWindow(FALSE);
		GetDlgItem(IDC_STATIC_GRP_ALIGN_OBJECTC_OFFSET3)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE3)->EnableWindow(FALSE);
		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE3)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_STATIC_GRP_ALIGN_TARGETC_OFFSET4)->EnableWindow(FALSE);
		GetDlgItem(IDC_STATIC_GRP_ALIGN_TARGETC_OFFSET4)->ShowWindow(SW_HIDE);

		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE4)->EnableWindow(FALSE);
		GetDlgItem(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE4)->ShowWindow(SW_HIDE);
...
void CDlgSysKindAlignObject::EnableAndShowControl(bool bEnable,bool bShow)
{
	bool bShowTemplateSet = false;
	bool bEnableTemplateSet = false;
	if(NULL != m_pParentKind)
	{
		bShowTemplateSet = m_pParentKind->m_bShowObjectTemplateSet;
		bEnableTemplateSet = m_pParentKind->m_bEnableObjectTemplateSet;
	}
...
void CDlgSysKindAlignObject::MoveDlgItem()
{
...
void CDlgSysKindAlignObject::CheckDlgData()
{
	UpdateData(TRUE);
...
void CDlgSysKindAlignObject::UpdateDlgData( BOOL bSaveAndValidate /*= TRUE*/ )
{
	...
	if (bSaveAndValidate)
	{
		...
		product.m_pAlignerParam->SetEnableObjectSearchShutter(i, cameraParamEnable);
	...
	else
	{
		...
		m_bObjectShutterEnable0 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bShutterEnable;
		m_bObjectGainEnable0 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGainEnable;
		m_bObjectGammaEnable0 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGammaEnable;
		...
		m_bObjectShutterEnable1 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bShutterEnable;
		m_bObjectGainEnable1 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGainEnable;
		m_bObjectGammaEnable1 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGammaEnable;
		...
		m_bObjectShutterEnable2 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bShutterEnable;
		m_bObjectGainEnable2 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGainEnable;
		m_bObjectGammaEnable2 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGammaEnable;
		...
		m_bObjectShutterEnable3 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bShutterEnable;
		m_bObjectGainEnable3 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGainEnable;
		m_bObjectGammaEnable3 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGammaEnable;
		...
		m_bObjectShutterEnable4 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bShutterEnable;
		m_bObjectGainEnable4 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGainEnable;
		m_bObjectGammaEnable4 = product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGammaEnable;
...
void CDlgSysKindAlignObject::GetDlgTempData(CProductData& product)
{
...
void CDlgSysKindAlignObject::UpdateStatusBar()
{
...
void CDlgSysKindAlignObject::UpdateProductListDisplay()
{
...
void CDlgSysKindAlignObject::UpdateDialogLanguage()
{
//	return;
	LANGID lgidLanguage = MAKELANGID(LANG_CHINESE, SUBLANG_CHINESE_SIMPLIFIED);
	if (m_psaSysInfoStrings != NULL)
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_SYS_KIND_ALIGN_OBJECT") == strDlgID)
		{
			int nID;
...
CString CDlgSysKindAlignObject::GetNewDefName()
{
...
BOOL CDlgSysKindAlignObject::IsNameUnique( LPCTSTR lpszName )
{
// 	CTotalProductData *pTotalProduct = m_vpTotalProductData.at(m_nPlatformIndex);
// 	int nProductNum = pTotalProduct->GetCount();
...
BOOL CDlgSysKindAlignObject::IsNameLegal( LPCTSTR lpszName )
{
	CString strName = lpszName;
	if (strName.IsEmpty())
	{
...
BOOL CDlgSysKindAlignObject::IsCalibratedInfosEqual( std::vector<CCalibratedInfo*> vpCalibratedInfo1, std::vector<CCalibratedInfo*> vpCalibratedInfo2 )
{
...
BOOL CDlgSysKindAlignObject::IsProductChanged()
{
...
//	m_nPlatformIndex = pView->m_nPlatformIndex;
	...
	if (m_bObjectShutterEnable0 != product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bShutterEnable
		|| m_bObjectGainEnable0 != product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGainEnable
		|| m_bObjectGammaEnable0 != product.m_pAlignerParam->GetEnableObjectSearchShutter(i).m_bGammaEnable)
	{
		return TRUE;
...
BOOL CDlgSysKindAlignObject::IsSearchToolSelected(CBaseSearchTool* pSearchTool)
{
	//UpdateData(TRUE);
...
BOOL CDlgSysKindAlignObject::IsStringNumerical( LPCTSTR lpszVal )
{
...
BOOL CDlgSysKindAlignObject::CreateDirectoryPro( LPCTSTR lpszDir )
{
...
BOOL CDlgSysKindAlignObject::ClearDirectoryPro( LPCTSTR lpszDir )
{
	CFileFind fileFind; 
	CString strDir(lpszDir);
...
BOOL CDlgSysKindAlignObject::RemoveDirectoryPro( LPCTSTR lpszDir )
{
	DWORD dwAttributes = GetFileAttributes(lpszDir);
	if ((dwAttributes == 0xFFFFFFFF) || ((dwAttributes & FILE_ATTRIBUTE_DIRECTORY) == 0))
	{
...
BOOL CDlgSysKindAlignObject::RenameDirecotryPro( LPCTSTR lpszOldDir, LPCTSTR lpszNewDir )
{
...
// 保存前一个产品的设置
BOOL CDlgSysKindAlignObject::SavePrevProduct()
{
	BOOL bSucceed = TRUE;
	UpdateData(TRUE);
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
...
void CDlgSysKindAlignObject::OnButtonNewProduct()
{
...
void CDlgSysKindAlignObject::OnBtnCloneProduct() 
{
...
void CDlgSysKindAlignObject::OnButtonDeleteCurProduct() 
{
// 	// 用户删除操作确认
...
void CDlgSysKindAlignObject::OnBtnProductRename()
{
...
void CDlgSysKindAlignObject::OnBtnAmendBenchmark() 
{
...
// 自定义菜单响应
LRESULT CDlgSysKindAlignObject::OnGuiDisplayMenuCustom1(WPARAM wParam, LPARAM lParam)
{
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
	m_nPlatformIndex = pView->m_nPlatformIndex;
	...
	for (i=0; i<nPatternNum; i++)
	{
		for (j=0; j < OBJECTCANDIDATENUM; j++)
		{
			if (wParam == m_vvpObjectGuiDisplay[i][j]->GetID())
			{
				...
				CameraParamEnable cameraParamEnable;
				cameraParamEnable = product.m_pAlignerParam->GetEnableObjectSearchShutter(j);
				...
				if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable) && bSystemOptionShutter)
				{
					...
					product.m_pAlignerParam->SetObjectSearchShutter(i, j, tmpameraParamSet);
					pTotalProduct->SetItem(nCurProdIdx, product);
				}
				...
				m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->DeleteRepoAlnObjectSearchTool(nCurProdIdx,i, j);
				m_vvpObjectGuiDisplay[i][j]->ClearScreen();

				// 标记产品模板已修改
				m_bProdPatternChanged = TRUE;
				// 标记对象指定位置模板已经修改了
				m_pParentKind->m_vvbAlnObjectSearchToolChanged[i][j] = TRUE;
				return S_OK;
			}
		}
	}
...
LRESULT CDlgSysKindAlignObject::OnGuiDisplayMenuCustom2(WPARAM wParam, LPARAM lParam)
{
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
	m_nPlatformIndex = pView->m_nPlatformIndex;
	if (pView->m_vpTotalProductData.at(m_nPlatformIndex)->GetCount() <= 0)
	...
	for (i=0; i<nPatternNum; i++)
	{
		for (j=0; j < OBJECTCANDIDATENUM; j++)
		{
			if (wParam == m_vvpObjectGuiDisplay[i][j]->GetID())
			{
				...
				dlgSearchToolCopyPos.m_nPosCNum = OBJECTCANDIDATENUM;
				...
				if (dlgSearchToolCopyPos.DoModal() == IDOK)
				{
					...
					for (k = 0; k < MAXPOSNUM && k < dlgSearchToolCopyPos.m_vbCopyPos.size(); k++)
					{
						if (dlgSearchToolCopyPos.m_vbCopyPos.at(k) == TRUE && ((k != i)||(nDstCandidateIndex != j)))
						{
							...
							{
								CameraParamEnable cameraParamEnable;
								cameraParamEnable = product.m_pAlignerParam->GetEnableObjectSearchShutter(nDstCandidateIndex);
								BOOL bSystemOptionShutter = optionInfo.m_bEnableSearchShutter;
								if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable) && bSystemOptionShutter)
								{
									CameraParamSet tmpameraParamSet;
									product.m_pAlignerParam->SetObjectSearchShutter(k,nDstCandidateIndex, tmpameraParamSet);
									pTotalProduct->SetItem(nCurProdIdx, product);
								}
								CBaseSearchTool *pSearchToolDst = NULL;
								pSearchToolDst = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->GetRepoAlnObjectSearchTool(nCurProdIdx,k,nDstCandidateIndex);
								if (pSearchToolDst == NULL)
								{
									continue;
								}

								m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->DeleteRepoAlnObjectSearchTool(nCurProdIdx,k,nDstCandidateIndex);
								m_vvpObjectGuiDisplay[k][nDstCandidateIndex]->ClearScreen();

							}
							else
							{
								CameraParamEnable cameraParamEnable = product.m_pAlignerParam->GetEnableObjectSearchShutter(j);
								BOOL bSystemOptionShutter = optionInfo.m_bEnableSearchShutter;
								if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable) && bSystemOptionShutter)
								{
									product.m_pAlignerParam->SetObjectSearchShutter(k,nDstCandidateIndex, product.m_pAlignerParam->GetObjectSearchShutter(i,j));
									pTotalProduct->SetItem(nCurProdIdx, product);
								}
								...
								m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->SetRepoAlnObjectSearchTool(nCurProdIdx, k, nDstCandidateIndex, pSearchTool);
							...
							// 标记对象指定位置模板已经修改了
							m_pParentKind->m_vvbAlnObjectSearchToolChanged[k][nDstCandidateIndex] = TRUE;
							///////////////////////////////////////////////////////////////////////


							strLog.Format(_T("将位置%d候选%d对象模板复制到位置%d候选%d\n"),i+1,j,k+1,nDstCandidateIndex);
...
LRESULT CDlgSysKindAlignObject::OnGuiDisplayMenuCustom3(WPARAM wParam, LPARAM lParam)
{
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
	m_nPlatformIndex = pView->m_nPlatformIndex;
	if (pView->m_vpTotalProductData.at(m_nPlatformIndex)->GetCount() <= 0)
	...
	for (i=0; i<nPatternNum; i++)
	{
		for (j=0; j < OBJECTCANDIDATENUM; j++)
		{
			if (wParam == m_vvpObjectGuiDisplay[i][j]->GetID())
			{
				...
				dlgSearchToolModelLibrary.m_nSearchModeFrom = eObjectSearch;
				...
				if (dlgSearchToolModelLibrary.DoModal() == IDOK)
				{
					...
					if(1)
					{
						if (m_pParent && m_nPlatformIndex<m_pParent->m_vpVisionASM.size() && m_pParent->m_vpVisionASM.at(m_nPlatformIndex))
						{
							if (m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->m_pSystemStatusInfo!=NULL)
							{
								...
								pSearchToolDstTmp = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->GetRepoAlnObjectSearchTool(nCurProdIdx,i,j);
					...
					bool bRet = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->SetRepoAlnObjectSearchTool(nCurProdIdx,i,j,pSearchTool);
					if(!bRet)
					{
						return S_FALSE;
					}
...
// 双击Display控件响应
LRESULT CDlgSysKindAlignObject::OnGuiDisplayDblClk(WPARAM wParam, LPARAM lParam)
{
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
	m_nPlatformIndex = pView->m_nPlatformIndex;
	if (pView->m_vpTotalProductData.at(m_nPlatformIndex)->GetCount() <= 0)
		...
		for (i=0; i<nPatternNum; i++)
		{
			for (j=0; j < OBJECTCANDIDATENUM; j++)
			{
				if (wParam == m_vvpObjectGuiDisplay[i][j]->GetID())
				{
					...
					if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable) &&  bSystemOptionShutter)
					{
						dlgSearch.SetProductSearchShutterInfo(product.m_pAlignerParam->GetEnableObjectSearchShutter(j) ,product.m_pAlignerParam->GetObjectSearchShutter(i,j));
					}
					...
					if (dlgSearch.DoModal() == IDOK)
					{
						if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable)  && bSystemOptionShutter)
						{
							product.m_pAlignerParam->SetObjectSearchShutter(i,j, dlgSearch.GetProductSearchShutterInfoShutter());
							pTotalProduct->SetItem(nCurProdIdx, product);
						}

						pSearchTool = dlgSearch.GetSearchTool();
						m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->SetRepoAlnObjectSearchTool(nCurProdIdx,i, j, pSearchTool);
...
void CDlgSysKindAlignObject::OnPlatformChange() 
{
	UpdateData(TRUE);
...
void CDlgSysKindAlignObject::OnSetfocusEditAlignerMaxTimes() 
{
...
void CDlgSysKindAlignObject::OnSetfocusEditAlignerXPrecision() 
{
// 	if (m_bSysKeyboardEnabled)
// 	{
// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditAlignerYPrecision() 
{
// 	if (m_bSysKeyboardEnabled)
// 	{
// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditAlignerDPrecision() 
{
// 	if (m_bSysKeyboardEnabled)
// 	{
// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditAlignerXOffset() 
{
// 	if (m_bSysKeyboardEnabled)
// 	{
// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditAlignerYOffset() 
{
// 	if (m_bSysKeyboardEnabled)
// 	{
// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditAlignerDOffset() 
{
// 	if (m_bSysKeyboardEnabled)
// 	{
// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateXOffset1() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateYOffset1() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateDOffset1() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateXOffset2() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateYOffset2() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateDOffset2() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateXOffset3() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateYOffset3() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateDOffset3() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateXOffset4() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateYOffset4() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnSetfocusEditObjectCandidateDOffset4() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignObject::OnKillfocusEditAlignerMaxTimes() 
{
...
void CDlgSysKindAlignObject::OnKillfocusEditAlignerXPrecision() 
{
// 	if (m_bKillFocusEnabled)
// 	{
// 		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditAlignerYPrecision() 
{
// 	if (m_bKillFocusEnabled)
// 	{
// 		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditAlignerDPrecision() 
{
// 	if (m_bKillFocusEnabled)
// 	{
// 		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditAlignerXOffset() 
{
// 	if (m_bKillFocusEnabled)
// 	{
// 		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditAlignerYOffset() 
{
// 	if (m_bKillFocusEnabled)
// 	{
// 		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditAlignerDOffset() 
{
// 	if (m_bKillFocusEnabled)
// 	{
// 		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateXOffset1() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateYOffset1() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateDOffset1() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateXOffset2() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateYOffset2() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateDOffset2() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateXOffset3() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateYOffset3() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateDOffset3() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateXOffset4() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateYOffset4() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignObject::OnKillfocusEditObjectCandidateDOffset4() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
/* Return type		: void 
/************************************************************************************/
void CDlgSysKindAlignObject::OnClickListProduct(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
BOOL CDlgSysKindAlignObject::DestroyWindow() 
{
	int i = 0 , j = 0;
...
void CDlgSysKindAlignObject::OnOK() 
{
// 	if (IsProductChanged())
// 	{
// 		if (SavePrevProduct())
...
void CDlgSysKindAlignObject::OnCancel() 
{
...
void CDlgSysKindAlignObject::OnClose() 
{
...
void CDlgSysKindAlignObject::OnSize(UINT nType, int cx, int cy)
{
...
void CDlgSysKindAlignObject::CopyObjectToCalib(int nObjectPosIndex)
{
	// TODO: 在此添加控件通知处理程序代码
	...
	CBaseSearchTool* pObjSearchTool = NULL;
	pObjSearchTool = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->GetRepoAlnObjectSearchTool(m_nCurProductIdx, nObjectPosIndex, 0);
...
void CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedBtnCopyObjectToCalib7()
{
	// TODO: 在此添加控件通知处理程序代码
...
BOOL CDlgSysKindAlignObject::PreTranslateMessage(MSG* pMsg)
{
...
void CDlgSysKindAlignObject::OnBnClickedRadioObjectcSearchMode0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedRadioObjectcSearchSync0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcOffsetEnable1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcOffsetEnable2()
{
	// TODO: 在此添加控件通知处理程序代码
	BOOL bObjectCCandidateOffsetEnable2Old = m_bObjectCandidateOffsetEnable2;

	UpdateData(TRUE);
	if (bObjectCCandidateOffsetEnable2Old != m_bObjectCandidateOffsetEnable2)
	{
		CString strLog;
...
void CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcOffsetEnable3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcOffsetEnable4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcShutterEnable()
{
	// TODO: 在此添加控件通知处理程序代码
    BOOL bAlignerObjectShutterEnable0Old = m_bObjectShutterEnable0;
    BOOL bAlignerObjectShutterEnable1Old = m_bObjectShutterEnable1;
    BOOL bAlignerObjectShutterEnable2Old = m_bObjectShutterEnable2;
    BOOL bAlignerObjectShutterEnable3Old = m_bObjectShutterEnable3;
    BOOL bAlignerObjectShutterEnable4Old = m_bObjectShutterEnable4;
	UpdateData(TRUE);
    if (bAlignerObjectShutterEnable0Old != m_bObjectShutterEnable0)
    {
        CString strLog;
    ...
    if (bAlignerObjectShutterEnable1Old != m_bObjectShutterEnable1)
    {
        CString strLog;
    ...
    if (bAlignerObjectShutterEnable2Old != m_bObjectShutterEnable2)
    {
        CString strLog;
    ...
    if (bAlignerObjectShutterEnable3Old != m_bObjectShutterEnable3)
    {
        CString strLog;
    ...
    if (bAlignerObjectShutterEnable4Old != m_bObjectShutterEnable4)
    {
        CString strLog;
...
void CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGainEnable()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::OnBnClickedCheckAlignerObjectcGammaEnable()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignObject::EnableWindowByAuthorizeset(bool bEnable)
{
	CWnd *pWnd;
