// PatternRectSearchTool.h: interface for the CPatternRectSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
// PatternRectSearch定位工具训练Data参数类
typedef struct tagPatternRectSearchTrainDataParam : public CBaseTrainDataParam
{
	...
	bool			m_bEnableDualEdge[RECT_LINE_NUM];		// 是否启用双极性
	tagPatternRectSearchTrainDataParam()
	{
...
}CPatternRectSearchTrainDataParam;

// PatternRectSearch定位工具训练Gui参数类
typedef struct tagPatternRectSearchTrainGuiParam : public CBaseTrainGuiParam
{
	...
	bool				 m_bCaliperVisible[RECT_LINE_NUM];			//卡尺是否可见
...
//	bool			m_bSearchRectVisible;				// 搜索区域是否可见
	...
	tagPatternRectSearchTrainGuiParam()
	{
		m_nCaliperNum[0]				= 2;
		m_dStartX[0]					= 100.0;
		m_dStartY[0]					= 100.0;
...
}CPatternRectSearchTrainGuiParam;

// PatternnRectSearch定位工具搜索Data参数类
typedef struct tagPatternnRectSearchSearchDataParam : public CBaseSearchDataParam
{
	int		m_nSearchNum;								// 搜索个数
	double	m_dAcceptThre;								// 接收阈值
	double  m_dConfusionThre;							// 混淆阈值。混淆阈值不小于接收阈值
	tagPatternnRectSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.6;
...
}CPatternRectSearchSearchDataParam;

// PatternRectSearch定位工具搜索Gui参数类
typedef struct tagPatternRectSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
...
}CPatternRectSearchSearchGuiParam;

// PatternSearch训练结果
typedef struct tagPatternRectSearchTrainResult
{
	...
	tagPatternRectSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CPatternRectSearchTrainResult;

class CPatternRectSearchTool :public CBaseSearchTool
{
public:
	CPatternRectSearchTool(void);
	CPatternRectSearchTool(CPatternRectSearchTool &cPatternRectSearchTool);
	CPatternRectSearchTool& operator=(CPatternRectSearchTool &cPatternRectSearchTool);
	~CPatternRectSearchTool(void);
...
private:
	...
	CPatternRectSearchTrainDataParam		m_tmpTrainDataParam;			// 当前训练Data参数
	CPatternRectSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CPatternRectSearchSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CPatternRectSearchSearchGuiParam		m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CPatternRectSearchTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	CPatternRectSearchTrainDataParam		m_TrainDataParam;				// 训练Data参数
	CPatternRectSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CPatternRectSearchSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CPatternRectSearchSearchGuiParam		m_SearchGuiParam;				// 搜索Gui参数	
	CPatternRectSearchTrainResult			m_TrainResult;					// 训练结果
