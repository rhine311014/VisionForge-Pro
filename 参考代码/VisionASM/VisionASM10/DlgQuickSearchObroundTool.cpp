// DlgQuickSearchObroundToolSetting.cpp : implementation file
//
...
CDlgQuickSearchObroundTool::CDlgQuickSearchObroundTool(CWnd* pParent /*=NULL*/)
: CDialog(CDlgQuickSearchObroundTool::IDD, pParent)
, m_bSortByScore1(TRUE)
, m_nImageChannel(0)
{
	//{{AFX_DATA_INIT(CDlgQuickSearchObroundTool)
...
void CDlgQuickSearchObroundTool::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgQuickSearchObroundTool)
...
BEGIN_MESSAGE_MAP(CDlgQuickSearchObroundTool, CDialog)
//{{AFX_MSG_MAP(CDlgQuickSearchObroundTool)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgQuickSearchObroundTool message handlers

void CDlgQuickSearchObroundTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgQuickSearchObroundTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;	
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau = m_dGrau;
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre = m_lNoiseThre;
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag = m_lTotalMag;
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum = m_nCircleOutLineNum;
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre = m_dCircleContrastThre;
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth = m_lCircleFilterHalfWidth;
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty = (EdgePolarity)m_nCirclePolarityMode;
		((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore = m_bSortByScore1;
		((CQuickSearchObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum = m_nCircleCaliperNum;
		((CQuickSearchObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CaliperSearchDirection = (CaliperSearchDirection)m_nCircleInwardMode;
	...
	{		
		m_nImageChannel	= ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_dGrau			= ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau;
		m_lNoiseThre	= ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre;
		m_lTotalMag		= ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag;
		m_bEnableMask	= ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;
		m_nCircleOutLineNum =  ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum;
		m_dCircleContrastThre = ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre;
		m_lCircleFilterHalfWidth = ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth;
		m_nCirclePolarityMode = ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty;
		m_bSortByScore1 = ((CQuickSearchObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore;
		m_nCircleCaliperNum = ((CQuickSearchObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum;
		m_nCircleInwardMode = ((CQuickSearchObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CaliperSearchDirection;
...
void CDlgQuickSearchObroundTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CQuickSearchObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CQuickSearchObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CQuickSearchObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow = m_dAngleLow;
		((CQuickSearchObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh = m_dAngleHigh;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CQuickSearchObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CQuickSearchObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;
		m_dAngleLow		= ((CQuickSearchObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CQuickSearchObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh;
...
void CDlgQuickSearchObroundTool::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_QUICKSEARCH_OBROUND_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgQuickSearchObroundTool::OnBtnGetTrainImage() 
{
...
void CDlgQuickSearchObroundTool::OnBtnTrain() 
{
...
void CDlgQuickSearchObroundTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgQuickSearchObroundTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgQuickSearchObroundTool::OnInitDialog()
{
...
void CDlgQuickSearchObroundTool::OnChangeEdtCircleCalipernum() 
{
...
void CDlgQuickSearchObroundTool::OnRadCircleInwardMode0() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgQuickSearchObroundTool::OnRadCircleInwardMode1() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgQuickSearchObroundTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtGrau() 
{
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtNoisethre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtTotalMag() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtCircleCalipernum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtCircleContrastThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtCircleOutlineNum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickSearchObroundTool::OnSetfocusEdtAngleLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickSearchObroundTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CQuickSearchObroundTrainGuiParam trainGuiParam;
...
BOOL CDlgQuickSearchObroundTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgQuickSearchObroundTool::OnEnSetfocusEditCircleFilterHalfWidth() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
