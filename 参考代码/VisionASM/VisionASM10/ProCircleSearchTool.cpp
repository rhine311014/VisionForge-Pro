// ProCircleSearchTool.cpp: implementation of the CProCircleSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
CProCircleSearchTool::CProCircleSearchTool()
{
	m_pGuiDisplay							= NULL;
	m_hDispWnd                              = NULL;
	...
	m_tmpTrainDataParam.m_edgeProperty = eDarkToLight;
...
CProCircleSearchTool::CProCircleSearchTool(CProCircleSearchTool &cProCircleSearchTool)
{
	if (cProCircleSearchTool.GetSearchToolType() != eProCircleSearchTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cProCircleSearchTool.m_CamHeight;
	m_CamWidth								= cProCircleSearchTool.m_CamWidth;

	m_TrainDataParam						= cProCircleSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cProCircleSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cProCircleSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cProCircleSearchTool.m_SearchGuiParam;
	m_TrainResult                           = cProCircleSearchTool.m_TrainResult;
	m_ImageTrain							= cProCircleSearchTool.m_ImageTrain;
	m_ImageMask								= cProCircleSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cProCircleSearchTool.m_bTrainGuiShow;
	m_bSearchResultGuiShow					= cProCircleSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cProCircleSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cProCircleSearchTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cProCircleSearchTool.UpdateSearchGuiData(true);
	cProCircleSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cProCircleSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cProCircleSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cProCircleSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cProCircleSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cProCircleSearchTool.m_tmpImageTrain);
	SetMaskImage(cProCircleSearchTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CProCircleSearchTool& CProCircleSearchTool::operator=(CProCircleSearchTool& cProCircleSearchTool)
{
	if (this == &cProCircleSearchTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CProCircleSearchTool::GetSearchToolType()
{
	return eProCircleSearchTool;
}										   

// 设置显示控件指针		
bool CProCircleSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CProCircleSearchTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CProCircleSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CProCircleSearchTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CProCircleSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CProCircleSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CProCircleSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CProCircleSearchTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CProCircleSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CProCircleSearchTool::UpdateTrainGuiDisplay()
{
...
// 更新搜索界面显示									
bool CProCircleSearchTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
bool CProCircleSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CProCircleSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eProCircleSearchTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CProCircleSearchTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CProCircleSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CProCircleSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CProCircleSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eProCircleSearchTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CProCircleSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CProCircleSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CProCircleSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CProCircleSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CProCircleSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CProCircleSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CProCircleSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CProCircleSearchTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CProCircleSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CProCircleSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eProCircleSearchTool)
	{
		return false;
	}
	
	*((CProCircleSearchTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}						

// 是否训练成功
bool CProCircleSearchTool::IsTrained()
{
	return m_bTrainOK;
}															
			
// 设置搜索Data参数	
bool CProCircleSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eProCircleSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CProCircleSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CProCircleSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CProCircleSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CProCircleSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eProCircleSearchTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CProCircleSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CProCircleSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CProCircleSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CProCircleSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
	...
	if (bRet)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			double dCenterY = 0;
			double dRadius  = 1;
			double dProjectLen = 20;
			double dSearchLen = 10;

			scAffineRect ar = m_TrainGuiParam.m_TrainAffineRect;

			dCenterX = ar.GetCenter().GetX();
			dCenterY = ar.GetCenter().GetY();
			dRadius = min(ar.GetXLength(), ar.GetYLength())/2;
			dProjectLen = max(3,2*skPI*dRadius/nCaliperNum);
			dSearchLen = dRadius;	
			...
			dTransCenterX = cos(dRotation) * dCenterX  - sin(dRotation) * dCenterY + dTransX;
			dTransCenterY = sin(dRotation) * dCenterX  + cos(dRotation) * dCenterY + dTransY;

			// 圆
			m_FindCircleTool.SetCaliperNum(nCaliperNum);
			m_FindCircleTool.SetCaliperParams(nCaliperNum, eOutward, dSearchLen,dProjectLen);
			m_FindCircleTool.SetCaliperProperty(5, m_TrainDataParam.m_edgeProperty, 1);
			m_FindCircleTool.SetOutLineNum(nCaliperNum/6);
			m_FindCircleTool.SetCenterRadiusAngleStartAngleSpan(sc2Vector(dTransCenterX, dTransCenterY), dRadius
				,scDegree(0), scDegree(360));
...
// 获取搜索结果个数										
int CProCircleSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CProCircleSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 				
// // 加载模板文件
// bool CProCircleSearchTool::LoadModelFromFile(CString strDir)
// {
// 	// strDir为文件夹路径
// 	// 配置文件包括以下部分:
// 	//    (1) 配置文件Pattern.xml
...
// 	sc2Vector vPos;
// 	BYTE byR, byG, byB;
// 	CProCircleSearchTrainDataParam tmpTrainDataParam;
// 	CProCircleSearchTrainGuiParam tmpTrainGuiParam;
// 	CProCircleSearchSearchDataParam tmpSearchDataParam;
// 	CProCircleSearchSearchGuiParam tmpSearchGuiParam;
// 	CProCircleSearchTrainResult    tmpTrainResult;
// 
...
// 	if (cSearchToolType != eProCircleSearchTool)
// 	{
// 		return false;
// 	}
// 
...
// 	
// // 保存模板文件							
// bool CProCircleSearchTool::SaveModelToFile(CString strDir)
// {
...
// 加载模板训练图像文件
bool CProCircleSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
...
// 更新训练控件数据信息	
bool CProCircleSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CProCircleSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CProCircleSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CProCircleSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CProCircleSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CProCircleSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CProCircleSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CProCircleSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CProCircleSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CProCircleSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CProCircleSearchTool::RestoreSearchParam()
{
...
void CProCircleSearchTool::SetLanguage(int nLanguage)
{
...
CString CProCircleSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
