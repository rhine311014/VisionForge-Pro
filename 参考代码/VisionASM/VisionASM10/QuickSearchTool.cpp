// QuickSearchTool.cpp: implementation of the CQuickSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
void CQuickSearchTrainDataParam::SaveModelToFile(vcXMLConfigurator& cXMLConfigurator)
{
	CString strInfo = _T("");
	// ImageChannel
...
void CQuickSearchTrainDataParam::LoadModelFromFile(vcXMLConfigurator& cXMLConfigurator)
{
	bool bRet = false;
	// coarse scale
	// ImageChannel
...
void CQuickSearchSearchDataParam::SaveModelToFile(vcXMLConfigurator& cXMLConfigurator)
{
	CString strInfo = _T("");
...
void CQuickSearchSearchDataParam::LoadModelFromFile(vcXMLConfigurator& cXMLConfigurator)
{
	bool bRet = false;
...
CQuickSearchTool::CQuickSearchTool()
{
	m_pGuiDisplay							= NULL;
	m_hDispWnd                              = NULL;
...
CQuickSearchTool::CQuickSearchTool(CQuickSearchTool &cQuickSearchTool)
{
	if (cQuickSearchTool.GetSearchToolType() != eQuickSearchTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cQuickSearchTool.m_CamHeight;
	m_CamWidth								= cQuickSearchTool.m_CamWidth;

	m_TrainDataParam						= cQuickSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cQuickSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cQuickSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cQuickSearchTool.m_SearchGuiParam;
	m_TrainResult                           = cQuickSearchTool.m_TrainResult;
	m_ImageTrain							= cQuickSearchTool.m_ImageTrain;
	m_ImageMask								= cQuickSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cQuickSearchTool.m_bTrainGuiShow;
	m_bSearchResultGuiShow					= cQuickSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cQuickSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cQuickSearchTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cQuickSearchTool.UpdateSearchGuiData(true);
	cQuickSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cQuickSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cQuickSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cQuickSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cQuickSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cQuickSearchTool.m_tmpImageTrain);
	SetMaskImage(cQuickSearchTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CQuickSearchTool& CQuickSearchTool::operator=(CQuickSearchTool& cQuickSearchTool)
{
	if (this == &cQuickSearchTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CQuickSearchTool::GetSearchToolType()
{
	return eQuickSearchTool;
}										   

// 设置显示控件指针		
bool CQuickSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CQuickSearchTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CQuickSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CQuickSearchTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CQuickSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CQuickSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CQuickSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CQuickSearchTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CQuickSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CQuickSearchTool::UpdateTrainGuiDisplay()
{
...
// 更新搜索界面显示									
bool CQuickSearchTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
bool CQuickSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CQuickSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eQuickSearchTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CQuickSearchTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CQuickSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CQuickSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CQuickSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eQuickSearchTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CQuickSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CQuickSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CQuickSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CQuickSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CQuickSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CQuickSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CQuickSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
bool CQuickSearchTool::Train()
{
	...
	sc2Vector tmp1 =  m_tmpTrainGuiParam.m_TrainAffineRect.GetCenter();
	scRadian  tmp2 =  m_tmpTrainGuiParam.m_TrainAffineRect.GetXRotation();

	scRadian tmp3 =  m_tmpTrainGuiParam.m_TrainAffineRect.GetYRotation();
	scRadian tmp4 =  m_tmpTrainGuiParam.m_TrainAffineRect.GetSkew();
...
// 获取训练结果图像														
bool CQuickSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CQuickSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eQuickSearchTool)
	{
		return false;
	}
	
	*((CQuickSearchTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}						

// 是否训练成功
bool CQuickSearchTool::IsTrained()
{
	return m_bTrainOK;
}															
			
// 设置搜索Data参数	
bool CQuickSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eQuickSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CQuickSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CQuickSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CQuickSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CQuickSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eQuickSearchTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CQuickSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CQuickSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CQuickSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CQuickSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
	...
	if (bRet)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			//计算清晰度
			double dScoreSharp = 0;
			if (m_tmpSearchDataParam.m_bEnableSharpScore)
			{
				
				scImageSharpness tool;
				//if (tool.Execute(ImageSearch,tmpQuickResult.m_MatchRect,dScoreSharp))

				bool bScoreSharp = false;
				if (bIsProcessImage)
				{
					bScoreSharp = tool.Execute(tmpImage,tmpQuickResult.m_MatchRect,dScoreSharp);
				}
				else
				{
					bScoreSharp = tool.Execute(ImageSearch,tmpQuickResult.m_MatchRect,dScoreSharp);
				}
				if (bScoreSharp)
				{
					dScoreSharp = dScoreSharp / m_TrainResult.m_dSharpness;

					if (dScoreSharp < m_tmpSearchDataParam.m_dSharpThre)
					{
						continue;
					}
				}
			...
			if (m_tmpSearchDataParam.m_bEnableSharpScore)
			{
				st.Format(_T("%d X:%.1f;Y:%.1f;D:%.3f;S:%.2f;SS:%.2f"), i, tmpQuickResult.GetPosition().GetX(), tmpQuickResult.GetPosition().GetY(), tmpQuickResult.GetRotate().ToDouble(),tmpQuickResult.GetScore(),dScoreSharp);
			}
			else
			{
...
// 获取搜索结果个数										
int CQuickSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CQuickSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像文件
bool CQuickSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eQuickSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CQuickSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CQuickSearchTrainDataParam tmpTrainDataParam;
	CQuickSearchTrainGuiParam tmpTrainGuiParam;
	CQuickSearchSearchDataParam tmpSearchDataParam;
	CQuickSearchSearchGuiParam tmpSearchGuiParam;
	CQuickSearchTrainResult    tmpTrainResult;
...
// 保存模板文件							
bool CQuickSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CQuickSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CQuickSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CQuickSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CQuickSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CQuickSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CQuickSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CQuickSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CQuickSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CQuickSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CQuickSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CQuickSearchTool::RestoreSearchParam()
{
...
void CQuickSearchTool::SetLanguage(int nLanguage)
{
...
CString CQuickSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
