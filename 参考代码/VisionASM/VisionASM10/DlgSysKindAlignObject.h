...
class CDlgSysKind;
class CDlgSysKindAlignObject : public CDialog
{
	DECLARE_DYNAMIC(CDlgSysKindAlignObject)

public:
	CDlgSysKindAlignObject(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgSysKindAlignObject();

// 对话框数据
	enum { IDD = IDD_SYS_KIND_ALIGN_OBJECT };
