...
class CDlgSearch;
class CDlgPatternSearchObroundTool : public CDialog
{
// Construction
public:
	CDlgPatternSearchObroundTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CDlgPatternSearchObroundTool)
	enum { IDD = IDD_DLG_PATTERNSEARCH_OBROUND_TOOL };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlgPatternSearchObroundTool)
	public:
...
protected:
	...
	//{{AFX_MSG(CDlgPatternSearchObroundTool)
