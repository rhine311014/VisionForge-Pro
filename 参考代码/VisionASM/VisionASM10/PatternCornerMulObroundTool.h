// PatternSearchObroundTool.h: interface for the CPatternCornerMulObroundTool class.
//
//////////////////////////////////////////////////////////////////////
...
// PatternCornerMulObround定位工具训练Data参数类
typedef struct tagPatternCornerMulObroundTrainDataParam : public CBaseTrainDataParam
{
	//区域定位
	...
	tagPatternCornerMulObroundTrainDataParam()
	{
...
}CPatternCornerMulObroundTrainDataParam;

// PatternCornerMulObround定位工具训练Gui参数类
typedef struct tagPatternCornerMulObroundTrainGuiParam : public CBaseTrainGuiParam
{
	//区域定位
	...
	tagPatternCornerMulObroundTrainGuiParam()
	{
		for (int i=0;i<OBROUND_NUM;i++)
		{
...
}CPatternCornerMulObroundTrainGuiParam;

// PatternCornerMulObround定位工具搜索Data参数类
typedef struct tagPatternCornerMulObroundSearchDataParam : public CBaseSearchDataParam
{
	...
	tagPatternCornerMulObroundSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.6;
...
}CPatternCornerMulObroundSearchDataParam;

// PatternCornerMulObround定位工具搜索Gui参数类
typedef struct tagPatternCornerMulObroundGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	...
	tagPatternCornerMulObroundGuiParam()
	{
...
}CPatternCornerMulObroundSearchGuiParam;

// PatternSearch训练结果
typedef struct tagPatternCornerMulObroundTrainResult
{
	double m_dModelX;
	double m_dModelY;
	...
	tagPatternCornerMulObroundTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
		for (int i = 0; i < LINE_NUM; i++)
...
}CPatternCornerMulObroundTrainResult;

//
//	圆定位工具
//
class /*SV_SEARCHTOOL_API*/ CPatternCornerMulObroundTool : public CBaseSearchTool    
{
public:
	CPatternCornerMulObroundTool();
	CPatternCornerMulObroundTool(CPatternCornerMulObroundTool &CPatternCornerMulObroundTool);
	CPatternCornerMulObroundTool& operator=(CPatternCornerMulObroundTool &CPatternCornerMulObroundTool);
	virtual ~CPatternCornerMulObroundTool();
...
private:	
	...
	CPatternCornerMulObroundTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CPatternCornerMulObroundTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CPatternCornerMulObroundSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CPatternCornerMulObroundSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CPatternCornerMulObroundTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
 	CPatternCornerMulObroundTrainDataParam			m_TrainDataParam;				// 训练Data参数
 	CPatternCornerMulObroundTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
 	CPatternCornerMulObroundSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
 	CPatternCornerMulObroundSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CPatternCornerMulObroundTrainResult			m_TrainResult;					// 训练结果
