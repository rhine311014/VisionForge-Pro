// ProCircleSearchTool.h: interface for the CProCircleSearchTool class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PROCIRCLESEARCHTOOL_H__8CF0FDDA_2D35_45FE_A3EF_327D8D73244F__INCLUDED_)
#define AFX_PROCIRCLESEARCHTOOL_H__8CF0FDDA_2D35_45FE_A3EF_327D8D73244F__INCLUDED_
...
#define PROCIRCLE_NUM  2

// ProCircleSearch定位工具训练Data参数类
typedef struct tagProCircleSearchTrainDataParam : public CBaseTrainDataParam
{
	double	m_dGrau;									// 颗粒度
	...
	tagProCircleSearchTrainDataParam()
	{
		m_dGrau			= 2.0;
		m_lNoiseThre	= 10;
		m_lTotalMag		= 200;
...
}CProCircleSearchTrainDataParam;

// ProCircleSearch定位工具训练Gui参数类
typedef struct tagProCircleSearchTrainGuiParam : public CBaseTrainGuiParam
{
	...
	tagProCircleSearchTrainGuiParam()
	{
...
}CProCircleSearchTrainGuiParam;

// ProCircleSearch定位工具搜索Data参数类
typedef struct tagProCircleSearchSearchDataParam : public CBaseSearchDataParam
{
	int		m_nSearchNum;								// 搜索个数
	double	m_dAcceptThre;								// 接收阈值
	double  m_dAngleLow;								// 低角度
	double	m_dAngleHigh;								// 高角度
	tagProCircleSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.8;
		m_dAngleLow		= -10.0;
...
}CProCircleSearchSearchDataParam;

// ProCircleSearch定位工具搜索Gui参数类
typedef struct tagProCircleSearchSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	...
	tagProCircleSearchSearchGuiParam()
	{
...
}CProCircleSearchSearchGuiParam;

// ProCircleSearch训练结果
typedef struct tagProCircleSearchTrainResult
{
	double m_dModelX; // 参考点X					
	double m_dModelY; // 参考点Y

	tagProCircleSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
	}
...
}CProCircleSearchTrainResult;

//
//	ProCircleSearch定位工具
//
class /*SV_SEARCHTOOL_API*/ CProCircleSearchTool : public CBaseSearchTool  
{
public:
	CProCircleSearchTool();
	CProCircleSearchTool(CProCircleSearchTool &cProCircleSearchTool);
	CProCircleSearchTool& operator=(CProCircleSearchTool &cProCircleSearchTool);
	virtual ~CProCircleSearchTool();
...
private:
	scQuickSearchTool                   m_QuickSearchTool;				// ProCircleSearch搜索工具
	...
	CProCircleSearchTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CProCircleSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CProCircleSearchSearchDataParam			m_tmpSearchDataParam;			// 当前搜索Data参数	
	CProCircleSearchSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CProCircleSearchTrainResult				m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	CProCircleSearchTrainDataParam			m_TrainDataParam;				// 训练Data参数
	CProCircleSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CProCircleSearchSearchDataParam			m_SearchDataParam;				// 搜索Data参数	
	CProCircleSearchSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CProCircleSearchTrainResult				m_TrainResult;					// 训练结果
...
#endif // !defined(AFX_PROCIRCLESEARCHTOOL_H__8CF0FDDA_2D35_45FE_A3EF_327D8D73244F__INCLUDED_)
