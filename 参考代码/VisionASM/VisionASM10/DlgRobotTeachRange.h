...
// CDlgRobotTeachRange 对话框

class CDlgRobotTeachRange : public CDialog
{
	DECLARE_DYNAMIC(CDlgRobotTeachRange)

public:
	CDlgRobotTeachRange(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgRobotTeachRange();

// 对话框数据
	enum { IDD = IDD_DLG_ROBOT_TEACH_RANGE };
	...
	int m_nPrevTeachSGIntIndex;

	// 实数常量
	std::vector<int> m_vnSGRealIndex;		// 实数常量编号
	int m_nPrevTeachSGRealIndex;
...
protected:
	...
	void UpdateDlgDataTeachPosRange(BOOL bSave, int nPosIndex);		// 更新示教点位置范围

	void UpdateDlgDataTeachSGIRange(BOOL bSave, int nPosIndex);		// 更新示整数范围
	void UpdateDlgDataTeachSGRRange(BOOL bSave, int nPosIndex);		// 更新示实数范围
...
//	afx_msg void OnTcnSelchangeTabTeachPos(NMHDR *pNMHDR, LRESULT *pResult);
	...
	CComboBox m_comboTeachPos;
	CString m_strTeachPosName;
	BOOL m_bCurPosRangeEnable;
	BOOL m_bTeachPosRangeEnable;
	afx_msg void OnCbnSelchangeComboTeachPos();
	afx_msg void OnEnSetfocusEditPosX1();
	afx_msg void OnEnKillfocusEditPosX1();
	afx_msg void OnEnSetfocusEditPosY1();
	afx_msg void OnEnKillfocusEditPosY1();
	afx_msg void OnEnSetfocusEditPosR1();
	afx_msg void OnEnKillfocusEditPosR1();
	afx_msg void OnEnSetfocusEditPosZ1();
	afx_msg void OnEnKillfocusEditPosZ1();

	afx_msg void OnEnSetfocusEditPosX2();
	afx_msg void OnEnKillfocusEditPosX2();
	afx_msg void OnEnSetfocusEditPosY2();
	afx_msg void OnEnKillfocusEditPosY2();
	afx_msg void OnEnSetfocusEditPosR2();
	afx_msg void OnEnKillfocusEditPosR2();
	afx_msg void OnEnSetfocusEditPosZ2();
	afx_msg void OnEnKillfocusEditPosZ2();

	afx_msg void OnEnSetfocusEditPosX3();
	afx_msg void OnEnKillfocusEditPosX3();
	afx_msg void OnEnSetfocusEditPosY3();
	afx_msg void OnEnKillfocusEditPosY3();
	afx_msg void OnEnSetfocusEditPosR3();
	afx_msg void OnEnKillfocusEditPosR3();
	afx_msg void OnEnSetfocusEditPosZ3();
	afx_msg void OnEnKillfocusEditPosZ3();

	afx_msg void OnEnSetfocusEditPosX4();
	afx_msg void OnEnKillfocusEditPosX4();
	afx_msg void OnEnSetfocusEditPosY4();
	afx_msg void OnEnKillfocusEditPosY4();
	afx_msg void OnEnSetfocusEditPosR4();
	afx_msg void OnEnKillfocusEditPosR4();
	afx_msg void OnEnSetfocusEditPosZ4();
	afx_msg void OnEnKillfocusEditPosZ4();

	afx_msg void OnBnClickedBtnApply();
	CComboBox m_comboTeachSGI;
	BOOL m_bTeachSGIRangeEnable;
	CString m_strTeachSGIName;
	CString m_strSGIMin;
	CString m_strSGIMax;
	afx_msg void OnCbnSelchangeComboTeachSgi();
	afx_msg void OnEnSetfocusEditSgiMin();
	afx_msg void OnEnKillfocusEditSgiMin();
	afx_msg void OnEnSetfocusEditSgiMax();
	afx_msg void OnEnKillfocusEditSgiMax();

	CComboBox m_comboTeachSGR;
	BOOL m_bTeachSGRRangeEnable;
	CString m_strTeachSGRName;
	CString m_strSGRMin;
	CString m_strSGRMax;
	afx_msg void OnCbnSelchangeComboTeachSgr();
	afx_msg void OnEnSetfocusEditSgrMin();
	afx_msg void OnEnKillfocusEditSgrMin();
	afx_msg void OnEnSetfocusEditSgrMax();
	afx_msg void OnEnKillfocusEditSgrMax();

	CString strComboTeachSgiOld;
	CString strComboTeachSgrOld;
	CString strComboTeachPosOld;
	afx_msg void OnBnClickedBtnPosRAdd();
	afx_msg void OnBnClickedCheckCurPosRangeEnable();
	afx_msg void OnBnClickedCheckTeachPosRangeEnable();
	afx_msg void OnBnClickedCheckTeachSgiRangeEnable();
	afx_msg void OnBnClickedCheckTeachSgrRangeEnable();
