...
#include <algorithm>
#include "DlgSearch.h"
// CDlgCalibTargetPos8 对话框

IMPLEMENT_DYNAMIC(CDlgCalibTargetPos8, CDialog)

CDlgCalibTargetPos8::CDlgCalibTargetPos8(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgCalibTargetPos8::IDD, pParent)
	, m_nRadioCalibTargetPos(0)
{
	...
	m_bCommGetPlatformAxisPosSuccess2 = FALSE;
...
CDlgCalibTargetPos8::~CDlgCalibTargetPos8()
{
...
void CDlgCalibTargetPos8::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_STATIC_NOTE_PLATFORM1, m_labelPlatform1);
	DDX_Control(pDX, IDC_STATIC_NOTE_PLATFORM2, m_labelPlatform2);
	DDX_Control(pDX, IDC_COMBO_EXPRODUCT_INDEX, m_comboExProductIndex);
}


BEGIN_MESSAGE_MAP(CDlgCalibTargetPos8, CDialog)
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_BTN_SERIAL_GRAB, &CDlgCalibTargetPos8::OnBnClickedBtnSerialGrab)
	ON_BN_CLICKED(IDCANCEL, &CDlgCalibTargetPos8::OnBnClickedCancel)
	ON_BN_CLICKED(IDOK, &CDlgCalibTargetPos8::OnBnClickedOk)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT0_MOVE_POS0, &CDlgCalibTargetPos8::OnBnClickedBtnSearchObject0Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT1_MOVE_POS0, &CDlgCalibTargetPos8::OnBnClickedBtnSearchObject1Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT0_MOVE_POS1, &CDlgCalibTargetPos8::OnBnClickedBtnSearchObject0Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT1_MOVE_POS1, &CDlgCalibTargetPos8::OnBnClickedBtnSearchObject1Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET0_MOVE_POS0, &CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject0Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET1_MOVE_POS0, &CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject1Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET0_MOVE_POS1, &CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject0Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET1_MOVE_POS1, &CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject1Pos1)
	ON_BN_CLICKED(IDC_BTN_CALIB_TARGET_POS, &CDlgCalibTargetPos8::OnBnClickedBtnCalcuVirtualObject)
	ON_BN_CLICKED(IDC_BTN_COMM_GET_PLATFORM_AXIS_POS, &CDlgCalibTargetPos8::OnBnClickedBtnCommGetPlatformAxisPos)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT2_MOVE_POS0, &CDlgCalibTargetPos8::OnBnClickedBtnSearchObject2MovePos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT3_MOVE_POS0, &CDlgCalibTargetPos8::OnBnClickedBtnSearchObject3MovePos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT2_MOVE_POS1, &CDlgCalibTargetPos8::OnBnClickedBtnSearchObject2MovePos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT3_MOVE_POS1, &CDlgCalibTargetPos8::OnBnClickedBtnSearchObject3MovePos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET2_MOVE_POS0, &CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject2MovePos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET3_MOVE_POS0, &CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject3MovePos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET2_MOVE_POS1, &CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject2MovePos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET3_MOVE_POS1, &CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject3MovePos1)
	ON_BN_CLICKED(IDC_BTN_COMM_GET_PLATFORM_AXIS_POS2, &CDlgCalibTargetPos8::OnBnClickedBtnCommGetPlatformAxisPos2)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS0, &CDlgCalibTargetPos8::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS1, &CDlgCalibTargetPos8::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS2, &CDlgCalibTargetPos8::OnBnClickedRadioCalibTargetPos0)
    ON_BN_CLICKED(IDC_BTN_LOAD_LAST_CALIBMARK, &CDlgCalibTargetPos8::OnBnClickedBtnLoadLastCalibmark)
    ON_BN_CLICKED(IDC_BTN_SET_DMCODE_PARAM, &CDlgCalibTargetPos8::OnBnClickedBtnSetDmcodeParam)
	ON_BN_CLICKED(IDC_BTN_SEND_TARGET_IMAGE_POS, &CDlgCalibTargetPos8::OnBnClickedBtnSendTargetImagePos)
	ON_BN_CLICKED(IDC_BTN_GET_TAR_IMAGE_POS, &CDlgCalibTargetPos8::OnBnClickedBtnGetTarImagePos)
	ON_CBN_SELCHANGE(IDC_COMBO_EXPRODUCT_INDEX, &CDlgCalibTargetPos8::OnCbnSelchangeComboExproductIndex)
	ON_BN_CLICKED(IDC_BUTTON_POS1_CAMERA_SHUTTER, &CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter1)
	ON_BN_CLICKED(IDC_BUTTON_POS2_CAMERA_SHUTTER, &CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter2)
	ON_BN_CLICKED(IDC_BUTTON_POS3_CAMERA_SHUTTER, &CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter3)
	ON_BN_CLICKED(IDC_BUTTON_POS4_CAMERA_SHUTTER, &CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter4)

	ON_BN_CLICKED(IDC_BUTTON_POS5_CAMERA_SHUTTER, &CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter5)
	ON_BN_CLICKED(IDC_BUTTON_POS6_CAMERA_SHUTTER, &CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter6)
	ON_BN_CLICKED(IDC_BUTTON_POS7_CAMERA_SHUTTER, &CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter7)
	ON_BN_CLICKED(IDC_BUTTON_POS8_CAMERA_SHUTTER, &CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter8)
	ON_MESSAGE(WM_SV_DISPLAY_DBLCLICK, OnGuiDisplayDblClk)
END_MESSAGE_MAP()


// CDlgCalibTargetPos8 消息处理程序

void CDlgCalibTargetPos8::SetVisionAlignerRef( vcBaseVisionAlign *pVisionAligner)
{
...
BOOL CDlgCalibTargetPos8::OnInitDialog()
{
...
void CDlgCalibTargetPos8::InitDlgItem()
{
	// 	// 	CRect cr;
	...
	m_labelPlatform1.SetBkColor(RGB(0,255,255));
	m_labelPlatform1.SetFontSize(10);
	m_labelPlatform1.SetFontBold(TRUE);
//	m_labelPlatform1.SetText(GetSysInfoString(m_psaSysInfoStrings,IDS_LABEL_NOTE2)/*_T("注:请确保各拍照位置的平台θ轴位置一致！！！")*/);
	m_labelPlatform1.SetText(_T("对象1、对象2拍照位置"));
	m_labelPlatform1.ShowWindow(FALSE);

	m_labelPlatform2.SetBkColor(RGB(0,255,255));
	m_labelPlatform2.SetFontSize(10);
	m_labelPlatform2.SetFontBold(TRUE);
//	m_labelPlatform2.SetText(GetSysInfoString(m_psaSysInfoStrings,IDS_LABEL_NOTE2)/*_T("注:请确保各拍照位置的平台θ轴位置一致！！！")*/);
	m_labelPlatform2.SetText(_T("对象3、对象4拍照位置"));
	m_labelPlatform2.ShowWindow(FALSE);
	GetDlgItem(IDC_BTN_COMM_GET_PLATFORM_AXIS_POS2)->ShowWindow(FALSE);
...
// 	m_pVisionASM->GetSysPlatformInfo(sysPlatformInfo);
	...
	if (sysPlatformInfo.m_bTarObjCamSepNoAxisCalib == TRUE)
	{
		...
		GetDlgItem(IDC_BTN_COMM_GET_PLATFORM_AXIS_POS2)->ShowWindow(SW_HIDE);
...
void CDlgCalibTargetPos8::UpdateDlgItem(BOOL bEnable)
{
    ...
    if (m_bIsDmCodeSearch)
    {
		...
		if (optionInfo.m_nTarInfoCommModeInDiffPC == 2)//通过PLC交换目标图像坐标和轴位置等
		{
			...
			if(platInfo.m_bObjectInDifferentComputer)
			{
				...
				GetDlgItem(IDC_BTN_SEARCH_TARGET0_MOVE_POS0)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_TARGET1_MOVE_POS0)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_TARGET0_MOVE_POS1)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_TARGET1_MOVE_POS1)->ShowWindow(SW_HIDE);

				GetDlgItem(IDC_BTN_SEARCH_TARGET2_MOVE_POS0)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_TARGET3_MOVE_POS0)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_TARGET2_MOVE_POS1)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_TARGET3_MOVE_POS1)->ShowWindow(SW_HIDE);
				
				GetDlgItem(IDC_BUTTON_POS5_CAMERA_SHUTTER)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BUTTON_POS6_CAMERA_SHUTTER)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BUTTON_POS7_CAMERA_SHUTTER)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BUTTON_POS8_CAMERA_SHUTTER)->ShowWindow(SW_HIDE);
			...
			if(platInfo.m_bTargetInDifferentComputer)
			{
				...
				GetDlgItem(IDC_BTN_SEARCH_OBJECT0_MOVE_POS0)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_OBJECT1_MOVE_POS0)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_OBJECT0_MOVE_POS1)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_OBJECT1_MOVE_POS1)->ShowWindow(SW_HIDE);

				GetDlgItem(IDC_BTN_SEARCH_OBJECT2_MOVE_POS0)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_OBJECT3_MOVE_POS0)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_OBJECT2_MOVE_POS1)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BTN_SEARCH_OBJECT3_MOVE_POS1)->ShowWindow(SW_HIDE);
				
				GetDlgItem(IDC_BUTTON_POS1_CAMERA_SHUTTER)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BUTTON_POS2_CAMERA_SHUTTER)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BUTTON_POS3_CAMERA_SHUTTER)->ShowWindow(SW_HIDE);
				GetDlgItem(IDC_BUTTON_POS4_CAMERA_SHUTTER)->ShowWindow(SW_HIDE);
...
void CDlgCalibTargetPos8::UpdateStatusBar()
{
...
void CDlgCalibTargetPos8::OnDestroy()
{
	CDialog::OnDestroy();
...
LRESULT CDlgCalibTargetPos8::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void CDlgCalibTargetPos8::UpdateBtnLiveGrab()
{
	// 更新“连续采集/停止采集”按钮 
...
void CDlgCalibTargetPos8::UpdateShutterDisplay()
{
	// 	// 更新曝光时间显示
...
BOOL CDlgCalibTargetPos8::SetGUI()
{
...
// 更新训练Gui控件显示
bool CDlgCalibTargetPos8::UpdateGuiDisplay()
{
	// 更新
	int nCamNum = m_pVisionASM->GetCameraNum();
	nCamNum = (nCamNum == 4) ? 2 : nCamNum;
...
void CDlgCalibTargetPos8::OnBnClickedBtnSerialGrab()
{
	// TODO: 在此添加控件通知处理程序代码
	int i=0;
	BOOL bSucceed = TRUE;
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchObject0Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchObject1Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject0Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 2; // 目标移动位置1
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject1Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 2; // 目标移动位置1
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchObject0Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 3; // 对象移动位置2
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchObject1Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 3; // 对象移动位置2
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject0Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 4; // 目标移动位置2
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject1Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 4; // 目标移动位置2
...
void CDlgCalibTargetPos8::OnBnClickedBtnCommGetPlatformAxisPos()
{
	// TODO: 在此添加控件通知处理程序代码
	SysPlatformInfo sysPlatformInfo;
	m_pVisionASM->GetSysPlatformInfo(sysPlatformInfo);
...
// 	{	
// 		AfxMessageBox(_T("请确认平台轴当前位置为对位拍照基准位置（对象1、对象2拍照位置）!"));
// 	}
// 	else
	{
...
void CDlgCalibTargetPos8::OnBnClickedBtnCommGetPlatformAxisPos2()
{
	// TODO: 在此添加控件通知处理程序代码

	AfxMessageBox(_T("请确认平台轴当前位置为对位拍照基准位置（对象3、对象4拍照位置）!"));

	m_nEvent = 6; // 获取平台基准位置（标定位置、接料位置、对位拍照基准位置）
	CString strLog;
	strLog.Format(_T("点击[获取平台基准位置2]\n"));
	g_opLogFile.SaveLogText(strLog, 2);
}


void CDlgCalibTargetPos8::OnBnClickedBtnCalcuVirtualObject()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
	...
	else
	{
		...
		if ( (!m_bCommGetPlatformAxisPosSuccess) /*|| (sysPlatformInfo.m_bTarCamWithDiffObjCam && !m_bCommGetPlatformAxisPosSuccess2)*/ )
		{
			m_bStatusBarFlag = FALSE;
        ...
        if (m_bIsDmCodeSearch)
        {
            ...
            for(nPosIndex = 0; nPosIndex < m_pVisionASM->GetPosNum()/2; nPosIndex++)
            {
				if (optionInfo.m_nTarInfoCommModeInDiffPC == 2)//通过PLC交换目标图像坐标和轴位置等
				{
					...
					if(TRUE == m_pVisionASM->ExecuteCalibrateDmCode(nPosIndex + m_pVisionASM->GetPosNum()/2+m_pVisionASM->GetPosNum()*nExProductIndex,
						nPosIndex+m_pVisionASM->GetPosNum()*nExProductIndex,
						vCalibImagePos,vBaseImagePos))
					{
...
void CDlgCalibTargetPos8::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
// 		CString strTemp;
// 		strInfo.Empty();
// 		strTemp.Format(_T("关联结果:\n"));
// 		strInfo += strTemp;
// 		int nCorrelationAxisNum = 0;
// 		nCorrelationAxisNum = m_pVisionASM->CorrelationMoveAxisAngle.size();
// 		if(nCorrelationAxisNum!=0)
// 		{
// 			vector<double> dAngle;
// 			dAngle.clear();
// 			double dMaxAngle = 0;
// 			double dMinAngle = 0;
// 			for (int i = 0;i<nCorrelationAxisNum;i++)
// 			{
// 				dAngle.push_back(m_pVisionASM->CorrelationMoveAxisAngle.at(i));
// 			}
// 			dMaxAngle = *max_element(dAngle.begin(),dAngle.end());
// 			dMinAngle = *min_element(dAngle.begin(),dAngle.end());
// 			if ((*max_element(dAngle.begin(),dAngle.end()))==(*min_element(dAngle.begin(),dAngle.end())))
// 			{
// 				strTemp.Format(_T("......关联过程中轴角度是否发生变化: 否;\n"));
// 				strInfo += strTemp;
// 			}
// 			else
// 			{
// 				strTemp.Format(_T("......关联过程中轴角度是否发生变化: 是,需要排查角度为何发生变化;\n"));
// 				strInfo += strTemp;
// 			}
// 		}
// 		m_pVisionASM->CorrelationMoveAxisAngle.clear();
// 
...
// 			for (int it = m_pVisionASM->GetPosNum()/2;it<m_pVisionASM->GetPosNum();it++)
// 			{
// 				strTemp.Format(_T("......位置%d:\n"),it+1);
// 				strInfo += strTemp;
// 				vpAllCalibratedInfo.at(it)->GetPlatformTransferH(hCorrelation); /// 关联转换矩阵  目标图像  -到-  对象图像
// 				vpAllCalibratedInfo.at(it - m_pVisionASM->GetPosNum()/2)->GetPlatformTransferH(hCalibrate);  ///  标定转换矩阵  对象图像  -到-  对象平台
// 				sc3Matrix m;
// 				sc3Matrix mTemp;
// 				// 关联转换矩阵 - 转换为3乘3矩阵
// 				for (int i = 0 ;i < 3;i++)
...
// 				strInfo += strTemp;
// 				strTemp.Format(_T("............基准mark平台坐标: X: %.2f; Y: %.2f;\n"),vpAllCalibratedInfo.at(it)->GetMarkPlatformCoordPos().GetPosX(),
// 					vpAllCalibratedInfo.at(it)->GetMarkPlatformCoordPos().GetPosY());
// 				strInfo += strTemp;
// 				strTemp.Format(_T("............基准mark图像坐标: X: %.2f; Y: %.2f;\n"),vpAllCalibratedInfo.at(it)->GetMarkImgCoordPos().GetPosX(),
// 					vpAllCalibratedInfo.at(it)->GetMarkImgCoordPos().GetPosY());
// 				strInfo += strTemp;
// 
// 				{
// 					CVisionASMConfig *vsConfig;
...
// 					SysPlatformInfo platformInfo;
// 					m_pVisionASM->GetSysPlatformInfo(platformInfo);
// 					if(((platformInfo.m_nCamNum==2)&&(platformInfo.m_nPositionNum==4))||((platformInfo.m_nCamNum==2)&&(platformInfo.m_nPositionNum==8)))
// 					{
// 						strTemp.Format(_T("............视野: X: %.2f * Y: %.2f;\n"),vsConfig->m_vCameraParam.at(1).m_nRawWidth*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2,
// 							vsConfig->m_vCameraParam.at(1).m_nRawHeight*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2);
// 						strInfo += strTemp;
// 					} 
// 					else if (((platformInfo.m_nCamNum==4)&&(platformInfo.m_nPositionNum==4))||((platformInfo.m_nCamNum==8)&&(platformInfo.m_nPositionNum==8)))
// 					{
// 						strTemp.Format(_T("............视野: X: %.2f * Y: %.2f;\n"),vsConfig->m_vCameraParam.at(it).m_nRawWidth*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2,
// 							vsConfig->m_vCameraParam.at(it).m_nRawHeight*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2);
// 						strInfo += strTemp;
// 					}
// 					else if ((platformInfo.m_nCamNum==4)&&(platformInfo.m_nPositionNum==8))
// 					{
// 						strTemp.Format(_T("............视野: X: %.2f * Y: %.2f;\n"),vsConfig->m_vCameraParam.at(it/2).m_nRawWidth*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2,
// 							vsConfig->m_vCameraParam.at(it/2).m_nRawHeight*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2);
// 						strInfo += strTemp;
// 					}
// 
// 				}
...
// 				{
// 					strTemp.Format(_T("............最大图像误差对应目标点坐标: X: %.2f; Y:%.2f;\n"),m_pVisionASM->GetAllCalibratedInfo().at(it)->GetMarkPlatformCoordPosRefineOffset().GetAuxiliaryPosX(0),
// 						m_pVisionASM->GetAllCalibratedInfo().at(it)->GetMarkPlatformCoordPosRefineOffset().GetAuxiliaryPosY(0));
// 					strInfo += strTemp;
// 					strTemp.Format(_T("............最大图像误差对应对象点坐标: X: %.2f; Y:%.2f;\n"),m_pVisionASM->GetAllCalibratedInfo().at(it)->GetMarkPlatformCoordPosRefineOffset().GetAuxiliaryPosX(1),
// 						m_pVisionASM->GetAllCalibratedInfo().at(it)->GetMarkPlatformCoordPosRefineOffset().GetAuxiliaryPosY(1));
// 					strInfo += strTemp;
// 					strTemp.Format(_T("............最大图像误差值: %.2f;\n"),m_pVisionASM->GetAllCalibratedInfo().at(it)->GetMarkPlatformCoordPosRefineOffset().GetPosX());
// 					strInfo += strTemp;
// 
// 				}
// 			}
...
// 				strTemp.Format(_T("......位置%d:\n"),i+1);
// 				strInfo += strTemp;
// 				vpAllCalibratedInfo.at(i)->GetPlatformTransferH(h);
// 				strTemp.Format(_T("............转换矩阵: h0: %.5f; h1: %.5f; h2: %.5f; h3: %.5f; h4: %.5f; h5: %.5f; h6: %.5f; h7: %.5f; h8: %.5f;\n"),
// 					h[0],h[1],h[2],h[3],h[4],h[5],h[6],h[7],h[8]);
// 				strInfo += strTemp;
// 
...
// 				strTemp.Format(_T("............轴夹角: %.2f;\n"),((atan2(h[0],h[1]))+(atan2(h[4],-h[3])))/2);
// 				strInfo += strTemp;
// 				strTemp.Format(_T("............基准mark平台坐标: X: %.2f; Y: %.2f;\n"),vpAllCalibratedInfo.at(i)->GetMarkPlatformCoordPos().GetPosX(),
// 					vpAllCalibratedInfo.at(i)->GetMarkPlatformCoordPos().GetPosY());
// 				strInfo += strTemp;
// 				strTemp.Format(_T("............基准mark图像坐标: X: %.2f; Y: %.2f;\n"),vpAllCalibratedInfo.at(i)->GetMarkImgCoordPos().GetPosX(),
// 					vpAllCalibratedInfo.at(i)->GetMarkImgCoordPos().GetPosY());
// 				strInfo += strTemp;
// 
// 				{
// 					CVisionASMConfig *vsConfig;
...
// 					else if (((platformInfo.m_nCamNum==4)&&(platformInfo.m_nPositionNum==4))||((platformInfo.m_nCamNum==8)&&(platformInfo.m_nPositionNum==8)))
// 					{
// 						strTemp.Format(_T("............视野: X: %.2f * Y: %.2f;\n"),vsConfig->m_vCameraParam.at(i).m_nRawWidth*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2,
// 							vsConfig->m_vCameraParam.at(i).m_nRawHeight*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2);
// 						strInfo += strTemp;
// 					}
// 					else if ((platformInfo.m_nCamNum==4)&&(platformInfo.m_nPositionNum==8))
// 					{
// 						strTemp.Format(_T("............视野: X: %.2f * Y: %.2f;\n"),vsConfig->m_vCameraParam.at(i/2).m_nRawWidth*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2,
// 							vsConfig->m_vCameraParam.at(i/2).m_nRawHeight*((sqrt(h[0]*h[0]+h[1]*h[1]))+(sqrt(h[3]*h[3]+h[4]*h[4])))/2);
// 						strInfo += strTemp;
// 					}
// 
// 				}
// 				if (m_pVisionASM->GetCalibTargetMarkPatternMode()== eDmCodeCalib)
// 				{
// 					strTemp.Format(_T("............最大图像误差对应目标点坐标: X: %.2f; Y:%.2f;\n"),m_pVisionASM->GetAllCalibratedInfo().at(i)->GetMarkPlatformCoordPosRefineOffset().GetAuxiliaryPosX(0),
// 						m_pVisionASM->GetAllCalibratedInfo().at(i)->GetMarkPlatformCoordPosRefineOffset().GetAuxiliaryPosY(0));
// 					strInfo += strTemp;
// 					strTemp.Format(_T("............最大图像误差对应对象点坐标: X: %.2f; Y:%.2f;\n"),m_pVisionASM->GetAllCalibratedInfo().at(i)->GetMarkPlatformCoordPosRefineOffset().GetAuxiliaryPosX(1),
// 						m_pVisionASM->GetAllCalibratedInfo().at(i)->GetMarkPlatformCoordPosRefineOffset().GetAuxiliaryPosY(1));
// 					strInfo += strTemp;
// 					strTemp.Format(_T("............最大图像误差值: %.2f;\n"),m_pVisionASM->GetAllCalibratedInfo().at(i)->GetMarkPlatformCoordPosRefineOffset().GetPosX());
// 					strInfo += strTemp;
// 
// 				}
// 			}
// 		}
// 
// 		m_pVisionASM->VisionAlignLogRecord(strCorrelationLogPath,strInfo,FALSE);
// 
// 
// 		////GYM
			...
			&&*/ optionInfo.m_bSaveCalibData)
		{
			if (m_bIsDmCodeSearch)
			{
				...
				for (int i=0;i<m_pVisionASM->m_vDmCodeCalibTool.size();i++)
				{
					...
					//2.保存角点
					std::vector<sc2Vector> vCornersImagePos = m_pVisionASM->m_vDmCodeCalibTool.at(i).m_vImgDecodecornersResult;
...
//获得关联结果
bool CDlgCalibTargetPos8::GetCalibResultCString(CString & strCalibResult)
{
...
// 保存CVS 文件
bool CDlgCalibTargetPos8::SaveCSVFile(CString strImageFileDirt,CString strName,CString& strSaveData )
{
	SYSTEMTIME sys;
	GetLocalTime(&sys);
	CString strFileName;
	...
	if(!bRes)//绘制表头
	{
		file.WriteString(_T("关联时间,位置,h0,h1,h2,h3,h4,h5,h6,h7,h8\n"));
	}
...
// 保存畸变校正前的图片
void CDlgCalibTargetPos8::SaveCalibSearchImage(CString strImageFileDirt,CString strImageName,cpImage & imageSave)
{
...
*/
/************************************************************************/
bool CDlgCalibTargetPos8::CreateMultipleDirectory(CString& szPath, char split)
{
...
void CDlgCalibTargetPos8::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
UINT CDlgCalibTargetPos8::ThreadReceiveData( LPVOID pParam )
{
	CDlgCalibTargetPos8 *pOwner = (CDlgCalibTargetPos8*)pParam;
	CString strReceived;
	while (!pOwner->m_bExitThread)
	{
		...
		else if (pOwner->m_nEvent == 6) // 获取平台轴位置
		{
			pOwner->m_nEvent = 0;
			pOwner->CommGetPlatformAxisPos2();
		}
		else if (pOwner->m_nEvent == 7) // 获取平台轴位置
		{
			pOwner->m_nEvent = 0;
			pOwner->CommSendTargetImagePos();
		}
		else if (pOwner->m_nEvent == 8) // 获取平台轴位置
		{
			pOwner->m_nEvent = 0;
			pOwner->CommGetTargetImagePos();
		}
...
void CDlgCalibTargetPos8::SearchObjectPos(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibTargetPos8::SearchObjectPos1(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibTargetPos8::SearchTargetPos(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibTargetPos8::SearchTargetPos1(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibTargetPos8::CommGetPlatformAxisPos()
{
	m_bCommGetPlatformAxisPosSuccess = FALSE;
	if (m_pVisionASM == NULL)
	{
...
void CDlgCalibTargetPos8::CommGetPlatformAxisPos2()
{
	m_bCommGetPlatformAxisPosSuccess2 = FALSE;
	if (m_pVisionASM == NULL)
	{
	...
	// 通信获取平台轴位置
	m_bCommGetPlatformAxisPosSuccess2 = m_pVisionASM->GetCalibAlignerTargetPlatformAxisPos(1);
}


void CDlgCalibTargetPos8::UpdateDialogLanguage()
{
	//	return;
	LANGID lgidLanguage = MAKELANGID(LANG_CHINESE, SUBLANG_CHINESE_SIMPLIFIED);
	if (m_psaSysInfoStrings != NULL)
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_CALIB_TARGET_POS8") == strDlgID)
		{
			int nID;
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchObject2MovePos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchObject3MovePos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchObject2MovePos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 3;
	m_nEvent =3; // 对象移动位置1
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchObject3MovePos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 4;
	m_nEvent = 3; // 对象移动位置1
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject2MovePos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 3;
	m_nEvent = 2; // 对象移动位置1
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject3MovePos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 4;
	m_nEvent = 2; // 对象移动位置1
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject2MovePos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 3;
	m_nEvent = 4; // 对象移动位置1
...
void CDlgCalibTargetPos8::OnBnClickedBtnSearchVirtualObject3MovePos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 4;
	m_nEvent = 4; // 对象移动位置1
...
void CDlgCalibTargetPos8::OnBnClickedRadioCalibTargetPos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibTargetPos8::OnBnClickedBtnLoadLastCalibmark()
{
    // TODO: 在此添加控件通知处理程序代码
    // 是否存在上次关联标定图像坐标
    vector<CMarkImagePos*> tmpCalibMarkImagPos =  m_pVisionASM->GetCalibMarkImagPos();
...
void CDlgCalibTargetPos8::UpdateMarkImageShow(int nPosIndex,int nMovePosIndex)
{
    SysPlatformInfo sysPlatformInfo;
    m_pVisionASM->GetSysPlatformInfo(sysPlatformInfo);
...
void CDlgCalibTargetPos8::OnBnClickedBtnSetDmcodeParam()
{
    // TODO: 在此添加控件通知处理程序代码
	CTotalProductData *pTotalProductData;
	pTotalProductData = m_pVisionASM->GetTotalProuductData();
...
BOOL CDlgCalibTargetPos8::DmCodeSearch(int nPosIndex)
{
    if (m_pVisionASM == NULL)
    {
        return FALSE;
...
void CDlgCalibTargetPos8::CommSendTargetImagePos()
{
...
void CDlgCalibTargetPos8::OnBnClickedBtnSendTargetImagePos()
{
	m_nEvent = 7;
...
void CDlgCalibTargetPos8::CommGetTargetImagePos()
{
	std::vector<int> vnPosIndex;
...
void CDlgCalibTargetPos8::OnBnClickedBtnGetTarImagePos()
{
	m_nEvent = 8;
	// TODO: 在此添加控件通知处理程序代码
// 	std::vector<int> vnPosIndex;
...
void CDlgCalibTargetPos8::OnCbnSelchangeComboExproductIndex()
{
...
void CDlgCalibTargetPos8::RecordCalibTargetVisionAlign()
{
	CVisionASMConfig *vsConfig;
	m_pVisionASM->GetVSconfig(vsConfig);
...
void CDlgCalibTargetPos8::RecordCalibTargetAlignToolData(int nCamIndex,int nBaseCamIndex,
...
void CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter1()
{
	SetCalibTargetShutter(0);
}

void CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter2()
{
	SetCalibTargetShutter(1);
}


void CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter3()
{
	SetCalibTargetShutter(2);
}

void CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter4()
{
	SetCalibTargetShutter(3);
}

void CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter5()
{
	SetCalibTargetShutter(4);
}

void CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter6()
{
	SetCalibTargetShutter(5);
}


void CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter7()
{
	SetCalibTargetShutter(6);
}

void CDlgCalibTargetPos8::OnBnClickedSetCalibTargetShutter8()
{
	SetCalibTargetShutter(7);
}

void CDlgCalibTargetPos8::ResetCameraShutter()
{
	if(m_pVisionASM)
	{
		for(int nPos=0;nPos<8 && nPos<m_pVisionASM->GetPosNum();nPos++)
...
void CDlgCalibTargetPos8::SetCalibTargetShutter(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
void CDlgCalibTargetPos8::CallDlgSearch(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
void CDlgCalibTargetPos8::SetCalibTargetSearchTool(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
LRESULT CDlgCalibTargetPos8::OnGuiDisplayDblClk(WPARAM wParam, LPARAM lParam)
{
