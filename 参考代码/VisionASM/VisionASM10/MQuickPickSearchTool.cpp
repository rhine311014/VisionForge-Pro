// MQuickSearchTool.cpp: implementation of the CMQuickSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
CMQuickPickSearchTool::CMQuickPickSearchTool()
{
	m_pGuiDisplay							= NULL;
	m_hDispWnd                              = NULL;
...
CMQuickPickSearchTool::CMQuickPickSearchTool(CMQuickPickSearchTool &cMQuickPickSearchTool)
{
	if (cMQuickPickSearchTool.GetSearchToolType() != eMQuickPickSearchTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cMQuickPickSearchTool.m_CamHeight;
	m_CamWidth								= cMQuickPickSearchTool.m_CamWidth;


	m_TrainDataParam						= cMQuickPickSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cMQuickPickSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cMQuickPickSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cMQuickPickSearchTool.m_SearchGuiParam;
	m_TrainResult                           = cMQuickPickSearchTool.m_TrainResult;
	m_ImageTrain							= cMQuickPickSearchTool.m_ImageTrain;
	m_ImageMask								= cMQuickPickSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cMQuickPickSearchTool.m_bTrainGuiShow;
	m_bSearchResultGuiShow					= cMQuickPickSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cMQuickPickSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cMQuickPickSearchTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cMQuickPickSearchTool.UpdateSearchGuiData(true);
	cMQuickPickSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cMQuickPickSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cMQuickPickSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cMQuickPickSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cMQuickPickSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cMQuickPickSearchTool.m_tmpImageTrain);
	SetMaskImage(cMQuickPickSearchTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CMQuickPickSearchTool& CMQuickPickSearchTool::operator=(CMQuickPickSearchTool& cMQuickPickSearchTool)
{
	if (this == &cMQuickPickSearchTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CMQuickPickSearchTool::GetSearchToolType()
{
	return eMQuickPickSearchTool;
}										   

// 设置显示控件指针		
bool CMQuickPickSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CMQuickPickSearchTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CMQuickPickSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CMQuickPickSearchTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CMQuickPickSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CMQuickPickSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CMQuickPickSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CMQuickPickSearchTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CMQuickPickSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CMQuickPickSearchTool::UpdateTrainGuiDisplay()
{
...
// 更新搜索界面显示									
bool CMQuickPickSearchTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
bool CMQuickPickSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CMQuickPickSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eMQuickPickSearchTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CMQuickPickSearchTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CMQuickPickSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CMQuickPickSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CMQuickPickSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eMQuickPickSearchTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CMQuickPickSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CMQuickPickSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CMQuickPickSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CMQuickPickSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CMQuickPickSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CMQuickPickSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CMQuickPickSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CMQuickPickSearchTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CMQuickPickSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CMQuickPickSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eMQuickPickSearchTool)
	{
		return false;
	}
	
	*((CMQuickPickSearchTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}						

// 是否训练成功
bool CMQuickPickSearchTool::IsTrained()
{
	return m_bTrainOK;
}															
			
// 设置搜索Data参数	
bool CMQuickPickSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eMQuickPickSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CMQuickPickSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CMQuickPickSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CMQuickPickSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CMQuickPickSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eMQuickPickSearchTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CMQuickPickSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CMQuickPickSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CMQuickPickSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CMQuickPickSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
	...
	if (bRet)
	{
		...
		for (int i=0,j=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			CString st;
			st.Format(_T("%d  S:%.2f"),i,tmpQuickResult.GetScore());
			...
			if(PointInRect(center,m_tmpTrainGuiParam.m_Hand1SearchRect)&&!hand1flag)
			{
				...
				if (bflag)
				{
					...
					searchResultHand1.m_dPosX = tmpQuickResult.GetPosition().GetX();
					searchResultHand1.m_dPosY = tmpQuickResult.GetPosition().GetY();
					searchResultHand1.m_dAngle = tmpQuickResult.GetRotate().ToDouble();
					searchResultHand1.m_dScore = tmpQuickResult.GetScore();
					...
					CString st;
					st.Format(_T("hand1 p0   X:%.1f;Y:%.1f;D:%.3f;S:%.2f"), tmpQuickResult.GetPosition().GetX(), tmpQuickResult.GetPosition().GetY(), tmpQuickResult.GetRotate().ToDouble(),tmpQuickResult.GetScore());
					pTempCross->SetLabel(st);
					pTempCross->SetLabelVisible(TRUE);
			...
			if(PointInRect(center,m_tmpTrainGuiParam.m_Hand2SearchRect)&&!hand2flag)
			{
				...
				if (bflag)
				{
					...
					searchResultHand2.m_dPosX = tmpQuickResult.GetPosition().GetX();
					searchResultHand2.m_dPosY = tmpQuickResult.GetPosition().GetY();
					searchResultHand2.m_dAngle = tmpQuickResult.GetRotate().ToDouble();
					searchResultHand2.m_dScore = tmpQuickResult.GetScore();
					...
					CString st;
					st.Format(_T("hand2  p0  X:%.1f;Y:%.1f;D:%.3f;S:%.2f"), tmpQuickResult.GetPosition().GetX(), tmpQuickResult.GetPosition().GetY(), tmpQuickResult.GetRotate().ToDouble(),tmpQuickResult.GetScore());
					pTempCross->SetLabel(st);
					pTempCross->SetLabelVisible(TRUE);
...
// 获取搜索结果个数										
int CMQuickPickSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CMQuickPickSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像文件
bool CMQuickPickSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eMQuickPickSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CMQuickPickSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CMQuickPickSearchTrainDataParam tmpTrainDataParam;
	CMQuickPickSearchTrainGuiParam tmpTrainGuiParam;
	CMQuickPickSearchSearchDataParam tmpSearchDataParam;
	CMQuickPickSearchSearchGuiParam tmpSearchGuiParam;
	CMQuickPickSearchTrainResult    tmpTrainResult;
...
// 保存模板文件							
bool CMQuickPickSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CMQuickPickSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CMQuickPickSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CMQuickPickSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CMQuickPickSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CMQuickPickSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CMQuickPickSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CMQuickPickSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CMQuickPickSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CMQuickPickSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CMQuickPickSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CMQuickPickSearchTool::RestoreSearchParam()
{
...
void CMQuickPickSearchTool::SetLanguage(int nLanguage)
{
...
CString	CMQuickPickSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
...
BOOL	CMQuickPickSearchTool::PointInRect(sc2Vector point,scRect rect)
{
