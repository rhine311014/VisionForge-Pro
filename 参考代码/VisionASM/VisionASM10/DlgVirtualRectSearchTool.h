...
// CDlgVirtualVirtualRectSearchTool 对话框
class CDlgSearch;
class CDlgVirtualRectSearchTool : public CDialog
{
	// Construction
public:
	CDlgVirtualRectSearchTool(CWnd* pParent = NULL);   // standard constructor
	...
	// Dialog Data
	//{{AFX_DATA(CDlgVirtualRectSearchTool)
	enum { IDD = IDD_DLG_VIRTUALRECTSEARCH_TOOL };
	...
	//{{AFX_VIRTUAL(CDlgVirtualRectSearchTool)
public:
...
protected:
	...
	//{{AFX_MSG(CDlgVirtualRectSearchTool)
