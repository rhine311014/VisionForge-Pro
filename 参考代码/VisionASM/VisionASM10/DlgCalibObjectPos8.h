...
class CDlgCalibObjectPos8 : public CDialog
{
	DECLARE_DYNAMIC(CDlgCalibObjectPos8)

public:
	CDlgCalibObjectPos8(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgCalibObjectPos8();

// 对话框数据
	enum { IDD = IDD_DLG_CALIB_OBJECT_POS8 };
