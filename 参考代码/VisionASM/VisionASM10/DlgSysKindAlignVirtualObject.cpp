// DlgSysKindAlignVirtualObject.cpp : 实现文件
//
...
// CDlgSysKindAlignVirtualObject 对话框

IMPLEMENT_DYNAMIC(CDlgSysKindAlignVirtualObject, CDialog)

	CDlgSysKindAlignVirtualObject::CDlgSysKindAlignVirtualObject(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgSysKindAlignVirtualObject::IDD, pParent)
...
{
	//{{AFX_DATA_INIT(CDlgSysKindAlignVirtualObject)
...
CDlgSysKindAlignVirtualObject::~CDlgSysKindAlignVirtualObject()
{
	DestroyWindow();
}

void CDlgSysKindAlignVirtualObject::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgSysKindAlignVirtualObject)
	...
	DDX_Check(pDX, IDC_CHECK_ALIGNER_TARGETC_GAIN_ENABLE, m_bObjectGainEnable0);
	DDX_Check(pDX, IDC_CHECK_ALIGNER_TARGETC_GAMMA_ENABLE, m_bObjectGammaEnable0);

}


BEGIN_MESSAGE_MAP(CDlgSysKindAlignVirtualObject, CDialog)
	//{{AFX_MSG_MAP(CDlgSysKindAlignVirtualObject)
	...
	//}}AFX_MSG_MAP
	ON_WM_SIZE()
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB0, &CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib0)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB1, &CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib1)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB2, &CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib2)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB3, &CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib3)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB4, &CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib4)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB5, &CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib5)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB6, &CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib6)
	ON_BN_CLICKED(IDC_BTN_COPY_OBJECT_TO_CALIB7, &CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib7)

	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE1, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE2, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE3, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_SHUTTER_ENABLE4, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcShutterEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAIN_ENABLE, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcGainEnable)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_GAMMA_ENABLE, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcGammaEnable)

	ON_BN_CLICKED(IDC_RADIO_VIRTUAL_OBJECTC_SEARCH_MODE0, &CDlgSysKindAlignVirtualObject::OnBnClickedRadioVirtualObjectcSearchMode0)
	ON_BN_CLICKED(IDC_RADIO_VIRTUAL_OBJECTC_SEARCH_MODE1, &CDlgSysKindAlignVirtualObject::OnBnClickedRadioVirtualObjectcSearchMode0)
	ON_BN_CLICKED(IDC_RADIO_OBJECTC_SEARCH_MODE0, &CDlgSysKindAlignVirtualObject::OnBnClickedRadioObjectcSearchMode0)
	ON_BN_CLICKED(IDC_RADIO_OBJECTC_SEARCH_MODE1, &CDlgSysKindAlignVirtualObject::OnBnClickedRadioObjectcSearchMode0)
	ON_BN_CLICKED(IDC_RADIO_OBJECTC_SEARCH_SYNC0, &CDlgSysKindAlignVirtualObject::OnBnClickedRadioObjectcSearchSync0)
	ON_BN_CLICKED(IDC_RADIO_OBJECTC_SEARCH_SYNC1, &CDlgSysKindAlignVirtualObject::OnBnClickedRadioObjectcSearchSync0)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE1, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcOffsetEnable1)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE2, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcOffsetEnable2)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE3, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcOffsetEnable3)
	ON_BN_CLICKED(IDC_CHECK_ALIGNER_OBJECTC_OFFSET_ENABLE4, &CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcOffsetEnable4)

END_MESSAGE_MAP()


// CDlgSysKindAlignVirtualObject 消息处理程序


BOOL CDlgSysKindAlignVirtualObject::OnInitDialog()
{
...
void CDlgSysKindAlignVirtualObject::InitDlgItem()
{
	int i = 0, j = 0;
...
//	nPosNum = (nPosNum == 1) ? platformInfo.m_nPositionNum : platformInfo.m_nCamNum;
	...
	if (platformInfo.m_eAlignerObjectType == eObjectVirtual)
	{
		...
		GetDlgItem(IDC_STATIC_VIRTUAL_OBJECTC_SEARCH_MODE)->EnableWindow(m_pParentKind->m_bEnableVirtualObjectTemplateSet);
		GetDlgItem(IDC_RADIO_VIRTUAL_OBJECTC_SEARCH_MODE0)->EnableWindow(m_pParentKind->m_bEnableVirtualObjectTemplateSet);
		GetDlgItem(IDC_RADIO_VIRTUAL_OBJECTC_SEARCH_MODE1)->EnableWindow(m_pParentKind->m_bEnableVirtualObjectTemplateSet);
		...
		for (i=0; i<MAXPOSNUM; i++)
		{
			...
			{
				// 				GetDlgItem(IDC_STATIC_OBJECT_DISPLAY0+i*2)->ShowWindow(SW_SHOW);
				GetDlgItem(IDC_STATIC_OBJECT_PATTERN0+i*2)->ShowWindow(m_pParentKind->m_bShowVirtualObjectTemplateSet);
				//				m_vpObjectGuiDisplay.at(i)->ShowWindow(SW_SHOW);

				if (i < MAXPOSNUM -1)
				{
					GetDlgItem(IDC_STATIC_SEPARATOR3+ i)->ShowWindow(m_pParentKind->m_bShowVirtualObjectTemplateSet);
				}
				m_vpLabelPos.at(i)->SetBkColor(RGB(0,255,0));
				m_vpLabelPos.at(i)->ShowWindow(m_pParentKind->m_bShowVirtualObjectTemplateSet);
				m_vpBtnCopyObjectToCalib.at(i)->ShowWindow(m_pParentKind->m_bShowVirtualObjectTemplateSet);
				...
				{
					//GetDlgItem(IDC_STATIC_OBJECTC_PATTERN0+i*OBJECTCANDIDATENUM+j)->ShowWindow(SW_SHOW);
					m_vvpObjectGuiDisplay[i][j]->ShowWindow(m_pParentKind->m_bShowVirtualObjectTemplateSet);
				}
			}
			else
			{
...
void CDlgSysKindAlignVirtualObject::EnableAndShowControl(bool bEnable,bool bShow)
{
	bool bShowTemplateSet = false;
	bool bEnableTemplateSet = false;
	if(NULL != m_pParentKind)
	{
		bShowTemplateSet = m_pParentKind->m_bShowVirtualObjectTemplateSet;
		bEnableTemplateSet = m_pParentKind->m_bEnableVirtualObjectTemplateSet;
	}
...
void CDlgSysKindAlignVirtualObject::MoveDlgItem()
{
...
void CDlgSysKindAlignVirtualObject::CheckDlgData()
{
	UpdateData(TRUE);
...
void CDlgSysKindAlignVirtualObject::UpdateDlgData( BOOL bSaveAndValidate /*= TRUE*/ )
{
	...
	if (bSaveAndValidate)
	{
		...
		product.m_pAlignerParam->SetEnableVirtualObjectSearchShutter(0, cameraParamEnable);
...
// 		product.m_pAlignerParam->SetObjectCandidateOffsetEnable(i, m_bObjectCandidateOffsetEnable4);
	...
	else
	{
		...
		m_bObjectShutterEnable0 = product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(0).m_bShutterEnable;
		m_bObjectGainEnable0 = product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(0).m_bGainEnable;
		m_bObjectGammaEnable0 = product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(0).m_bGammaEnable;
...
// 		}
		...
		if (product.m_pAlignerParam->GetObjectMarkType() == eObjectVirtual)
		{
			CBaseSearchTool* pObjSearchTool = NULL;
			cpImage image;
			for (i=0; i<product.m_pAlignerParam->GetObjectMarkPatternNum()/*GetVirtualObjectMarkPatternNum()*/; i++)
			{
				// 				pObjSearchTool = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->GetAlnObjectSearchToolParam(i);
				// 				if (pObjSearchTool != NULL)
				// 				{
...
void CDlgSysKindAlignVirtualObject::GetDlgTempData(CProductData& product)
{

	UpdateData(TRUE);
	product.m_pAlignerParam->SetVirtualObjectMarkEnable(m_nVirtualObjectCandidateEnable);

	//product.m_pAlignerParam->SetEnableVirtualObjectSearchShutter(0, m_bObjectShutterEnable0);
	CameraParamEnable cameraParamEnable;
	cameraParamEnable.m_bShutterEnable = m_bObjectShutterEnable0;
	cameraParamEnable.m_bGainEnable = m_bObjectGainEnable0;
	cameraParamEnable.m_bGammaEnable = m_bObjectGammaEnable0;
...
void CDlgSysKindAlignVirtualObject::UpdateStatusBar()
{
...
void CDlgSysKindAlignVirtualObject::UpdateProductListDisplay()
{
...
void CDlgSysKindAlignVirtualObject::UpdateDialogLanguage()
{
//	return;
	LANGID lgidLanguage = MAKELANGID(LANG_CHINESE, SUBLANG_CHINESE_SIMPLIFIED);
	if (m_psaSysInfoStrings != NULL)
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_SYS_KIND_ALIGN_VIRTUAL_OBJECT") == strDlgID)
		{
			int nID;
...
CString CDlgSysKindAlignVirtualObject::GetNewDefName()
{
...
BOOL CDlgSysKindAlignVirtualObject::IsNameUnique( LPCTSTR lpszName )
{
	// 	CTotalProductData *pTotalProduct = m_vpTotalProductData.at(m_nPlatformIndex);
	// 	int nProductNum = pTotalProduct->GetCount();
...
BOOL CDlgSysKindAlignVirtualObject::IsNameLegal( LPCTSTR lpszName )
{
	CString strName = lpszName;
	if (strName.IsEmpty())
	{
...
BOOL CDlgSysKindAlignVirtualObject::IsCalibratedInfosEqual( std::vector<CCalibratedInfo*> vpCalibratedInfo1, std::vector<CCalibratedInfo*> vpCalibratedInfo2 )
{
...
BOOL CDlgSysKindAlignVirtualObject::IsProductChanged()
{
	...
	if (m_bObjectShutterEnable0 != product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(0).m_bShutterEnable
		|| m_bObjectGainEnable0 != product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(0).m_bGainEnable
		|| m_bObjectGammaEnable0 != product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(0).m_bGammaEnable)
...
BOOL CDlgSysKindAlignVirtualObject::IsSearchToolSelected(CBaseSearchTool* pSearchTool)
{
	//UpdateData(TRUE);
	BOOL bExistSearchTool =TRUE;
...
BOOL CDlgSysKindAlignVirtualObject::IsStringNumerical( LPCTSTR lpszVal )
{
...
BOOL CDlgSysKindAlignVirtualObject::CreateDirectoryPro( LPCTSTR lpszDir )
{
...
BOOL CDlgSysKindAlignVirtualObject::ClearDirectoryPro( LPCTSTR lpszDir )
{
	CFileFind fileFind; 
	CString strDir(lpszDir);
...
BOOL CDlgSysKindAlignVirtualObject::RemoveDirectoryPro( LPCTSTR lpszDir )
{
	DWORD dwAttributes = GetFileAttributes(lpszDir);
	if ((dwAttributes == 0xFFFFFFFF) || ((dwAttributes & FILE_ATTRIBUTE_DIRECTORY) == 0))
	{
...
BOOL CDlgSysKindAlignVirtualObject::RenameDirecotryPro( LPCTSTR lpszOldDir, LPCTSTR lpszNewDir )
{
...
// 保存前一个产品的设置
BOOL CDlgSysKindAlignVirtualObject::SavePrevProduct()
{
	BOOL bSucceed = TRUE;
	UpdateData(TRUE);
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
...
void CDlgSysKindAlignVirtualObject::OnButtonNewProduct()
{
...
void CDlgSysKindAlignVirtualObject::OnBtnCloneProduct() 
{
...
void CDlgSysKindAlignVirtualObject::OnButtonDeleteCurProduct() 
{
	// 	// 用户删除操作确认
...
void CDlgSysKindAlignVirtualObject::OnBtnProductRename()
{
...
void CDlgSysKindAlignVirtualObject::OnBtnAmendBenchmark() 
{
...
// 自定义菜单响应
LRESULT CDlgSysKindAlignVirtualObject::OnGuiDisplayMenuCustom1(WPARAM wParam, LPARAM lParam)
{
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
	m_nPlatformIndex = pView->m_nPlatformIndex;
	...
	for (i=0; i<nPatternNum; i++)
	{
		for (j=0; j < OBJECTCANDIDATENUM; j++)
		{
			if (wParam == m_vvpObjectGuiDisplay[i][j]->GetID())
			{
				...
				CameraParamEnable cameraParamEnable;
				cameraParamEnable =  product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(j);
				CPlatformOptionInfo optionInfo;
				if (m_pParent && m_pParent->m_vpVisionASM.at(m_nPlatformIndex))
				{
					m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->GetPlatformOptionInfo(optionInfo);
				...
				if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable) && bSystemOptionShutter)
				{
					...
					product.m_pAlignerParam->SetVirtualObjectSearchShutter(i,j, tmpameraParamSet);
					pTotalProduct->SetItem(nCurProdIdx, product);
				}
				...
				m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->DeleteRepoAlnVirtualObjectSearchTool(nCurProdIdx,i, j);
				m_vvpObjectGuiDisplay[i][j]->ClearScreen();

				// 标记产品模板已修改
				m_bProdPatternChanged = TRUE;
				// 标记指定位置虚拟模板已经被修改了
				m_pParentKind->m_vvbAlnVirtualObjectSearchToolChanged[i][j] = TRUE;
				return S_OK;
			}
		}
	}
...
LRESULT CDlgSysKindAlignVirtualObject::OnGuiDisplayMenuCustom2(WPARAM wParam, LPARAM lParam)
{
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
	m_nPlatformIndex = pView->m_nPlatformIndex;
	if (pView->m_vpTotalProductData.at(m_nPlatformIndex)->GetCount() <= 0)
	...
	for (i=0; i<nPatternNum; i++)
	{
		for (j=0; j < VIRTUALOBJECTCANDIDATENUM; j++)
		{
			if (wParam == m_vvpObjectGuiDisplay[i][j]->GetID())
			{
				...
				dlgSearchToolCopyPos.m_nPosCNum = VIRTUALOBJECTCANDIDATENUM;
				...
				if (dlgSearchToolCopyPos.DoModal() == IDOK)
				{
					...
					for (k = 0; k < MAXPOSNUM && k < dlgSearchToolCopyPos.m_vbCopyPos.size(); k++)
					{
						if (dlgSearchToolCopyPos.m_vbCopyPos.at(k) == TRUE && ((k != i)||(nDstCandidateIndex != j)))
						{
							...
							{
								CameraParamEnable cameraParamEnable;
								cameraParamEnable = product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(nDstCandidateIndex);
								BOOL bSystemOptionShutter = optionInfo.m_bEnableSearchShutter;

								if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable) && bSystemOptionShutter)
								{
									CameraParamSet tmpameraParamSet;
									product.m_pAlignerParam->SetVirtualObjectSearchShutter(k,nDstCandidateIndex, tmpameraParamSet);
									pTotalProduct->SetItem(nCurProdIdx, product);
								}
								CBaseSearchTool *pSearchToolDst = NULL;
								pSearchToolDst = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->GetRepoAlnVirtualObjectSearchTool(nCurProdIdx,k,nDstCandidateIndex);
								if (pSearchToolDst == NULL)
								{
									continue;
								}

								m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->DeleteRepoAlnVirtualObjectSearchTool(nCurProdIdx,k,nDstCandidateIndex);
							...
							else
							{
								...
								if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable) && bSystemOptionShutter)
								{
									product.m_pAlignerParam->SetVirtualObjectSearchShutter(k,nDstCandidateIndex, product.m_pAlignerParam->GetVirtualObjectSearchShutter(i,j));
									pTotalProduct->SetItem(nCurProdIdx, product);
								}
								...
								m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->SetRepoAlnVirtualObjectSearchTool(nCurProdIdx, k, nDstCandidateIndex, pSearchTool);
							...
							// 标记指定位置虚拟模板已经被修改了
							m_pParentKind->m_vvbAlnVirtualObjectSearchToolChanged[k][nDstCandidateIndex] = TRUE;
							///////////////////////////////////////////////////////////////////////
							
							strLog.Format(_T("将位置%d候选%d许你对象模板复制到位置%d候选%d\n"),i+1,j,k+1,nDstCandidateIndex);
...
LRESULT CDlgSysKindAlignVirtualObject::OnGuiDisplayMenuCustom3(WPARAM wParam, LPARAM lParam)
{
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
	m_nPlatformIndex = pView->m_nPlatformIndex;
	if (pView->m_vpTotalProductData.at(m_nPlatformIndex)->GetCount() <= 0)
	...
	for (i=0; i<nPatternNum; i++)
	{
		for (j=0; j < VIRTUALOBJECTCANDIDATENUM; j++)
		{
			if (wParam == m_vvpObjectGuiDisplay[i][j]->GetID())
			{
				...
				dlgSearchToolModelLibrary.m_nSearchModeFrom = eVirtualSearch;
				...
				if (dlgSearchToolModelLibrary.DoModal() == IDOK)
				{
					...
					if(1)
					{
						if (m_pParent && m_nPlatformIndex<m_pParent->m_vpVisionASM.size() && m_pParent->m_vpVisionASM.at(m_nPlatformIndex))
						{
							if (m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->m_pSystemStatusInfo!=NULL)
							{
								...
								pSearchToolDstTmp = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->GetRepoAlnVirtualObjectSearchTool(nCurProdIdx,i,j);
					...
					bool bRet = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->SetRepoAlnVirtualObjectSearchTool(nCurProdIdx,i,j,pSearchTool);
					if(!bRet)
					{
						return S_FALSE;
					}
...
// 双击Display控件响应
LRESULT CDlgSysKindAlignVirtualObject::OnGuiDisplayDblClk(WPARAM wParam, LPARAM lParam)
{
	CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;;
	m_nPlatformIndex = pView->m_nPlatformIndex;
	if (pView->m_vpTotalProductData.at(m_nPlatformIndex)->GetCount() <= 0)
		...
		for (i=0; i<nPatternNum; i++)
		{
			for (j=0; j < OBJECTCANDIDATENUM; j++)
			{
				if (wParam == m_vvpObjectGuiDisplay[i][j]->GetID())
				{
					...
					if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable) && bSystemOptionShutter)
					{
						dlgSearch.SetProductSearchShutterInfo(product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(j) ,product.m_pAlignerParam->GetVirtualObjectSearchShutter(i,j));
					}
					...
					if (dlgSearch.DoModal() == IDOK)
					{
						if ((cameraParamEnable.m_bShutterEnable || cameraParamEnable.m_bGainEnable || cameraParamEnable.m_bGammaEnable)  && bSystemOptionShutter)
						{
							product.m_pAlignerParam->SetVirtualObjectSearchShutter(i,j, dlgSearch.GetProductSearchShutterInfoShutter());
							pTotalProduct->SetItem(nCurProdIdx, product);
						}
...
// 						CProductData product = pTotalProduct->GetItem(nCurProdIdx);
// 
// 						BOOL bSearchShutter = product.m_pAlignerParam->GetEnableVirtualObjectSearchShutter(j);
// 						BOOL bSystemOptionShutter = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->m_pSystempOptionConfig->m_bEnableSearchShutter;
// 
...
void CDlgSysKindAlignVirtualObject::OnPlatformChange() 
{
	UpdateData(TRUE);
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditAlignerMaxTimes() 
{
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditAlignerXPrecision() 
{
	// 	if (m_bSysKeyboardEnabled)
	// 	{
	// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditAlignerYPrecision() 
{
	// 	if (m_bSysKeyboardEnabled)
	// 	{
	// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditAlignerDPrecision() 
{
	// 	if (m_bSysKeyboardEnabled)
	// 	{
	// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditAlignerXOffset() 
{
	// 	if (m_bSysKeyboardEnabled)
	// 	{
	// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditAlignerYOffset() 
{
	// 	if (m_bSysKeyboardEnabled)
	// 	{
	// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditAlignerDOffset() 
{
	// 	if (m_bSysKeyboardEnabled)
	// 	{
	// 		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateXOffset1() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateYOffset1() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateDOffset1() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateXOffset2() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateYOffset2() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateDOffset2() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateXOffset3() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateYOffset3() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateDOffset3() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateXOffset4() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateYOffset4() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnSetfocusEditObjectCandidateDOffset4() 
{
	if (m_bSysKeyboardEnabled)
	{
		m_bKillFocusEnabled = FALSE;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditAlignerMaxTimes() 
{
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditAlignerXPrecision() 
{
	// 	if (m_bKillFocusEnabled)
	// 	{
	// 		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditAlignerYPrecision() 
{
	// 	if (m_bKillFocusEnabled)
	// 	{
	// 		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditAlignerDPrecision() 
{
	// 	if (m_bKillFocusEnabled)
	// 	{
	// 		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditAlignerXOffset() 
{
	// 	if (m_bKillFocusEnabled)
	// 	{
	// 		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditAlignerYOffset() 
{
	// 	if (m_bKillFocusEnabled)
	// 	{
	// 		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditAlignerDOffset() 
{
	// 	if (m_bKillFocusEnabled)
	// 	{
	// 		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateXOffset1() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateYOffset1() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateDOffset1() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateXOffset2() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateYOffset2() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateDOffset2() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateXOffset3() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateYOffset3() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateDOffset3() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateXOffset4() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateYOffset4() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
void CDlgSysKindAlignVirtualObject::OnKillfocusEditObjectCandidateDOffset4() 
{
	if (m_bKillFocusEnabled)
	{
		CString strVal;
...
/* Return type		: void 
/************************************************************************************/
void CDlgSysKindAlignVirtualObject::OnClickListProduct(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
BOOL CDlgSysKindAlignVirtualObject::DestroyWindow() 
{
	int i = 0 , j = 0;
...
void CDlgSysKindAlignVirtualObject::OnOK() 
{
	// 	if (IsProductChanged())
	// 	{
	// 		if (SavePrevProduct())
...
void CDlgSysKindAlignVirtualObject::OnCancel() 
{
...
void CDlgSysKindAlignVirtualObject::OnClose() 
{
...
void CDlgSysKindAlignVirtualObject::OnSize(UINT nType, int cx, int cy)
{
...
void CDlgSysKindAlignVirtualObject::CopyObjectToCalib(int nObjectPosIndex)
{
	// TODO: 在此添加控件通知处理程序代码
	...
	CBaseSearchTool* pObjSearchTool = NULL;
	pObjSearchTool = m_pParent->m_vpVisionASM.at(m_nPlatformIndex)->GetRepoAlnVirtualObjectSearchTool(m_nCurProductIdx, nObjectPosIndex, 0);
...
void CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib5()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib6()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedBtnCopyObjectToCalib7()
{
	// TODO: 在此添加控件通知处理程序代码
...
BOOL CDlgSysKindAlignVirtualObject::PreTranslateMessage(MSG* pMsg)
{
...
void CDlgSysKindAlignVirtualObject::OnBnClickedRadioVirtualObjectcSearchMode0()
{
	// TODO: 在此添加控件通知处理程序代码
	int nVirtualObjectCandidateEnableOld = m_nVirtualObjectCandidateEnable;
	UpdateData(TRUE);

	CString strVal[] = {_T("关"), _T("开")};
	if (nVirtualObjectCandidateEnableOld != m_nVirtualObjectCandidateEnable)
	{
		CDlgSysKindAlignView *pView = m_pParentKind->m_pDlgKindAlignView;
		m_nPrevPlatformIdx = pView->m_nPrevPlatformIdx;
		CString strLog;
		strLog.Format(_T("修改[虚拟对象]由%s到%s\n"),strVal[nVirtualObjectCandidateEnableOld],strVal[m_nVirtualObjectCandidateEnable]);
		g_opLogFile.SaveLogText(strLog,4);
	}
}
...
void CDlgSysKindAlignVirtualObject::OnBnClickedRadioObjectcSearchMode0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedRadioObjectcSearchSync0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcOffsetEnable1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcOffsetEnable2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcOffsetEnable3()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcOffsetEnable4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcShutterEnable()
{
	// TODO: 在此添加控件通知处理程序代码
    BOOL bObjectShutterEnable0Old = m_bObjectShutterEnable0;
    BOOL bObjectShutterEnable1Old = m_bObjectShutterEnable1;
    BOOL bObjectShutterEnable2Old = m_bObjectShutterEnable2;
    BOOL bObjectShutterEnable3Old = m_bObjectShutterEnable3;
    BOOL bObjectShutterEnable4Old = m_bObjectShutterEnable4;
	UpdateData(TRUE);
    if (bObjectShutterEnable0Old != m_bObjectShutterEnable0)
    {
        CString strLog;
    ...
    if (bObjectShutterEnable1Old != m_bObjectShutterEnable1)
    {
        CString strLog;
    ...
    if (bObjectShutterEnable2Old != m_bObjectShutterEnable2)
    {
        CString strLog;
    ...
    if (bObjectShutterEnable3Old != m_bObjectShutterEnable3)
    {
        CString strLog;
    ...
    if (bObjectShutterEnable4Old != m_bObjectShutterEnable4)
    {
        CString strLog;
        CString strValue = m_bObjectShutterEnable0 ? _T("选中状态"):_T("未选中状态");
...
void CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcGainEnable()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::OnBnClickedCheckAlignerObjectcGammaEnable()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgSysKindAlignVirtualObject::EnableWindowByAuthorizeset(bool bEnable)
{
	SysPlatformInfo platformInfo;
	...
	while(pWnd!=NULL)
	{
		pWnd->EnableWindow(bEnable && platformInfo.m_eAlignerObjectType == eObjectVirtual);
