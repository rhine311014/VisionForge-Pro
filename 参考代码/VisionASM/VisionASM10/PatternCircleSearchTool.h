...
// PatternCircleSearch定位工具训练Data参数类
typedef struct tagPatternCircleSearchTrainDataParam : public CBaseTrainDataParam
{
	...
	tagPatternCircleSearchTrainDataParam()
	{
...
}CPatternCircleSearchTrainDataParam;

// PatternCircleSearch定位工具训练Gui参数类
typedef struct tagPatternCircleSearchTrainGuiParam : public CBaseTrainGuiParam
{
	...
	tagPatternCircleSearchTrainGuiParam()
	{
...
}CPatternCircleSearchTrainGuiParam;

// PatternCircleSearch定位工具搜索Data参数类
typedef struct tagPatternCircleSearchSearchDataParam : public CBaseSearchDataParam
{
	...
	tagPatternCircleSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.6;
...
}CPatternCircleSearchSearchDataParam;

// PatternCircleSearch定位工具搜索Gui参数类
typedef struct tagPatternCircleSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
//	bool			m_bAffineRectVisible;				// 搜索结果矩形可见
	...
	tagPatternCircleSearchGuiParam()
	{
...
}CPatternCircleSearchSearchGuiParam;

// QuickSearch训练结果
typedef struct tagPatternCircleSearchTrainResult
{
	double m_dModelX;
	double m_dModelY;
	...
	tagPatternCircleSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CPatternCircleSearchTrainResult;

class CPatternCircleSearchTool : public CBaseSearchTool
{
public:

	CPatternCircleSearchTool();
	CPatternCircleSearchTool(CPatternCircleSearchTool &cPatternCircleSearchTool);
	CPatternCircleSearchTool& operator=(CPatternCircleSearchTool &cPatternCircleSearchTool);
	virtual ~CPatternCircleSearchTool();
...
//	scQuickSearchTool                   m_QuickSearchTool;				// QuickSearch搜索工具
	...
	CPatternCircleSearchTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CPatternCircleSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CPatternCircleSearchSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CPatternCircleSearchSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CPatternCircleSearchTrainResult			m_tmpTrainResult;				// 当前训练结果

	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像

	CPatternCircleSearchTrainDataParam			m_TrainDataParam;				// 训练Data参数
	CPatternCircleSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CPatternCircleSearchSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CPatternCircleSearchSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CPatternCircleSearchTrainResult			m_TrainResult;					// 训练结果
