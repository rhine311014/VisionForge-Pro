#if !defined(AFX_DLGCORNERSEARCHCHECKTOOLSETTING_H__FD052144_C0F9_4940_AE83_7A8B5CEC816D__INCLUDED_)
#define AFX_DLGCORNERSEARCHCHECKTOOLSETTING_H__FD052144_C0F9_4940_AE83_7A8B5CEC816D__INCLUDED_
...
class CDlgSearch;
class CDlgCornerSearchCheckTool : public CDialog
{
// Construction
public:
	CDlgCornerSearchCheckTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	...
	enum { IDD = IDD_DLG_CORNERSEARCH_CHECK_TOOL };
...
protected:
	...
	afx_msg void OnSetfocusEdtGrau2();
	afx_msg void OnSetfocusEdtNoisethre2();
	afx_msg void OnSetfocusEdtTotalMag2();
	afx_msg void OnSetfocusEdtAcceptThreCheck();
