// DlgMQuickPickSearchTool.cpp : 实现文件
//
...
IMPLEMENT_DYNAMIC(CDlgMQuickPickSearchTool, CDialog)

CDlgMQuickPickSearchTool::CDlgMQuickPickSearchTool(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgMQuickPickSearchTool::IDD, pParent)
	, m_nImageChannel(0)
...
CDlgMQuickPickSearchTool::~CDlgMQuickPickSearchTool()
{
}

void CDlgMQuickPickSearchTool::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgMQuickPickSearchTool)
...
BEGIN_MESSAGE_MAP(CDlgMQuickPickSearchTool, CDialog)
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_CHK_ENABLE_MARK2, &CDlgMQuickPickSearchTool::OnBnClickedChkEnableMark2)
	ON_CBN_SELCHANGE(IDC_COMBO_COORD_SORT_METHOD, &CDlgMQuickPickSearchTool::OnCbnSelchangeComboCoordSortMethod)
	ON_EN_SETFOCUS(IDC_EDT_COORD_SORT_GAP2, &CDlgMQuickPickSearchTool::OnEnSetfocusEdtCoordSortGap2)
	ON_BN_CLICKED(IDC_CHK_SHOW_HIDE_SEARCH1_RECT, &CDlgMQuickPickSearchTool::OnBnClickedChkShowHideSearch1Rect)
	ON_BN_CLICKED(IDC_CHK_SHOW_HIDE_SEARCH2_RECT, &CDlgMQuickPickSearchTool::OnBnClickedChkShowHideSearch2Rect)
END_MESSAGE_MAP()


// CDlgMQuickPickSearchTool 消息处理程序

void CDlgMQuickPickSearchTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgMQuickPickSearchTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel; 
		((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau = m_dGrau; 
		((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre = m_lNoiseThre;
		((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag = m_lTotalMag;
		((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		
		((CMQuickPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible = m_bEnableMark2;

		((CMQuickPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible1 = m_bSearchHideRectVisible1;
		((CMQuickPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible2 = m_bSearchHideRectVisible2;
	...
	{
		m_nImageChannel	= ((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_dGrau			= ((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau;
		m_lNoiseThre	= ((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre;
		m_lTotalMag		= ((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag;
		m_bEnableMask	= ((CMQuickPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;
		if (m_bEnableMask)
		{
		...
		m_bEnableMark2 = ((CMQuickPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible;

		m_bSearchHideRectVisible1 = ((CMQuickPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible1;
		m_bSearchHideRectVisible2 = ((CMQuickPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible2;
...
void CDlgMQuickPickSearchTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow = m_dAngleLow;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh = m_dAngleHigh;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeLow = m_dSizeLow;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeHigh = m_dSizeHigh;

		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bCoordSortEnable = m_bCoordSortEnable;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortMethod = (CoordSortMethod)m_nCoordSortMethod;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dCoordSortGap = m_dCoordSortGap;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderX = (SortOrder)m_nCoordSortOrderX;
		((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderY =  (SortOrder)m_nCoordSortOrderY;
	...
	{
		m_nSearchNum	= ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;
		m_dAngleLow		= ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh;
		m_dSizeLow		= ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeLow;
		m_dSizeHigh	= ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeHigh;

		m_bCoordSortEnable = ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bCoordSortEnable;
		m_nCoordSortMethod = ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortMethod;
		m_dCoordSortGap = ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dCoordSortGap;
		m_nCoordSortOrderX = ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderX;
		m_nCoordSortOrderY = ((CMQuickPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderY;
...
void CDlgMQuickPickSearchTool::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_MQuickPickSearch_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgMQuickPickSearchTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgMQuickPickSearchTool::OnBtnGetTrainImage() 
{
...
void CDlgMQuickPickSearchTool::OnBtnTrain() 
{
...
void CDlgMQuickPickSearchTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgMQuickPickSearchTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgMQuickPickSearchTool::OnInitDialog() 
{
...
void CDlgMQuickPickSearchTool::OnBtnSetCenter() 
{
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		cpImage imageTrain, imagePattern;
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CMQuickPickSearchTrainGuiParam *pTrainGuiParam = new CMQuickPickSearchTrainGuiParam;
...
void CDlgMQuickPickSearchTool::OnSetfocusEdtGrau() 
{
	TRACE(_T("CDlgMQuickPickSearchTool EdtGrau SetFocus\n"));
...
void CDlgMQuickPickSearchTool::OnKillfocusEdtGrau() 
{
	TRACE(_T("CDlgMQuickPickSearchTool EdtGrau KillFocus\n"));
}

void CDlgMQuickPickSearchTool::OnSetfocusEdtNoisethre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickSearchTool::OnSetfocusEdtTotalMag() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickSearchTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMQuickPickSearchTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickSearchTool::OnSetfocusEdtAngleLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickSearchTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickSearchTool::OnSetfocusEdtSizeLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickSearchTool::OnSetfocusEdtSizeHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickSearchTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CMQuickPickSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgMQuickPickSearchTool::PreTranslateMessage(MSG* pMsg) 
{
...
LRESULT CDlgMQuickPickSearchTool::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
	switch (message)
	{
	case WM_SETFOCUS:
		{
			TRACE(_T("CDlgMQuickPickSearchTool WM_SETFOCUS\n"));
		}
		break;
	case WM_KILLFOCUS:
		{
			TRACE(_T("CDlgMQuickPickSearchTool WM_KILLFOCUS\n"));
		}
		break;
	default:
		break;
...
void CDlgMQuickPickSearchTool::OnBnClickedChkEnableMark2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMQuickPickSearchTool::OnCbnSelchangeComboCoordSortMethod()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMQuickPickSearchTool::OnEnSetfocusEdtCoordSortGap2()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMQuickPickSearchTool::OnBnClickedChkShowHideSearch1Rect()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}
...
void CDlgMQuickPickSearchTool::OnBnClickedChkShowHideSearch2Rect()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}
