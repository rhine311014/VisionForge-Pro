...
CDlgMPatternSearchTool::CDlgMPatternSearchTool(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgMPatternSearchTool::IDD, pParent)
	, m_nImageChannel(0)
{
	//{{AFX_DATA_INIT(CDlgMPatternSearchTool)
	m_nSearchNum = 1;
	m_dAcceptThre = 0.6;
...
void CDlgMPatternSearchTool::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgMPatternSearchTool)
...
BEGIN_MESSAGE_MAP(CDlgMPatternSearchTool, CDialog)
	//{{AFX_MSG_MAP(CDlgMPatternSearchTool)
	...
	ON_BN_CLICKED(IDC_CHK_ENABLE_MARK2, &CDlgMPatternSearchTool::OnBnClickedChkEnableMark2)
	//}}AFX_MSG_MAP
	ON_CBN_SELCHANGE(IDC_COMBO_COORD_SORT_METHOD, &CDlgMPatternSearchTool::OnCbnSelchangeComboCoordSortMethod)
	ON_EN_SETFOCUS(IDC_EDT_COORD_SORT_GAP, &CDlgMPatternSearchTool::OnEnSetfocusEdtCoordSortGap)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgMPatternSearchTool message handlers
void CDlgMPatternSearchTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgMPatternSearchTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;
		((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy = (Accuracy)(1<<m_nPatAccuracyMode);
		((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale = (CoarseScale)(m_nPatSpeedMode+1);
		((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow  =  m_dAngleLow;
		((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh = m_dAngleHigh;

		((CMPatternSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible = m_bEnableMark2;
	...
	{
		m_nImageChannel = ((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_nPatAccuracyMode = ((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy/2;
		m_nPatSpeedMode = ((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale-1;
		m_dAngleLow	    = ((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh;
		m_bEnableMask = ((CMPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;				
		if (m_bEnableMask)
		{
		...
		m_bEnableMark2 = ((CMPatternSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible;

		UpdateData(FALSE);
	}
}

void CDlgMPatternSearchTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre = m_dConfusionThre;
		((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bCoordSortEnable = m_bCoordSortEnable;
		((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortMethod = (CoordSortMethod)m_nCoordSortMethod;
		((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dCoordSortGap = m_dCoordSortGap;
		((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderX = (SortOrder)m_nCoordSortOrderX;
		((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderY =  (SortOrder)m_nCoordSortOrderY;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;	
		m_dConfusionThre = ((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre;
		m_bCoordSortEnable = ((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bCoordSortEnable;
		m_nCoordSortMethod = ((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortMethod;
		m_dCoordSortGap = ((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dCoordSortGap;
		m_nCoordSortOrderX = ((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderX;
		m_nCoordSortOrderY = ((CMPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderY;
...
void CDlgMPatternSearchTool::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_MPATTERNSEARCH_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgMPatternSearchTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgMPatternSearchTool::OnBtnGetTrainImage() 
{
...
void CDlgMPatternSearchTool::OnBtnTrain() 
{
...
void CDlgMPatternSearchTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgMPatternSearchTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgMPatternSearchTool::OnInitDialog() 
{
...
void CDlgMPatternSearchTool::OnSelchangeComboAccuracyMode() 
{
	m_nPatAccuracyMode = m_comboAccuracy.GetCurSel();	
}

void CDlgMPatternSearchTool::OnSelchangeComboSpeedMode() 
{
	m_nPatSpeedMode = m_comboSpeed.GetCurSel();
}

void CDlgMPatternSearchTool::OnBtnSetCenter() 
{
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		cpImage imageTrain, imagePattern;
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CMPatternSearchTrainGuiParam *pTrainGuiParam = new CMPatternSearchTrainGuiParam;
...
void CDlgMPatternSearchTool::OnSetfocusEdtAngleLow() 
{
...
void CDlgMPatternSearchTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMPatternSearchTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMPatternSearchTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMPatternSearchTool::OnSetfocusEdtConfusionThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMPatternSearchTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CMPatternSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgMPatternSearchTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgMPatternSearchTool::OnBnClickedChkEnableMark2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMPatternSearchTool::OnCbnSelchangeComboCoordSortMethod()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMPatternSearchTool::OnEnSetfocusEdtCoordSortGap()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
