// PatternCornerCircleSearchTool.cpp: implementation of the CPatternCornerCircleSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
CPatternCornerCircleSearchTool::CPatternCornerCircleSearchTool(void)
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
	...
	// 找线工具
	m_GuiFindLine[1].SetStartXYEndXY(120, 300, 120, 200);
	...
	for (i=0; i<LINE_NUM; i++)
	{
		m_FindLineTool[i].GetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[i], m_tmpTrainDataParam.m_LineedgeProperty[i], 
			m_tmpTrainDataParam.m_lLineFilterHalfWidth[i]);
		m_tmpTrainDataParam.m_nLineOutLineNum[i]			= 0;
...
CPatternCornerCircleSearchTool::CPatternCornerCircleSearchTool(CPatternCornerCircleSearchTool &cPatternCornerCircleSearchTool)
{
	if (cPatternCornerCircleSearchTool.GetSearchToolType() != ePatternCornerCircleSearchTool)
	{
		return;
	}
	...
	// 赋值
	m_CamHeight								= cPatternCornerCircleSearchTool.m_CamHeight;
	m_CamWidth								= cPatternCornerCircleSearchTool.m_CamWidth;

	m_TrainDataParam						= cPatternCornerCircleSearchTool.m_TrainDataParam;
	m_TrainGuiParam							= cPatternCornerCircleSearchTool.m_TrainGuiParam;
	m_SearchDataParam						= cPatternCornerCircleSearchTool.m_SearchDataParam;
	m_SearchGuiParam						= cPatternCornerCircleSearchTool.m_SearchGuiParam;
	m_TrainResult							= cPatternCornerCircleSearchTool.m_TrainResult;
	m_ImageTrain							= cPatternCornerCircleSearchTool.m_ImageTrain;
	m_ImageMask								= cPatternCornerCircleSearchTool.m_ImageMask;
	m_bTrainGuiShow							= cPatternCornerCircleSearchTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow					= cPatternCornerCircleSearchTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cPatternCornerCircleSearchTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cPatternCornerCircleSearchTool.m_bTrainOK;
	m_pGuiDisplay							= cPatternCornerCircleSearchTool.m_pGuiDisplay;
	...
	cPatternCornerCircleSearchTool.UpdateSearchGuiData(true);
	cPatternCornerCircleSearchTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cPatternCornerCircleSearchTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cPatternCornerCircleSearchTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cPatternCornerCircleSearchTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cPatternCornerCircleSearchTool.m_tmpSearchGuiParam);
	SetTrainImage(cPatternCornerCircleSearchTool.m_tmpImageTrain);
	SetMaskImage(cPatternCornerCircleSearchTool.m_tmpImageMask);

	if (m_bTrainOK)
	{	
		m_PatternSearchTool = cPatternCornerCircleSearchTool.m_PatternSearchTool;
	}
}

CPatternCornerCircleSearchTool& CPatternCornerCircleSearchTool::operator=(CPatternCornerCircleSearchTool &cPatternCornerCircleSearchTool)
{
	if (this == &cPatternCornerCircleSearchTool)
	{
		return *this;	
	}
...
CSearchToolType CPatternCornerCircleSearchTool::GetSearchToolType()
{
	return ePatternCornerCircleSearchTool;
}

// 设置显示控件指针		
bool CPatternCornerCircleSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CPatternCornerCircleSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 设置Gui图形的关键字														
bool CPatternCornerCircleSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CPatternCornerCircleSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CPatternCornerCircleSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CPatternCornerCircleSearchTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CPatternCornerCircleSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CPatternCornerCircleSearchTool::UpdateTrainGuiDisplay()
{	
...
bool CPatternCornerCircleSearchTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索界面显示									
bool CPatternCornerCircleSearchTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
// 更新界面显示
bool CPatternCornerCircleSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CPatternCornerCircleSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != ePatternCornerCircleSearchTool)
	{
		return false;
	}

	m_tmpTrainDataParam = *((CPatternCornerCircleSearchTrainDataParam*)pTrainDataParam);

	return true;
}

// 获取训练Data参数									
bool CPatternCornerCircleSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CPatternCornerCircleSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;

	return true;
}

// 获取搜索Gui参数						
bool CPatternCornerCircleSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != ePatternCornerCircleSearchTool)
	{
		return false;
	}

	m_tmpTrainGuiParam = *((CPatternCornerCircleSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CPatternCornerCircleSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CPatternCornerCircleSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;

	return true;
}

// 设置训练原始图像				
bool CPatternCornerCircleSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CPatternCornerCircleSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CPatternCornerCircleSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CPatternCornerCircleSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CPatternCornerCircleSearchTool::Train()
{
	m_bTrainOK = false;
	...
	if (m_tmpTrainDataParam.m_bMaskEnable)
	{
		...
		m_FindLineTool[0].SetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[0], m_tmpTrainDataParam.m_LineedgeProperty[0], m_tmpTrainDataParam.m_lLineFilterHalfWidth[0]);
		...
		if (m_tmpTrainDataParam.m_bEnableLineDualEdge[0])
		{
			...
			if (m_tmpTrainDataParam.m_LineedgeProperty[0] == eDarkToLight)
			{
				tmpEdgePolarity = eLightToDark;
			} 
			else if (m_tmpTrainDataParam.m_LineedgeProperty[0] == eLightToDark)
			{
				tmpEdgePolarity = eDarkToLight;
			}
			m_FindLineTool[0].SetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[0], 
				m_tmpTrainDataParam.m_LineedgeProperty[0],tmpEdgePolarity, m_tmpTrainDataParam.m_lLineFilterHalfWidth[0]);
		} 
		else
		{
			m_FindLineTool[0].SetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[0], 
				m_tmpTrainDataParam.m_LineedgeProperty[0],m_tmpTrainDataParam.m_lLineFilterHalfWidth[0]);
		}
		scLineSeg cLineSeg1;
		double dRMS1;
		if(bIsProcessImage)
		...
		// 找线1
		m_FindLineTool[1].SetCaliperNum(m_tmpTrainGuiParam.m_nLineCaliperNum[1]);
		m_FindLineTool[1].SetCaliperParams(m_tmpTrainGuiParam.m_nLineCaliperNum[1], m_tmpTrainGuiParam.m_LineCaliperSearchRotation[1], m_tmpTrainGuiParam.m_dLineCaliperSearchLen[1]
		,m_tmpTrainGuiParam.m_dLineCaliperProjectLen[1]);
		m_FindLineTool[1].SetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[1], m_tmpTrainDataParam.m_LineedgeProperty[1], m_tmpTrainDataParam.m_lLineFilterHalfWidth[1]);
		m_FindLineTool[1].SetOutLineNum(m_tmpTrainDataParam.m_nLineOutLineNum[1], eRansacRobust);
		m_FindLineTool[1].SetStartXYEndXY(m_tmpTrainGuiParam.m_dLineStartX[1], m_tmpTrainGuiParam.m_dLineStartY[1], 
			m_tmpTrainGuiParam.m_dLineEndX[1], m_tmpTrainGuiParam.m_dLineEndY[1]);
		//掩膜与双极性
		m_FindLineTool[1].SetCaliperMasked(m_tmpTrainGuiParam.m_vbLineCaliperMask[1]);
		if (m_tmpTrainDataParam.m_bEnableLineDualEdge[1])
		{
			EdgePolarity tmpEdgePolarity = eDontCare;
			if (m_tmpTrainDataParam.m_LineedgeProperty[1] == eDarkToLight)
			{
				tmpEdgePolarity = eLightToDark;
			} 
			else if (m_tmpTrainDataParam.m_LineedgeProperty[1] == eLightToDark)
			{
				tmpEdgePolarity = eDarkToLight;
			}
			m_FindLineTool[1].SetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[1], 
				m_tmpTrainDataParam.m_LineedgeProperty[1],tmpEdgePolarity, m_tmpTrainDataParam.m_lLineFilterHalfWidth[1]);
		} 
		else
		{
			m_FindLineTool[1].SetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[1], 
				m_tmpTrainDataParam.m_LineedgeProperty[1],m_tmpTrainDataParam.m_lLineFilterHalfWidth[1]);
		}
		scLineSeg cLineSeg2;
		double dRMS2;
		if(bIsProcessImage)
		...
		m_tmpTrainResult.m_dLineStartX[1] = cLineSeg2.GetP1().GetX();
		m_tmpTrainResult.m_dLineStartY[1] = cLineSeg2.GetP1().GetY();
		m_tmpTrainResult.m_dLineEndX[1] = cLineSeg2.GetP2().GetX();
		m_tmpTrainResult.m_dLineEndY[1] = cLineSeg2.GetP2().GetY();
	...
	else
	{
		...
		if (m_tmpTrainDataParam.m_nLineAngleType[1] == 0)	// 任意角度
		{
			m_tmpTrainResult.m_dLineStartX[1] = cLineSeg1.GetP1().GetX();
			m_tmpTrainResult.m_dLineStartY[1] = cLineSeg1.GetP1().GetY();
			m_tmpTrainResult.m_dLineEndX[1] = cLineSeg1.GetP2().GetX();
			m_tmpTrainResult.m_dLineEndY[1] = cLineSeg1.GetP2().GetY();
		}
		else if (m_tmpTrainDataParam.m_nLineAngleType[1] == 1)	//水平线
		{
			scDegree degLineAngle;
			degLineAngle = scDegree(cLineSeg1.GetRotation()).SignedNorm();
			...
			{
				m_tmpTrainResult.m_dLineStartX[1] = cLineSeg1.GetP2().GetX();
				m_tmpTrainResult.m_dLineStartY[1] = cLineSeg1.GetP2().GetY();
				m_tmpTrainResult.m_dLineEndX[1] = cLineSeg1.GetP1().GetX();
				m_tmpTrainResult.m_dLineEndY[1] = cLineSeg1.GetP1().GetY();
			}
		}
		else if (m_tmpTrainDataParam.m_nLineAngleType[1] == 2)	//垂直线
		{
			scDegree degLineAngle;
			degLineAngle = scDegree(cLineSeg1.GetRotation()).Norm();
...
// 获取训练结果图像														
bool CPatternCornerCircleSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CPatternCornerCircleSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != ePatternCornerCircleSearchTool)
	{
		return false;
	}

	*((CPatternCornerCircleSearchTrainResult*)pTrainResult) = m_tmpTrainResult;

	return true;
}	

// 是否训练成功
bool CPatternCornerCircleSearchTool::IsTrained()
{
	return m_bTrainOK;
}

// 设置搜索Data参数	
bool CPatternCornerCircleSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != ePatternCornerCircleSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CPatternCornerCircleSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CPatternCornerCircleSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CPatternCornerCircleSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CPatternCornerCircleSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != ePatternCornerCircleSearchTool)
	{
		return false;
	}

	m_tmpSearchGuiParam = *((CPatternCornerCircleSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CPatternCornerCircleSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CPatternCornerCircleSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;

	return true;
}

// 执行搜索 					
bool CPatternCornerCircleSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
	...
	modelLineSeg1.SetP1(sc2Vector(m_TrainResult.m_dLineStartX[0], m_TrainResult.m_dLineStartY[0]));
	modelLineSeg1.SetP2(sc2Vector(m_TrainResult.m_dLineEndX[0], m_TrainResult.m_dLineEndY[0]));
	modelLineSeg2.SetP1(sc2Vector(m_TrainResult.m_dLineStartX[1], m_TrainResult.m_dLineStartY[1]));
	modelLineSeg2.SetP2(sc2Vector(m_TrainResult.m_dLineEndX[1], m_TrainResult.m_dLineEndY[1]));
	...
	for (int i=0; i<LINE_NUM; i++)
	{
		...
		m_FindLineTool[i].SetCaliperProperty(m_TrainDataParam.m_dLineContrastThre[i], m_TrainDataParam.m_LineedgeProperty[i], m_TrainDataParam.m_lLineFilterHalfWidth[i]);
	...
	if (bRet)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			for (int j=0; j<LINE_NUM; j++)
			{
				...
				{
					EdgePolarity tmpEdgePolarity = eDontCare;
					if (m_tmpTrainDataParam.m_LineedgeProperty[j] == eDarkToLight)
					{
						tmpEdgePolarity = eLightToDark;
					} 
					else if (m_tmpTrainDataParam.m_LineedgeProperty[j] == eLightToDark)
					{
						tmpEdgePolarity = eDarkToLight;
					}
					m_FindLineTool[j].SetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[j], 
						m_tmpTrainDataParam.m_LineedgeProperty[j],tmpEdgePolarity, m_tmpTrainDataParam.m_lLineFilterHalfWidth[j]);
				} 
				else
				{
					m_FindLineTool[j].SetCaliperProperty(m_tmpTrainDataParam.m_dLineContrastThre[j], 
						m_tmpTrainDataParam.m_LineedgeProperty[j], m_tmpTrainDataParam.m_lLineFilterHalfWidth[j]);
				}
				if(bIsProcessImage)
				{
					// 执行找线
			...
			if (bFindLine[0] && bFindLine[1] && bFindCircle)
			{
					...
					&& crossPointArray.size() > 0)
				{
					...
					double dRotAngle = scDegree((ResLine[0].GetRotation().NormMod180()-modelLineSeg1.GetRotation().NormMod180()
											   + ResLine[1].GetRotation().NormMod180()-modelLineSeg2.GetRotation().NormMod180())/2.0).ToDouble(); 
					...
					searchResult.m_resultCircleSearchTool.m_scCircleCircle = sc2Vector(ResCircle.GetCenter().GetX(),ResCircle.GetCenter().GetY());
					...
					// 找线0拟合点
					{
						...
						for (long m=0; m<bUsed.size(); m++)
						{
							...
							strTmpKey.Format(_T("%s_LineFitPoint0_%d"), m_strKeyText, nIndex);
...
// 获取搜索结果个数										
int CPatternCornerCircleSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CPatternCornerCircleSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像
bool CPatternCornerCircleSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != ePatternCornerCircleSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CPatternCornerCircleSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
	//	BYTE byR, byG, byB;
	CPatternCornerCircleSearchTrainDataParam tmpTrainDataParam;
	CPatternCornerCircleSearchTrainGuiParam tmpTrainGuiParam;
	CPatternCornerCircleSearchSearchDataParam tmpSearchDataParam;
	CPatternCornerCircleSearchSearchGuiParam tmpSearchGuiParam;	
	CPatternCornerCircleSearchTrainResult    tmpTrainResult;
	...
	tmpTrainDataParam.m_LineedgeProperty[0] = (EdgePolarity)_ttol(cXMLConfigurator.GetElemData());
	// SortByScore1
	...
	tmpTrainDataParam.m_dLineContrastThre[1] = _tcstod(cXMLConfigurator.GetElemData(), NULL);
	// FilterHalfWidth2
	bRet = cXMLConfigurator.FindElem(_T("FilterHalfWidth2"));
	if (!bRet)
	{
		tmpTrainDataParam.m_lLineFilterHalfWidth[1] = 1;
	}
	else
	{
		tmpTrainDataParam.m_lLineFilterHalfWidth[1] = _ttol(cXMLConfigurator.GetElemData());
	}
	// outlinenum2
	...
	tmpTrainDataParam.m_nLineOutLineNum[1] = _ttol(cXMLConfigurator.GetElemData());
	// edgeproperty2
	...
	tmpTrainDataParam.m_LineedgeProperty[1] = (EdgePolarity)_ttol(cXMLConfigurator.GetElemData());
	// SortByScore2
	bRet = cXMLConfigurator.FindElem(_T("SortByScore2"));
	if (!bRet)
	{
		tmpTrainDataParam.m_bLineSortByScore[1] = true;
	}
	tmpTrainDataParam.m_bLineSortByScore[1] = _ttoi(cXMLConfigurator.GetElemData());
	// DualEdge2
	...
	// LineAngleType2
	bRet = cXMLConfigurator.FindElem(_T("LineAngleType2"));
	if (bRet)
	{
		tmpTrainDataParam.m_nLineAngleType[1] = _ttol(cXMLConfigurator.GetElemData());
	}
	else
	{
		tmpTrainDataParam.m_nLineAngleType[1] = 0 ;
	}
	...
	tmpTrainGuiParam.m_nLineCaliperNum[1] = _ttoi(cXMLConfigurator.GetElemData());
	// startX
	...
	tmpTrainGuiParam.m_dLineStartX[1] = _tcstod(cXMLConfigurator.GetElemData(), NULL);
	// startY
	...
	tmpTrainGuiParam.m_dLineStartY[1] = _tcstod(cXMLConfigurator.GetElemData(), NULL);
	// EndX
	...
	tmpTrainGuiParam.m_dLineEndX[1] = _tcstod(cXMLConfigurator.GetElemData(), NULL);
	// EndY
	...
	tmpTrainGuiParam.m_dLineEndY[1] = _tcstod(cXMLConfigurator.GetElemData(), NULL);
	// Project Len
	...
	tmpTrainGuiParam.m_dLineCaliperProjectLen[1] = _tcstod(cXMLConfigurator.GetElemData(), NULL);
	// Search Len
	...
	tmpTrainGuiParam.m_dLineCaliperSearchLen[1] = _tcstod(cXMLConfigurator.GetElemData(), NULL);
	// Search Rotation
	...
	tmpTrainGuiParam.m_LineCaliperSearchRotation[1] = scRadian(_tcstod(cXMLConfigurator.GetElemData(), NULL));
...
//	cXMLConfigurator.LeaveElem();
	...
	vPos.SetY(_tcstod(cXMLConfigurator.GetElemData(), NULL));
	tmpTrainResult.m_dLineStartX[0] = vPos.GetX();
	tmpTrainResult.m_dLineStartY[0] = vPos.GetY();
	bRet = cXMLConfigurator.FindElem(_T("EndX1"));
	if (!bRet)
	{
		return false;
	...
	vPos.SetY(_tcstod(cXMLConfigurator.GetElemData(), NULL));
	tmpTrainResult.m_dLineEndX[0] = vPos.GetX();
	tmpTrainResult.m_dLineEndY[0] = vPos.GetY();
	...
	vPos.SetY(_tcstod(cXMLConfigurator.GetElemData(), NULL));
	tmpTrainResult.m_dLineStartX[1] = vPos.GetX();
	tmpTrainResult.m_dLineStartY[1] = vPos.GetY();
	bRet = cXMLConfigurator.FindElem(_T("EndX2"));
	if (!bRet)
	{
		return false;
	...
	vPos.SetY(_tcstod(cXMLConfigurator.GetElemData(), NULL));
	tmpTrainResult.m_dLineEndX[1] = vPos.GetX();
	tmpTrainResult.m_dLineEndY[1] = vPos.GetY();
...
// 保存模板文件							
bool CPatternCornerCircleSearchTool::SaveModelToFile(CString strDir)
{
	...
	// edgeproperty1
	strInfo.Format(_T("%d"), m_TrainDataParam.m_LineedgeProperty[0]);
	...
	// contrastthre2
	strInfo.Format(_T("%f"), m_TrainDataParam.m_dLineContrastThre[1]);
	cXMLConfigurator.AddElem(_T("ContrastThre2"), strInfo);
	// fileterhalfwidth2
	strInfo.Format(_T("%d"), m_TrainDataParam.m_lLineFilterHalfWidth[1]);
	cXMLConfigurator.AddElem(_T("FilterHalfWidth2"), strInfo);
	// outlinenum2
	strInfo.Format(_T("%d"), m_TrainDataParam.m_nLineOutLineNum[1]);
	cXMLConfigurator.AddElem(_T("OutLineNum2"), strInfo);
	// edgeproperty2
	strInfo.Format(_T("%d"), m_TrainDataParam.m_LineedgeProperty[1]);
	cXMLConfigurator.AddElem(_T("EdgeProperty2"), strInfo);
	// SortByScore2
	strInfo.Format(_T("%d"), m_TrainDataParam.m_bLineSortByScore[1]);
	cXMLConfigurator.AddElem(_T("SortByScore2"), strInfo);
	// LineAngleType2
	strInfo.Format(_T("%d"), m_TrainDataParam.m_nLineAngleType[1]);
	cXMLConfigurator.AddElem(_T("LineAngleType2"), strInfo);
	// DualEdge1
	...
	// Caliper Num2 
	strInfo.Format(_T("%d"), m_TrainGuiParam.m_nLineCaliperNum[1]);
	cXMLConfigurator.AddElem(_T("CaliperNum2"), strInfo);
	// startX2
	strInfo.Format(_T("%f"), m_TrainGuiParam.m_dLineStartX[1]);
	cXMLConfigurator.AddElem(_T("StartX2"), strInfo);
	// startY2
	strInfo.Format(_T("%f"), m_TrainGuiParam.m_dLineStartY[1]);
	cXMLConfigurator.AddElem(_T("StartY2"), strInfo);
	// EndX
	strInfo.Format(_T("%f"), m_TrainGuiParam.m_dLineEndX[1]);
	cXMLConfigurator.AddElem(_T("EndX2"), strInfo);
	// EndY2
	strInfo.Format(_T("%f"), m_TrainGuiParam.m_dLineEndY[1]);
	cXMLConfigurator.AddElem(_T("EndY2"), strInfo);
	// Project Len2
	strInfo.Format(_T("%f"), m_TrainGuiParam.m_dLineCaliperProjectLen[1]);
	cXMLConfigurator.AddElem(_T("ProjectLen2"), strInfo);
	// Search Len2
	strInfo.Format(_T("%f"), m_TrainGuiParam.m_dLineCaliperSearchLen[1]);
	cXMLConfigurator.AddElem(_T("SearchLen2"), strInfo);
	// Search Rotation2
	strInfo.Format(_T("%f"), m_TrainGuiParam.m_LineCaliperSearchRotation[1].ToDouble());
	...
	// line0
	strInfo.Format(_T("%f"), m_TrainResult.m_dLineStartX[0]);
	cXMLConfigurator.AddElem(_T("StartX1"), strInfo);
	strInfo.Format(_T("%f"), m_TrainResult.m_dLineStartY[0]);
	cXMLConfigurator.AddElem(_T("StartY1"), strInfo);
	strInfo.Format(_T("%f"), m_TrainResult.m_dLineEndX[0]);
	cXMLConfigurator.AddElem(_T("EndX1"), strInfo);
	strInfo.Format(_T("%f"), m_TrainResult.m_dLineEndY[0]);
	cXMLConfigurator.AddElem(_T("EndY1"), strInfo);
	// line 1
	strInfo.Format(_T("%f"), m_TrainResult.m_dLineStartX[1]);
	cXMLConfigurator.AddElem(_T("StartX2"), strInfo);
	strInfo.Format(_T("%f"), m_TrainResult.m_dLineStartY[1]);
	cXMLConfigurator.AddElem(_T("StartY2"), strInfo);
	strInfo.Format(_T("%f"), m_TrainResult.m_dLineEndX[1]);
	cXMLConfigurator.AddElem(_T("EndX2"), strInfo);
	strInfo.Format(_T("%f"), m_TrainResult.m_dLineEndY[1]);
	cXMLConfigurator.AddElem(_T("EndY2"), strInfo);
...
// 更新训练控件数据信息	
bool CPatternCornerCircleSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CPatternCornerCircleSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CPatternCornerCircleSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CPatternCornerCircleSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CPatternCornerCircleSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CPatternCornerCircleSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CPatternCornerCircleSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
bool CPatternCornerCircleSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CPatternCornerCircleSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CPatternCornerCircleSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CPatternCornerCircleSearchTool::RestoreSearchParam()
{
...
void CPatternCornerCircleSearchTool::SetLanguage(int nLanguage)
{
...
CString	CPatternCornerCircleSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
