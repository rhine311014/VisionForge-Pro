// DlgMQuickPickCornerSearchTool.cpp : 实现文件
//
...
/////////////////////////////////////////////////////////////////////////////
// CDlgMQuickPickCornerSearchTool dialog


CDlgMQuickPickCornerSearchTool::CDlgMQuickPickCornerSearchTool(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgMQuickPickCornerSearchTool::IDD, pParent)
	, m_nCliperIndex(0)
...
{
	//{{AFX_DATA_INIT(CDlgMQuickPickCornerSearchTool)
	m_nSearchNum = 1;
	m_dAcceptThre = 0.6;
	m_lNoiseThre = 10;
	m_lTotalMag = 500;
...
void CDlgMQuickPickCornerSearchTool::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgMQuickPickCornerSearchTool)
...
BEGIN_MESSAGE_MAP(CDlgMQuickPickCornerSearchTool, CDialog)
	//{{AFX_MSG_MAP(CDlgMQuickPickCornerSearchTool)
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_CHK_ENABLE_MARK2, &CDlgMQuickPickCornerSearchTool::OnBnClickedChkEnableMark2)
	ON_CBN_SELCHANGE(IDC_COMBO_COORD_SORT_METHOD, &CDlgMQuickSearchTool::OnCbnSelchangeComboCoordSortMethod)
	ON_EN_SETFOCUS(IDC_EDT_COORD_SORT_GAP2, &CDlgMQuickPickCornerSearchTool::OnEnSetfocusEdtCoordSortGap2)
	ON_EN_CHANGE(IDC_EDT_LINE_CALIPERNUM_1, OnChangeEdtLineCalipernum1)
	ON_EN_SETFOCUS(IDC_EDT_LINE_CALIPERNUM_1, &CDlgMQuickPickCornerSearchTool::OnEnSetfocusEdtLineCalipernum1)
	ON_EN_SETFOCUS(IDC_EDT_LINE_OUTLINE_NUM_1, &CDlgMQuickPickCornerSearchTool::OnEnSetfocusEdtLineOutlineNum1)
	ON_EN_SETFOCUS(IDC_EDT_LINE_CONTRAST_THRE_1, &CDlgMQuickPickCornerSearchTool::OnEnSetfocusEdtLineContrastThre1)
	...
	ON_BN_CLICKED(IDC_CHK_GET_FOUR_RESULT, &CDlgMQuickPickCornerSearchTool::OnBnClickedChkGetFourResult)
	ON_BN_CLICKED(IDC_CHECK_SORT_BY_SCORE1, &CDlgMQuickPickCornerSearchTool::OnBnClickedCheckSortByScore1)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_1, &CDlgMQuickPickCornerSearchTool::OnBnClickedCheckLineMask1)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_1, &CDlgMQuickPickCornerSearchTool::OnBnClickedCheckShowFitpoint1)
	ON_BN_CLICKED(IDC_CHK_ENABLE_DUAL_EDGE, &CDlgMQuickPickCornerSearchTool::OnBnClickedChkEnableDualEdge)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER, &CDlgMQuickPickCornerSearchTool::OnBnClickedChkShowLineCaliper)
	ON_BN_CLICKED(IDC_CHK_OUTPUT_13_MID, &CDlgMQuickPickCornerSearchTool::OnBnClickedChkOutput13Mid)
	ON_BN_CLICKED(IDC_CHK_24_COR_LINE_COMBINE, &CDlgMQuickPickCornerSearchTool::OnBnClickedChk24CorLineCombine)
	ON_BN_CLICKED(IDC_CHK_SHOW_HIDE_SEARCH1_RECT, &CDlgMQuickPickCornerSearchTool::OnBnClickedChkShowHideSearchRect)
	ON_BN_CLICKED(IDC_CHK_SHOW_HIDE_SEARCH2_RECT, &CDlgMQuickPickCornerSearchTool::OnBnClickedChkShowHideSearchRect1)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgMQuickPickCornerSearchTool message handlers

void CDlgMQuickPickCornerSearchTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgMQuickPickCornerSearchTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel; 
		((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau = m_dGrau; 
		((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre = m_lNoiseThre;
		((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag = m_lTotalMag;
		((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		
		((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible = m_bEnableMark2;
		((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible1 = m_bSearchHideRectVisible1;
		((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible2 = m_bSearchHideRectVisible2;
		...
		for (int i=0;i<4;i++)
		{	
			((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[i]  = m_nLineOutLineNum[i];
			((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[i] = m_dLineContrastThre[i];
			((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[i] = m_lLineFilterHalfWidth[i];
			((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[i] = (EdgePolarity)m_nLinePolarityMode[i];
			((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableSortByScore[i] = m_bSortByScore[i];
			((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[i] = m_bEnableDualEdge[i];

			((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[i] = m_nLineCaliperNum[i];
			((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[i] = m_bEnableLineMask[i];
			((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[i] = m_bShowCaliper[i];
		}
	...
	{
		m_nImageChannel	= ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_dGrau			= ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau;
		m_lNoiseThre	= ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre;
		m_lTotalMag		= ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag;
		m_bEnableMask	= ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;
		m_bSearchHideRectVisible1 = ((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible1;
		m_bSearchHideRectVisible2 = ((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible2;
		if (m_bEnableMask)
		{
		...
		for (int i=0;i<4;i++)
		{
			m_nLineOutLineNum[i] =  ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[i];
			m_dLineContrastThre[i] = ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[i];
			m_lLineFilterHalfWidth[i] = ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[i];
			m_nLinePolarityMode[i] = ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[i];
			m_bSortByScore[i] = ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableSortByScore[i];
			m_bEnableDualEdge[i] = ((CMQuickPickCornerSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge[i];

			m_nLineCaliperNum[i] = ((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[i];
			m_bEnableLineMask[i] = ((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableLineMask[i];
			m_bShowCaliper[i] =((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCaliperVisible[i];
		}
		...
		m_bEnableMark2 = ((CMQuickPickCornerSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible;
		UpdateData(FALSE);	
...
void CDlgMQuickPickCornerSearchTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow = m_dAngleLow;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh = m_dAngleHigh;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeLow = m_dSizeLow;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeHigh = m_dSizeHigh;

		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bGetFourResultEnable = m_bGetFourResultEnable;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnable24CorLineCombine = m_bEnable24CorLineCombine;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnable13ProjectTo24Combine = m_bEnable13ProjectTo24Combine;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableOutput13MidCombine = m_bEnableOutput13MidCombine;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bCoordSortEnable = m_bCoordSortEnable;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortMethod = (CoordSortMethod)m_nCoordSortMethod;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dCoordSortGap = m_dCoordSortGap;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderX = (SortOrder)m_nCoordSortOrderX;
		((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderY =  (SortOrder)m_nCoordSortOrderY;


		m_bShowFitPoint[m_nCliperIndex] = m_bShowFitPoint_1;

		((CMQuickPickCornerSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint = m_bShowFitPoint[0];
		((CMQuickPickCornerSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint1 = m_bShowFitPoint[1];
		((CMQuickPickCornerSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint2 = m_bShowFitPoint[2];
		((CMQuickPickCornerSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint3 = m_bShowFitPoint[3];
	...
	{
		m_nSearchNum	= ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;
		m_dAngleLow		= ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh;
		m_dSizeLow		= ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeLow;
		m_dSizeHigh	= ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeHigh;

		m_bGetFourResultEnable = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bGetFourResultEnable;
		m_bEnable24CorLineCombine = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnable24CorLineCombine;
		m_bEnable13ProjectTo24Combine = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnable13ProjectTo24Combine;
		m_bEnableOutput13MidCombine = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableOutput13MidCombine;
		m_bCoordSortEnable = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bCoordSortEnable;
		m_nCoordSortMethod = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortMethod;
		m_dCoordSortGap = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dCoordSortGap;
		m_nCoordSortOrderX = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderX;
		m_nCoordSortOrderY = ((CMQuickPickCornerSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderY;


		m_bShowFitPoint[0] = ((CMQuickPickCornerSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint;
		m_bShowFitPoint[1] = ((CMQuickPickCornerSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint1;
		m_bShowFitPoint[2] = ((CMQuickPickCornerSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint2;
		m_bShowFitPoint[3] = ((CMQuickPickCornerSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint3;
...
void CDlgMQuickPickCornerSearchTool::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_MQuickPickCornerSearch_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgMQuickPickCornerSearchTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgMQuickPickCornerSearchTool::OnBtnGetTrainImage() 
{
...
void CDlgMQuickPickCornerSearchTool::OnBtnTrain() 
{
...
void CDlgMQuickPickCornerSearchTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgMQuickPickCornerSearchTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgMQuickPickCornerSearchTool::OnInitDialog() 
{
...
void CDlgMQuickPickCornerSearchTool::OnBtnSetCenter() 
{
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		cpImage imageTrain, imagePattern;
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CMQuickPickCornerSearchTrainGuiParam *pTrainGuiParam = new CMQuickPickCornerSearchTrainGuiParam;
...
void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtGrau() 
{
	TRACE(_T("CDlgMQuickPickCornerSearchTool EdtGrau SetFocus\n"));
...
void CDlgMQuickPickCornerSearchTool::OnKillfocusEdtGrau() 
{
	TRACE(_T("CDlgMQuickPickCornerSearchTool EdtGrau KillFocus\n"));
}

void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtNoisethre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtTotalMag() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtAngleLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtSizeLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickCornerSearchTool::OnSetfocusEdtSizeHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMQuickPickCornerSearchTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CMQuickPickCornerSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgMQuickPickCornerSearchTool::PreTranslateMessage(MSG* pMsg) 
{
...
LRESULT CDlgMQuickPickCornerSearchTool::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
	switch (message)
	{
	case WM_SETFOCUS:
		{
			TRACE(_T("CDlgMQuickPickCornerSearchTool WM_SETFOCUS\n"));
		}
		break;
	case WM_KILLFOCUS:
		{
			TRACE(_T("CDlgMQuickPickCornerSearchTool WM_KILLFOCUS\n"));
		}
		break;
	default:
		break;
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedChkEnableMark2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMQuickPickCornerSearchTool::OnCbnSelchangeComboCoordSortMethod()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMQuickPickCornerSearchTool::OnEnSetfocusEdtCoordSortGap2()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMQuickPickCornerSearchTool::OnEnSetfocusEdtLineCalipernum1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMQuickPickCornerSearchTool::OnEnSetfocusEdtLineOutlineNum1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMQuickPickCornerSearchTool::OnEnSetfocusEdtLineContrastThre1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMQuickPickCornerSearchTool::OnCliperChange() 
{
	// TODO: Add your control notification handler code here
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedChkGetFourResult()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedCheckSortByScore1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedCheckLineMask1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedCheckShowFitpoint1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedChkEnableDualEdge()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedChkShowLineCaliper()
{
	UpdateTrainData(true);
}

void CDlgMQuickPickCornerSearchTool::OnChangeEdtLineCalipernum1() 
{
...
void CDlgMQuickPickCornerSearchTool::OnEnSetfocusEditLineFilterHalfWidth1() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedChkOutput13Mid()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedChk24CorLineCombine()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedChkShowHideSearchRect()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}
...
void CDlgMQuickPickCornerSearchTool::OnBnClickedChkShowHideSearchRect1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}
