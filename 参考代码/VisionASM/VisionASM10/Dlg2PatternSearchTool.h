...
#endif //BIF_NEWDIALOGSTYLE
class CDlgSearch;
class CDlg2PatternSearchTool : public CDialogEx
{
	DECLARE_DYNAMIC(CDlg2PatternSearchTool)

public:
	CDlg2PatternSearchTool(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlg2PatternSearchTool();
...
// 对话框数据
	enum { IDD = IDD_DLG_2PATTERNSEARCH_TOOL };
