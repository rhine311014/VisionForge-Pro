...
#include "afxwin.h"
class CDlgSearch;
class CDlgAreaInspectPickTool : public CDialog
{
	DECLARE_DYNAMIC(CDlgAreaInspectPickTool)
public: 
...
public:
	CDlgAreaInspectPickTool(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgAreaInspectPickTool();
public:
...
// 对话框数据
	enum { IDD = IDD_DLG_AREAINSPECT_PICK_TOOL };
