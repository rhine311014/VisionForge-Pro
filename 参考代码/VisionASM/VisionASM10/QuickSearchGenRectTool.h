// QuickSearchGenRectTool.h: interface for the CQuickSearchGenRectTool class.
//
//////////////////////////////////////////////////////////////////////
...
// QuickSearchGenRect定位工具训练Data参数类
typedef struct tagQuickSearchGenRectTrainDataParam : public CBaseTrainDataParam
{
	double			m_dGrau;							// 颗粒度
	...
	tagQuickSearchGenRectTrainDataParam()
	{
		m_dGrau				= 2.0;
		m_lNoiseThre		= 10;
		m_lTotalMag			= 200;
...
}CQuickSearchGenRectTrainDataParam;

// QuickSearchGenRect定位工具训练Gui参数类
typedef struct tagQuickSearchGenRectTrainGuiParam : public CBaseTrainGuiParam
{
	...
	tagQuickSearchGenRectTrainGuiParam()
	{
...
}CQuickSearchGenRectTrainGuiParam;

// QuickSearchGenRect定位工具搜索Data参数类
typedef struct tagQuickSearchGenRectSearchDataParam : public CBaseSearchDataParam
{
	...
	int		m_nMethod;									// 定位方法
	tagQuickSearchGenRectSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.8;
		m_dAngleLow		= -5.0;
...
}CQuickSearchGenRectSearchDataParam;

// QuickSearchGenRect定位工具搜索Gui参数类
typedef struct tagQuickSearchGenRectGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
...
}CQuickSearchGenRectSearchGuiParam;

// QuickSearch训练结果
typedef struct tagQuickSearchGenRectTrainResult
{
	double m_dModelX;
	double m_dModelY;
	double m_dCenterX;
	double m_dCenterY;
	tagQuickSearchGenRectTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
		m_dCenterX = 0;
...
}CQuickSearchGenRectTrainResult;

//
//	圆定位工具
//
class /*SV_SEARCHTOOL_API*/ CQuickSearchGenRectTool : public CBaseSearchTool    
{
public:
	CQuickSearchGenRectTool();
	CQuickSearchGenRectTool(CQuickSearchGenRectTool &cQuickSearchGenRectTool);
	CQuickSearchGenRectTool& operator=(CQuickSearchGenRectTool &cQuickSearchGenRectTool);
	virtual ~CQuickSearchGenRectTool();
...
public:
	...
	virtual CString	GetResultErrInfo();										//输出错误序列号
private:
...
private:	
	...
	CQuickSearchGenRectTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CQuickSearchGenRectTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CQuickSearchGenRectSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CQuickSearchGenRectSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CQuickSearchGenRectTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
 	CQuickSearchGenRectTrainDataParam			m_TrainDataParam;				// 训练Data参数
 	CQuickSearchGenRectTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
 	CQuickSearchGenRectSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
 	CQuickSearchGenRectSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CQuickSearchGenRectTrainResult			m_TrainResult;					// 训练结果
