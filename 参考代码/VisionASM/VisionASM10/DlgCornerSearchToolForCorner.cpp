...
CDlgCornerSearchToolForCorner::CDlgCornerSearchToolForCorner(CWnd* pParent /*=NULL*/)
: CDialog(CDlgCornerSearchToolForCorner::IDD, pParent)
...
, m_nImageChannel(0)
{
	//{{AFX_DATA_INIT(CDlgCornerSearchToolForCorner)
...
void CDlgCornerSearchToolForCorner::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgCornerSearchToolForCorner)
...
BEGIN_MESSAGE_MAP(CDlgCornerSearchToolForCorner, CDialog)
//{{AFX_MSG_MAP(CDlgCornerSearchToolForCorner)
	...
	//}}AFX_MSG_MAP
	ON_EN_CHANGE(IDC_EDT_ACCEPT_THRE, &CDlgCornerSearchToolForCorner::OnEnChangeEdtAcceptThre)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_1, &CDlgCornerSearchToolForCorner::OnBnClickedCheckLineMask1)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_1, &CDlgCornerSearchToolForCorner::OnBnClickedCheckShowFitpoint1)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_2, &CDlgCornerSearchToolForCorner::OnBnClickedCheckLineMask2)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_2, &CDlgCornerSearchToolForCorner::OnBnClickedCheckShowFitpoint2)

	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER_2, &CDlgCornerSearchToolForCorner::OnBnClickedChkShowLineCaliper2)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER_1, &CDlgCornerSearchToolForCorner::OnBnClickedChkShowLineCaliper1)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgCornerSearchToolForCorner message handlers

void CDlgCornerSearchToolForCorner::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgCornerSearchToolForCorner::UpdateTrainData(bool bValidate)
{
...
void CDlgCornerSearchToolForCorner::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
...
void CDlgCornerSearchToolForCorner::UpdateDialogLanguage()
{
//	return;
...
void CDlgCornerSearchToolForCorner::OnBtnGetTrainImage() 
{
...
void CDlgCornerSearchToolForCorner::OnBtnTrain() 
{
...
void CDlgCornerSearchToolForCorner::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgCornerSearchToolForCorner::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgCornerSearchToolForCorner::OnInitDialog() 
{
...
void CDlgCornerSearchToolForCorner::OnChangeEdtLineCalipernum1() 
{
...
void CDlgCornerSearchToolForCorner::OnChangeEdtLineCalipernum2() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgCornerSearchToolForCorner::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtGrau() 
{
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtNoisethre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtTotalMag() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtLineCalipernum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtLineContrastThre1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtLineOutlineNum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtLineCalipernum2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtLineContrastThre2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtLineOutlineNum2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnSetfocusEdtAngleLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgCornerSearchToolForCorner::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		if (m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
...
BOOL CDlgCornerSearchToolForCorner::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgCornerSearchToolForCorner::OnEnChangeEdtAcceptThre()
{
...
void CDlgCornerSearchToolForCorner::OnBnClickedCheckLineMask1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCornerSearchToolForCorner::OnBnClickedCheckShowFitpoint1()
{
	// TODO: 在此添加控件通知处理程序代码
    if (m_pDlgParent->m_pSearchTool && m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
    {
...
void CDlgCornerSearchToolForCorner::OnBnClickedCheckLineMask2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCornerSearchToolForCorner::OnBnClickedCheckShowFitpoint2()
{
	// TODO: 在此添加控件通知处理程序代码
    if (m_pDlgParent->m_pSearchTool && m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
    {
...
void CDlgCornerSearchToolForCorner::OnBnClickedChkShowLineCaliper1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	if (m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
	...
	if (m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCombinationCornerSearchTool)
	{
		m_pDlgParent->m_pSearchTool->GetTrainGuiParam(m_pDlgParent->m_pTrainGuiParam);
...
void CDlgCornerSearchToolForCorner::OnBnClickedChkShowLineCaliper2()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	if (m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
...
void CDlgCornerSearchToolForCorner::OnEnSetfocusEditLineFilterHalfWidth1() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgCornerSearchToolForCorner::OnEnSetfocusEditLineFilterHalfWidth2() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
BOOL CDlgCornerSearchToolForCorner::OnCommand(WPARAM wParam, LPARAM lParam)
{
