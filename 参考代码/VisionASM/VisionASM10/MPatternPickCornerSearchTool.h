...
//class CMPatternPickCornerSearchTool :
//	public CBaseSearchTool
//{
//public:
//	CMPatternPickCornerSearchTool(void);
//	~CMPatternPickCornerSearchTool(void);
//};
...
typedef struct tagMPatternPickCornerSearchTrainDataParam : public CBaseTrainDataParam
{
	...
	tagMPatternPickCornerSearchTrainDataParam()
	{
...
}CMPatternPickCornerSearchTrainDataParam;

// PatternCornerSearch定位工具训练Gui参数类
typedef struct tagMPatternPickCornerSearchTrainGuiParam : public CBaseTrainGuiParam
{
	...
	scRect			m_ACFSearch2HideRect;					// ACF检测1
	...
	bool			m_bSearchHideRectVisible1;			// 夹爪1屏蔽区域是否可见
	bool			m_bSearchHideRectVisible2;			// 夹爪2屏蔽区域是否可见
	...
	tagMPatternPickCornerSearchTrainGuiParam()
	{
		for (int i = 0; i < FIND_LINE_TOOL_NUM; ++i)
		{
			m_nCaliperNum[i]				= 2;
...
}CMPatternPickCornerSearchTrainGuiParam;

// PatternnCornerSearch定位工具搜索Data参数类
typedef struct tagMPatternPickCornerSearchSearchDataParam : public CBaseSearchDataParam
{
	...
	tagMPatternPickCornerSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.6;
...
}CMPatternPickCornerSearchSearchDataParam;

// PatternCornerSearch定位工具搜索Gui参数类
typedef struct tagMPatternPickCornerSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	...
	tagMPatternPickCornerSearchGuiParam()
	{
...
}CMPatternPickCornerSearchSearchGuiParam;

// PatternSearch训练结果
typedef struct tagMPatternPickCornerSearchTrainResult
{
	...
	tagMPatternPickCornerSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CMPatternPickCornerSearchTrainResult;

class CMPatternPickCornerSearchTool :public CBaseSearchTool
{
public:
	CMPatternPickCornerSearchTool(void);
	CMPatternPickCornerSearchTool(CMPatternPickCornerSearchTool &cPatternCornerSearchTool);
	CMPatternPickCornerSearchTool& operator=(CMPatternPickCornerSearchTool &cPatternCornerSearchTool);
	~CMPatternPickCornerSearchTool(void);
...
public:
	...
	virtual bool ACFSearch(cpImage &ImageSearch,std::vector<bool> &index);
...
private:
	...
	CMPatternPickCornerSearchTrainDataParam		m_tmpTrainDataParam;			// 当前训练Data参数
	CMPatternPickCornerSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CMPatternPickCornerSearchSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CMPatternPickCornerSearchSearchGuiParam		m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CMPatternPickCornerSearchTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	CMPatternPickCornerSearchTrainDataParam		m_TrainDataParam;				// 训练Data参数
	CMPatternPickCornerSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CMPatternPickCornerSearchSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CMPatternPickCornerSearchSearchGuiParam		m_SearchGuiParam;				// 搜索Gui参数	
	CMPatternPickCornerSearchTrainResult			m_TrainResult;					// 训练结果
	...
	scGuiRect							m_GuiACFHand1SearchRect;				//ACF1检测搜索矩形
	scGuiRect							m_GuiACFHand2SearchRect;				//ACF1检测搜索矩形
