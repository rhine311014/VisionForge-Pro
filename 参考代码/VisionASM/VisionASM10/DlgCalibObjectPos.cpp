...
IMPLEMENT_DYNAMIC(CDlgCalibObjectPos, CDialog)

CDlgCalibObjectPos::CDlgCalibObjectPos(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgCalibObjectPos::IDD, pParent)
...
CDlgCalibObjectPos::~CDlgCalibObjectPos()
{
...
void CDlgCalibObjectPos::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgCalibObjectPos, CDialog)
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_BTN_SERIAL_GRAB, &CDlgCalibObjectPos::OnBnClickedBtnSerialGrab)
	ON_BN_CLICKED(IDCANCEL, &CDlgCalibObjectPos::OnBnClickedCancel)
	ON_BN_CLICKED(IDOK, &CDlgCalibObjectPos::OnBnClickedOk)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT0_MOVE_POS0, &CDlgCalibObjectPos::OnBnClickedBtnSearchObject0Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT1_MOVE_POS0, &CDlgCalibObjectPos::OnBnClickedBtnSearchObject1Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT0_MOVE_POS1, &CDlgCalibObjectPos::OnBnClickedBtnSearchObject0Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_OBJECT1_MOVE_POS1, &CDlgCalibObjectPos::OnBnClickedBtnSearchObject1Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET0_MOVE_POS0, &CDlgCalibObjectPos::OnBnClickedBtnSearchVirtualObject0Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET1_MOVE_POS0, &CDlgCalibObjectPos::OnBnClickedBtnSearchVirtualObject1Pos0)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET0_MOVE_POS1, &CDlgCalibObjectPos::OnBnClickedBtnSearchVirtualObject0Pos1)
	ON_BN_CLICKED(IDC_BTN_SEARCH_TARGET1_MOVE_POS1, &CDlgCalibObjectPos::OnBnClickedBtnSearchVirtualObject1Pos1)
	ON_BN_CLICKED(IDC_BTN_CALIB_TARGET_POS, &CDlgCalibObjectPos::OnBnClickedBtnCalcuVirtualObject)
	ON_BN_CLICKED(IDC_BTN_COMM_GET_PLATFORM_AXIS_POS, &CDlgCalibObjectPos::OnBnClickedBtnCommGetPlatformAxisPos)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS0, &CDlgCalibObjectPos::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS1, &CDlgCalibObjectPos::OnBnClickedRadioCalibTargetPos0)
	ON_BN_CLICKED(IDC_RADIO_CALIB_TARGET_POS2, &CDlgCalibObjectPos::OnBnClickedRadioCalibTargetPos0)
    ON_BN_CLICKED(IDC_BTN_SET_DMCODE_PARAM, &CDlgCalibObjectPos::OnBnClickedBtnSetDmcodeParam)
	ON_BN_CLICKED(IDC_BUTTON_POS1_CAMERA_SHUTTER, &CDlgCalibObjectPos::OnBnClickedSetCalibTargetShutter1)
	ON_BN_CLICKED(IDC_BUTTON_POS2_CAMERA_SHUTTER, &CDlgCalibObjectPos::OnBnClickedSetCalibTargetShutter2)
	ON_BN_CLICKED(IDC_BUTTON_POS3_CAMERA_SHUTTER, &CDlgCalibObjectPos::OnBnClickedSetCalibTargetShutter3)
	ON_BN_CLICKED(IDC_BUTTON_POS4_CAMERA_SHUTTER, &CDlgCalibObjectPos::OnBnClickedSetCalibTargetShutter4)
...
void CDlgCalibObjectPos::SetVisionAlignerRef( vcBaseVisionAlign *pVisionAligner)
{
...
BOOL CDlgCalibObjectPos::OnInitDialog()
{
...
void CDlgCalibObjectPos::InitDlgItem()
{
	// 	// 	CRect cr;
    ...
    GetDlgItem(IDC_BTN_LOAD_LAST_CALIBMARK)->ShowWindow(FALSE);
...
void CDlgCalibObjectPos::UpdateDlgItem(BOOL bEnable)
{
...
void CDlgCalibObjectPos::UpdateStatusBar()
{
...
void CDlgCalibObjectPos::OnDestroy()
{
	CDialog::OnDestroy();
...
LRESULT CDlgCalibObjectPos::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void CDlgCalibObjectPos::UpdateBtnLiveGrab()
{
	// 更新“连续采集/停止采集”按钮 
...
void CDlgCalibObjectPos::UpdateShutterDisplay()
{
	// 	// 更新曝光时间显示
...
BOOL CDlgCalibObjectPos::SetGUI()
{
	int nCamNum = m_pVisionASM->GetCameraNum();
	nCamNum = (nCamNum == 4) ? 2 : nCamNum;
...
// 更新训练Gui控件显示
bool CDlgCalibObjectPos::UpdateGuiDisplay()
{
	// 更新
	int nCamNum = m_pVisionASM->GetCameraNum();
	nCamNum = (nCamNum == 4) ? 2 : nCamNum;
...
void CDlgCalibObjectPos::OnBnClickedBtnSerialGrab()
{
	// TODO: 在此添加控件通知处理程序代码
	int i=0;
	BOOL bSucceed = TRUE;
...
void CDlgCalibObjectPos::OnBnClickedBtnSearchObject0Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibObjectPos::OnBnClickedBtnSearchObject1Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibObjectPos::OnBnClickedBtnSearchVirtualObject0Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 2; // 目标移动位置1
...
void CDlgCalibObjectPos::OnBnClickedBtnSearchVirtualObject1Pos0()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 2; // 目标移动位置1
...
void CDlgCalibObjectPos::OnBnClickedBtnSearchObject0Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 3; // 对象移动位置2
...
void CDlgCalibObjectPos::OnBnClickedBtnSearchObject1Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 3; // 对象移动位置2
...
void CDlgCalibObjectPos::OnBnClickedBtnSearchVirtualObject0Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 1;
	m_nEvent = 4; // 目标移动位置2
...
void CDlgCalibObjectPos::OnBnClickedBtnSearchVirtualObject1Pos1()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nRadioCalibTargetPos = 2;
	m_nEvent = 4; // 目标移动位置2
...
void CDlgCalibObjectPos::OnBnClickedBtnCommGetPlatformAxisPos()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibObjectPos::OnBnClickedBtnCalcuVirtualObject()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
void CDlgCalibObjectPos::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
void CDlgCalibObjectPos::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	CString strLog;
...
UINT CDlgCalibObjectPos::ThreadReceiveData( LPVOID pParam )
{
	CDlgCalibObjectPos *pOwner = (CDlgCalibObjectPos*)pParam;
	CString strReceived;
...
void CDlgCalibObjectPos::SearchObjectPos(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibObjectPos::SearchObjectPos1(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibObjectPos::SearchTargetPos(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibObjectPos::SearchTargetPos1(int nPosIndex)
{
	if (m_pVisionASM == NULL)
	{
		return;
...
void CDlgCalibObjectPos::CommGetPlatformAxisPos()
{
	m_bCommGetPlatformAxisPosSuccess = FALSE;
	if (m_pVisionASM == NULL)
	{
...
void CDlgCalibObjectPos::UpdateDialogLanguage()
{
	//	return;
	LANGID lgidLanguage = MAKELANGID(LANG_CHINESE, SUBLANG_CHINESE_SIMPLIFIED);
	if (m_psaSysInfoStrings != NULL)
...
void CDlgCalibObjectPos::OnBnClickedRadioCalibTargetPos0()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibObjectPos::OnBnClickedBtnSetDmcodeParam()
{
    // TODO: 在此添加控件通知处理程序代码
    // TODO: 在此添加控件通知处理程序代码
	CTotalProductData *pTotalProductData;
...
BOOL CDlgCalibObjectPos::DmCodeSearch(int nPosIndex)
{
    if (m_pVisionASM == NULL)
    {
        return FALSE;
...
*/
/************************************************************************/
bool CDlgCalibObjectPos::CreateMultipleDirectory(CString& szPath, char split)
{
...
//获得关联结果
bool CDlgCalibObjectPos::GetCalibResultCString(CString & strCalibResult)
{
...
// 保存CVS 文件
bool CDlgCalibObjectPos::SaveCSVFile(CString strImageFileDirt,CString strName,CString& strSaveData )
{
	SYSTEMTIME sys;
	GetLocalTime(&sys);
	CString strFileName;
...
// 保存畸变校正前的图片
void CDlgCalibObjectPos::SaveCalibSearchImage(CString strImageFileDirt,CString strImageName,cpImage & imageSave)
{
...
void CDlgCalibObjectPos::OnBnClickedSetCalibTargetShutter1()
{
	// TODO: 在此添加控件通知处理程序代码
	SetCalibTargetShutter(0);
}

void CDlgCalibObjectPos::OnBnClickedSetCalibTargetShutter2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCalibObjectPos::OnBnClickedSetCalibTargetShutter3()
{
	// TODO: 在此添加控件通知处理程序代码
	SetCalibTargetShutter(2);
}

void CDlgCalibObjectPos::OnBnClickedSetCalibTargetShutter4()
{
	// TODO: 在此添加控件通知处理程序代码
	SetCalibTargetShutter(3);
}

void CDlgCalibObjectPos::ResetCameraShutter()
{
	if(m_pVisionASM)
	{
		for(int nPos=0;nPos<4 && nPos<m_pVisionASM->GetPosNum();nPos++)
...
void CDlgCalibObjectPos::SetCalibTargetShutter(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
void CDlgCalibObjectPos::CallDlgSearch(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
void CDlgCalibObjectPos::SetCalibTargetSearchTool(int nPosIndex)
{
	if(m_pVisionASM== NULL)
	{
		return;
...
LRESULT CDlgCalibObjectPos::OnGuiDisplayDblClk(WPARAM wParam, LPARAM lParam)
{
