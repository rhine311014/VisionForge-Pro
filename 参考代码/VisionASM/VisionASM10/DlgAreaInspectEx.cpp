// CDlgAreaInspectEx 消息处理程序

// CDlgAreaInspectEx.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDlgAreaInspectEx dialog


CDlgAreaInspectEx::CDlgAreaInspectEx(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgAreaInspectEx::IDD, pParent)
	, m_nInsToolNum(0)
	, m_dCurMean(0)
	, m_dCurStdDev(0)
	, m_dCurMinMean(0)
	...
	, m_nRowNum(1)
{
	//{{AFX_DATA_INIT(CDlgAreaInspectEx)
...
void CDlgAreaInspectEx::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgAreaInspectEx)
...
BEGIN_MESSAGE_MAP(CDlgAreaInspectEx, CDialog)
	//{{AFX_MSG_MAP(CDlgAreaInspectEx)
	...
	//}}AFX_MSG_MAP
	ON_CBN_SELCHANGE(IDC_COMBO_AREA_INDEX, &CDlgAreaInspectEx::OnCbnSelchangeComboAreaIndex)
	ON_EN_SETFOCUS(IDC_EDT_INSTOOL_NUM, &CDlgAreaInspectEx::OnEnSetfocusEdtInstoolNum)
	ON_EN_SETFOCUS(IDC_EDT_MIN_MEAN, &CDlgAreaInspectEx::OnEnSetfocusEdtMinMean)
	ON_EN_SETFOCUS(IDC_EDT_MAX_MEAN, &CDlgAreaInspectEx::OnEnSetfocusEdtMaxMean)
	ON_EN_SETFOCUS(IDC_EDT_MIN_STDDEV, &CDlgAreaInspectEx::OnEnSetfocusEdtMinStddev)
	ON_EN_SETFOCUS(IDC_EDT_MAX_STDDEV, &CDlgAreaInspectEx::OnEnSetfocusEdtMaxStddev)
    ON_EN_KILLFOCUS(IDC_EDT_INSTOOL_NUM, &CDlgAreaInspectEx::OnEnKillfocusEdtInstoolNum)
    ON_EN_CHANGE(IDC_EDT_INSTOOL_NUM, &CDlgAreaInspectEx::OnEnChangeEdtInstoolNum)
	ON_BN_CLICKED(IDC_BTN_SET_CUR_TO_ALL, &CDlgAreaInspectEx::OnBtnSetCurToAll)
	ON_EN_SETFOCUS(IDC_EDT_COL_NUM, &CDlgAreaInspectEx::OnEnSetfocusEdtColNum)
	ON_EN_SETFOCUS(IDC_EDT_ROW_NUM, &CDlgAreaInspectEx::OnEnSetfocusEdtRowNum)
	ON_BN_CLICKED(IDC_BTN_AUTO_ARRANGE, &CDlgAreaInspectEx::OnBtnAutoArrange)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgAreaInspectEx message handlers
void CDlgAreaInspectEx::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgAreaInspectEx::UpdateTrainData(bool bValidate)
{
...
//		m_nCurToolIndex = m_SelAreaIndex.GetCurSel();
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel= m_nImageChannel;
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nInsAreaNum= m_nInsToolNum;
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLogicIndex = m_nCurLogicIndex;
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nColNum = m_nColNum;
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nRowNum = m_nRowNum;

		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMinMean.resize(m_nInsToolNum,0.0);
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMaxMean.resize(m_nInsToolNum,255.0);
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMeanInvalid.resize(m_nInsToolNum,true);
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMeanInvert.resize(m_nInsToolNum,false);

		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMinStdDev.resize(m_nInsToolNum,0.0);
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMaxStdDev.resize(m_nInsToolNum,255.0);
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bStdDevInvalid.resize(m_nInsToolNum,true);
		((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bStdDevInvert.resize(m_nInsToolNum,false);

		((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchRectVisible.resize(m_nInsToolNum,true);
		((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_LineColor.resize(m_nInsToolNum,RGB(0, 0, 255));
		((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nLineWidth.resize(m_nInsToolNum,1);
		((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_SearchRect.resize(m_nInsToolNum/*,scRect(250, 200, 50, 50)*/);

		((CAreaInspectExSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bAffineRectVisible.resize(m_nInsToolNum,true);
		((CAreaInspectExSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bModelPointVisible.resize(m_nInsToolNum,true);
		((CAreaInspectExSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_LineColor.resize(m_nInsToolNum,RGB(0, 0, 255));
		((CAreaInspectExSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_nLineWidth.resize(m_nInsToolNum,1);
		...
		{
			((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMinMean.at(i)=			m_dMinMean.at(i);
			((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMaxMean.at(i)=			m_dMaxMean.at(i);
			((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMeanInvalid.at(i)=		m_bMeanInvalid.at(i);
			((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMeanInvert.at(i) =		m_bMeanInvert.at(i);

			((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMinStdDev.at(i) =        m_dMinStdDev.at(i);
			((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMaxStdDev.at(i) =        m_dMaxStdDev.at(i);
			((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bStdDevInvalid.at(i) =    m_bStdDevInvalid.at(i);
			((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bStdDevInvert.at(i) =     m_bStdDevInvert.at(i);
		}
	...
	{
//		m_nCurToolIndex = m_SelAreaIndex.GetCurSel();
		m_nImageChannel = ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_nInsToolNum = ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nInsAreaNum;
		m_nCurLogicIndex = ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLogicIndex;
		m_nColNum = ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nColNum;
		m_nRowNum = ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nRowNum;
		...
		for (int i=0;i<m_nInsToolNum;i++)
		{
			m_dMinMean.at(i) = ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMinMean.at(i);
			m_dMaxMean.at(i)=	((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMaxMean.at(i);
			m_bMeanInvalid.at(i)=((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMeanInvalid.at(i);
			m_bMeanInvert.at(i)=((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMeanInvert.at(i);

			m_dMinStdDev.at(i)= ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMinStdDev.at(i);
			m_dMaxStdDev.at(i)= ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dMaxStdDev.at(i) ;
			m_bStdDevInvalid.at(i)= ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bStdDevInvalid.at(i);
			m_bStdDevInvert.at(i)= ((CAreaInspectExTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bStdDevInvert.at(i);
		}
...
void CDlgAreaInspectEx::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
...
void CDlgAreaInspectEx::UpdateDialogLanguage()
{
	//	return;
...
void CDlgAreaInspectEx::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgAreaInspectEx::OnBtnGetTrainImage() 
{
...
void CDlgAreaInspectEx::OnBtnTrain() 
{
...
BOOL CDlgAreaInspectEx::OnInitDialog() 
{
...
void CDlgAreaInspectEx::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CAreaInspectExTrainGuiParam trainGuiParam;
...
BOOL CDlgAreaInspectEx::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgAreaInspectEx::UpdateSearchResult()
{
...
void CDlgAreaInspectEx::OnCbnSelchangeComboAreaIndex()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
...
void CDlgAreaInspectEx::OnEnSetfocusEdtInstoolNum()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgAreaInspectEx::OnEnSetfocusEdtMinMean()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgAreaInspectEx::OnEnSetfocusEdtMaxMean()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgAreaInspectEx::OnEnSetfocusEdtMinStddev()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgAreaInspectEx::OnEnSetfocusEdtMaxStddev()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgAreaInspectEx::OnEnKillfocusEdtInstoolNum()
{
    // TODO: 在此添加控件通知处理程序代码
...
void CDlgAreaInspectEx::OnEnChangeEdtInstoolNum()
{
...
void CDlgAreaInspectEx::OnBtnSetCurToAll() 
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	// 将当前矩形大小设置给全部矩形
	sc2Vector tempRectSize = ((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_SearchRect.at(m_nCurToolIndex)->GetSize();
	for (int i=0;i<m_nInsToolNum;i++)
	{
		((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_SearchRect.at(i)->SetSize(tempRectSize);
	}
...
void CDlgAreaInspectEx::OnEnSetfocusEdtColNum()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgAreaInspectEx::OnEnSetfocusEdtRowNum()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgAreaInspectEx::OnBtnAutoArrange() 
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	m_pDlgParent->m_pSearchTool->GetTrainGuiParam(m_pDlgParent->m_pTrainGuiParam);
	sc2Vector tempRectOriginFirst = ((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_SearchRect.at(0)->GetOrigin();
	sc2Vector tempRectOriginEnd = ((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_SearchRect.at(m_nInsToolNum-1)->GetOrigin();
	...
	if (m_nRowNum == 1)
	{
		for (int i=0;i<m_nColNum; i++)
		{
			...
			((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_SearchRect.at(i)->SetOrigion(sc2Vector(dOriginX, dOriginY));
		}
	}
	else if (m_nColNum == 1)
	{
	...
	else
	{
		for (int i=0;i<m_nRowNum;i++)
		{
			for (int j=0;j<m_nColNum; j++)
			{
				...
				double dOriginY = tempRectOriginFirst.GetY() + dSeparatorY*i;
				((CAreaInspectExTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_SearchRect.at(i*m_nColNum + j)->SetOrigion(sc2Vector(dOriginX, dOriginY));
			}
		}
	}
