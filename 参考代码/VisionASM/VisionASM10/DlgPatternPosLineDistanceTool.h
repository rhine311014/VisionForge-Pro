...
class CDlgSearch;
class CDlgPatternPosLineDistanceTool : public CDialogEx
{
	DECLARE_DYNAMIC(CDlgPatternPosLineDistanceTool)

public:
	CDlgPatternPosLineDistanceTool(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgPatternPosLineDistanceTool();
	...
	// 对话框数据
	enum { IDD = IDD_DLG_PATTERN_POSLINEDISTANCE_TOOL };
