#if !defined(AFX_DLGQUICKSEARCHTOOLSETTING_H__6AA12E6D_AE79_4FA3_8F5C_5DA2B54D13D8__INCLUDED_)
#define AFX_DLGQUICKSEARCHTOOLSETTING_H__6AA12E6D_AE79_4FA3_8F5C_5DA2B54D13D8__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DlgQuickSearchToolSetting.h : header file
//
...
class CDlgSearch;
class CDlgQuickSearchTool : public CDialog
{
// Construction
public:
	CDlgQuickSearchTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CDlgQuickSearchTool)
	enum { IDD = IDD_DLG_QUICKSEARCH_TOOL };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlgQuickSearchTool)
	public:
...
public:
	BOOL m_bEnableSharpness;
	double m_dSharpnessScore;
	afx_msg void OnBnClickedChkEnableSharpness();
	afx_msg void OnEnSetfocusEdtSharpnessThre();
public:
	int m_nImageChannel;
};
