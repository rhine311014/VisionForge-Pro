// IdReaderBarCodeTool.h: interface for the CIdReaderBarCodeTool class.
//
//////////////////////////////////////////////////////////////////////
...
#define BarCodeTool_MaxResultNum 20
#pragma pack(push,8)

// IdReaderBarCode定位工具训练Data参数类
typedef struct tagIdReaderBarCodeTrainDataParam : public CBaseTrainDataParam
{

	Find1DCodePara m_Find1DCodePara;		//读码参数

	tagIdReaderBarCodeTrainDataParam()
	{
...
}CIdReaderBarCodeTrainDataParam;

// IdReaderBarCode定位工具训练Gui参数类
typedef struct tagIdReaderBarCodeTrainGuiParam : public CBaseTrainGuiParam
{
	scRect    m_TrainRect;
	...
	tagIdReaderBarCodeTrainGuiParam()
	{
...
}CIdReaderBarCodeTrainGuiParam;

// IdReaderBarCode定位工具搜索Data参数类
typedef struct tagIdReaderBarCodeSearchDataParam : public CBaseSearchDataParam
{

	tagIdReaderBarCodeSearchDataParam()
	{
...
}CIdReaderBarCodeSearchDataParam;

// IdReaderBarCode定位工具搜索Gui参数类
typedef struct tagIdReaderBarCodeGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColorOK;					    // 图形OK颜色
	int				m_nLineWidth;						// 图形线宽
	bool			m_bVisible;							// 搜索结果可见

	tagIdReaderBarCodeGuiParam()
	{
...
}CIdReaderBarCodeSearchGuiParam;

// IdReaderBarCode训练结果
typedef struct tagIdReaderBarCodeTrainResult
{
...
}CIdReaderBarCodeTrainResult;


//
//	DM读码工具
//
class CIdReaderBarCodeTool : public CBaseSearchTool    
{
public:
	CIdReaderBarCodeTool();
	CIdReaderBarCodeTool(CIdReaderBarCodeTool &cIdReaderBarCodeTool);
	CIdReaderBarCodeTool& operator=(CIdReaderBarCodeTool &cIdReaderBarCodeTool);
	virtual ~CIdReaderBarCodeTool();
...
private:	
	...
	CIdReaderBarCodeTrainDataParam		m_tmpTrainDataParam;			// 当前训练Data参数
	CIdReaderBarCodeTrainGuiParam		m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CIdReaderBarCodeSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CIdReaderBarCodeSearchGuiParam		m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CIdReaderBarCodeTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage								m_tmpImageTrain;				// 当前训练图像
	cpImage								m_tmpImageMask;					// 当前掩模图像
	CIdReaderBarCodeTrainDataParam		m_TrainDataParam;				// 训练Data参数
	CIdReaderBarCodeTrainGuiParam		m_TrainGuiParam;				// 训练Gui参数	
	CIdReaderBarCodeSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CIdReaderBarCodeSearchGuiParam		m_SearchGuiParam;				// 搜索Gui参数
	CIdReaderBarCodeTrainResult			m_TrainResult;					// 训练结果
	...
	scGuiPolyline						m_pGuiPolylineArray[BarCodeTool_MaxResultNum];
	scGuiText							m_pGuiTextArray[BarCodeTool_MaxResultNum];
