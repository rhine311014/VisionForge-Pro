#if !defined(AFX_DLGMQUICKSEARCHTOOLSETTING_H__6AA12E6D_AE79_4FA3_8F5C_5DA2B54D13D8__INCLUDED_)
#define AFX_DLGMQUICKSEARCHTOOLSETTING_H__6AA12E6D_AE79_4FA3_8F5C_5DA2B54D13D8__INCLUDED_
...
class CDlgSearch;
class CDlgMQuickSearchTool : public CDialog
{
// Construction
public:
	CDlgMQuickSearchTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CDlgMQuickSearchTool)
	enum { IDD = IDD_DLG_MQUICKSEARCH_TOOL };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlgMQuickSearchTool)
	public:
