...
void CDynDialogEx::AddSystemButtons()
{
	...
	CRect rect(FIXEDCOL1, m_nCurRow+ (long)(ROWSTEPSIZE * 1.2), FIXEDCOL2 - 60, m_nCurRow + 2* (long)(ROWSTEPSIZE * 1.2));

	AddDlgControl(BUTTON, _T("确定"), STYLE_BUTTON, EXSTYLE_BUTTON, &rect, NULL, IDOK);
		
	// This has to be revised later.
	rect.left  += 100;
	rect.right += 100;
	AddDlgControl(BUTTON, _T("取消"), STYLE_BUTTON, EXSTYLE_BUTTON, &rect, NULL, IDCANCEL);
