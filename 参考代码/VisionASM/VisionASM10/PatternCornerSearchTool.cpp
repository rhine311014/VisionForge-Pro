...
CPatternCornerSearchTool::CPatternCornerSearchTool(void)
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
...
CPatternCornerSearchTool::CPatternCornerSearchTool(CPatternCornerSearchTool &cPatternCornerSearchTool)
{
	if (cPatternCornerSearchTool.GetSearchToolType() != ePatternCornerSearchTool)
	{
		return;
	}
...
CPatternCornerSearchTool& CPatternCornerSearchTool::operator=(CPatternCornerSearchTool &cPatternCornerSearchTool)
{
...
CSearchToolType CPatternCornerSearchTool::GetSearchToolType()
{
	return ePatternCornerSearchTool;
}

// 设置显示控件指针		
bool CPatternCornerSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CPatternCornerSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 设置Gui图形的关键字														
bool CPatternCornerSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CPatternCornerSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CPatternCornerSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CPatternCornerSearchTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CPatternCornerSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CPatternCornerSearchTool::UpdateTrainGuiDisplay()
{	
...
bool CPatternCornerSearchTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索界面显示									
bool CPatternCornerSearchTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
// 更新界面显示
bool CPatternCornerSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CPatternCornerSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != ePatternCornerSearchTool)
	{
		return false;
	}

	m_tmpTrainDataParam = *((CPatternCornerSearchTrainDataParam*)pTrainDataParam);

	return true;
}

// 获取训练Data参数									
bool CPatternCornerSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CPatternCornerSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;

	return true;
}

// 获取搜索Gui参数						
bool CPatternCornerSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != ePatternCornerSearchTool)
	{
		return false;
	}

	m_tmpTrainGuiParam = *((CPatternCornerSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CPatternCornerSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CPatternCornerSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;

	return true;
}

// 设置训练原始图像				
bool CPatternCornerSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CPatternCornerSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CPatternCornerSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CPatternCornerSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CPatternCornerSearchTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CPatternCornerSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CPatternCornerSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != ePatternCornerSearchTool)
	{
		return false;
	}

	*((CPatternCornerSearchTrainResult*)pTrainResult) = m_tmpTrainResult;

	return true;
}	

// 是否训练成功
bool CPatternCornerSearchTool::IsTrained()
{
	return m_bTrainOK;
}

// 设置搜索Data参数	
bool CPatternCornerSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != ePatternCornerSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CPatternCornerSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CPatternCornerSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CPatternCornerSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CPatternCornerSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != ePatternCornerSearchTool)
	{
		return false;
	}

	m_tmpSearchGuiParam = *((CPatternCornerSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CPatternCornerSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CPatternCornerSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;

	return true;
}

// 执行搜索 					
bool CPatternCornerSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			if (bFindLine[0] && bFindLine[1])
			{
					...
					&& crossPointArray.size() > 0)
				{
					...
					searchResult.m_vdAuxiliaryPosX[3] = tmpPatternResult.GetPosition().GetX();
					searchResult.m_vdAuxiliaryPosY[3] = tmpPatternResult.GetPosition().GetY();
...
// 获取搜索结果个数										
int CPatternCornerSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CPatternCornerSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像
bool CPatternCornerSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != ePatternCornerSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CPatternCornerSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
	//	BYTE byR, byG, byB;
	CPatternCornerSearchTrainDataParam tmpTrainDataParam;
	CPatternCornerSearchTrainGuiParam tmpTrainGuiParam;
	CPatternCornerSearchSearchDataParam tmpSearchDataParam;
	CPatternCornerSearchSearchGuiParam tmpSearchGuiParam;	
	CPatternCornerSearchTrainResult    tmpTrainResult;
...
// 保存模板文件							
bool CPatternCornerSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CPatternCornerSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CPatternCornerSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CPatternCornerSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CPatternCornerSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CPatternCornerSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CPatternCornerSearchTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CPatternCornerSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
bool CPatternCornerSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CPatternCornerSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CPatternCornerSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CPatternCornerSearchTool::RestoreSearchParam()
{
...
void CPatternCornerSearchTool::SetLanguage(int nLanguage)
{
...
CString	CPatternCornerSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
