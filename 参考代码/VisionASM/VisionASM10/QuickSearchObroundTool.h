// QuickSearchObroundTool.h: interface for the CQuickSearchObroundTool class.
//
//////////////////////////////////////////////////////////////////////
...
// QuickSearchObround定位工具训练Data参数类
typedef struct tagQuickSearchObroundTrainDataParam : public CBaseTrainDataParam
{
	double			m_dGrau;							// 颗粒度
	...
	tagQuickSearchObroundTrainDataParam()
	{
		m_dGrau				= 2.0;
		m_lNoiseThre		= 10;
		m_lTotalMag			= 200;
...
}CQuickSearchObroundTrainDataParam;

// QuickSearchObround定位工具训练Gui参数类
typedef struct tagQuickSearchObroundTrainGuiParam : public CBaseTrainGuiParam
{
	...
	tagQuickSearchObroundTrainGuiParam()
	{
...
}CQuickSearchObroundTrainGuiParam;

// QuickSearchObround定位工具搜索Data参数类
typedef struct tagQuickSearchObroundSearchDataParam : public CBaseSearchDataParam
{
	int		m_nSearchNum;								// 搜索个数
	double	m_dAcceptThre;								// 接收阈值
	double  m_dAngleLow;								// 低角度
	double	m_dAngleHigh;								// 高角度
	tagQuickSearchObroundSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.8;
		m_dAngleLow		= -5.0;
...
}CQuickSearchObroundSearchDataParam;

// QuickSearchObround定位工具搜索Gui参数类
typedef struct tagQuickSearchObroundGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
...
}CQuickSearchObroundSearchGuiParam;

// QuickSearch训练结果
typedef struct tagQuickSearchObroundTrainResult
{
	double m_dModelX;
	double m_dModelY;
	double m_dCenterX;
	double m_dCenterY;
	tagQuickSearchObroundTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
		m_dCenterX = 0;
...
}CQuickSearchObroundTrainResult;

//
//	圆定位工具
//
class /*SV_SEARCHTOOL_API*/ CQuickSearchObroundTool : public CBaseSearchTool    
{
public:
	CQuickSearchObroundTool();
	CQuickSearchObroundTool(CQuickSearchObroundTool &cQuickSearchObroundTool);
	CQuickSearchObroundTool& operator=(CQuickSearchObroundTool &cQuickSearchObroundTool);
	virtual ~CQuickSearchObroundTool();
...
private:	
	...
	CQuickSearchObroundTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CQuickSearchObroundTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CQuickSearchObroundSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CQuickSearchObroundSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CQuickSearchObroundTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
 	CQuickSearchObroundTrainDataParam			m_TrainDataParam;				// 训练Data参数
 	CQuickSearchObroundTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
 	CQuickSearchObroundSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
 	CQuickSearchObroundSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CQuickSearchObroundTrainResult			m_TrainResult;					// 训练结果
