...
CDlgQuickCornerMulObroundTool::CDlgQuickCornerMulObroundTool(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgQuickCornerMulObroundTool::IDD, pParent)
...
void CDlgQuickCornerMulObroundTool::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDT_SEARCH_NUM0, m_nSearchNum);
	DDX_Check(pDX, IDC_CHK_ENABLE_MASK, m_bEnableMask);
	DDX_Text(pDX, IDC_EDT_ANGLE_HIGH0, m_dAngleHigh);
	DDX_Text(pDX, IDC_EDT_ANGLE_LOW0, m_dAngleLow);
...
BEGIN_MESSAGE_MAP(CDlgQuickCornerMulObroundTool, CDialog)
	...
	ON_EN_SETFOCUS(IDC_EDT_ANGLE_LOW0, OnSetfocusEdtAngleLow)
	ON_EN_SETFOCUS(IDC_EDT_ANGLE_HIGH0, OnSetfocusEdtAngleHigh)
	ON_EN_SETFOCUS(IDC_EDT_ACCEPT_THRE, OnSetfocusEdtAcceptThre)
	ON_BN_CLICKED(IDC_BTN_FULL_IMAGE_SEARCH, OnBtnFullImageSearch)
	ON_EN_SETFOCUS(IDC_EDT_SEARCH_NUM0, OnSetfocusEdtSearchNum)
	...
	ON_EN_SETFOCUS(IDC_EDT_GRAU,&CDlgQuickCornerMulObroundTool::OnSetfocusEdtGrau)
	ON_EN_KILLFOCUS(IDC_EDT_GRAU,&CDlgQuickCornerMulObroundTool::OnKillfocusEdtGrau)
	ON_EN_SETFOCUS(IDC_EDT_NOISETHRE,&CDlgQuickCornerMulObroundTool::OnSetfocusEdtNoise)
	ON_EN_KILLFOCUS(IDC_EDT_NOISETHRE,&CDlgQuickCornerMulObroundTool::OnKillfocusEdtNoise)
	ON_EN_SETFOCUS(IDC_EDT_TOTAL_MAG,&CDlgQuickCornerMulObroundTool::OnSetfocusEdtTotalMag)
	ON_EN_KILLFOCUS(IDC_EDT_TOTAL_MAG,&CDlgQuickCornerMulObroundTool::OnKillfocusEdtTotalMag)
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_RADIO_OBROUND_INDEX1, &CDlgQuickCornerMulObroundTool::OnBnClickedRadioObroundIndex1)
	ON_BN_CLICKED(IDC_RADIO_OBROUND_INDEX2, &CDlgQuickCornerMulObroundTool::OnBnClickedRadioObroundIndex2)
	ON_BN_CLICKED(IDC_CHK_MUL_OBROUND, &CDlgQuickCornerMulObroundTool::OnBnClickedChkMulObround)
	ON_BN_CLICKED(IDC_RAD_CIRCLE_RESULT_CENTRE_CIRCLE, &CDlgQuickCornerMulObroundTool::OnBnClickedRadCircleResultCentreCircle)
	ON_BN_CLICKED(IDC_RAD_CIRCLE_RESULT_RIGHT_CIRCLE, &CDlgQuickCornerMulObroundTool::OnBnClickedRadCircleResultRightCircle)
	ON_BN_CLICKED(IDC_RAD_CIRCLE_RESULT_LEFT_CIRCLE, &CDlgQuickCornerMulObroundTool::OnBnClickedRadCircleResultLeftCircle)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER, &CDlgQuickCornerMulObroundTool::OnBnClickedChkShowLineCaliper)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgPatternCornerMulObroundTool message handlers
void CDlgQuickCornerMulObroundTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgQuickCornerMulObroundTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel; 
		((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau = m_dGrau; 
		((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre = m_lNoiseThre;
		((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag = m_lTotalMag;
		((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableMulObround = m_bEnableMulObround;
		...
		for (int i=0;i<DLG_QUICK_OBROUND_NUM;i++)
		{
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[i] = m_nTempCircleOutLineNum[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[i] = m_dTempCircleContrastThre[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[i] = m_lTempCircleFilterHalfWidth[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[i] = (EdgePolarity)m_nTempCirclePolarityMode[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[i] = m_bTempSortByScore1[i];
			((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[i] = m_nTempCircleCaliperNum[i];
			((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CaliperSearchDirection[i] = (CaliperSearchDirection)m_nTempCircleInwardMode[i];
		}
		...
		for (int i = 0; i < DLG_QUICK_LINE_NUM; i++)
		{
			((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nLineCaliperNum[i]		= m_nTempLineCaliperNum[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineOutLineNum[i]		= m_nTempLineOutLineNum[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dLineContrastThre[i]	= m_dTempLineContrastThre[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeLineProperty[i]	= (EdgePolarity)m_nTempLinePolarityMode[i];				
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bLineSortByScore[i]	= m_bTempLineSortByScore[i];
			((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bLineEnableLineMask[i]	= m_bTempLineEnableMask[i];
			((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bLineCaliperVisible[i]	= m_bTempShowCaliper[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bLineEnableDualEdge[i]	= m_bTempLineEnableDualEdge[i];
			((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lLineFilterHalfWidth[i] = m_lTempLineFilterHalfWidth[i];
		}
	...
	{
		m_nImageChannel	= ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_dGrau			= ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau;
		m_lNoiseThre	= ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre;
		m_lTotalMag		= ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag;
		m_bEnableMask = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;
		m_bEnableMulObround = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableMulObround;	

		for (int i=0;i<DLG_QUICK_OBROUND_NUM;i++)
		{
			m_nTempCircleOutLineNum[i] =  ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nOutLineNum[i];
			m_dTempCircleContrastThre[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dContrastThre[i];
			m_lTempCircleFilterHalfWidth[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lFilterHalfWidth[i];
			m_nTempCirclePolarityMode[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeProperty[i];
			m_bTempSortByScore1[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bSortByScore[i];
			m_nTempCircleCaliperNum[i] = ((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCaliperNum[i];
			m_nTempCircleInwardMode[i] = ((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CaliperSearchDirection[i];
		...
		for (int i = 0; i < DLG_QUICK_LINE_NUM; i++)
		{
			m_nTempLineCaliperNum[i] = ((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nLineCaliperNum[i];
			m_nTempLineOutLineNum[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineOutLineNum[i];
			m_dTempLineContrastThre[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dLineContrastThre[i];
			m_nTempLinePolarityMode[i]=((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_edgeLineProperty[i];				
			m_bTempLineSortByScore[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bLineSortByScore[i];
			m_bTempLineEnableMask[i] =((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bLineEnableLineMask[i];
			m_bTempShowCaliper[i] = ((CQuickCornerMulObroundTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bLineCaliperVisible[i];
			m_bTempLineEnableDualEdge[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bLineEnableDualEdge[i];
			m_lTempLineFilterHalfWidth[i] = ((CQuickCornerMulObroundTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lLineFilterHalfWidth[i];
		}
...
void CDlgQuickCornerMulObroundTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow = m_dAngleLow;
		((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh = m_dAngleHigh;
		((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nObroundOutputResult = m_nObroundOutputResult;

		m_bTempEnableShowLinePoint[m_nLineIndex] = m_bEnableShowLinePoint;
		for (int i = 0;i < DLG_QUICK_LINE_NUM; i++)
		{
			((CQuickCornerMulObroundSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint[i] = m_bTempEnableShowLinePoint[i];
		}
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;
		m_dAngleLow		= ((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CQuickCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh;
		m_nObroundOutputResult = ((CPatternCornerMulObroundSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nObroundOutputResult;

		for (int i = 0;i  < DLG_QUICK_LINE_NUM; i++)
		{
			m_bTempEnableShowLinePoint[i] = ((CQuickCornerMulObroundSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint[i];
		}
...
void CDlgQuickCornerMulObroundTool::UpdateDialogLanguage()
{
	//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_QUICK_CORNER_MUIOBROUND_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgQuickCornerMulObroundTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgQuickCornerMulObroundTool::OnBtnGetTrainImage() 
{
...
void CDlgQuickCornerMulObroundTool::OnBtnTrain() 
{
...
void CDlgQuickCornerMulObroundTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgQuickCornerMulObroundTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgQuickCornerMulObroundTool::OnInitDialog() 
{
...
void CDlgQuickCornerMulObroundTool::OnBtnSetCenter() 
{
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		cpImage imageTrain, imagePattern;
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CQuickCornerMulObroundTrainGuiParam *pTrainGuiParam = new CQuickCornerMulObroundTrainGuiParam;
...
void CDlgQuickCornerMulObroundTool::OnSetfocusEdtAngleLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		...
		GetDlgItem(IDC_EDT_ANGLE_LOW0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDT_ANGLE_LOW0, strInput);

		if (TRUE == m_pDlgParent->m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDT_ANGLE_LOW0, strOutput);
		}
	}
}

void CDlgQuickCornerMulObroundTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDT_ANGLE_HIGH0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDT_ANGLE_HIGH0, strInput);

		if (TRUE == m_pDlgParent->m_ctrlKeyboard.ShowNumeralDotSymbolKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDT_ANGLE_HIGH0, strOutput);
		}
	}
}

void CDlgQuickCornerMulObroundTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDT_SEARCH_NUM0)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDT_SEARCH_NUM0, strInput);

		if (TRUE == m_pDlgParent->m_ctrlKeyboard.ShowNumeralKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDT_SEARCH_NUM0, strOutput);
		}
	}
}

void CDlgQuickCornerMulObroundTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickCornerMulObroundTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CQuickCornerMulObroundTrainGuiParam trainGuiParam;
...
BOOL CDlgQuickCornerMulObroundTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgQuickCornerMulObroundTool::OnChangeEdtCircleCalipernum() 
{
...
void CDlgQuickCornerMulObroundTool::OnRadCircleInwardMode0() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgQuickCornerMulObroundTool::OnRadCircleInwardMode1() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgQuickCornerMulObroundTool::OnSetfocusEdtCircleCalipernum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickCornerMulObroundTool::OnSetfocusEdtCircleContrastThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickCornerMulObroundTool::OnSetfocusEdtCircleOutlineNum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickCornerMulObroundTool::OnBnClickedRadioLineIndex1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);		
...
void CDlgQuickCornerMulObroundTool::OnEnSetfocusEdtLineCalipernum()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgQuickCornerMulObroundTool::OnEnSetfocusEdtLineOutlineNum()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgQuickCornerMulObroundTool::OnEnSetfocusEdtLineContrastThre()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgQuickCornerMulObroundTool::OnEnChangeEdtLineCalipernum()
{
...
void CDlgQuickCornerMulObroundTool::OnBnClickedCheckLineShowLinePoint()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateSearchData(true);
	m_pDlgParent->UpdateGuiDisplay();
...
void CDlgQuickCornerMulObroundTool::OnBnClickedCheckLineSortByScore()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgQuickCornerMulObroundTool::OnBnClickedRadLinePolarityMode1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgQuickCornerMulObroundTool::OnBnClickedCheckLineEnableMask()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
	m_pDlgParent->UpdateGuiDisplay();
...
void CDlgQuickCornerMulObroundTool::OnBnClickedRadioObroundIndex1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);	
...
void CDlgQuickCornerMulObroundTool::OnBnClickedRadioObroundIndex2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgQuickCornerMulObroundTool::OnBnClickedChkMulObround()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	UpdateTrainData(true);
...
void CDlgQuickCornerMulObroundTool::OnBnClickedRadCircleResultCentreCircle()
{
	// TODO: 在此添加控件通知处理程序代码
	// 	UpdateTrainData(true);
	// 	UpdateSearchData(true);
...
void CDlgQuickCornerMulObroundTool::OnBnClickedRadCircleResultRightCircle()
{
	// TODO: 在此添加控件通知处理程序代码
	// 	UpdateTrainData(true);
	// 	UpdateSearchData(true);
...
void CDlgQuickCornerMulObroundTool::OnBnClickedRadCircleResultLeftCircle()
{
	// TODO: 在此添加控件通知处理程序代码
	// 	UpdateTrainData(true);
	// 	UpdateSearchData(true);
...
void CDlgQuickCornerMulObroundTool::OnBnClickedChkShowLineCaliper()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgQuickCornerMulObroundTool::OnSetfocusEdtGrau()
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickCornerMulObroundTool::OnKillfocusEdtGrau()
{
	return ;
}

void CDlgQuickCornerMulObroundTool::OnSetfocusEdtNoise()
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickCornerMulObroundTool::OnKillfocusEdtNoise()
{
	return ;
}
void CDlgQuickCornerMulObroundTool::OnSetfocusEdtTotalMag()
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickCornerMulObroundTool::OnKillfocusEdtTotalMag()
{
	return ;
}

void CDlgQuickCornerMulObroundTool::OnEnSetfocusEditLineFilterHalfWidth1() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgQuickCornerMulObroundTool::OnEnSetfocusEditCircleFilterHalfWidth1() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
