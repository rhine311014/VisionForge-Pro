// QuickSearchGenRectTool.cpp: implementation of the CQuickSearchGenRectTool class.
//
//////////////////////////////////////////////////////////////////////
...
CQuickSearchGenRectTool::CQuickSearchGenRectTool()
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
...
CQuickSearchGenRectTool::CQuickSearchGenRectTool(CQuickSearchGenRectTool &cQuickSearchGenRectTool)
{
	if (cQuickSearchGenRectTool.GetSearchToolType() != eQuickSearchGenRectTool)
	{
		return;
	}
...
// 	ClearResult();
	...
	// 赋值
	m_CamHeight								= cQuickSearchGenRectTool.m_CamHeight;
	m_CamWidth								= cQuickSearchGenRectTool.m_CamWidth;

	m_TrainDataParam						= cQuickSearchGenRectTool.m_TrainDataParam;
	m_TrainGuiParam							= cQuickSearchGenRectTool.m_TrainGuiParam;
	m_SearchDataParam						= cQuickSearchGenRectTool.m_SearchDataParam;
	m_SearchGuiParam						= cQuickSearchGenRectTool.m_SearchGuiParam;
	m_TrainResult							= cQuickSearchGenRectTool.m_TrainResult;
	m_ImageTrain							= cQuickSearchGenRectTool.m_ImageTrain;
	m_ImageMask								= cQuickSearchGenRectTool.m_ImageMask;
	m_bTrainGuiShow							= cQuickSearchGenRectTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow                   = cQuickSearchGenRectTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cQuickSearchGenRectTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cQuickSearchGenRectTool.m_bTrainOK;
	m_pGuiDisplay							= cQuickSearchGenRectTool.m_pGuiDisplay;
	if (m_pGuiDisplay)
	{
		SetDisplay(m_pGuiDisplay);
	}
	cQuickSearchGenRectTool.UpdateSearchGuiData(true);
	cQuickSearchGenRectTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cQuickSearchGenRectTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cQuickSearchGenRectTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cQuickSearchGenRectTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cQuickSearchGenRectTool.m_tmpSearchGuiParam);
	SetTrainImage(cQuickSearchGenRectTool.m_tmpImageTrain);
	SetMaskImage(cQuickSearchGenRectTool.m_tmpImageMask);
	if (m_bTrainOK)
	{
		m_bTrainOK = false;
...
CQuickSearchGenRectTool& CQuickSearchGenRectTool::operator=(CQuickSearchGenRectTool &cQuickSearchGenRectTool)
{
	if (this == &cQuickSearchGenRectTool)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CQuickSearchGenRectTool::GetSearchToolType()
{
	return eQuickSearchGenRectTool;
}										   

// 设置显示控件指针		
bool CQuickSearchGenRectTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{	
	ClearAllGui();
...
// 设置训练结果显示控件指针
bool CQuickSearchGenRectTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CQuickSearchGenRectTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 获取训练结果显示控件指针
scGuiDisplay* CQuickSearchGenRectTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CQuickSearchGenRectTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CQuickSearchGenRectTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CQuickSearchGenRectTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CQuickSearchGenRectTool::ShowTrainResultGui(bool bShow)
{
...
// 更新搜索界面显示									
bool CQuickSearchGenRectTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练Gui控件显示
bool CQuickSearchGenRectTool::UpdateTrainGuiDisplay()
{
...
// 更新训练结果Gui控件显示
bool CQuickSearchGenRectTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索Gui控件显示														
bool CQuickSearchGenRectTool::UpdateSearchResultGuiDisplay()
{
	int i=0;
...
// 更新界面显示
bool CQuickSearchGenRectTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CQuickSearchGenRectTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eQuickSearchGenRectTool)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CQuickSearchGenRectTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CQuickSearchGenRectTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CQuickSearchGenRectTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CQuickSearchGenRectTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eQuickSearchGenRectTool)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CQuickSearchGenRectTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CQuickSearchGenRectTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CQuickSearchGenRectTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CQuickSearchGenRectTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CQuickSearchGenRectTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CQuickSearchGenRectTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CQuickSearchGenRectTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CQuickSearchGenRectTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CQuickSearchGenRectTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CQuickSearchGenRectTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eQuickSearchGenRectTool)
	{
		return false;
	}
	
	*((CQuickSearchGenRectTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}	

// 是否训练成功
bool CQuickSearchGenRectTool::IsTrained()
{
	return m_bTrainOK;
}
				
// 设置搜索Data参数	
bool CQuickSearchGenRectTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eQuickSearchGenRectTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CQuickSearchGenRectSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CQuickSearchGenRectTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CQuickSearchGenRectSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CQuickSearchGenRectTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eQuickSearchGenRectTool)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CQuickSearchGenRectSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CQuickSearchGenRectTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CQuickSearchGenRectSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CQuickSearchGenRectTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
	...
	if (bRet)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			double dRMS;
			//if (m_FindGenRectTool.Execute(ImageSearch, ResGenRect, dRMS, (scFindGenRect::FindMethod)(m_tmpSearchDataParam.m_nMethod+1))) // 成功
			
			if(bIsProcessImage)
			{
				bRet = m_FindGenRectTool.Execute(tmpImage, ResGenRect, dRMS, (scFindGenRect::FindMethod)(m_tmpSearchDataParam.m_nMethod+1)); // 成功
			}
			else
			{
				bRet = m_FindGenRectTool.Execute(ImageSearch, ResGenRect, dRMS, (scFindGenRect::FindMethod)(m_tmpSearchDataParam.m_nMethod+1)); // 成功
			}
...
// 获取搜索结果个数										
int CQuickSearchGenRectTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CQuickSearchGenRectTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像文件
bool CQuickSearchGenRectTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eQuickSearchGenRectTool)
	{
		return false;
	}
...
// 加载模板文件
bool CQuickSearchGenRectTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CQuickSearchGenRectTrainDataParam tmpTrainDataParam;
	CQuickSearchGenRectTrainGuiParam tmpTrainGuiParam;
	CQuickSearchGenRectSearchDataParam tmpSearchDataParam;
	CQuickSearchGenRectSearchGuiParam tmpSearchGuiParam;
	CQuickSearchGenRectTrainResult  tmpTrainResult;
	if (!cXMLConfigurator.Load(strXmlPath))
	{
		return false;
	}
...
// 保存模板文件							
bool CQuickSearchGenRectTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CQuickSearchGenRectTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CQuickSearchGenRectTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CQuickSearchGenRectTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
bool CQuickSearchGenRectTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CQuickSearchGenRectTool::ClearResult()
{
	ClearResultGui();
...
bool CQuickSearchGenRectTool::SetGuiByCam(double nWidth,double nHeight)
{
	//训练区域
...
bool CQuickSearchGenRectTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CQuickSearchGenRectTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CQuickSearchGenRectTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CQuickSearchGenRectTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CQuickSearchGenRectTool::RestoreSearchParam()
{
...
void CQuickSearchGenRectTool::SetLanguage(int nLanguage)
{
...
CString CQuickSearchGenRectTool::GetResultErrInfo()
{
	CString strErrInfo;
