...
#ifndef BTNST_DISABLETYPE_NORMALDISABLE
#define BTNST_DISABLETYPE_NORMALDISABLE	(HICON)(0xffffffff - 1L)
#endif

#ifndef BTNST_DISABLETYPE_GRAY
#define BTNST_DISABLETYPE_GRAY			(HICON)(0xffffffff - 2L)
#endif

#ifndef BTNST_DISABLETYPE_UNION
#define BTNST_DISABLETYPE_UNION			(HICON)(0xffffffff - 3L)
#endif

#ifndef BTNST_DISABLETYPE_NORMAL
#define BTNST_DISABLETYPE_NORMAL		(HICON)(0xffffffff - 4L)
#endif
...
public:
	...
	DWORD SetIcon(	int nIconIn, UINT uiCxDesiredIn, UINT uiCyDesiredIn, 
					int nIconOut = NULL, UINT uiCxDesiredOut = 0, UINT uiCyDesiredOut = 0, 
					int nIconDisabled = (int)BTNST_DISABLETYPE_GRAY, UINT uiCxDesiredDisabled = 0, UINT uiCyDesiredDisabled = 0);
	DWORD SetIcon(int nIconIn, int nIconOut = 0, int nIconDisabled = (int)BTNST_DISABLETYPE_GRAY);
	DWORD SetIcon(HICON hIconIn, HICON hIconOut = NULL, HICON hIconDisabled = BTNST_DISABLETYPE_GRAY);
...
protected:
	...
	HICON CreateUnionIcon(HICON hIcon);		// New defined
	...
	int			m_nIdxSelect;		// radiobutton selected index
	HWND		m_hRadioFirst;
	HWND		m_hRadioLast;
...
private:
	...
	void CancelHover();
	virtual void FreeResources(BOOL bCheckForNULL = TRUE);
	...
	int			m_nDisableIconType;	// Icon type of Disabled button (New defined)
