// DlgCombinedPatternSearchTool.cpp : 实现文件
//
...
IMPLEMENT_DYNAMIC(CDlgCombinedPatternSearchTool, CDialogEx)

CDlgCombinedPatternSearchTool::CDlgCombinedPatternSearchTool(CWnd* pParent /*=NULL*/)
	: CDialogEx(CDlgCombinedPatternSearchTool::IDD, pParent)
	, m_dAcceptThre2(0)
	, m_dConfusionThre2(0)
	, m_nImageChannel(0)
{
...
CDlgCombinedPatternSearchTool::~CDlgCombinedPatternSearchTool()
{
}

void CDlgCombinedPatternSearchTool::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHK_ENABLE_MASK2, m_bEnableMask1);
	DDX_Radio(pDX, IDC_RADIO_POSTION, m_nPostion);
	DDX_Text(pDX, IDC_EDT_ACCEPT_THRE3, m_dAcceptThre2);
	DDX_Text(pDX, IDC_EDT_CONFUSION_THRE2, m_dConfusionThre2);
	DDX_Radio(pDX, IDC_RADIO_CHANNEL_GRAY, m_nImageChannel);
}


BEGIN_MESSAGE_MAP(CDlgCombinedPatternSearchTool, CDialogEx)
	ON_BN_CLICKED(IDC_BTN_GET_TRAIN_IMAGE, &CDlgCombinedPatternSearchTool::OnBnClickedBtnGetTrainImage)
	ON_BN_CLICKED(IDC_BTN_TRAIN, &CDlgCombinedPatternSearchTool::OnBnClickedBtnTrain)
	ON_BN_CLICKED(IDC_BTN_SET_CENTER, &CDlgCombinedPatternSearchTool::OnBnClickedBtnSetCenter)
	ON_BN_CLICKED(IDC_BTN_SET_MASK_IMAGE, &CDlgCombinedPatternSearchTool::OnBnClickedBtnSetMaskImage)
	ON_BN_CLICKED(IDC_CHK_ENABLE_MASK, &CDlgCombinedPatternSearchTool::OnBnClickedChkEnableMask)
	ON_CBN_SELCHANGE(IDC_COMBO_ACCURACY_MODE, &CDlgCombinedPatternSearchTool::OnCbnSelchangeComboAccuracyMode)
	ON_CBN_SELCHANGE(IDC_COMBO_SPEED_MODE, &CDlgCombinedPatternSearchTool::OnCbnSelchangeComboSpeedMode)
	ON_EN_SETFOCUS(IDC_EDT_ANGLE_LOW, &CDlgCombinedPatternSearchTool::OnSetfocusEdtAngleLow)
	ON_EN_SETFOCUS(IDC_EDT_ANGLE_HIGH, &CDlgCombinedPatternSearchTool::OnSetfocusEdtAngleHigh)
	ON_EN_SETFOCUS(IDC_EDT_SEARCH_NUM, &CDlgCombinedPatternSearchTool::OnSetfocusEdtSearchNum)
	ON_EN_SETFOCUS(IDC_EDT_ACCEPT_THRE, &CDlgCombinedPatternSearchTool::OnSetfocusEdtAcceptThre)
	ON_EN_SETFOCUS(IDC_EDT_CONFUSION_THRE, &CDlgCombinedPatternSearchTool::OnSetfocusEdtConfusionThre)
	ON_BN_CLICKED(IDC_BTN_FULL_IMAGE_SEARCH, &CDlgCombinedPatternSearchTool::OnBnClickedBtnFullImageSearch)
	ON_BN_CLICKED(IDC_BTN_SET_MASK_IMAGE2, &CDlgCombinedPatternSearchTool::OnBnClickedBtnSetMaskImage2)
	ON_BN_CLICKED(IDC_CHK_ENABLE_MASK2, &CDlgCombinedPatternSearchTool::OnBnClickedChkEnableMask2)
	ON_EN_SETFOCUS(IDC_EDT_ACCEPT_THRE3, &CDlgCombinedPatternSearchTool::OnEnSetfocusEdtAcceptThre3)
	ON_EN_SETFOCUS(IDC_EDT_CONFUSION_THRE2, &CDlgCombinedPatternSearchTool::OnEnSetfocusEdtConfusionThre2)
END_MESSAGE_MAP()


// CDlgCombinedPatternSearchTool 消息处理程序

void CDlgCombinedPatternSearchTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
	...
	if (m_pDlgParent->m_pSearchTool != NULL)
	{
		if (m_pDlgParent->m_imageTrain.IsValid())
		{
			...
			GetDlgItem(IDC_BTN_SET_MASK_IMAGE2)->EnableWindow(m_bEnableMask1);
...
void CDlgCombinedPatternSearchTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;
		((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy = (Accuracy)(1<<m_nPatAccuracyMode);
		((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale = (CoarseScale)(m_nPatSpeedMode+1);
		((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable1 = m_bEnableMask1/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow  =  m_dAngleLow;
		((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh = m_dAngleHigh;
	...
	{
		m_nImageChannel = ((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_nPatAccuracyMode = ((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy/2;
		m_nPatSpeedMode = ((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale-1;
		m_dAngleLow	    = ((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh;
		m_bEnableMask = ((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;	
		m_bEnableMask1 = ((CCombinedPatternSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable1;
...
void CDlgCombinedPatternSearchTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre = m_dConfusionThre;
		((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre2 = m_dAcceptThre2;
		((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre2 = m_dConfusionThre2;
		((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nPosIndex = m_nPostion;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;	
		m_dConfusionThre = ((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre;
		m_dAcceptThre2	= ((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre2;	
		m_dConfusionThre2 = ((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre2;
		m_nPostion		= ((CCombinedPatternSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nPosIndex;
...
void CDlgCombinedPatternSearchTool::UpdateDialogLanguage()
{
	//return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_COMBINED_PATTERNSEARCH_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgCombinedPatternSearchTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgCombinedPatternSearchTool::OnBnClickedBtnGetTrainImage()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnBnClickedBtnTrain()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnBnClickedBtnSetMaskImage()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnBnClickedChkEnableMask()
{
	// TODO: 在此添加控件通知处理程序代码
...
BOOL CDlgCombinedPatternSearchTool::OnInitDialog()
{
	...
	m_GuiPatternDisplay2.Create(IDC_STC_PATTERN_DISPLAY3, this, 0);
...
void CDlgCombinedPatternSearchTool::OnCbnSelchangeComboAccuracyMode()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnCbnSelchangeComboSpeedMode()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnBnClickedBtnSetCenter()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		...
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CCombinedPatternSearchTrainGuiParam *pTrainGuiParam = new CCombinedPatternSearchTrainGuiParam;
...
void CDlgCombinedPatternSearchTool::OnSetfocusEdtAngleLow()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnSetfocusEdtAngleHigh()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnSetfocusEdtSearchNum()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnSetfocusEdtAcceptThre()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnEnSetfocusEdtAcceptThre3()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgCombinedPatternSearchTool::OnEnSetfocusEdtConfusionThre2()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		...
		CRect rcWnd;
		CString strInput, strOutput;
		GetDlgItem(IDC_EDT_CONFUSION_THRE2)->GetWindowRect(&rcWnd);
		GetDlgItemText(IDC_EDT_CONFUSION_THRE2, strInput);

		if (TRUE == m_pDlgParent->m_ctrlKeyboard.ShowNumeralDotKeyBoard(rcWnd, strInput, strOutput))
		{
			SetDlgItemText(IDC_EDT_CONFUSION_THRE2, strOutput);
		}
	}
}


void CDlgCombinedPatternSearchTool::OnSetfocusEdtConfusionThre()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnBnClickedBtnFullImageSearch()
{
	// TODO: 在此添加控件通知处理程序代码

	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CCombinedPatternSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgCombinedPatternSearchTool::PreTranslateMessage(MSG* pMsg)
{
...
void CDlgCombinedPatternSearchTool::OnBnClickedBtnSetMaskImage2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgCombinedPatternSearchTool::OnBnClickedChkEnableMask2()
{
	// TODO: 在此添加控件通知处理程序代码
