...
class CDlgSearch;
class CDlgMPatternCornerSearchTool : public CDialogEx
{
	DECLARE_DYNAMIC(CDlgMPatternCornerSearchTool)

public:
	CDlgMPatternCornerSearchTool(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgMPatternCornerSearchTool();
...
// 对话框数据
	enum { IDD = IDD_DLG_MPATTERNCORNERSEARCH_TOOL };
