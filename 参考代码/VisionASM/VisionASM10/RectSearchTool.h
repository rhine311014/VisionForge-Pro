// RectSearchTool.h: interface for the CRectSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
typedef struct tagRectSearchTrainDataParam : public CBaseTrainDataParam
{
	double			m_dGrau;							// 颗粒度
...
}CRectSearchTrainDataParam;

// RectSearch定位工具训练Gui参数类
typedef struct tagRectSearchTrainGuiParam : public CBaseTrainGuiParam
{
	...
	bool				 m_bCaliperVisible[RECT_LINE_NUM];			// 是否显示卡尺
	// 颜色与可见性
...
}CRectSearchTrainGuiParam;

// RectSearch定位工具搜索Data参数类
typedef struct tagRectSearchSearchDataParam : public CBaseSearchDataParam
{
	int		m_nSearchNum;								// 搜索个数
	double	m_dAcceptThre;								// 接收阈值
	double  m_dAngleLow;								// 低角度
	double	m_dAngleHigh;								// 高角度
	tagRectSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.8;
		m_dAngleLow		= -5.0;
...
}CRectSearchSearchDataParam;

// RectSearch定位工具搜索Gui参数类
typedef struct tagRectSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
...
}CRectSearchSearchGuiParam;

// RectSearch训练结果
typedef struct tagRectSearchTrainResult
{
...
}CRectSearchTrainResult;


//
//	角定位工具
//
class /*SV_SEARCHTOOL_API*/ CRectSearchTool : public CBaseSearchTool    
{
public:
	CRectSearchTool();
	CRectSearchTool(CRectSearchTool &cRectSearchTool);
	CRectSearchTool& operator=(CRectSearchTool &cRectSearchTool);
	virtual ~CRectSearchTool();
...
private:	
	...
	CRectSearchTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CRectSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CRectSearchSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CRectSearchSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CRectSearchTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	CRectSearchTrainDataParam			m_TrainDataParam;				// 训练Data参数
	CRectSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CRectSearchSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CRectSearchSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CRectSearchTrainResult			m_TrainResult;					// 训练结果
