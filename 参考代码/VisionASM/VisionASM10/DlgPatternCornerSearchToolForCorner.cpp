...
IMPLEMENT_DYNAMIC(CDlgPatternCornerSearchToolForCorner, CDialogEx)

CDlgPatternCornerSearchToolForCorner::CDlgPatternCornerSearchToolForCorner(CWnd* pParent /*=NULL*/)
	: CDialogEx(CDlgPatternCornerSearchToolForCorner::IDD, pParent)
...
CDlgPatternCornerSearchToolForCorner::~CDlgPatternCornerSearchToolForCorner()
{
}

void CDlgPatternCornerSearchToolForCorner::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHECK_LINE2_VERTICAL, m_bLine2ForceVerticalLine1);
}


BEGIN_MESSAGE_MAP(CDlgPatternCornerSearchToolForCorner, CDialogEx)
...
//	ON_BN_CLICKED(IDC_BTN_SET_CENTER, OnBtnSetCenter)
	...
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_1, &CDlgPatternCornerSearchToolForCorner::OnBnClickedCheckLineMask1)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_1, &CDlgPatternCornerSearchToolForCorner::OnBnClickedCheckShowFitpoint1)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK_2, &CDlgPatternCornerSearchToolForCorner::OnBnClickedCheckLineMask2)
	ON_BN_CLICKED(IDC_CHECK_SHOW_FITPOINT_2, &CDlgPatternCornerSearchToolForCorner::OnBnClickedCheckShowFitpoint2)
	
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER_1, &CDlgPatternCornerSearchToolForCorner::OnBnClickedChkShowLineCaliper1)
	ON_BN_CLICKED(IDC_CHK_SHOW_LINE_CALIPER_2, &CDlgPatternCornerSearchToolForCorner::OnBnClickedChkShowLineCaliper2)
END_MESSAGE_MAP()


// CDlgPatternCornerSearchToolForCorner 消息处理程序

void CDlgPatternCornerSearchToolForCorner::UpdateControlDisplay()
{
 	UpdateData(TRUE);
...
void CDlgPatternCornerSearchToolForCorner::UpdateTrainData(bool bValidate)
{
...
void CDlgPatternCornerSearchToolForCorner::UpdateSearchData(bool bValidate)
{
...
void CDlgPatternCornerSearchToolForCorner::UpdateDialogLanguage()
{
...
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_PATTERNCORNERSEARCH_TOOL_FORCORNER") == strDlgID)
		{
			int nID;
...
void CDlgPatternCornerSearchToolForCorner::CheckDlgDataValidation()
{
...
void CDlgPatternCornerSearchToolForCorner::OnBtnGetTrainImage() 
{
...
void CDlgPatternCornerSearchToolForCorner::OnBtnTrain() 
{
...
void CDlgPatternCornerSearchToolForCorner::OnBtnSetMaskImage()
{
...
void CDlgPatternCornerSearchToolForCorner::OnChkEnableMask() 
{
...
BOOL CDlgPatternCornerSearchToolForCorner::OnInitDialog() 
{
...
void CDlgPatternCornerSearchToolForCorner::OnSelchangeComboAccuracyMode() 
{
	m_nPatAccuracyMode = m_comboAccuracy.GetCurSel();	
}

void CDlgPatternCornerSearchToolForCorner::OnSelchangeComboSpeedMode() 
{
	m_nPatSpeedMode = m_comboSpeed.GetCurSel();
}

void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtAngleLow() 
{
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtSearchNum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtConfusionThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtLineCalipernum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtLineContrastThre1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtLineOutlineNum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtLineCalipernum2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtLineContrastThre2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnSetfocusEdtLineOutlineNum2() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgPatternCornerSearchToolForCorner::OnChangeEdtLineCalipernum1() 
{
...
void CDlgPatternCornerSearchToolForCorner::OnChangeEdtLineCalipernum2() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternCornerSearchToolForCorner::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		if (m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
		...
		else if (m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCircleCornerSearchCheckInspectTool)
		{
			CCircleCornerCheckSearchTrainGuiParam trainGuiParam;
			m_pDlgParent->m_pSearchTool->GetTrainGuiParam(&trainGuiParam);
			trainGuiParam.m_SearchRect.Set(0, 0, m_pDlgParent->m_imageTrain.Width(), m_pDlgParent->m_imageTrain.Height());
			m_pDlgParent->m_pSearchTool->SetTrainGuiParam(&trainGuiParam);
			m_pDlgParent->UpdateGuiDisplay();
...
BOOL CDlgPatternCornerSearchToolForCorner::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgPatternCornerSearchToolForCorner::OnBnClickedCheckLineMask1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternCornerSearchToolForCorner::OnBnClickedCheckShowFitpoint1()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_pSearchTool && m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
	{
...
void CDlgPatternCornerSearchToolForCorner::OnBnClickedCheckLineMask2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgPatternCornerSearchToolForCorner::OnBnClickedCheckShowFitpoint2()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_pSearchTool && m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
	{
...
void CDlgPatternCornerSearchToolForCorner::OnBnClickedChkShowLineCaliper1()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	if (m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
...
void CDlgPatternCornerSearchToolForCorner::OnBnClickedChkShowLineCaliper2()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	if (m_pDlgParent->m_pSearchTool->GetSearchToolType()==eCornerSearchCheckInspectTool)
...
void CDlgPatternCornerSearchToolForCorner::OnEnSetfocusEditLineFilterHalfWidth1() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgPatternCornerSearchToolForCorner::OnEnSetfocusEditLineFilterHalfWidth2() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
