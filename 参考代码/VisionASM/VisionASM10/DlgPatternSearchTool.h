#if !defined(AFX_DLGPATTERNSEARCHTOOLSETTING_H__9E83C67C_E77B_43B6_ABBD_90BF3E5F3D95__INCLUDED_)
#define AFX_DLGPATTERNSEARCHTOOLSETTING_H__9E83C67C_E77B_43B6_ABBD_90BF3E5F3D95__INCLUDED_
...
class CDlgSearch;
class CDlgPatternSearchTool : public CDialog
{
// Construction
public:
	CDlgPatternSearchTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	...
	enum { IDD = IDD_DLG_PATTERNSEARCH_TOOL };
