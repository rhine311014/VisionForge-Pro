// DlgTwoQuickModelSearchTool.cpp : 实现文件
//
...
// CDlgTwoQuickModelSearchTool 对话框

IMPLEMENT_DYNAMIC(CDlgTwoQuickModelSearchTool, CDialogEx)

CDlgTwoQuickModelSearchTool::CDlgTwoQuickModelSearchTool(CWnd* pParent /*=NULL*/)
	: CDialogEx(CDlgTwoQuickModelSearchTool::IDD, pParent)
	, m_dAcceptThre2(0)
	, m_nImageChannel(0)
...
CDlgTwoQuickModelSearchTool::~CDlgTwoQuickModelSearchTool()
{
}

void CDlgTwoQuickModelSearchTool::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHECK_ENABLE_SIZE_CHECK, m_bEnableSizeCheck);
	DDX_Check(pDX, IDC_CHECK_DISTANCE_MAX_1, m_bEnableMax);
	DDX_Check(pDX, IDC_CHECK_DISTANCE_MIN_1, m_bEnableMin);
	DDX_Text(pDX, IDC_EDT_DISTANCE_MAX_1, m_dDistanceMax);
	DDX_Text(pDX, IDC_EDT_DISTANCE_MIN_1, m_dDistanceMin);
	DDX_Text(pDX, IDC_EDT_PIXEL_RATIO, m_dPixelRatio);

	DDX_Text(pDX, IDC_EDT_ANGLE_HIGH1, m_dAngleHigh1);
	DDX_Text(pDX, IDC_EDT_ANGLE_LOW1, m_dAngleLow1);
	DDX_Text(pDX, IDC_EDT_SIZE_HIGH1, m_dSizeHigh1);
	DDX_Text(pDX, IDC_EDT_SIZE_LOW1, m_dSizeLow1);
}


BEGIN_MESSAGE_MAP(CDlgTwoQuickModelSearchTool, CDialogEx)
	ON_BN_CLICKED(IDC_BTN_GET_TRAIN_IMAGE, &CDlgTwoQuickModelSearchTool::OnBnClickedBtnGetTrainImage)
	ON_BN_CLICKED(IDC_BTN_TRAIN, &CDlgTwoQuickModelSearchTool::OnBnClickedBtnTrain)
	ON_BN_CLICKED(IDC_BTN_SET_MASK_IMAGE, &CDlgTwoQuickModelSearchTool::OnBnClickedBtnSetMaskImage)
	ON_BN_CLICKED(IDC_CHK_ENABLE_MASK, &CDlgTwoQuickModelSearchTool::OnBnClickedChkEnableMask)
	ON_BN_CLICKED(IDC_BTN_SET_CENTER, &CDlgTwoQuickModelSearchTool::OnBnClickedBtnSetCenter)
	ON_BN_CLICKED(IDC_BTN_SET_CENTER2, &CDlgTwoQuickModelSearchTool::OnBnClickedBtnSetCenter2)
	ON_EN_SETFOCUS(IDC_EDT_GRAU, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtGrau)
	ON_EN_KILLFOCUS(IDC_EDT_GRAU, &CDlgTwoQuickModelSearchTool::OnKillfocusEdtGrau)
	ON_EN_SETFOCUS(IDC_EDT_NOISETHRE, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtNoisethre)
	ON_EN_SETFOCUS(IDC_EDT_TOTAL_MAG, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtTotalMag)
	ON_EN_SETFOCUS(IDC_EDT_SEARCH_NUM, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtSearchNum)
	ON_EN_SETFOCUS(IDC_EDT_ACCEPT_THRE, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtAcceptThre)
	ON_EN_SETFOCUS(IDC_EDT_ANGLE_LOW, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtAngleLow)
	ON_EN_SETFOCUS(IDC_EDT_ANGLE_HIGH, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtAngleHigh)
	ON_EN_SETFOCUS(IDC_EDT_SIZE_LOW, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtSizeLow)
	ON_EN_SETFOCUS(IDC_EDT_SIZE_HIGH, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtSizeHigh)
	//ON_BN_CLICKED(IDC_BTN_FULL_IMAGE_SEARCH, &CDlgTwoQuickModelSearchTool::OnBnClickedBtnFullImageSearch)
	ON_BN_CLICKED(IDC_BTN_SET_MASK_IMAGE1, &CDlgTwoQuickModelSearchTool::OnBnClickedBtnSetMaskImage1)
	ON_BN_CLICKED(IDC_CHK_ENABLE_MASK1, &CDlgTwoQuickModelSearchTool::OnBnClickedChkEnableMask1)
	ON_EN_SETFOCUS(IDC_EDT_GRAU1, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtGrau1)
	ON_EN_KILLFOCUS(IDC_EDT_GRAU1, &CDlgTwoQuickModelSearchTool::OnKillfocusEdtGrau1)
	ON_EN_SETFOCUS(IDC_EDT_NOISETHRE1, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtNoisethre1)
	ON_EN_SETFOCUS(IDC_EDT_TOTAL_MAG1, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtTotalMag1)
	ON_EN_SETFOCUS(IDC_EDT_ACCEPT_THRE3, &CDlgTwoQuickModelSearchTool::OnEnSetfocusEdtAcceptThre3)
	ON_EN_SETFOCUS(IDC_EDT_PIXEL_RATIO, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtPixelRatio)
	ON_EN_SETFOCUS(IDC_EDT_DISTANCE_MAX_1, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtDistanceMax1)
	ON_EN_SETFOCUS(IDC_EDT_DISTANCE_MIN_1, &CDlgTwoQuickModelSearchTool::OnSetfocusEdtDistanceMin1)
END_MESSAGE_MAP()


// CDlgTwoQuickModelSearchTool 消息处理程序

void CDlgTwoQuickModelSearchTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgTwoQuickModelSearchTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel; 
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau = m_dGrau; 
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau2 = m_dGrau1; 
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre = m_lNoiseThre;
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre2 = m_lNoiseThre1;
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag = m_lTotalMag;
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag2 = m_lTotalMag1;
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable2 = m_bEnableMask1/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
	...
	{
		m_nImageChannel	= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_dGrau			= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau;
		m_dGrau1		= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau2;
		m_lNoiseThre	= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre;
		m_lNoiseThre1	= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre2;
		m_lTotalMag		= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag;
		m_lTotalMag1	= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag2;
		m_bEnableMask	= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;
		m_bEnableMask1	= ((CTwoQuickModelSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable2;
...
void CDlgTwoQuickModelSearchTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre2 = m_dAcceptThre2;

		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow = m_dAngleLow;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh = m_dAngleHigh;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeLow = m_dSizeLow;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeHigh = m_dSizeHigh;

		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow1 = m_dAngleLow1;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh1 = m_dAngleHigh1;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeLow1 = m_dSizeLow1;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeHigh1 = m_dSizeHigh1;



		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableSizeCheck = m_bEnableSizeCheck;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dPixelRatio = m_dPixelRatio;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableMax = m_bEnableMax;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableMin= m_bEnableMin;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dDistanceMax = m_dDistanceMax;
		((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dDistanceMin = m_dDistanceMin;

		//((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nPosIndex = m_nPostion;
	...
	{
		m_nSearchNum	= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;
		m_dAcceptThre2	= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre2;

		m_dAngleLow		= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh;
		m_dSizeLow		= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeLow;
		m_dSizeHigh		= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeHigh;

		m_dAngleLow1	= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow1;
		m_dAngleHigh1	= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh1;
		m_dSizeLow1		= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeLow1;
		m_dSizeHigh1	= ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dSizeHigh1;




		m_bEnableSizeCheck = ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableSizeCheck;
		m_dPixelRatio = ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dPixelRatio;
		m_bEnableMax = ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableMax;
		m_bEnableMin = ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bEnableMin;
		m_dDistanceMax = ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dDistanceMax;
		m_dDistanceMin = ((CTwoQuickModelSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dDistanceMin;
...
void CDlgTwoQuickModelSearchTool::UpdateDialogLanguage()
{
	//return;
...
void CDlgTwoQuickModelSearchTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
	...
	if (m_dSizeLow1 < 0.8 || m_dSizeLow1 > 1.2)
	{
		m_dSizeLow1 = 1.0;	
	}

	if (m_dSizeHigh1 < 0.8 || m_dSizeHigh1 > 1.2)
	{
		m_dSizeHigh1 = 1.0;
	}

	if (m_dSizeLow1 > m_dSizeHigh1)
	{
		m_dSizeLow1 = 1.0;
		m_dSizeHigh1 = 1.0;
	}
...
void CDlgTwoQuickModelSearchTool::OnBnClickedBtnGetTrainImage()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnBnClickedBtnTrain()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnBnClickedBtnSetMaskImage()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnBnClickedChkEnableMask()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnBnClickedBtnSetMaskImage1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnBnClickedChkEnableMask1()
{
	// TODO: 在此添加控件通知处理程序代码
...
BOOL CDlgTwoQuickModelSearchTool::OnInitDialog()
{
...
void CDlgTwoQuickModelSearchTool::OnBnClickedBtnSetCenter()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		...
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CTwoQuickModelSearchTrainGuiParam *pTrainGuiParam = new CTwoQuickModelSearchTrainGuiParam;
...
void CDlgTwoQuickModelSearchTool::OnBnClickedBtnSetCenter2()
{
	// TODO: 在此添加控件通知处理程序代码
	...
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		...
		scRect rcTrain = pTrainGuiParam->m_TrainAffineRect2.BoundingBox();
		imageTrain.GetSubImage(imagePattern, rcTrain);
		dMarkX -= rcTrain.GetUL().GetX();
		dMarkY -= rcTrain.GetUL().GetY();
		...
		{
			dlgPatternCenterSet.GetPatternCenter(dMarkX, dMarkY);
			pTrainGuiParam->m_ModelPoint2.SetX(dMarkX+rcTrain.GetUL().GetX());
			pTrainGuiParam->m_ModelPoint2.SetY(dMarkY+rcTrain.GetUL().GetY());
			m_pDlgParent->m_pSearchTool->SetTrainGuiParam(pTrainGuiParam);
			m_pDlgParent->m_pSearchTool->Train();
			m_pDlgParent->m_comboDisplayType.SetCurSel(1);
			m_pDlgParent->UpdateGuiDisplay();
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtGrau()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnKillfocusEdtGrau()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtGrau1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnKillfocusEdtGrau1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtNoisethre()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtNoisethre1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtTotalMag()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtTotalMag1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtSearchNum()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtAcceptThre()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnEnSetfocusEdtAcceptThre3()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtAngleLow()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtAngleHigh()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtSizeLow()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtSizeHigh()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnBnClickedBtnFullImageSearch()
{
	// TODO: 在此添加控件通知处理程序代码

	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CTwoQuickModelSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgTwoQuickModelSearchTool::PreTranslateMessage(MSG* pMsg)
{
...
LRESULT CDlgTwoQuickModelSearchTool::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	// TODO: 在此添加专用代码和/或调用基类
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtPixelRatio()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtDistanceMax1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgTwoQuickModelSearchTool::OnSetfocusEdtDistanceMin1()
{
	// TODO: 在此添加控件通知处理程序代码
