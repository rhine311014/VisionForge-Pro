// DlgQuickLineCircleSearchTool.cpp : 实现文件
...
CDlgQuickLineCircleTool::CDlgQuickLineCircleTool(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgQuickLineCircleTool::IDD, pParent)
...
CDlgQuickLineCircleTool::~CDlgQuickLineCircleTool()
{
}

void CDlgQuickLineCircleTool::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHECK_ENABLE_MARK2, m_bEnableMark2);
	...
	DDX_Check(pDX, IDC_CHECK_ENABLE_CIRCLE, m_bEnableCircle);
...
BEGIN_MESSAGE_MAP(CDlgQuickLineCircleTool, CDialog)
	...
	ON_BN_CLICKED(IDC_CHECK_ENABLE_MARK2, &CDlgQuickLineCircleTool::OnBnClickedCheckEnableMark2)
	...
	ON_BN_CLICKED(IDC_CHECK_SHOW_LINE_POINT, &CDlgQuickLineCircleTool::OnBnClickedCheckShowLinePoint)
	ON_BN_CLICKED(IDC_CHECK_ENABLE_CIRCLE, &CDlgQuickLineCircleTool::OnBnClickedCheckEnableCircle)
	...
	ON_CBN_SELCHANGE(IDC_COMBO_LINE_ANGLE_TYPE, &CDlgQuickLineCircleTool::OnCbnSelchangeComboLineAngleType)
	ON_BN_CLICKED(IDC_CHECK_SHOW_LINE_POINT2, &CDlgQuickLineCircleTool::OnBnClickedCheckShowLinePoint2)
	ON_BN_CLICKED(IDC_CHECK_ENABLE_LINE, &CDlgQuickLineCircleTool::OnBnClickedCheckEnableLine)
	...
	ON_BN_CLICKED(IDC_CHK_SHOW_CIRCLE_CALIPER, &CDlgQuickLineCircleTool::OnBnClickedChkShowCircleCaliper)
	ON_BN_CLICKED(IDC_CHECK_LINE_MASK, &CDlgQuickLineCircleTool::OnBnClickedCheckLineMask)
END_MESSAGE_MAP()

// void CDlgQuickLineCircleTool::DoDataExchange(CDataExchange* pDX)
// {
// 	CDialog::DoDataExchange(pDX);
//{{AFX_DATA_MAP(CDlgQuickLineCircleTool)
// 	DDX_Control(pDX, IDC_BTN_TRAIN, m_btnTrain);
// 	DDX_Control(pDX, IDC_BTN_SET_MASK_IMAGE, m_btnSetMask);
// 	DDX_Control(pDX, IDC_BTN_GET_TRAIN_IMAGE, m_btnGetTrainImage);
// 	DDX_Text(pDX, IDC_EDT_ACCEPT_THRE, m_dAcceptThre);
...
void CDlgQuickLineCircleTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgQuickLineCircleTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau = m_dGrau;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre = m_lNoiseThre;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag = m_lTotalMag;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask;

		((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible = m_bEnableMark2;

		// Circle
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableCircle = m_bEnableCircle;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nCircleOutLineNum = m_nCircleOutLineNum;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dCircleContrastThre = m_dCircleContrastThre;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lCircleFilterHalfWidth = m_lCircleFilterHalfWidth;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_eCircledgeProperty = (EdgePolarity)m_nCirclePolarityMode;		
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bCircleSortByScore = m_bCircleSortByScore;
		((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCircleCaliperNum = m_nCircleCaliperNum;
		((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CircleCaliperSearchDirection = (CaliperSearchDirection)m_nCircleInwardMode;
		((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCircleCaliperVisible = m_bShowCircleCaliper;
		((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableCircleMask = m_bEnableCircleMask;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge = m_bEnableDualEdge;
		// Line
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableLine[0]  = m_bEnableLine;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineOutLineNum[0]  = m_nLineOutLineNum1;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dLineContrastThre[0] = m_dLineContrastThre1;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lLineFilterHalfWidth[0] = m_lLineFilterHalfWidth1;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_eLinedgeProperty[0] = (EdgePolarity)m_nLinePolarityMode1;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bLineSortByScore[0] = m_bLineSortByScore1;
		((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineAngleType[0] = m_nLineAngleType;
		((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nLineCaliperNum[0] = m_nLineCaliperNum1;
		((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bLineCaliperVisible[0] = m_bShowLineCaliper;
	...
	{		
		m_nImageChannel	= ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_dGrau			= ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dGrau;
		m_lNoiseThre	= ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lNoiseThre;
		m_lTotalMag		= ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lTotalMag;
		m_bEnableMask	= ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;

		m_bEnableMark2 = ((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible;

		// Circle
		m_bEnableCircle =  ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableCircle;
		m_nCircleOutLineNum =  ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nCircleOutLineNum;
		m_dCircleContrastThre = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dCircleContrastThre;
		m_lCircleFilterHalfWidth = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lCircleFilterHalfWidth;
		m_nCirclePolarityMode = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_eCircledgeProperty;
		m_bCircleSortByScore = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bCircleSortByScore;
		m_nCircleCaliperNum = ((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nCircleCaliperNum;
		m_nCircleInwardMode = ((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_CircleCaliperSearchDirection;
		m_bShowCircleCaliper = ((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bCircleCaliperVisible;
		m_bEnableCircleMask = ((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bEnableCircleMask;
		m_bEnableDualEdge = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableDualEdge;

		// Line
		m_bEnableLine =  ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bEnableLine[0];
		m_nLineOutLineNum1 =  ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineOutLineNum[0];
		m_dLineContrastThre1 = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dLineContrastThre[0];
		m_lLineFilterHalfWidth1 = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_lLineFilterHalfWidth[0];
		m_nLinePolarityMode1 = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_eLinedgeProperty[0];
		m_bLineSortByScore1 = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bLineSortByScore[0];
		m_nLineAngleType = ((CQuickLineCircleSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nLineAngleType[0];
		m_nLineCaliperNum1 = ((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_nLineCaliperNum[0];
		m_bShowLineCaliper = ((CQuickLineCircleSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bLineCaliperVisible[0];
...
void CDlgQuickLineCircleTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CQuickLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CQuickLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CQuickLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow = m_dAngleLow;
		((CQuickLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh = m_dAngleHigh;
		((CQuickLineCircleSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint = m_bEnableShowLinePoint;
		((CQuickLineCircleSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint2 = m_bEnableShowLinePoint2;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CQuickLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CQuickLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;
		m_dAngleLow		= ((CQuickLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CQuickLineCircleSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAngleHigh;

		m_bEnableShowLinePoint = ((CQuickLineCircleSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint;
		m_bEnableShowLinePoint2 = ((CQuickLineCircleSearchSearchGuiParam*)m_pDlgParent->m_pSearchGuiParam)->m_bEnableShowLinePoint2;
		UpdateData(FALSE);
	}

}

void CDlgQuickLineCircleTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgQuickLineCircleTool::UpdateDialogLanguage()
{
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_QUICK_LINE_CIRCLE_TOOL") == strDlgID)
		{
			int nID;
...
BOOL CDlgQuickLineCircleTool::OnInitDialog()
{
...
BOOL CDlgQuickLineCircleTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgQuickLineCircleTool::OnBtnGetTrainImage() 
{
...
void CDlgQuickLineCircleTool::OnBtnTrain() 
{
...
void CDlgQuickLineCircleTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgQuickLineCircleTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
void CDlgQuickLineCircleTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CQuickLineCircleSearchTrainGuiParam trainGuiParam;
...
void CDlgQuickLineCircleTool::OnSetfocusEdtGrau() 
{
...
void CDlgQuickLineCircleTool::OnSetfocusEdtNoisethre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnSetfocusEdtTotalMag() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnChangeEdtCircleCalipernum() 
{
...
void CDlgQuickLineCircleTool::OnSetfocusEdtCircleCalipernum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnSetfocusEdtCircleOutlineNum() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnSetfocusEdtCircleContrastThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnRadCircleInwardMode0() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgQuickLineCircleTool::OnRadCircleInwardMode1() 
{
	// TODO: Add your control notification handler code here
	UpdateTrainData(true);
	UpdateSearchData(true);
...
void CDlgQuickLineCircleTool::OnBnClickedCheckShowLinePoint()
{
	// TODO: 在此添加控件通知处理程序代码

	m_bEnableShowLinePoint = !m_bEnableShowLinePoint;

	CQuickLineCircleSearchSearchGuiParam searchGuiParam;
...
void CDlgQuickLineCircleTool::OnChangeEdtLineCalipernum1() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CDlgQuickLineCircleTool::OnSetfocusEdtLineCalipernum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnSetfocusEdtLineContrastThre1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnSetfocusEdtLineOutlineNum1() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnCbnSelchangeComboLineAngleType()
{
	// TODO: 在此添加控件通知处理程序代码
	m_nLineAngleType = m_comboLineAngleType.GetCurSel();
}

void CDlgQuickLineCircleTool::OnBnClickedCheckShowLinePoint2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgQuickLineCircleTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgQuickLineCircleTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnSetfocusEdtAngleLow() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgQuickLineCircleTool::OnBnClickedCheckEnableMark2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgQuickLineCircleTool::OnBnClickedCheckEnableCircle()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgQuickLineCircleTool::OnBnClickedCheckEnableLine()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgQuickLineCircleTool::OnBnClickedChkShowCircleCaliper()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}
...
void CDlgQuickLineCircleTool::OnBnClickedCheckLineMask()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(true);
}

void CDlgQuickLineCircleTool::OnEnSetfocusEditCircleFilterHalfWidth() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
