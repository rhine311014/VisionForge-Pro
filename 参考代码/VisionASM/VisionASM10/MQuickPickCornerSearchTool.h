...
//class MQuickPickCornerSearchTool :
//	public CBaseSearchTool
//{
//public:
//	MQuickPickCornerSearchTool(void);
//	~MQuickPickCornerSearchTool(void);
//};



// MQuickPickCornerSearchTool.h: interface for the CCornerSearch2Tool class.
//
//////////////////////////////////////////////////////////////////////
			 
#if !defined(AFX_MQUICKPICKCORNERSEARCHTOOL_H__B84841C2_1E6B_4589_A474_5BE4F312043F__INCLUDED_)
#define AFX_MQUICKPICKCORNERSEARCHTOOL_H__B84841C2_1E6B_4589_A474_5BE4F312043F__INCLUDED_
...
typedef struct tagMQuickPickCornerSearchTrainDataParam : public CBaseTrainDataParam
{
	double			m_dGrau;							// 颗粒度
	...
	tagMQuickPickCornerSearchTrainDataParam()
	{
		m_dGrau			= 2.0;
		m_lNoiseThre	= 10;
		m_lTotalMag		= 200;
...
}CMQuickPickCornerSearchTrainDataParam;

// CornerSearch2定位工具训练Gui参数类
typedef struct tagMQuickPickCornerSearchTrainGuiParam : public CBaseTrainGuiParam
{
	...
	tagMQuickPickCornerSearchTrainGuiParam()
	{
		m_nCaliperNum[0]				= 2;
		m_dStartX[0]					= 100.0;
		m_dStartY[0]					= 100.0;
...
}CMQuickPickCornerSearchTrainGuiParam;

// CenterSearch定位工具搜索Data参数类
typedef struct tagMQuickPickCornerSearchDataParam : public CBaseSearchDataParam
{
	...
	tagMQuickPickCornerSearchDataParam()
	{
		m_nSearchNum	= 2;
		m_dAcceptThre	= 0.8;
		m_dAngleLow		= -5.0;
...
}CMQuickPickCornerSearchDataParam;

// CenterSearch2定位工具搜索Gui参数类
typedef struct tagMQuickPickCornerSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	...
	tagMQuickPickCornerSearchGuiParam()
	{
...
}CMQuickPickCornerSearchGuiParam;

// CornerSearch2训练结果
typedef struct tagMQuickPickCornerSearchTrainResult
{
	...
	tagMQuickPickCornerSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CMQuickPickCornerSearchTrainResult;

//
//	角定位工具2
//

class /*SV_SEARCHTOOL_API*/ CMQuickPickCornerSearchTool : public CBaseSearchTool  
{
public:
	CMQuickPickCornerSearchTool();
	virtual ~CMQuickPickCornerSearchTool();

	CMQuickPickCornerSearchTool(CMQuickPickCornerSearchTool &cMQuickPickCornerSearchTool);
	CMQuickPickCornerSearchTool& operator=(CMQuickPickCornerSearchTool &cMQuickPickCornerSearchTool);
...
private:
	...
	CMQuickPickCornerSearchTrainDataParam			m_tmpTrainDataParam;			// 当前训练Data参数
	CMQuickPickCornerSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CMQuickPickCornerSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CMQuickPickCornerSearchGuiParam			m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CMQuickPickCornerSearchTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage							m_tmpImageTrain;				// 当前训练图像
	cpImage							m_tmpImageMask;					// 当前掩模图像
	CMQuickPickCornerSearchTrainDataParam			m_TrainDataParam;				// 训练Data参数
	CMQuickPickCornerSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CMQuickPickCornerSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CMQuickPickCornerSearchGuiParam			m_SearchGuiParam;				// 搜索Gui参数
	CMQuickPickCornerSearchTrainResult			m_TrainResult;					// 训练结果
...
#endif // !defined(AFX_MQuickPickCornerSearchTool_H__B84841C2_1E6B_4589_A474_5BE4F312043F__INCLUDED_)
