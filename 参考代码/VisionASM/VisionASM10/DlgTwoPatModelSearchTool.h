...
class CDlgSearch;
class CDlgTwoPatModelSearchTool : public CDialog
{
// Construction
public:
	CDlgTwoPatModelSearchTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CDlgTwoPatModelSearchTool)
	enum { IDD = IDD_DLG_TWO_PATCORNERSEARCH_TOOL };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlgTwoPatModelSearchTool)
	public:
...
protected:
	...
	//{{AFX_MSG(CDlgTwoPatModelSearchTool)
...
public:
	...
	afx_msg void OnEnSetfocusEdtAcceptConfusionThre4();
