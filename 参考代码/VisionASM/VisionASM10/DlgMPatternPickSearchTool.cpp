// DlgMPatternPickSearchTool.cpp : 实现文件
//
...
IMPLEMENT_DYNAMIC(CDlgMPatternPickSearchTool, CDialog)

CDlgMPatternPickSearchTool::CDlgMPatternPickSearchTool(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgMPatternPickSearchTool::IDD, pParent)
	, m_nImageChannel(0)
...
CDlgMPatternPickSearchTool::~CDlgMPatternPickSearchTool()
{
}

void CDlgMPatternPickSearchTool::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgMPatternPickSearchTool, CDialog)
	...
	ON_BN_CLICKED(IDC_CHK_ENABLE_MARK2, &CDlgMPatternPickSearchTool::OnBnClickedChkEnableMark2)
	//}}AFX_MSG_MAP
	ON_CBN_SELCHANGE(IDC_COMBO_COORD_SORT_METHOD, &CDlgMPatternPickSearchTool::OnCbnSelchangeComboCoordSortMethod)
	ON_EN_SETFOCUS(IDC_EDT_COORD_SORT_GAP, &CDlgMPatternPickSearchTool::OnEnSetfocusEdtCoordSortGap)
	ON_BN_CLICKED(IDC_CHK_SHOW_HIDE_SEARCH1_RECT, &CDlgMPatternPickSearchTool::OnBnClickedChkShowHideSearch1Rect)
	ON_BN_CLICKED(IDC_CHK_SHOW_HIDE_SEARCH2_RECT, &CDlgMPatternPickSearchTool::OnBnClickedChkShowHideSearch2Rect)
END_MESSAGE_MAP()


// CDlgMPatternPickSearchTool 消息处理程序
// CDlgMPatternPickSearchTool message handlers
void CDlgMPatternPickSearchTool::UpdateControlDisplay()
{	
	UpdateData(TRUE);
...
void CDlgMPatternPickSearchTool::UpdateTrainData(bool bValidate)
{
	...
	{
		UpdateData(TRUE);
		((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel = m_nImageChannel;
		((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy = (Accuracy)(1<<m_nPatAccuracyMode);
		((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale = (CoarseScale)(m_nPatSpeedMode+1);
		((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable = m_bEnableMask/*m_imageMask.IsValid() ? m_bEnableMask : false*/;
		((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow  =  m_dAngleLow;
		((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh = m_dAngleHigh;

		((CMPatternPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible = m_bEnableMark2;

		((CMPatternPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible1 = m_bSearchHideRectVisible1;
		((CMPatternPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible2 = m_bSearchHideRectVisible2;
	...
	{
		m_nImageChannel = ((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_nImageChannel;
		m_nPatAccuracyMode = ((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_Accuracy/2;
		m_nPatSpeedMode = ((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_CoarseScale-1;
		m_dAngleLow	    = ((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleLow;
		m_dAngleHigh	= ((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_dAngleHigh;
		m_bEnableMask = ((CMPatternPickSearchTrainDataParam*)m_pDlgParent->m_pTrainDataParam)->m_bMaskEnable;				
		if (m_bEnableMask)
		{
		...
		m_bEnableMark2 = ((CMPatternPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bModelPoint2Visible;

		m_bSearchHideRectVisible1 = ((CMPatternPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible1;
		m_bSearchHideRectVisible2 = ((CMPatternPickSearchTrainGuiParam*)m_pDlgParent->m_pTrainGuiParam)->m_bSearchHideRectVisible2;

		UpdateData(FALSE);
	}
}

void CDlgMPatternPickSearchTool::UpdateSearchData(bool bValidate)
{
	if (!m_pDlgParent->m_pSearchTool)
	{
		return;
	...
	if (bValidate) // 从界面获取搜索参数
	{
		...
		((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum = m_nSearchNum;
		((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre = m_dAcceptThre;
		((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre = m_dConfusionThre;
		((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bCoordSortEnable = m_bCoordSortEnable;
		((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortMethod = (CoordSortMethod)m_nCoordSortMethod;
		((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dCoordSortGap = m_dCoordSortGap;
		((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderX = (SortOrder)m_nCoordSortOrderX;
		((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderY =  (SortOrder)m_nCoordSortOrderY;
	...
	else // 设置界面值
	{
		...
		m_nSearchNum	= ((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nSearchNum;
		m_dAcceptThre	= ((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dAcceptThre;	
		m_dConfusionThre = ((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dConfusionThre;
		m_bCoordSortEnable = ((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_bCoordSortEnable;
		m_nCoordSortMethod = ((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortMethod;
		m_dCoordSortGap = ((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_dCoordSortGap;
		m_nCoordSortOrderX = ((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderX;
		m_nCoordSortOrderY = ((CMPatternPickSearchSearchDataParam*)m_pDlgParent->m_pSearchDataParam)->m_nCoordSortOrderY;
...
void CDlgMPatternPickSearchTool::UpdateDialogLanguage()
{
//	return;
	...
	while(xml.FindElem(_T("")))
	{
		...
		if(_T("IDD_DLG_MPatternPickSearch_TOOL") == strDlgID)
		{
			int nID;
...
void CDlgMPatternPickSearchTool::CheckDlgDataValidation()
{
	UpdateData(TRUE);
...
void CDlgMPatternPickSearchTool::OnBtnGetTrainImage() 
{
...
void CDlgMPatternPickSearchTool::OnBtnTrain() 
{
...
void CDlgMPatternPickSearchTool::OnBtnSetMaskImage() 
{
	// TODO: Add your control notification handler code here
	if (!m_pDlgParent->m_pSearchTool)
	{
...
void CDlgMPatternPickSearchTool::OnChkEnableMask() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
...
BOOL CDlgMPatternPickSearchTool::OnInitDialog() 
{
...
void CDlgMPatternPickSearchTool::OnSelchangeComboAccuracyMode() 
{
	m_nPatAccuracyMode = m_comboAccuracy.GetCurSel();	
}

void CDlgMPatternPickSearchTool::OnSelchangeComboSpeedMode() 
{
	m_nPatSpeedMode = m_comboSpeed.GetCurSel();
}

void CDlgMPatternPickSearchTool::OnBtnSetCenter() 
{
	if (m_pDlgParent->m_pSearchTool->IsTrained())
	{
		cpImage imageTrain, imagePattern;
		m_pDlgParent->m_pSearchTool->GetTrainImage(imageTrain);
		CMPatternPickSearchTrainGuiParam *pTrainGuiParam = new CMPatternPickSearchTrainGuiParam;
		...
		if (dlgPatternCenterSet.DoModal() == IDOK)
		{
			...
			pTrainGuiParam->m_ModelPoint.SetX(vecModelPointResult[0].GetX() + pTrainGuiParam->m_TrainRect.GetUL().GetX());
			pTrainGuiParam->m_ModelPoint.SetY(vecModelPointResult[0].GetY() + pTrainGuiParam->m_TrainRect.GetUL().GetY());
			if (pTrainGuiParam->m_bModelPoint2Visible)
			{
				pTrainGuiParam->m_ModelPoint2.SetX(vecModelPointResult[1].GetX() + pTrainGuiParam->m_TrainRect.GetUL().GetX());
				pTrainGuiParam->m_ModelPoint2.SetY(vecModelPointResult[1].GetY() + pTrainGuiParam->m_TrainRect.GetUL().GetY());
			}
// 			dlgPatternCenterSet.GetPatternCenter(dMarkX, dMarkY);
...
void CDlgMPatternPickSearchTool::OnSetfocusEdtAngleLow() 
{
...
void CDlgMPatternPickSearchTool::OnSetfocusEdtAngleHigh() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMPatternPickSearchTool::OnSetfocusEdtSearchNum() 
{
	// TODO: Add your control notification handler code here
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMPatternPickSearchTool::OnSetfocusEdtAcceptThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMPatternPickSearchTool::OnSetfocusEdtConfusionThre() 
{
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
		::PostMessage(m_pDlgParent->GetSafeHwnd(), WM_SETFOCUS, NULL, NULL);
...
void CDlgMPatternPickSearchTool::OnBtnFullImageSearch() 
{
	if (m_pDlgParent->m_imageTrain.IsValid())
	{
		CMPatternPickSearchTrainGuiParam trainGuiParam;
...
BOOL CDlgMPatternPickSearchTool::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgMPatternPickSearchTool::OnBnClickedChkEnableMark2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMPatternPickSearchTool::OnCbnSelchangeComboCoordSortMethod()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CDlgMPatternPickSearchTool::OnEnSetfocusEdtCoordSortGap()
{
	// TODO: 在此添加控件通知处理程序代码
	if (m_pDlgParent->m_bSysKeyboardEnabled)
	{
...
void CDlgMPatternPickSearchTool::OnBnClickedChkShowHideSearch1Rect()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}
...
void CDlgMPatternPickSearchTool::OnBnClickedChkShowHideSearch2Rect()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateTrainData(TRUE);
}
