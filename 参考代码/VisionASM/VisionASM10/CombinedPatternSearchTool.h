...
typedef struct tagCombinedPatternSearchTrainDataParam : public CBaseTrainDataParam
{
	...
	tagCombinedPatternSearchTrainDataParam()
	{
...
}CCombinedPatternSearchTrainDataParam;


// PatternSearch定位工具训练Gui参数类
typedef struct tagCombinedPatternSearchTrainGuiParam : public CBaseTrainGuiParam
{
	...
	tagCombinedPatternSearchTrainGuiParam()
	{
...
}CCombinedPatternSearchTrainGuiParam;

// PatternSearch定位工具搜索Data参数类
typedef struct tagCombinedPatternSearchSearchDataParam : public CBaseSearchDataParam
{
	...
	tagCombinedPatternSearchSearchDataParam()
	{
		m_nSearchNum	= 1;
		m_dAcceptThre	= 0.6;
...
}CCombinedPatternSearchSearchDataParam;

// PatternSearch定位工具搜索Gui参数类
typedef struct tagCombinedPatternSearchGuiParam : public CBaseSearchGuiParam
{
	COLORREF        m_LineColor;						// 图形颜色
	int				m_nLineWidth;						// 图形线宽
	...
	tagCombinedPatternSearchGuiParam()
	{
...
}CCombinedPatternSearchSearchGuiParam;


// QuickSearch训练结果
typedef struct tagCombinedPatternSearchTrainResult
{
	...
	tagCombinedPatternSearchTrainResult()
	{
		m_dModelX = 0;
		m_dModelY = 0;
...
}CCombinedPatternSearchTrainResult;


class CCombinedPatternSearchTool : public CBaseSearchTool
{
public:

	CCombinedPatternSearchTool();
	CCombinedPatternSearchTool(CCombinedPatternSearchTool &cPatternSearchTool);
	CCombinedPatternSearchTool& operator=(CCombinedPatternSearchTool &cPatternSearchTool);
	virtual ~CCombinedPatternSearchTool();
...
private:
	...
	CCombinedPatternSearchTrainDataParam		m_tmpTrainDataParam;			// 当前训练Data参数
	CCombinedPatternSearchTrainGuiParam			m_tmpTrainGuiParam;				// 当前训练Gui参数	
	CCombinedPatternSearchSearchDataParam		m_tmpSearchDataParam;			// 当前搜索Data参数	
	CCombinedPatternSearchSearchGuiParam		m_tmpSearchGuiParam;			// 当前搜索Gui参数
	CCombinedPatternSearchTrainResult			m_tmpTrainResult;				// 当前训练结果
	cpImage									m_tmpImageTrain;				// 当前训练图像
	cpImage									m_tmpImageMask;					// 当前掩模图像
	cpImage									m_tmpImageMask1;				// 当前掩模图像

	CCombinedPatternSearchTrainDataParam		m_TrainDataParam;				// 训练Data参数
	CCombinedPatternSearchTrainGuiParam			m_TrainGuiParam;				// 训练Gui参数	
	CCombinedPatternSearchSearchDataParam		m_SearchDataParam;				// 搜索Data参数	
	CCombinedPatternSearchSearchGuiParam		m_SearchGuiParam;				// 搜索Gui参数	
	CCombinedPatternSearchTrainResult			m_TrainResult;					// 训练结果

	cpImage							m_ImageTrain;					// 训练图像
	cpImage							m_ImageMask;					// 掩模图像
	cpImage							m_ImageMask3;					// 掩模图像
