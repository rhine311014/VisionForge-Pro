// PatternCircle4LineSearchTool.cpp: implementation of the CPatternCircleLineSearchTool class.
//
//////////////////////////////////////////////////////////////////////
...
CPatternCircle4LineSearchTool::CPatternCircle4LineSearchTool(void)
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
	...
	int i=0;
	for (i=0; i<PATTERN_CIRCLE_4LINE_NUM; i++)
	{
		CString str;
		switch (m_iLanguage)
		{
...
CPatternCircle4LineSearchTool::CPatternCircle4LineSearchTool(CPatternCircle4LineSearchTool &cPatternCircleLineSearchTool)
{
	if (cPatternCircleLineSearchTool.GetSearchToolType() != ePatternCircle4LineSearchTool)
	{
		return;
	}
	...
	if (m_bTrainOK)
	{
		m_PatternSearchTool = cPatternCircleLineSearchTool.m_PatternSearchTool;
	}
}

CPatternCircle4LineSearchTool& CPatternCircle4LineSearchTool::operator=(CPatternCircle4LineSearchTool &cPatternCircleLineSearchTool)
{
...
CSearchToolType CPatternCircle4LineSearchTool::GetSearchToolType()
{
	return ePatternCircle4LineSearchTool;
}

// 设置显示控件指针		
bool CPatternCircle4LineSearchTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CPatternCircle4LineSearchTool::GetDisplay()
{
	return m_pGuiDisplay;
}

// 设置Gui图形的关键字														
bool CPatternCircle4LineSearchTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CPatternCircle4LineSearchTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CPatternCircle4LineSearchTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CPatternCircle4LineSearchTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CPatternCircle4LineSearchTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CPatternCircle4LineSearchTool::UpdateTrainGuiDisplay()
{	
	// 区域定位参数
...
bool CPatternCircle4LineSearchTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索界面显示									
bool CPatternCircle4LineSearchTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
// 更新界面显示
bool CPatternCircle4LineSearchTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CPatternCircle4LineSearchTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != ePatternCircle4LineSearchTool)
	{
		return false;
	}

	m_tmpTrainDataParam = *((CPatternCircle4LineSearchTrainDataParam*)pTrainDataParam);

	return true;
}

// 获取训练Data参数									
bool CPatternCircle4LineSearchTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CPatternCircle4LineSearchTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;

	return true;
}

// 获取搜索Gui参数						
bool CPatternCircle4LineSearchTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != ePatternCircle4LineSearchTool)
	{
		return false;
	}

	m_tmpTrainGuiParam = *((CPatternCircle4LineSearchTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CPatternCircle4LineSearchTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CPatternCircle4LineSearchTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;

	return true;
}

// 设置训练原始图像				
bool CPatternCircle4LineSearchTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CPatternCircle4LineSearchTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CPatternCircle4LineSearchTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CPatternCircle4LineSearchTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CPatternCircle4LineSearchTool::Train()
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CPatternCircle4LineSearchTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CPatternCircle4LineSearchTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != ePatternCircle4LineSearchTool)
	{
		return false;
	}

	*((CPatternCircle4LineSearchTrainResult*)pTrainResult) = m_tmpTrainResult;

	return true;
}	

// 是否训练成功
bool CPatternCircle4LineSearchTool::IsTrained()
{
	return m_bTrainOK;
}

// 设置搜索Data参数	
bool CPatternCircle4LineSearchTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != ePatternCircle4LineSearchTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CPatternCircle4LineSearchSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CPatternCircle4LineSearchTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CPatternCircle4LineSearchSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CPatternCircle4LineSearchTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != ePatternCircle4LineSearchTool)
	{
		return false;
	}

	m_tmpSearchGuiParam = *((CPatternCircle4LineSearchSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CPatternCircle4LineSearchTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CPatternCircle4LineSearchSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;

	return true;
}

// 执行搜索 					
bool CPatternCircle4LineSearchTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
	...
	if (bRet)
	{
		...
		for (int i=0; i<nResultNum && i<MAXRESNUM; i++)
		{
			...
			// 1.求线的结果
			scLineSeg arrLineSeg[PATTERN_CIRCLE_4LINE_NUM];
			double dRMS[PATTERN_CIRCLE_4LINE_NUM];
			bool   bFindLine[PATTERN_CIRCLE_4LINE_NUM];
			for (int k=0; k<PATTERN_CIRCLE_4LINE_NUM; k++)
			{
				bFindLine[k] = 1;
			}

			for (int j=0; j<PATTERN_CIRCLE_4LINE_NUM; j++)
			{
				// 求找线工具变换后的位置,找线
				...
				if (m_tmpTrainDataParam.m_bEnableLine[j])
				{
					if(bIsProcessImage)
					{
						bFindLine[j] = m_FindLineTool[j].Execute(tmpImage, arrLineSeg[j], dRMS[j]); // 成功
					}
					else
					{
			...
			// 5.4.显示直线拟合的点
			for (int Index = 0; Index < PATTERN_CIRCLE_4LINE_NUM; Index++)
			{
			...
			// 线
			for (int nLine = 0; nLine < PATTERN_CIRCLE_4LINE_NUM; nLine++)
			{
				if (m_tmpTrainDataParam.m_bEnableLine[nLine])
				{
					CResultLine line;
...
// 获取搜索结果个数										
int CPatternCircle4LineSearchTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CPatternCircle4LineSearchTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像
bool CPatternCircle4LineSearchTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != ePatternCircle4LineSearchTool)
	{
		return false;
	}
...
// 加载模板文件
bool CPatternCircle4LineSearchTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
	//	BYTE byR, byG, byB;
	CPatternCircle4LineSearchTrainDataParam tmpTrainDataParam;
	CPatternCircle4LineSearchTrainGuiParam tmpTrainGuiParam;
	CPatternCircle4LineSearchSearchDataParam tmpSearchDataParam;
	CPatternCircle4LineSearchSearchGuiParam tmpSearchGuiParam;	
	CPatternCircle4LineSearchTrainResult    tmpTrainResult;
...
// 保存模板文件							
bool CPatternCircle4LineSearchTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CPatternCircle4LineSearchTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CPatternCircle4LineSearchTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CPatternCircle4LineSearchTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CPatternCircle4LineSearchTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CPatternCircle4LineSearchTool::ClearResult()
{
	ClearResultGui();
...
bool CPatternCircle4LineSearchTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
		...
		for (j=0; j<PATTERN_CIRCLE_4LINE_NUM; j++)
		{
			CString strKey;
...
bool CPatternCircle4LineSearchTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CPatternCircle4LineSearchTool::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CPatternCircle4LineSearchTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CPatternCircle4LineSearchTool::RestoreSearchParam()
{
...
void CPatternCircle4LineSearchTool::SetLanguage(int nLanguage)
{
...
// 根据相机宽高设置GUI大小
bool CPatternCircle4LineSearchTool::SetGuiByCam(double nWidth,double nHeight) 
{
...
CString CPatternCircle4LineSearchTool::GetResultErrInfo()
{
	CString strErrInfo;
