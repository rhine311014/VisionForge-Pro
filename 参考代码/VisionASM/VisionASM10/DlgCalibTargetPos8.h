...
class CDlgCalibTargetPos8 : public CDialog
{
	DECLARE_DYNAMIC(CDlgCalibTargetPos8)

public:
	CDlgCalibTargetPos8(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgCalibTargetPos8();

// 对话框数据
	enum { IDD = IDD_DLG_CALIB_TARGET_POS8 };
	...
	BOOL							m_bCommGetPlatformAxisPosSuccess2;
...
public:
	...
	CXPStyleButtonST	m_btnSearchObject2Pos0;
	CXPStyleButtonST	m_btnSearchObject3Pos0;
	CXPStyleButtonST	m_btnSearchObject0Pos1;
	CXPStyleButtonST	m_btnSearchObject1Pos1;
	CXPStyleButtonST	m_btnSearchObject2Pos1;
	CXPStyleButtonST	m_btnSearchObject3Pos1;
	CXPStyleButtonST	m_btnSearchVirtualObject0Pos0;
	CXPStyleButtonST	m_btnSearchVirtualObject1Pos0;
	CXPStyleButtonST	m_btnSearchVirtualObject2Pos0;
	CXPStyleButtonST	m_btnSearchVirtualObject3Pos0;
	CXPStyleButtonST	m_btnSearchVirtualObject0Pos1;
	CXPStyleButtonST	m_btnSearchVirtualObject1Pos1;
	CXPStyleButtonST	m_btnSearchVirtualObject2Pos1;
	CXPStyleButtonST	m_btnSearchVirtualObject3Pos1;
	...
	afx_msg void OnBnClickedBtnSearchObject2MovePos0();
	afx_msg void OnBnClickedBtnSearchObject3MovePos0();
	afx_msg void OnBnClickedBtnSearchObject2MovePos1();
	afx_msg void OnBnClickedBtnSearchObject3MovePos1();
	afx_msg void OnBnClickedBtnSearchVirtualObject2MovePos0();
	afx_msg void OnBnClickedBtnSearchVirtualObject3MovePos0();
	afx_msg void OnBnClickedBtnSearchVirtualObject2MovePos1();
	afx_msg void OnBnClickedBtnSearchVirtualObject3MovePos1();
	afx_msg void OnBnClickedBtnCommGetPlatformAxisPos2();
	CLabel m_labelPlatform1;
	CLabel m_labelPlatform2;
	...
	void CommSendTargetImagePos();
	void CommGetTargetImagePos();
...
//	CString strCorrelationLogPath;
	...
	afx_msg void OnBnClickedSetCalibTargetShutter5();
	afx_msg void OnBnClickedSetCalibTargetShutter6();
	afx_msg void OnBnClickedSetCalibTargetShutter7();
	afx_msg void OnBnClickedSetCalibTargetShutter8();
