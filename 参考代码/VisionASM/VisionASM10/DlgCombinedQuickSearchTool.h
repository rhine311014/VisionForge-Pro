...
class CDlgSearch;
class CDlgCombinedQuickSearchTool : public CDialogEx
{
	DECLARE_DYNAMIC(CDlgCombinedQuickSearchTool)

public:
	CDlgCombinedQuickSearchTool(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgCombinedQuickSearchTool();
