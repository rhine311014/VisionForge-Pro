...
/////////////////////////////////////////////////////////////////////////////
// CDlgQuickSearchGenRectTool dialog
...
class CDlgSearch;
class CDlgQuickSearchGenRectTool : public CDialog
{
// Construction
public:
	CDlgQuickSearchGenRectTool(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CDlgQuickSearchGenRectTool)
	enum { IDD = IDD_DLG_QUICKSEARCH_GENRECT_TOOL };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlgQuickSearchGenRectTool)
	public:
...
protected:
	...
	//{{AFX_MSG(CDlgQuickSearchGenRectTool)
