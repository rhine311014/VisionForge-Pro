...
class CDlgCalcuVirtualObject : public CDialog
{
	DECLARE_DYNAMIC(CDlgCalcuVirtualObject)

public:
	CDlgCalcuVirtualObject(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgCalcuVirtualObject();

// 对话框数据
	enum { IDD = IDD_DLG_CALCU_VIRTUAL_OBJECT };
...
public:
	...
	int m_nRadioExProductIndex;
	afx_msg void OnBnClickedRadioExProductIndex0();
