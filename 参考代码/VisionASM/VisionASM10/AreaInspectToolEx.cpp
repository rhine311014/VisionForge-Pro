...
CAreaInspectToolEx::CAreaInspectToolEx()
{
	m_strName								= _T("ACF检测");
...
CAreaInspectToolEx::CAreaInspectToolEx(CAreaInspectToolEx &cAreaInspectToolEx)
{
	if (cAreaInspectToolEx.GetSearchToolType() != eAreaInspectToolEx)
	{
		return;
	}
...
//	m_pParentTool							= NULL;
	...
	CString str;
	for (int i=0;i<cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum;i++)
	{
		scGuiAffineRect* tempGuiTrainRect = new scGuiAffineRect;
		tempGuiTrainRect->SetCenterLengthsRotationSkew(250+i*100, 200, 50, 50, 0, 0);
		str.Format(_T("ACF检测%d"),i+1);
	...
	m_tmpTrainGuiParam.m_LineColor.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,RGB(0, 0, 255));
	m_tmpTrainGuiParam.m_nLineWidth.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,1);
	m_tmpTrainGuiParam.m_bSearchRectVisible.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,TRUE);

	m_tmpSearchGuiParam.m_LineColor.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,RGB(0, 0, 255));
	m_tmpSearchGuiParam.m_nLineWidth.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,1);
	m_tmpSearchGuiParam.m_bAffineRectVisible.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,TRUE);
	m_tmpSearchGuiParam.m_bModelPointVisible.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,TRUE);
	m_tmpTrainDataParam.m_nInsAreaNum = cAreaInspectToolEx.m_tmpTrainDataParam.m_nInsAreaNum;
	...
	m_dCurMean.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,0);
	m_dCurStdDev.resize(cAreaInspectToolEx.m_TrainDataParam.m_nInsAreaNum,0);

	CreateGUID(m_strKeyText);				// 创建guid作为Key的唯一标识

	// 赋值
	m_CamHeight								=  cAreaInspectToolEx.m_CamHeight;
	m_CamWidth								=  cAreaInspectToolEx.m_CamWidth;
	m_strName								= cAreaInspectToolEx.m_strName;

	m_TrainDataParam						= cAreaInspectToolEx.m_TrainDataParam;
	m_TrainGuiParam							= cAreaInspectToolEx.m_TrainGuiParam;
	m_SearchDataParam						= cAreaInspectToolEx.m_SearchDataParam;
	m_SearchGuiParam						= cAreaInspectToolEx.m_SearchGuiParam;
	m_TrainResult                           = cAreaInspectToolEx.m_TrainResult;
	m_ImageTrain							= cAreaInspectToolEx.m_ImageTrain;
	m_ImageMask								= cAreaInspectToolEx.m_ImageMask;
	m_bTrainGuiShow							= cAreaInspectToolEx.m_bTrainGuiShow;
	m_bSearchResultGuiShow					= cAreaInspectToolEx.m_bSearchResultGuiShow;
	m_bTrainOK								= cAreaInspectToolEx.m_bTrainOK;
	m_pGuiDisplay							= cAreaInspectToolEx.m_pGuiDisplay;
	...
	cAreaInspectToolEx.UpdateSearchGuiData(true);
	cAreaInspectToolEx.UpdateTrainGuiData(true);
	SetTrainDataParam(&cAreaInspectToolEx.m_tmpTrainDataParam);
	SetTrainGuiParam(&cAreaInspectToolEx.m_tmpTrainGuiParam);
	SetSearchDataParam(&cAreaInspectToolEx.m_tmpSearchDataParam);
	SetSearchGuiParam(&cAreaInspectToolEx.m_tmpSearchGuiParam);
	SetTrainImage(cAreaInspectToolEx.m_tmpImageTrain);
	SetMaskImage(cAreaInspectToolEx.m_tmpImageMask);
	//if (m_bTrainOK)
	//{
	//	m_bTrainOK = false;
...
CAreaInspectToolEx& CAreaInspectToolEx::operator=(CAreaInspectToolEx& cAreaInspectToolEx)
{
	if (this == &cAreaInspectToolEx)
	{
		return *this;
	}
...
// 获取工具类型
CSearchToolType CAreaInspectToolEx::GetSearchToolType()
{
	return eAreaInspectToolEx;
}					

void CAreaInspectToolEx::SetSearchToolName(CString strName)
{
	m_strName = strName;
}

CString CAreaInspectToolEx::GetSearchToolName()
{
	return m_strName;
}

// 设置显示控件指针		
bool CAreaInspectToolEx::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CAreaInspectToolEx::GetDisplay()
{
	return m_pGuiDisplay;
}

// 设置Gui图形的关键字														
bool CAreaInspectToolEx::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CAreaInspectToolEx::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CAreaInspectToolEx::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CAreaInspectToolEx::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CAreaInspectToolEx::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CAreaInspectToolEx::UpdateTrainGuiDisplay()
{
...
// 更新搜索界面显示									
bool CAreaInspectToolEx::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
bool CAreaInspectToolEx::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CAreaInspectToolEx::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eAreaInspectToolEx)
	{
		return false;
	}
	
	m_tmpTrainDataParam = *((CAreaInspectExTrainDataParam*)pTrainDataParam);
	
	return true;
}

// 获取训练Data参数									
bool CAreaInspectToolEx::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CAreaInspectExTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;
	
	return true;
}

// 获取搜索Gui参数						
bool CAreaInspectToolEx::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eAreaInspectToolEx)
	{
		return false;
	}
	
	m_tmpTrainGuiParam = *((CAreaInspectExTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CAreaInspectToolEx::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CAreaInspectExTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;
	
	return true;
}

// 设置训练原始图像				
bool CAreaInspectToolEx::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CAreaInspectToolEx::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CAreaInspectToolEx::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CAreaInspectToolEx::GetMaskImage(cpImage &ImageMask)
{
...
// 获取训练结果图像														
bool CAreaInspectToolEx::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CAreaInspectToolEx::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eAreaInspectToolEx)
	{
		return false;
	}
	
	*((CAreaInspectExTrainResult*)pTrainResult) = m_tmpTrainResult;
	
	return true;
}						

// 是否训练成功
bool CAreaInspectToolEx::IsTrained()
{
	return m_bTrainOK;
}															
			
// 设置搜索Data参数	
bool CAreaInspectToolEx::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eAreaInspectToolEx)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CAreaInspectExSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CAreaInspectToolEx::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CAreaInspectExSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CAreaInspectToolEx::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eAreaInspectToolEx)
	{
		return false;
	}
	
	m_tmpSearchGuiParam = *((CAreaInspectExSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CAreaInspectToolEx::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CAreaInspectExSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;
	
	return true;
}

// 执行搜索 					
bool CAreaInspectToolEx::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
...
// 	}
	...
	for (int i=0;i<m_tmpTrainDataParam.m_nInsAreaNum;i++)
	{
		...
		else
		{
			...
			{
				if ((m_dCurMean.at(i)<m_tmpTrainDataParam.m_dMinMean.at(i)) || (m_dCurMean.at(i)-0.001>m_tmpTrainDataParam.m_dMaxMean.at(i)))
				{
					m_bmean=false;
				}
			}
			...
			{
				if ((m_dCurStdDev.at(i)<m_tmpTrainDataParam.m_dMinStdDev.at(i))||(m_dCurStdDev.at(i)-0.001>m_tmpTrainDataParam.m_dMaxStdDev.at(i)))
				{
					m_bstddev=false;
				}
			}
	...
	for (int i=0;i<bInspectResult.size();i++)
	{
		...
		strLable.Format(_T("%s_%d"), GetSearchToolName(), i+1);
...
bool CAreaInspectToolEx::SearchStatistic(cpImage &ImageSearch)
{
	// 清空
	ClearResult();
...
// 获取搜索结果个数										
int CAreaInspectToolEx::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CAreaInspectToolEx::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像
bool CAreaInspectToolEx::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eAreaInspectToolEx)
	{
		return false;
	}
...
// 加载模板文件
bool CAreaInspectToolEx::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
//	BYTE byR, byG, byB;
	CAreaInspectExTrainDataParam tmpTrainDataParam;
	CAreaInspectExTrainGuiParam tmpTrainGuiParam;
	CAreaInspectExSearchDataParam tmpSearchDataParam;
	CAreaInspectExSearchGuiParam tmpSearchGuiParam;
	CAreaInspectExTrainResult    tmpTrainResult;
...
// 保存模板文件							
bool CAreaInspectToolEx::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CAreaInspectToolEx::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CAreaInspectToolEx::SaveTrainGuiData()
{
	return UpdateTrainGuiData(true);
}

bool CAreaInspectToolEx::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CAreaInspectToolEx::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CAreaInspectToolEx::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CAreaInspectToolEx::ClearResult()
{
	ClearResultGui();
...
bool CAreaInspectToolEx::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CAreaInspectToolEx::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
 		m_pGuiInteractiveContainer = m_pGuiDisplay->GetInteractiveContainer();
...
bool CAreaInspectToolEx::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 清除vector中的Gui
bool CAreaInspectToolEx::ClearTrainVectorGui()
{
	for (int i=0;i<m_GuiSearchRect.size();i++)
	{
		if (m_GuiSearchRect.at(i)!=NULL)
...
// 获取训练模板原始图像
bool CAreaInspectToolEx::GetPatternImage(cpImage &ImagePattern)
{
...
// 恢复训练参数
bool CAreaInspectToolEx::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CAreaInspectToolEx::RestoreSearchParam()
{
...
bool CAreaInspectToolEx::ApplyStatisticData()
{
...
bool CAreaInspectToolEx::ResetStatisticData()
{
...
void CAreaInspectToolEx::SetLanguage(int nLanguage)
{
...
void  CAreaInspectToolEx::ResizeToolsAllParam(int nNewToolNum)
{
...
CString	CAreaInspectToolEx::GetResultErrInfo()
{
	CString strErrInfo;
