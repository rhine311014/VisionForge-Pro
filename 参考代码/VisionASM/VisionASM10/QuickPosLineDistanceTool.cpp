...
CQuickPosLineDistanceTool::CQuickPosLineDistanceTool(void)
{
	m_pGuiDisplay								= NULL;
	m_hDispWnd									= NULL;
...
CQuickPosLineDistanceTool::CQuickPosLineDistanceTool(CQuickPosLineDistanceTool &cQuickPosLineDistanceTool)
{
	if (cQuickPosLineDistanceTool.GetSearchToolType() != eQuickPosLineDistanceTool)
	{
		return;
	}
	...
	// 赋值
    m_CamHeight								= cQuickPosLineDistanceTool.m_CamHeight;
    m_CamWidth								= cQuickPosLineDistanceTool.m_CamWidth;
	m_TrainDataParam						= cQuickPosLineDistanceTool.m_TrainDataParam;
	m_TrainGuiParam							= cQuickPosLineDistanceTool.m_TrainGuiParam;
	m_SearchDataParam						= cQuickPosLineDistanceTool.m_SearchDataParam;
	m_SearchGuiParam						= cQuickPosLineDistanceTool.m_SearchGuiParam;
	m_TrainResult							= cQuickPosLineDistanceTool.m_TrainResult;
	m_ImageTrain							= cQuickPosLineDistanceTool.m_ImageTrain;
	m_ImageMask								= cQuickPosLineDistanceTool.m_ImageMask;
	m_bTrainGuiShow							= cQuickPosLineDistanceTool.m_bTrainGuiShow;
	m_bTrainResultGuiShow					= cQuickPosLineDistanceTool.m_bTrainResultGuiShow;
	m_bSearchResultGuiShow					= cQuickPosLineDistanceTool.m_bSearchResultGuiShow;
	m_bTrainOK								= cQuickPosLineDistanceTool.m_bTrainOK;
	m_pGuiDisplay							= cQuickPosLineDistanceTool.m_pGuiDisplay;
	...
	cQuickPosLineDistanceTool.UpdateSearchGuiData(true);
	cQuickPosLineDistanceTool.UpdateTrainGuiData(true);
	SetTrainDataParam(&cQuickPosLineDistanceTool.m_tmpTrainDataParam);
	SetTrainGuiParam(&cQuickPosLineDistanceTool.m_tmpTrainGuiParam);
	SetSearchDataParam(&cQuickPosLineDistanceTool.m_tmpSearchDataParam);
	SetSearchGuiParam(&cQuickPosLineDistanceTool.m_tmpSearchGuiParam);
	SetTrainImage(cQuickPosLineDistanceTool.m_tmpImageTrain);
	SetMaskImage(cQuickPosLineDistanceTool.m_tmpImageMask);
...
CQuickPosLineDistanceTool& CQuickPosLineDistanceTool::operator=(CQuickPosLineDistanceTool &cQuickPosLineDistanceTool)
{
	if (this == &cQuickPosLineDistanceTool)
	{
		return *this;	
	}
...
CSearchToolType CQuickPosLineDistanceTool::GetSearchToolType()
{
	return eQuickPosLineDistanceTool;
}

// 设置显示控件指针		
bool CQuickPosLineDistanceTool::SetDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取显示控件指针										
scGuiDisplay* CQuickPosLineDistanceTool::GetDisplay()
{
	return m_pGuiDisplay;
}
// 设置训练结果显示控件指针
bool CQuickPosLineDistanceTool::SetTrainResultDisplay(scGuiDisplay *pGuiDisplay)
{
	ClearAllGui();
...
// 获取训练结果显示控件指针
scGuiDisplay* CQuickPosLineDistanceTool::GetTrainResultDisplay()
{
	return m_pGuiTrainResultDisplay;
}

// 设置Gui图形的关键字														
bool CQuickPosLineDistanceTool::SetGuiKeyText(CString strGuiKeyText)									
{
...
// 获取Gui图形的关键字
bool CQuickPosLineDistanceTool::GetGuiKeyText(CString &strGuiKeyText)
{
...
// 更新训练界面显示					
bool CQuickPosLineDistanceTool::ShowTrainGui(bool bShow)
{
...
// 是否显示训练结果界面
bool CQuickPosLineDistanceTool::ShowTrainResultGui(bool bShow)
{
	return false;
}

// 更新搜索界面显示									
bool CQuickPosLineDistanceTool::ShowSearchResultGui(bool bShow)							
{
...
// 更新训练界面显示					
bool CQuickPosLineDistanceTool::UpdateTrainGuiDisplay()
{	
...
bool CQuickPosLineDistanceTool::UpdateTrainResultGuiDisplay()
{
	// 训练结果
...
// 更新搜索界面显示									
bool CQuickPosLineDistanceTool::UpdateSearchResultGuiDisplay()							
{
	int i=0;
...
// 更新界面显示
bool CQuickPosLineDistanceTool::UpdateGuiDisplay()
{
	UpdateTrainGuiDisplay();
...
// 设置训练Data参数	
bool CQuickPosLineDistanceTool::SetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	if (pTrainDataParam->GetSearchToolType() != eQuickPosLineDistanceTool)
	{
		return false;
	}

	m_tmpTrainDataParam = *((CQuickPosLineDistanceTrainDataParam*)pTrainDataParam);

	return true;
}

// 获取训练Data参数									
bool CQuickPosLineDistanceTool::GetTrainDataParam(CBaseTrainDataParam *pTrainDataParam)
{
	if (!pTrainDataParam)
	{
		return false;
	...
	*((CQuickPosLineDistanceTrainDataParam*)pTrainDataParam) = m_tmpTrainDataParam;

	return true;
}

// 获取搜索Gui参数						
bool CQuickPosLineDistanceTool::SetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	if (pTrainGuiParam->GetSearchToolType() != eQuickPosLineDistanceTool)
	{
		return false;
	}

	m_tmpTrainGuiParam = *((CQuickPosLineDistanceTrainGuiParam*)pTrainGuiParam);
...
// 获取搜索Gui参数							
bool CQuickPosLineDistanceTool::GetTrainGuiParam(CBaseTrainGuiParam *pTrainGuiParam)
{
	if (!pTrainGuiParam)
	{
		return false;
	...
	*((CQuickPosLineDistanceTrainGuiParam*)pTrainGuiParam) = m_tmpTrainGuiParam;

	return true;
}

// 设置训练原始图像				
bool CQuickPosLineDistanceTool::SetTrainImage(const cpImage &ImageTrain)
{
...
// 获取训练原始图像									
bool CQuickPosLineDistanceTool::GetTrainImage(cpImage &ImageTrain)
{
...
// 设置训练原始图像									
bool CQuickPosLineDistanceTool::SetMaskImage(const cpImage &ImageMask)
{
...
// 获取训练原始图像								
bool CQuickPosLineDistanceTool::GetMaskImage(cpImage &ImageMask)
{
...
// 执行训练											
bool CQuickPosLineDistanceTool::Train()                                                                                                                                                                                                                                                      
{
	m_bTrainOK = false;
...
// 获取训练结果图像														
bool CQuickPosLineDistanceTool::GetTrainResultImage(cpImage &ImageTrainResult)
{
...
// 获取训练结果
bool CQuickPosLineDistanceTool::GetTrainResult(CBaseTrainResult *pTrainResult)
{
	if (!pTrainResult)
	{
		return false;
	...
	if (pTrainResult->GetSearchToolType() != eQuickPosLineDistanceTool)
	{
		return false;
	}

	*((CQuickPosLineDistanceTrainResult*)pTrainResult) = m_tmpTrainResult;

	return true;
}	

// 是否训练成功
bool CQuickPosLineDistanceTool::IsTrained()
{
	return m_bTrainOK;
}

// 设置搜索Data参数	
bool CQuickPosLineDistanceTool::SetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{	
	if (!pSearchDataParam)
	{
		return false;
	...
	if (pSearchDataParam->GetSearchToolType() != eQuickPosLineDistanceTool)
	{
		return false;
	}

	m_tmpSearchDataParam = *((CQuickPosLineDistanceSearchDataParam*)pSearchDataParam);

	return true;
}

// 获取搜索Data参数				
bool CQuickPosLineDistanceTool::GetSearchDataParam(CBaseSearchDataParam *pSearchDataParam)
{
	if (!pSearchDataParam)
	{
		return false;
	...
	*((CQuickPosLineDistanceSearchDataParam*)pSearchDataParam) = m_tmpSearchDataParam;

	return true;
}

// 设置搜索Gui参数					
bool CQuickPosLineDistanceTool::SetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	if (pSearchGuiParam->GetSearchToolType() != eQuickPosLineDistanceTool)
	{
		return false;
	}

	m_tmpSearchGuiParam = *((CQuickPosLineDistanceSearchGuiParam*)pSearchGuiParam);
...
// 获取搜索Gui参数			
bool CQuickPosLineDistanceTool::GetSearchGuiParam(CBaseSearchGuiParam *pSearchGuiParam)
{
	if (!pSearchGuiParam)
	{
		return false;
	...
	*((CQuickPosLineDistanceSearchGuiParam*)pSearchGuiParam) = m_tmpSearchGuiParam;

	return true;
}

// 执行搜索 					
bool CQuickPosLineDistanceTool::Search(cpImage &ImageSearch)
{
	if (!m_bTrainOK)
	{
...
//	bool bRet = true;
	...
	if (m_TrainDataParam.m_bEnableSearchPos)
	{
		...
		if(bIsProcessImage)
		{
			bExecute = m_QuickSearchTool.Execute(tmpImage, m_TrainGuiParam.m_SearchRect);		
		}
		else
		{
			bExecute = m_QuickSearchTool.Execute(ImageSearch, m_TrainGuiParam.m_SearchRect);
		}
		// 执行搜索
		if (!bExecute)
		{
		...
		if (m_QuickSearchTool.GetResultNum() <= 0)
		{
			m_nResultErrNumber = -1; // 找点失败
			return false;
		}
...
// 获取搜索结果个数										
int CQuickPosLineDistanceTool::GetResultNum()
{
	return m_SearchResultArray.size();
}

// 获取搜索结果														
bool CQuickPosLineDistanceTool::GetResult(int nIndex, CSearchResult &searchResult)
{
...
// 加载模板训练图像
bool CQuickPosLineDistanceTool::LoadModelTrainPatternImage(CString strDir ,cpImage &ImagePattern)
{
	// strDir为文件夹路径
	// 仅配置ModelImage.bmp
	if (strDir == _T(""))
	...
	if (cSearchToolType != eQuickPosLineDistanceTool)
	{
		return false;
	}
...
// 加载模板文件
bool CQuickPosLineDistanceTool::LoadModelFromFile(CString strDir)
{
	// strDir为文件夹路径
	// 配置文件包括以下部分:
	//    (1) 配置文件Model.xml
	...
	sc2Vector vPos;
	//	BYTE byR, byG, byB;
	CQuickPosLineDistanceTrainDataParam tmpTrainDataParam;
	CQuickPosLineDistanceTrainGuiParam tmpTrainGuiParam;
	CQuickPosLineDistanceSearchDataParam tmpSearchDataParam;
	CQuickPosLineDistanceSearchGuiParam tmpSearchGuiParam;	
	CQuickPosLineDistanceTrainResult    tmpTrainResult;
...
// 保存模板文件							
bool CQuickPosLineDistanceTool::SaveModelToFile(CString strDir)
{
...
// 更新训练控件数据信息	
bool CQuickPosLineDistanceTool::UpdateTrainGuiData(bool bSaveAndValidate)
{
...
bool CQuickPosLineDistanceTool::UpdateSearchGuiData(bool bSaveAndValidate)
{
	if (bSaveAndValidate)	// 从Gui控件获取数据
	{
...
// 清除控件及其显示					
bool CQuickPosLineDistanceTool::ClearGraphicsArray(std::vector<scGuiGraphic*> &pGraphicsArray)
{
...
// 清除定位工具在Display上的控件
bool CQuickPosLineDistanceTool::ClearAllGui()
{
	ClearTrainGui();
...
// 清除搜索结果，需先清除结果GUI
bool CQuickPosLineDistanceTool::ClearResult()
{
	ClearResultGui();
...
bool CQuickPosLineDistanceTool::SetGuiByCam(double nWidth,double nHeight)
{
...
bool CQuickPosLineDistanceTool::ClearTrainGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
bool CQuickPosLineDistanceTool::ClearResultGui()
{
	if (m_pGuiDisplay && ::IsWindow(m_hDispWnd))
	{
		int j=0;
...
// 获取训练模板原始图像
bool CQuickPosLineDistanceTool::GetPatternImage(cpImage &ImagePattern)
{
	/*bool bRet = m_QuickSearchTool.GetPatternImage(ImagePattern);
	if (!bRet)
	{
		return false;
	}
...
// 恢复训练参数
bool CQuickPosLineDistanceTool::RestoreTrainParam()
{ 
...
// 恢复搜索参数		
bool CQuickPosLineDistanceTool::RestoreSearchParam()
{
...
void CQuickPosLineDistanceTool::SetLanguage(int nLanguage)
{
...
CString	CQuickPosLineDistanceTool::GetResultErrInfo()
{
	CString strErrInfo;
