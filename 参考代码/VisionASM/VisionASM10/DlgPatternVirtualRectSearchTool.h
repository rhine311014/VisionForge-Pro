...
class CDlgSearch;
class CDlgPatternVirtualRectSearchTool : public CDialogEx
{
	DECLARE_DYNAMIC(CDlgPatternVirtualRectSearchTool)

public:
	CDlgPatternVirtualRectSearchTool(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgPatternVirtualRectSearchTool();
	...
	// 对话框数据
	enum { IDD = IDD_DLG_PATTERNVIRTUALRECTSEARCH_TOOL };
