...
class SV_CALIBRATE_3D_API sc3D5PlaneCalibFeatureTool
{
public:
	sc3D5PlaneCalibFeatureTool(void);
	~sc3D5PlaneCalibFeatureTool(void);
	...
	bool Execute(const cpImage& img, scMaskAffineRect maskAffineRect, std::vector<sc3Vector>& vPoint);
...
public:
	...
	bool FitMultiPlane(const cpImage& img, scMaskAffineRect maskAffineRect, std::vector<scZeroPlaneResult>& vFitRes, std::vector<std::vector<sc3Vector>>& vFitPoint, std::vector<double>& vdRms);
	bool FitRegionSegment(const cpImage& img, scMaskAffineRect maskAffineRect, std::vector<scZeroPlaneResult>& vFitRes, std::vector<std::vector<sc3Vector>>& vFitPoint, std::vector<double>& vdRms);
