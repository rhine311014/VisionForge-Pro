...
#define DToINT4_8(Val)                                                        \
  ((Val) < (double)INT4_8_MIN                                                 \
       ? INT4_8_MIN                                                           \
       : ((Val) < INT_4_8_MAXDOUBLE                                           \
              ? (INT4_8)(Val)                                                 \
              : (((INT4_8_MIN == (INT4_8)(Val)) && ((Val) > 0))               \
                     ? INT4_8_MAX                                             \
                     : ((INT4_8)(Val)))))
#define DToINT4(Val)                                                          \
  ((INT4)MIN((double)INT4_MAX, MAX((double)INT4_MIN, (Val))))
#define DToINT2(Val)                                                          \
  ((INT2)MIN((double)INT2_MAX, MAX((double)INT2_MIN, (Val))))
